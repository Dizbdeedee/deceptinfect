...
class SpawnSystem extends System {
	...
	public var evac:SpawnPointTable;
...
class SpawnSystemDef extends SpawnSystem {
	...
	public override function generateSpawns() {
		obj.generateSpawns(MapStorage.spawns.get(GameLib.GetMap())
			.objectives);
		item.generateSpawns(MapStorage.spawns.get(GameLib.GetMap())
			.items);
		nest.generateSpawns(MapStorage.spawns.get(GameLib.GetMap())
			.nests);
		evac.generateBoundSpawns(MapStorage.spawns.get(GameLib.GetMap())
			.evacs);
	}
}
...
class SpawnPointTable {
	...
	public var componentManager:ComponentManager; // grim
