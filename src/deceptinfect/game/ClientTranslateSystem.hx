...
class ClientTranslateSystem extends System {
    ...
    override function init_shared() {
        net_replEntsMessage = new NET_Server<"di_netreplents",Net_ReplicatedEntitiesMessage>(#if client [updateEntRecv] #end);
        net_RemoveComponentMessage = new NET_Server<"di_removecomponent",Net_RemoveComponentMessage>(#if client [removeCompRecv] #end);
        net_RemoveEntityMessage = new NET_Server<"di_removentity",Net_RemoveEntityMessage>(#if client [removeEntityRecv] #end);
    ...
    override function init_server() {
        ...
        componentManager.getAddSignal(ClassToID.idc(ReplicatedEntity)).handle((add) -> {
        ...
        componentManager.getAddSignal(ClassToID.idc(PlayerComponent)).handle((sig) -> {
