...
@:native("gui")extern class GuiLib {
    ...
    **/
    ...
    public static function InternalMouseReleased(key:Float):Void;
    ...
    **/
    ...
    public static function InternalMousePressed(key:Float):Void;
    ...
    **/
    ...
    public static function InternalKeyCodeReleased(key:Float):Void;
    ...
    **/
    ...
    public static function InternalKeyCodePressed(key:Float):Void;
    ...
    **/
    ...
    public static function InternalMouseDoublePressed(key:Float):Void;
    ...
    **/
    ...
    public static function InternalKeyCodeTyped(key:Float):Void;
