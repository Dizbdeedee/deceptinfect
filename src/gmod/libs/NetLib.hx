...
@:native("net")extern class NetLib {
    ...
    **/
    ...
    public static function ReadColor():AnyTable;
    ...
    **/
    @:deprecated
    public static function ReadType(?typeID:Float):Any;
    ...
    **/
    @:deprecated
    public static function WriteType(Data:Any):Void;
    ...
    **/
    ...
    public static function WriteColor(Color:AnyTable):Void;
