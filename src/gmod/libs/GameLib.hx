...
@:native("game")extern class GameLib {
    ...
    **/
    ...
    public static function AddAmmoType(ammoData:AnyTable):Void;
    ...
    **/
    ...
    public static function GetGlobalState(name:String):Float;
    #end
    ...
    **/
    ...
    public static function GetAmmoDamageType(id:Float):Float;
    ...
    **/
    ...
    public static function SetGlobalState(name:String, state:Float):Void;
    #end
    ...
    **/
    ...
    public static function GetAmmoData(id:Float):AnyTable;
