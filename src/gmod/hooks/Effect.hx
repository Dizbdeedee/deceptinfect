...
class Effect {
    ...
    **/
    ...
    @:hook
    public function StartTouch():Void {}
    ...
    **/
    ...
    @:hook
    public function Init(effectData:CEffectData):Void {}
    ...
    **/
    ...
    @:hook
    public function GetTracerShootPos(pos:Vector, ent:Weapon, attachment:Float):Vector {return null;}
