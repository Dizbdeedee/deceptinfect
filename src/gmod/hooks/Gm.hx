...
class Gm {
    ...
    **/
    ...
    @:hook
    public function HUDShouldDraw(name:HUDElementList):Bool {return null;}
    #end
    #if client
    /**
...
@:multiReturn extern class GmPlayerCanHearPlayersVoiceReturn {
var a:Bool;
var b:Bool;
...
@:multiReturn extern class GmCheckPasswordReturn {
var a:Bool;
var b:String;

}
@:multiReturn extern class GmCalcViewModelViewReturn {
var a:Vector;
var b:Angle;
