...
**/
@:forward
abstract Func_dustmotes(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Start Disabled
	**/
    public var StartDisabled(get,set):Func_dustmotesStartDisabledChoices;

    @:noCompletion
    public extern inline function get_StartDisabled():Func_dustmotesStartDisabledChoices {
        return untyped this.GetKeyValues().StartDisabled;
    }
    
    @:noCompletion
    public extern inline function set_StartDisabled(value:Func_dustmotesStartDisabledChoices):Func_dustmotesStartDisabledChoices {
	...
	**/
    public var Frozen(get,set):Func_dustmotesFrozenChoices;

    @:noCompletion
    public extern inline function get_Frozen():Func_dustmotesFrozenChoices {
        return untyped this.GetKeyValues().Frozen;
    }
    
    @:noCompletion
    public extern inline function set_Frozen(value:Func_dustmotesFrozenChoices):Func_dustmotesFrozenChoices {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Func_dustmotes}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Func_dustmotes}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Func_dustmotes}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Func_dustmotes}>):CallbackLink {
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("func_dustmotes");
    }
}

enum abstract Func_dustmotesStartDisabledChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_dustmotesFrozenChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
