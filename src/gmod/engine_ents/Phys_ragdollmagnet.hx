...
**/
@:forward
abstract Phys_ragdollmagnet(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Start Disabled
	**/
    public var StartDisabled(get,set):Phys_ragdollmagnetStartDisabledChoices;

    @:noCompletion
    public extern inline function get_StartDisabled():Phys_ragdollmagnetStartDisabledChoices {
        return untyped this.GetKeyValues().StartDisabled;
    }
    
    @:noCompletion
    public extern inline function set_StartDisabled(value:Phys_ragdollmagnetStartDisabledChoices):Phys_ragdollmagnetStartDisabledChoices {
	...
	**/
    public var force(get,set):Float;

    @:noCompletion
    public extern inline function get_force():Float {
        return untyped this.GetKeyValues().force;
    }
    
    @:noCompletion
    public extern inline function set_force(value:Float):Float {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Phys_ragdollmagnet}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Phys_ragdollmagnet}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Phys_ragdollmagnet}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Phys_ragdollmagnet}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Phys_ragdollmagnetSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Phys_ragdollmagnetSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Phys_ragdollmagnetSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("phys_ragdollmagnet");
    }
}

enum abstract Phys_ragdollmagnetStartDisabledChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Phys_ragdollmagnetSpawnFlags(Int) to Int {
	var BAR_MAGNET_USE_AXIS_HELPER = 2;
}
