...
**/
@:forward
abstract Npc_combine_s(NPC) to Entity to NPC {
    //Inputs
    
    /**
		Look normally
	**/
    public extern inline function FireLookOn(delay:Float) {
        untyped this.Fire("LookOn",untyped null,delay);
    }
    
    /**
		Don't look for myself, use other squad member's eyes
	**/
    public extern inline function FireLookOff(delay:Float) {
        untyped this.Fire("LookOff",untyped null,delay);
    }
	...
	**/
    public extern inline function FireThrowGrenadeAtTarget(param:String,delay:Float) {
        untyped this.Fire("ThrowGrenadeAtTarget",untyped param,delay);
    }
	...
	**/
    ...
    /**
		BeginRappel
	**/
    public extern inline function FireBeginRappel(delay:Float) {
        untyped this.Fire("BeginRappel",untyped null,delay);
    }
	...
	**/
    public extern inline function FireAssault(param:String,delay:Float) {
        untyped this.Fire("Assault",untyped param,delay);
    }
	...
	**/
    ...
    /**
		Weapons
	**/
    public var additionalequipment(get,set):Npc_combine_sadditionalequipmentChoices;

    @:noCompletion
    public extern inline function get_additionalequipment():Npc_combine_sadditionalequipmentChoices {
        return untyped this.GetKeyValues().additionalequipment;
    }
    
    @:noCompletion
    public extern inline function set_additionalequipment(value:Npc_combine_sadditionalequipmentChoices):Npc_combine_sadditionalequipmentChoices {
    ...
    /**
		Number of Grenades
	**/
    public var NumGrenades(get,set):Npc_combine_sNumGrenadesChoices;

    @:noCompletion
    public extern inline function get_NumGrenades():Npc_combine_sNumGrenadesChoices {
        return untyped this.GetKeyValues().NumGrenades;
    }
    
    @:noCompletion
    public extern inline function set_NumGrenades(value:Npc_combine_sNumGrenadesChoices):Npc_combine_sNumGrenadesChoices {
        return untyped this.SetKeyValue("NumGrenades",untyped value);
    }
	...
	**/
    public var hintlimiting(get,set):Npc_combine_shintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Npc_combine_shintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Npc_combine_shintlimitingChoices):Npc_combine_shintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Npc_combine_ssleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Npc_combine_ssleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Npc_combine_ssleepstateChoices):Npc_combine_ssleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Npc_combine_swakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Npc_combine_swakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Npc_combine_swakesquadChoices):Npc_combine_swakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Npc_combine_signoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Npc_combine_signoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Npc_combine_signoreunseenenemiesChoices):Npc_combine_signoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Npc_combine_sgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Npc_combine_sgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Npc_combine_sgmod_allowphysgunChoices):Npc_combine_sgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var waitingtorappel(get,set):Npc_combine_swaitingtorappelChoices;

    @:noCompletion
    public extern inline function get_waitingtorappel():Npc_combine_swaitingtorappelChoices {
        return untyped this.GetKeyValues().waitingtorappel;
    }
    
    @:noCompletion
    public extern inline function set_waitingtorappel(value:Npc_combine_swaitingtorappelChoices):Npc_combine_swaitingtorappelChoices {
        return untyped this.SetKeyValue("waitingtorappel",untyped value);
    }
	...
	**/
    public var rendermode(get,set):Npc_combine_srendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Npc_combine_srendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Npc_combine_srendermodeChoices):Npc_combine_srendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Npc_combine_sdisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Npc_combine_sdisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Npc_combine_sdisablereceiveshadowsChoices):Npc_combine_sdisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Npc_combine_srenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Npc_combine_srenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Npc_combine_srenderfxChoices):Npc_combine_srenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Npc_combine_sdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Npc_combine_sdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Npc_combine_sdisableshadowsChoices):Npc_combine_sdisableshadowsChoices {
	...
	**/
    ...
    /**
		...
		Regular Soldier
	**/
    public var model(get,set):Npc_combine_smodelChoices;

    @:noCompletion
    public extern inline function get_model():Npc_combine_smodelChoices {
        return untyped this.GetKeyValues().model;
    }
    
    @:noCompletion
    public extern inline function set_model(value:Npc_combine_smodelChoices):Npc_combine_smodelChoices {
    ...
    /**
		Tactical Variant
	**/
    public var tacticalvariant(get,set):Npc_combine_stacticalvariantChoices;

    @:noCompletion
    public extern inline function get_tacticalvariant():Npc_combine_stacticalvariantChoices {
        return untyped this.GetKeyValues().tacticalvariant;
    }
    
    @:noCompletion
    public extern inline function set_tacticalvariant(value:Npc_combine_stacticalvariantChoices):Npc_combine_stacticalvariantChoices {
        return untyped this.SetKeyValue("tacticalvariant",untyped value);
    }
	...
	**/
    public var usemarch(get,set):Npc_combine_susemarchChoices;

    @:noCompletion
    public extern inline function get_usemarch():Npc_combine_susemarchChoices {
        return untyped this.GetKeyValues().usemarch;
    }
    
    @:noCompletion
    public extern inline function set_usemarch(value:Npc_combine_susemarchChoices):Npc_combine_susemarchChoices {
        return untyped this.SetKeyValue("usemarch",untyped value);
    }
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Npc_combine_s}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Npc_combine_s}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Npc_combine_s}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Npc_combine_s}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Npc_combine_s}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Npc_combine_s}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Npc_combine_s,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Npc_combine_s}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Npc_combine_s}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Npc_combine_s,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Npc_combine_s}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Npc_combine_s}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Npc_combine_s}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Npc_combine_s}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Npc_combine_s}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Npc_combine_s}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Npc_combine_s}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Npc_combine_s}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Npc_combine_s}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Npc_combine_s}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnRappelTouchdown(callback:Callback<{activator:Npc_combine_s}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnRappelTouchdown",callback);
    }
    
    /**
		Fired in response to FireUser1 input.
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Npc_combine_s}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Npc_combine_s}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Npc_combine_s}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Npc_combine_s}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Npc_combine_sSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Npc_combine_sSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Npc_combine_sSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("npc_combine_s");
    }
}

enum abstract Npc_combine_swakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_combine_swaitingtorappelChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_combine_susemarchChoices(String) to String {
	var NO = "0";
	var YES = "2";
}
enum abstract Npc_combine_stacticalvariantChoices(String) to String {
	var NORMAL_TACTICS = "0";
	var PRESSURE_THE_ENEMY_KEEP_ADVANCING = "1";
	var PRESSURE_UNTIL_WITHIN_30FT_THEN_NORMAL = "2";
}
enum abstract Npc_combine_ssleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Npc_combine_srendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Npc_combine_srenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Npc_combine_smodelChoices(String) to String {
	var REGULAR_SOLDIER = "models/combine_soldier.mdl";
	var NOVA_PROSPEKT_SOLDIER = "models/combine_soldier_prisonguard.mdl";
	var ELITE_SOLDIER = "models/combine_super_soldier.mdl";
}
enum abstract Npc_combine_signoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_combine_shintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_combine_sgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_combine_sdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_combine_sdisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_combine_sadditionalequipmentChoices(String) to String {
	var AR2 = "weapon_ar2";
...
enum abstract Npc_combine_sNumGrenadesChoices(String) to String {
	var NONE = "0";
	var _1 = "1";
	var _2 = "2";
	var _3 = "3";
...
enum abstract Npc_combine_sSpawnFlags(Int) to Int {
	var START_LOOKOFF = 65536;
	var DONT_DROP_GRENADES = 131072;
	var DONT_DROP_AR2_ALT_FIRE_ELITE_ONLY_ = 262144;
