...
**/
@:forward
abstract Prop_vehicle_cannon(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Start locked
	**/
    public var VehicleLocked(get,set):Prop_vehicle_cannonVehicleLockedChoices;

    @:noCompletion
    public extern inline function get_VehicleLocked():Prop_vehicle_cannonVehicleLockedChoices {
        return untyped this.GetKeyValues().VehicleLocked;
    }
    
    @:noCompletion
    public extern inline function set_VehicleLocked(value:Prop_vehicle_cannonVehicleLockedChoices):Prop_vehicle_cannonVehicleLockedChoices {
	...
	**/
    ...
    /**
		Minimum DX Level
	**/
    public var mindxlevel(get,set):Prop_vehicle_cannonmindxlevelChoices;

    @:noCompletion
    public extern inline function get_mindxlevel():Prop_vehicle_cannonmindxlevelChoices {
        return untyped this.GetKeyValues().mindxlevel;
    }
    
    @:noCompletion
    public extern inline function set_mindxlevel(value:Prop_vehicle_cannonmindxlevelChoices):Prop_vehicle_cannonmindxlevelChoices {
    ...
    /**
		Maximum DX Level
	**/
    public var maxdxlevel(get,set):Prop_vehicle_cannonmaxdxlevelChoices;

    @:noCompletion
    public extern inline function get_maxdxlevel():Prop_vehicle_cannonmaxdxlevelChoices {
        return untyped this.GetKeyValues().maxdxlevel;
    }
    
    @:noCompletion
    public extern inline function set_maxdxlevel(value:Prop_vehicle_cannonmaxdxlevelChoices):Prop_vehicle_cannonmaxdxlevelChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Prop_vehicle_cannongmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Prop_vehicle_cannongmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Prop_vehicle_cannongmod_allowphysgunChoices):Prop_vehicle_cannongmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    ...
    /**
		Collisions
	**/
    public var solid(get,set):Prop_vehicle_cannonsolidChoices;

    @:noCompletion
    public extern inline function get_solid():Prop_vehicle_cannonsolidChoices {
        return untyped this.GetKeyValues().solid;
    }
    
    @:noCompletion
    public extern inline function set_solid(value:Prop_vehicle_cannonsolidChoices):Prop_vehicle_cannonsolidChoices {
    ...
    /**
		Disable Shadows
	**/
    public var disableshadows(get,set):Prop_vehicle_cannondisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Prop_vehicle_cannondisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Prop_vehicle_cannondisableshadowsChoices):Prop_vehicle_cannondisableshadowsChoices {
	...
	**/
    public var screenspacefade(get,set):Prop_vehicle_cannonscreenspacefadeChoices;

    @:noCompletion
    public extern inline function get_screenspacefade():Prop_vehicle_cannonscreenspacefadeChoices {
        return untyped this.GetKeyValues().screenspacefade;
    }
    
    @:noCompletion
    public extern inline function set_screenspacefade(value:Prop_vehicle_cannonscreenspacefadeChoices):Prop_vehicle_cannonscreenspacefadeChoices {
	...
	**/
    public var disablevertexlighting(get,set):Prop_vehicle_cannondisablevertexlightingChoices;

    @:noCompletion
    public extern inline function get_disablevertexlighting():Prop_vehicle_cannondisablevertexlightingChoices {
        return untyped this.GetKeyValues().disablevertexlighting;
    }
    
    @:noCompletion
    public extern inline function set_disablevertexlighting(value:Prop_vehicle_cannondisablevertexlightingChoices):Prop_vehicle_cannondisablevertexlightingChoices {
	...
	**/
    public var disableselfshadowing(get,set):Prop_vehicle_cannondisableselfshadowingChoices;

    @:noCompletion
    public extern inline function get_disableselfshadowing():Prop_vehicle_cannondisableselfshadowingChoices {
        return untyped this.GetKeyValues().disableselfshadowing;
    }
    
    @:noCompletion
    public extern inline function set_disableselfshadowing(value:Prop_vehicle_cannondisableselfshadowingChoices):Prop_vehicle_cannondisableselfshadowingChoices {
	...
	**/
    public var ignorenormals(get,set):Prop_vehicle_cannonignorenormalsChoices;

    @:noCompletion
    public extern inline function get_ignorenormals():Prop_vehicle_cannonignorenormalsChoices {
        return untyped this.GetKeyValues().ignorenormals;
    }
    
    @:noCompletion
    public extern inline function set_ignorenormals(value:Prop_vehicle_cannonignorenormalsChoices):Prop_vehicle_cannonignorenormalsChoices {
	...
	**/
    public extern inline function OutputPlayerOn(callback:Callback<{activator:Prop_vehicle_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputPlayerOff(callback:Callback<{activator:Prop_vehicle_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputPressedAttack(callback:Callback<{activator:Prop_vehicle_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputPressedAttack2(callback:Callback<{activator:Prop_vehicle_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputAttackAxis(callback:Callback<{activator:Prop_vehicle_cannon,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputAttack2Axis(callback:Callback<{activator:Prop_vehicle_cannon,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Prop_vehicle_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Prop_vehicle_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Prop_vehicle_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Prop_vehicle_cannon}>):CallbackLink {
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("prop_vehicle_cannon");
    }
}

enum abstract Prop_vehicle_cannonsolidChoices(Int) to Int {
	var NOT_SOLID = 0;
	var USE_BOUNDING_BOX = 2;
	var USE_VPHYSICS = 6;
}
enum abstract Prop_vehicle_cannonscreenspacefadeChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_cannonmindxlevelChoices(Int) to Int {
...
enum abstract Prop_vehicle_cannonmaxdxlevelChoices(Int) to Int {
...
enum abstract Prop_vehicle_cannonignorenormalsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_cannongmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_cannondisablevertexlightingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_cannondisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_cannondisableselfshadowingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_cannonVehicleLockedChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
