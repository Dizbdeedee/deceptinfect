...
**/
@:forward
abstract Info_projecteddecal(Entity) to Entity {
    //Inputs
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Info_projecteddecal}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Info_projecteddecal}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Info_projecteddecal}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Info_projecteddecal}>):CallbackLink {
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("info_projecteddecal");
    }
}
