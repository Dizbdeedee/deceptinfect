...
**/
@:forward
abstract Func_bulletshield(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Start Disabled
	**/
    public var StartDisabled(get,set):Func_bulletshieldStartDisabledChoices;

    @:noCompletion
    public extern inline function get_StartDisabled():Func_bulletshieldStartDisabledChoices {
        return untyped this.GetKeyValues().StartDisabled;
    }
    
    @:noCompletion
    public extern inline function set_StartDisabled(value:Func_bulletshieldStartDisabledChoices):Func_bulletshieldStartDisabledChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Func_bulletshieldgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Func_bulletshieldgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Func_bulletshieldgmod_allowphysgunChoices):Func_bulletshieldgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var InputFilter(get,set):Func_bulletshieldInputFilterChoices;

    @:noCompletion
    public extern inline function get_InputFilter():Func_bulletshieldInputFilterChoices {
        return untyped this.GetKeyValues().InputFilter;
    }
    
    @:noCompletion
    public extern inline function set_InputFilter(value:Func_bulletshieldInputFilterChoices):Func_bulletshieldInputFilterChoices {
	...
	**/
    public var rendermode(get,set):Func_bulletshieldrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Func_bulletshieldrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Func_bulletshieldrendermodeChoices):Func_bulletshieldrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Func_bulletshielddisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Func_bulletshielddisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Func_bulletshielddisablereceiveshadowsChoices):Func_bulletshielddisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Func_bulletshieldrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Func_bulletshieldrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Func_bulletshieldrenderfxChoices):Func_bulletshieldrenderfxChoices {
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Func_bulletshielddisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Func_bulletshielddisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Func_bulletshielddisableshadowsChoices):Func_bulletshielddisableshadowsChoices {
...
This also includes the context menu properties!
	...
	**/
    public var Solidity(get,set):Func_bulletshieldSolidityChoices;

    @:noCompletion
    public extern inline function get_Solidity():Func_bulletshieldSolidityChoices {
        return untyped this.GetKeyValues().Solidity;
    }
    
    @:noCompletion
    public extern inline function set_Solidity(value:Func_bulletshieldSolidityChoices):Func_bulletshieldSolidityChoices {
	...
	**/
    public var invert_exclusion(get,set):Func_bulletshieldinvert_exclusionChoices;

    @:noCompletion
    public extern inline function get_invert_exclusion():Func_bulletshieldinvert_exclusionChoices {
        return untyped this.GetKeyValues().invert_exclusion;
    }
    
    @:noCompletion
    public extern inline function set_invert_exclusion(value:Func_bulletshieldinvert_exclusionChoices):Func_bulletshieldinvert_exclusionChoices {
	...
	**/
    public var solidbsp(get,set):Func_bulletshieldsolidbspChoices;

    @:noCompletion
    public extern inline function get_solidbsp():Func_bulletshieldsolidbspChoices {
        return untyped this.GetKeyValues().solidbsp;
    }
    
    @:noCompletion
    public extern inline function set_solidbsp(value:Func_bulletshieldsolidbspChoices):Func_bulletshieldsolidbspChoices {
	...
	**/
    public var vrad_brush_cast_shadows(get,set):Func_bulletshieldvrad_brush_cast_shadowsChoices;

    @:noCompletion
    public extern inline function get_vrad_brush_cast_shadows():Func_bulletshieldvrad_brush_cast_shadowsChoices {
        return untyped this.GetKeyValues().vrad_brush_cast_shadows;
    }
    
    @:noCompletion
    public extern inline function set_vrad_brush_cast_shadows(value:Func_bulletshieldvrad_brush_cast_shadowsChoices):Func_bulletshieldvrad_brush_cast_shadowsChoices {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Func_bulletshield}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Func_bulletshield}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Func_bulletshield}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Func_bulletshield}>):CallbackLink {
	...
	**/
    ...
    public extern inline function addSpawnFlag(spawnflag:Func_bulletshieldSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Func_bulletshieldSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Func_bulletshieldSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("func_bulletshield");
    }
}

enum abstract Func_bulletshieldvrad_brush_cast_shadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_bulletshieldsolidbspChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_bulletshieldrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Func_bulletshieldrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Func_bulletshieldinvert_exclusionChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_bulletshieldgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_bulletshielddisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_bulletshielddisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_bulletshieldStartDisabledChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_bulletshieldSolidityChoices(Int) to Int {
	var TOGGLE = 0;
	var NEVER_SOLID = 1;
	var ALWAYS_SOLID = 2;
}
enum abstract Func_bulletshieldInputFilterChoices(Int) to Int {
...
enum abstract Func_bulletshieldSpawnFlags(Int) to Int {
