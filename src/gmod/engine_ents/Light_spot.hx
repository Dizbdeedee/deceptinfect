...
**/
@:forward
abstract Light_spot(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Focus
	**/
    public var _exponent(get,set):Int;

    @:noCompletion
    public extern inline function get__exponent():Int {
        return untyped this.GetKeyValues()._exponent;
    }
    
    @:noCompletion
    public extern inline function set__exponent(value:Int):Int {
        return untyped this.SetKeyValue("_exponent",untyped value);
    }
	...
	**/
    ...
    /**
		Pitch
	**/
    public var pitch(get,set):angle_negative_pitch;

    @:noCompletion
    public extern inline function get_pitch():angle_negative_pitch {
        return untyped this.GetKeyValues().pitch;
    }
    
    @:noCompletion
    public extern inline function set_pitch(value:angle_negative_pitch):angle_negative_pitch {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Light_spot}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Light_spot}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Light_spot}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Light_spot}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Light_spotSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Light_spotSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Light_spotSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("light_spot");
    }
}



enum abstract Light_spotSpawnFlags(Int) to Int {
