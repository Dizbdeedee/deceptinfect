...
**/
@:forward
abstract Func_tankpulselaser(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Bullet accuracy
	**/
    public var firespread(get,set):Func_tankpulselaserfirespreadChoices;

    @:noCompletion
    public extern inline function get_firespread():Func_tankpulselaserfirespreadChoices {
        return untyped this.GetKeyValues().firespread;
    }
    
    @:noCompletion
    public extern inline function set_firespread(value:Func_tankpulselaserfirespreadChoices):Func_tankpulselaserfirespreadChoices {
	...
	**/
    ...
    /**
		Lead Target
	**/
    public var LeadTarget(get,set):Func_tankpulselaserLeadTargetChoices;

    @:noCompletion
    public extern inline function get_LeadTarget():Func_tankpulselaserLeadTargetChoices {
        return untyped this.GetKeyValues().LeadTarget;
    }
    
    @:noCompletion
    public extern inline function set_LeadTarget(value:Func_tankpulselaserLeadTargetChoices):Func_tankpulselaserLeadTargetChoices {
	...
	**/
    ...
    /**
		Effect Handling
	**/
    public var effecthandling(get,set):Func_tankpulselasereffecthandlingChoices;

    @:noCompletion
    public extern inline function get_effecthandling():Func_tankpulselasereffecthandlingChoices {
        return untyped this.GetKeyValues().effecthandling;
    }
    
    @:noCompletion
    public extern inline function set_effecthandling(value:Func_tankpulselasereffecthandlingChoices):Func_tankpulselasereffecthandlingChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Func_tankpulselasergmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Func_tankpulselasergmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Func_tankpulselasergmod_allowphysgunChoices):Func_tankpulselasergmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Func_tankpulselaserrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Func_tankpulselaserrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Func_tankpulselaserrendermodeChoices):Func_tankpulselaserrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Func_tankpulselaserdisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Func_tankpulselaserdisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Func_tankpulselaserdisablereceiveshadowsChoices):Func_tankpulselaserdisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Func_tankpulselaserrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Func_tankpulselaserrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Func_tankpulselaserrenderfxChoices):Func_tankpulselaserrenderfxChoices {
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Func_tankpulselaserdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Func_tankpulselaserdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Func_tankpulselaserdisableshadowsChoices):Func_tankpulselaserdisableshadowsChoices {
	...
	**/
    public var PulseSpeed(get,set):Float;

    @:noCompletion
    public extern inline function get_PulseSpeed():Float {
        return untyped this.GetKeyValues().PulseSpeed;
    }
    
    @:noCompletion
    public extern inline function set_PulseSpeed(value:Float):Float {
        return untyped this.SetKeyValue("PulseSpeed",untyped value);
    }
    ...
    /**
		...
		Color of the pulse
	**/
    public var PulseColor(get,set):String;

    @:noCompletion
    public extern inline function get_PulseColor():String {
        return untyped this.GetKeyValues().PulseColor;
    }
    
    @:noCompletion
    public extern inline function set_PulseColor(value:String):String {
        return untyped this.SetKeyValue("PulseColor",untyped value);
    }
    ...
    /**
		...
		Width of the pulse
	**/
    public var PulseWidth(get,set):Float;

    @:noCompletion
    public extern inline function get_PulseWidth():Float {
        return untyped this.GetKeyValues().PulseWidth;
    }
    
    @:noCompletion
    public extern inline function set_PulseWidth(value:Float):Float {
        return untyped this.SetKeyValue("PulseWidth",untyped value);
    }
    
    /**
		Pulse Life

		(Seconds)  How long the pulse lasts
	**/
    public var PulseLife(get,set):Float;

    @:noCompletion
    public extern inline function get_PulseLife():Float {
        return untyped this.GetKeyValues().PulseLife;
    }
    
    @:noCompletion
    public extern inline function set_PulseLife(value:Float):Float {
        return untyped this.SetKeyValue("PulseLife",untyped value);
    }
    
    /**
		Pulse Lag

		(Seconds)  How far behind is pulse tail
	**/
    public var PulseLag(get,set):Float;

    @:noCompletion
    public extern inline function get_PulseLag():Float {
        return untyped this.GetKeyValues().PulseLag;
    }
    
    @:noCompletion
    public extern inline function set_PulseLag(value:Float):Float {
        return untyped this.SetKeyValue("PulseLag",untyped value);
    }
    
    /**
		Pulse Fire Sound

		Sound played when pulse fires
	**/
    public var PulseFireSound(get,set):String;

    @:noCompletion
    public extern inline function get_PulseFireSound():String {
        return untyped this.GetKeyValues().PulseFireSound;
    }
    
    @:noCompletion
    public extern inline function set_PulseFireSound(value:String):String {
        return untyped this.SetKeyValue("PulseFireSound",untyped value);
    }
	...
	**/
    public extern inline function OutputOnFire(callback:Callback<{activator:Func_tankpulselaser}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnAquireTarget(callback:Callback<{activator:Func_tankpulselaser}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLoseTarget(callback:Callback<{activator:Func_tankpulselaser}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnAmmoDepleted(callback:Callback<{activator:Func_tankpulselaser}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnGotController(callback:Callback<{activator:Func_tankpulselaser}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostController(callback:Callback<{activator:Func_tankpulselaser}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnGotPlayerController(callback:Callback<{activator:Func_tankpulselaser}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerController(callback:Callback<{activator:Func_tankpulselaser}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnReadyToFire(callback:Callback<{activator:Func_tankpulselaser}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Func_tankpulselaser}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Func_tankpulselaser}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Func_tankpulselaser}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Func_tankpulselaser}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Func_tankpulselaserSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Func_tankpulselaserSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Func_tankpulselaserSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("func_tankpulselaser");
    }
}

enum abstract Func_tankpulselaserrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Func_tankpulselaserrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Func_tankpulselasergmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_tankpulselaserfirespreadChoices(Int) to Int {
	var PERFECT_SHOT = 0;
	var SMALL_CONE = 1;
	var MEDIUM_CONE = 2;
	var LARGE_CONE = 3;
...
enum abstract Func_tankpulselasereffecthandlingChoices(Int) to Int {
	var USE_INDIVIDUAL_SETTINGS = 0;
	var AR2 = 1;
	var COMBINE_CANNON = 2;
}
enum abstract Func_tankpulselaserdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_tankpulselaserdisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_tankpulselaserLeadTargetChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Func_tankpulselaserSpawnFlags(Int) to Int {
	var ACTIVE = 1;
	var ONLY_DIRECT = 16;
	var CONTROLLABLE = 32;
	var DAMAGE_KICK = 64;
