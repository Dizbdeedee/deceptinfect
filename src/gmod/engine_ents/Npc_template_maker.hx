...
**/
@:forward
abstract Npc_template_maker(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Start Disabled
	**/
    public var StartDisabled(get,set):Npc_template_makerStartDisabledChoices;

    @:noCompletion
    public extern inline function get_StartDisabled():Npc_template_makerStartDisabledChoices {
        return untyped this.GetKeyValues().StartDisabled;
    }
    
    @:noCompletion
    public extern inline function set_StartDisabled(value:Npc_template_makerStartDisabledChoices):Npc_template_makerStartDisabledChoices {
	...
	**/
    public extern inline function OutputOnSpawnNPC(callback:Callback<{activator:Npc_template_maker,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnAllSpawned(callback:Callback<{activator:Npc_template_maker}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnAllSpawnedDead(callback:Callback<{activator:Npc_template_maker}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnAllLiveChildrenDead(callback:Callback<{activator:Npc_template_maker}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Npc_template_maker}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Npc_template_maker}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Npc_template_maker}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Npc_template_maker}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Npc_template_makerSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Npc_template_makerSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Npc_template_makerSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("npc_template_maker");
    }
}

enum abstract Npc_template_makerStartDisabledChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Npc_template_makerSpawnFlags(Int) to Int {
	var FADE_CORPSE = 16;
