...
**/
@:forward
abstract Npc_antlionguard(NPC) to Entity to NPC {
    //Inputs
	...
	**/
    public extern inline function FireUnburrow(delay:Float) {
        untyped this.Fire("Unburrow",untyped null,delay);
    }
    
    /**
		Sets a shove target to attack
	**/
    public extern inline function FireSetShoveTarget(param:String,delay:Float) {
        untyped this.Fire("SetShoveTarget",untyped param,delay);
    }
    
    /**
		Sets a charge target to attack.  Parameters are the name of the entity to start at and the name of the entity to charge towards, separated by a space (i.e. start target)
	**/
    public extern inline function FireSetChargeTarget(param:String,delay:Float) {
        untyped this.Fire("SetChargeTarget",untyped param,delay);
    }
    
    /**
		Clear the charge target
	**/
    public extern inline function FireClearChargeTarget(delay:Float) {
        untyped this.Fire("ClearChargeTarget",untyped null,delay);
    }
    
    /**
		Sets whether or not the creature will protect itself from attacks
	**/
    public extern inline function FireSetCoverFromAttack(param:Int,delay:Float) {
        untyped this.Fire("SetCoverFromAttack",untyped param,delay);
    }
    
    /**
		Causes the antlion guard to die, regardless of health
	**/
    public extern inline function FireRagdoll(delay:Float) {
        untyped this.Fire("Ragdoll",untyped null,delay);
    }
    
    /**
		Allow the antlion guard to try and summon antlions
	**/
    public extern inline function FireEnableBark(delay:Float) {
        untyped this.Fire("EnableBark",untyped null,delay);
    }
    
    /**
		Stop the antlion guard from trying to summon antlions
	**/
    public extern inline function FireDisableBark(delay:Float) {
        untyped this.Fire("DisableBark",untyped null,delay);
    }
    
    /**
		Sniff around at a hint group until told otherwise
	**/
    public extern inline function FireInvestigateHint(param:String,delay:Float) {
        untyped this.Fire("InvestigateHint",untyped param,delay);
    }
    
    /**
		Stop trying to sniff out the player
	**/
    public extern inline function FireStopInvestigating(delay:Float) {
        untyped this.Fire("StopInvestigating",untyped null,delay);
    }
    
    /**
		Prefer to use physics attacks if at all possible, even when inside a cavern.
	**/
    public extern inline function FireEnablePreferPhysicsAttack(delay:Float) {
        untyped this.Fire("EnablePreferPhysicsAttack",untyped null,delay);
    }
    
    /**
		Do not prefer to use physics attacks if at all possible, even when inside a cavern.
	**/
    public extern inline function FireDisablePreferPhysicsAttack(delay:Float) {
        untyped this.Fire("DisablePreferPhysicsAttack",untyped null,delay);
    }
	...
	**/
    public var hintlimiting(get,set):Npc_antlionguardhintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Npc_antlionguardhintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Npc_antlionguardhintlimitingChoices):Npc_antlionguardhintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Npc_antlionguardsleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Npc_antlionguardsleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Npc_antlionguardsleepstateChoices):Npc_antlionguardsleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Npc_antlionguardwakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Npc_antlionguardwakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Npc_antlionguardwakesquadChoices):Npc_antlionguardwakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Npc_antlionguardignoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Npc_antlionguardignoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Npc_antlionguardignoreunseenenemiesChoices):Npc_antlionguardignoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Npc_antlionguardgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Npc_antlionguardgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Npc_antlionguardgmod_allowphysgunChoices):Npc_antlionguardgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Npc_antlionguardrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Npc_antlionguardrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Npc_antlionguardrendermodeChoices):Npc_antlionguardrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Npc_antlionguarddisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Npc_antlionguarddisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Npc_antlionguarddisablereceiveshadowsChoices):Npc_antlionguarddisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Npc_antlionguardrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Npc_antlionguardrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Npc_antlionguardrenderfxChoices):Npc_antlionguardrenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Npc_antlionguarddisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Npc_antlionguarddisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Npc_antlionguarddisableshadowsChoices):Npc_antlionguarddisableshadowsChoices {
	...
	**/
    ...
    /**
		Start Burrowed
	**/
    public var startburrowed(get,set):Npc_antlionguardstartburrowedChoices;

    @:noCompletion
    public extern inline function get_startburrowed():Npc_antlionguardstartburrowedChoices {
        return untyped this.GetKeyValues().startburrowed;
    }
    
    @:noCompletion
    public extern inline function set_startburrowed(value:Npc_antlionguardstartburrowedChoices):Npc_antlionguardstartburrowedChoices {
        return untyped this.SetKeyValue("startburrowed",untyped value);
    }
    
    /**
		Allow Bark
	**/
    public var allowbark(get,set):Npc_antlionguardallowbarkChoices;

    @:noCompletion
    public extern inline function get_allowbark():Npc_antlionguardallowbarkChoices {
        return untyped this.GetKeyValues().allowbark;
    }
    
    @:noCompletion
    public extern inline function set_allowbark(value:Npc_antlionguardallowbarkChoices):Npc_antlionguardallowbarkChoices {
        return untyped this.SetKeyValue("allowbark",untyped value);
    }
    
    /**
		Cavern Guard Model and Texture
	**/
    public var cavernbreed(get,set):Npc_antlionguardcavernbreedChoices;

    @:noCompletion
    public extern inline function get_cavernbreed():Npc_antlionguardcavernbreedChoices {
        return untyped this.GetKeyValues().cavernbreed;
    }
    
    @:noCompletion
    public extern inline function set_cavernbreed(value:Npc_antlionguardcavernbreedChoices):Npc_antlionguardcavernbreedChoices {
        return untyped this.SetKeyValue("cavernbreed",untyped value);
    }
    
    /**
		Use inside-Cavern Behavior
	**/
    public var incavern(get,set):Npc_antlionguardincavernChoices;

    @:noCompletion
    public extern inline function get_incavern():Npc_antlionguardincavernChoices {
        return untyped this.GetKeyValues().incavern;
    }
    
    @:noCompletion
    public extern inline function set_incavern(value:Npc_antlionguardincavernChoices):Npc_antlionguardincavernChoices {
        return untyped this.SetKeyValue("incavern",untyped value);
    }
    
    /**
		Shove Targets
	**/
    public var shovetargets(get,set):String;

    @:noCompletion
    public extern inline function get_shovetargets():String {
        return untyped this.GetKeyValues().shovetargets;
    }
    
    @:noCompletion
    public extern inline function set_shovetargets(value:String):String {
        return untyped this.SetKeyValue("shovetargets",untyped value);
    }
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Npc_antlionguard,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Npc_antlionguard,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSeeHiddenPlayer(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnSeeHiddenPlayer",callback);
    }
    
    /**
		Fires when the current enemy is smelled while trying to hide
	**/
    public extern inline function OutputOnSmellHiddenPlayer(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnSmellHiddenPlayer",callback);
    }
    
    /**
		Antlion guard is attempting to summon antlions
	**/
    public extern inline function OutputOnSummon(callback:Callback<{activator:Npc_antlionguard}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnSummon",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Npc_antlionguardSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Npc_antlionguardSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Npc_antlionguardSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("npc_antlionguard");
    }
}

enum abstract Npc_antlionguardwakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_antlionguardstartburrowedChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_antlionguardsleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Npc_antlionguardrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Npc_antlionguardrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Npc_antlionguardincavernChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_antlionguardignoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_antlionguardhintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_antlionguardgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_antlionguarddisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_antlionguarddisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_antlionguardcavernbreedChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_antlionguardallowbarkChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Npc_antlionguardSpawnFlags(Int) to Int {
	...
	var CREATE_SERVERSIDE_RAGDOLL_ON_DEATH = 65536;
	var USE_INSIDE_FOOTSTEPS = 131072;
}
