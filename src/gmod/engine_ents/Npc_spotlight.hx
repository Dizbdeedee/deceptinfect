...
**/
@:forward
abstract Npc_spotlight(NPC) to Entity to NPC {
    //Inputs
	...
	**/
    ...
    /**
		TrackOn
	**/
    public extern inline function FireTrackOn(delay:Float) {
        untyped this.Fire("TrackOn",untyped null,delay);
    }
    
    /**
		TrackOff
	**/
    public extern inline function FireTrackOff(delay:Float) {
        untyped this.Fire("TrackOff",untyped null,delay);
    }
	...
	**/
    public var hintlimiting(get,set):Npc_spotlighthintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Npc_spotlighthintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Npc_spotlighthintlimitingChoices):Npc_spotlighthintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Npc_spotlightsleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Npc_spotlightsleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Npc_spotlightsleepstateChoices):Npc_spotlightsleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Npc_spotlightwakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Npc_spotlightwakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Npc_spotlightwakesquadChoices):Npc_spotlightwakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Npc_spotlightignoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Npc_spotlightignoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Npc_spotlightignoreunseenenemiesChoices):Npc_spotlightignoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Npc_spotlightgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Npc_spotlightgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Npc_spotlightgmod_allowphysgunChoices):Npc_spotlightgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Npc_spotlightrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Npc_spotlightrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Npc_spotlightrendermodeChoices):Npc_spotlightrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Npc_spotlightdisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Npc_spotlightdisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Npc_spotlightdisablereceiveshadowsChoices):Npc_spotlightdisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Npc_spotlightrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Npc_spotlightrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Npc_spotlightrenderfxChoices):Npc_spotlightrenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Npc_spotlightdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Npc_spotlightdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Npc_spotlightdisableshadowsChoices):Npc_spotlightdisableshadowsChoices {
	...
	**/
    ...
    /**
		Health
	**/
    public var health(get,set):Integer;

    @:noCompletion
    public extern inline function get_health():Integer {
        return untyped this.GetKeyValues().health;
    }
    
    @:noCompletion
    public extern inline function set_health(value:Integer):Integer {
    ...
    /**
		YawRange
	**/
    public var YawRange(get,set):Int;

    @:noCompletion
    public extern inline function get_YawRange():Int {
        return untyped this.GetKeyValues().YawRange;
    }
    
    @:noCompletion
    public extern inline function set_YawRange(value:Int):Int {
    ...
    /**
		PitchMin
	**/
    public var PitchMin(get,set):Int;

    @:noCompletion
    public extern inline function get_PitchMin():Int {
        return untyped this.GetKeyValues().PitchMin;
    }
    
    @:noCompletion
    public extern inline function set_PitchMin(value:Int):Int {
        return untyped this.SetKeyValue("PitchMin",untyped value);
    }
    
    /**
		PitchMax
	**/
    public var PitchMax(get,set):Int;

    @:noCompletion
    public extern inline function get_PitchMax():Int {
        return untyped this.GetKeyValues().PitchMax;
    }
    
    @:noCompletion
    public extern inline function set_PitchMax(value:Int):Int {
        return untyped this.SetKeyValue("PitchMax",untyped value);
    }
    
    /**
		IdleSpeed
	**/
    public var IdleSpeed(get,set):Int;

    @:noCompletion
    public extern inline function get_IdleSpeed():Int {
        return untyped this.GetKeyValues().IdleSpeed;
    }
    
    @:noCompletion
    public extern inline function set_IdleSpeed(value:Int):Int {
        return untyped this.SetKeyValue("IdleSpeed",untyped value);
    }
    
    /**
		AlertSpeed
	**/
    public var AlertSpeed(get,set):Int;

    @:noCompletion
    public extern inline function get_AlertSpeed():Int {
        return untyped this.GetKeyValues().AlertSpeed;
    }
    
    @:noCompletion
    public extern inline function set_AlertSpeed(value:Int):Int {
        return untyped this.SetKeyValue("AlertSpeed",untyped value);
    }
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Npc_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Npc_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Npc_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Npc_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Npc_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Npc_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Npc_spotlight,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Npc_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Npc_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Npc_spotlight,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Npc_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Npc_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Npc_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Npc_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Npc_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Npc_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Npc_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Npc_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Npc_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Npc_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Npc_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Npc_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Npc_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Npc_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnAlert(callback:Callback<{activator:Npc_spotlight}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnAlert",callback);
    }
    
    /**
		Outputs enemy entity when spotlight finds and starts tracking enemy
	**/
    public extern inline function OutputDetectedEnemy(callback:Callback<{activator:Npc_spotlight,data:String}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"DetectedEnemy",callback);
    }
    
    /**
		Outputs enemy entity when spotlight loses enemy that it's tracking, if enemy still exists
	**/
    public extern inline function OutputLostEnemy(callback:Callback<{activator:Npc_spotlight,data:String}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"LostEnemy",callback);
    }
    
    /**
		Outputs enemy entity when squad finds and starts tracking enemy
	**/
    public extern inline function OutputSquadDetectedEnemy(callback:Callback<{activator:Npc_spotlight,data:String}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"SquadDetectedEnemy",callback);
    }
    
    /**
		Outputs enemy entity when squad loses enemy that it's tracking, if entity still exists
	**/
    public extern inline function OutputSquadLostEnemy(callback:Callback<{activator:Npc_spotlight,data:String}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"SquadLostEnemy",callback);
    }
    
    /**
		Position of the end of the spotlight beam
	**/
    public extern inline function OutputLightPosition(callback:Callback<{activator:Npc_spotlight,data:String}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"LightPosition",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Npc_spotlightSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Npc_spotlightSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Npc_spotlightSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("npc_spotlight");
    }
}

enum abstract Npc_spotlightwakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_spotlightsleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Npc_spotlightrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Npc_spotlightrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Npc_spotlightignoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_spotlighthintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_spotlightgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_spotlightdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_spotlightdisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Npc_spotlightSpawnFlags(Int) to Int {
	...
	var START_TRACK_ON = 65536;
	var START_LIGHT_ON = 131072;
	var NO_DYNAMIC_LIGHT = 262144;
	var NEVER_MOVE = 524288;
}
