...
**/
@:forward
abstract Trigger_weapon_strip(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Start Disabled
	**/
    public var StartDisabled(get,set):Trigger_weapon_stripStartDisabledChoices;

    @:noCompletion
    public extern inline function get_StartDisabled():Trigger_weapon_stripStartDisabledChoices {
        return untyped this.GetKeyValues().StartDisabled;
    }
    
    @:noCompletion
    public extern inline function set_StartDisabled(value:Trigger_weapon_stripStartDisabledChoices):Trigger_weapon_stripStartDisabledChoices {
	...
	**/
    ...
    /**
		Kill Weapons
	**/
    public var KillWeapons(get,set):Trigger_weapon_stripKillWeaponsChoices;

    @:noCompletion
    public extern inline function get_KillWeapons():Trigger_weapon_stripKillWeaponsChoices {
        return untyped this.GetKeyValues().KillWeapons;
    }
    
    @:noCompletion
    public extern inline function set_KillWeapons(value:Trigger_weapon_stripKillWeaponsChoices):Trigger_weapon_stripKillWeaponsChoices {
        return untyped this.SetKeyValue("KillWeapons",untyped value);
    }
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Trigger_weapon_strip}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Trigger_weapon_strip}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Trigger_weapon_strip}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Trigger_weapon_strip}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnStartTouchAll(callback:Callback<{activator:Trigger_weapon_strip}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnEndTouch(callback:Callback<{activator:Trigger_weapon_strip}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnEndTouchAll(callback:Callback<{activator:Trigger_weapon_strip}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnStartTouch(callback:Callback<{activator:Trigger_weapon_strip}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnStartTouch",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Trigger_weapon_stripSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Trigger_weapon_stripSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Trigger_weapon_stripSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("trigger_weapon_strip");
    }
}

enum abstract Trigger_weapon_stripStartDisabledChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Trigger_weapon_stripKillWeaponsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Trigger_weapon_stripSpawnFlags(Int) to Int {
	var CLIENTS = 1;
	var NPCS = 2;
	var PUSHABLES = 4;
