...
**/
@:forward
abstract Trigger_physics_trap(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Start Disabled
	**/
    public var StartDisabled(get,set):Trigger_physics_trapStartDisabledChoices;

    @:noCompletion
    public extern inline function get_StartDisabled():Trigger_physics_trapStartDisabledChoices {
        return untyped this.GetKeyValues().StartDisabled;
    }
    
    @:noCompletion
    public extern inline function set_StartDisabled(value:Trigger_physics_trapStartDisabledChoices):Trigger_physics_trapStartDisabledChoices {
	...
	**/
    ...
    /**
		Dissolve Type
	**/
    public var dissolvetype(get,set):Trigger_physics_trapdissolvetypeChoices;

    @:noCompletion
    public extern inline function get_dissolvetype():Trigger_physics_trapdissolvetypeChoices {
        return untyped this.GetKeyValues().dissolvetype;
    }
    
    @:noCompletion
    public extern inline function set_dissolvetype(value:Trigger_physics_trapdissolvetypeChoices):Trigger_physics_trapdissolvetypeChoices {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Trigger_physics_trap}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Trigger_physics_trap}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Trigger_physics_trap}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Trigger_physics_trap}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnStartTouchAll(callback:Callback<{activator:Trigger_physics_trap}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnEndTouch(callback:Callback<{activator:Trigger_physics_trap}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnEndTouchAll(callback:Callback<{activator:Trigger_physics_trap}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnStartTouch(callback:Callback<{activator:Trigger_physics_trap}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnStartTouch",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Trigger_physics_trapSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Trigger_physics_trapSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Trigger_physics_trapSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("trigger_physics_trap");
    }
}

enum abstract Trigger_physics_trapdissolvetypeChoices(Int) to Int {
	var ENERGY = 0;
	var HEAVY_ELECTRICAL = 1;
	var LIGHT_ELECTRICAL = 2;
}
enum abstract Trigger_physics_trapStartDisabledChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Trigger_physics_trapSpawnFlags(Int) to Int {
	var CLIENTS = 1;
	var NPCS = 2;
	var PUSHABLES = 4;
