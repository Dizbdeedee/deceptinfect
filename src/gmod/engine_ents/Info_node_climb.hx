...
**/
@:forward
abstract Info_node_climb(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Hint
	**/
    public var hinttype(get,set):Info_node_climbhinttypeChoices;

    @:noCompletion
    public extern inline function get_hinttype():Info_node_climbhinttypeChoices {
        return untyped this.GetKeyValues().hinttype;
    }
    
    @:noCompletion
    public extern inline function set_hinttype(value:Info_node_climbhinttypeChoices):Info_node_climbhinttypeChoices {
	...
	**/
    public var nodeFOV(get,set):Info_node_climbnodeFOVChoices;

    @:noCompletion
    public extern inline function get_nodeFOV():Info_node_climbnodeFOVChoices {
        return untyped this.GetKeyValues().nodeFOV;
    }
    
    @:noCompletion
    public extern inline function set_nodeFOV(value:Info_node_climbnodeFOVChoices):Info_node_climbnodeFOVChoices {
    ...
    /**
		Start Hint Disabled
	**/
    public var StartHintDisabled(get,set):Info_node_climbStartHintDisabledChoices;

    @:noCompletion
    public extern inline function get_StartHintDisabled():Info_node_climbStartHintDisabledChoices {
        return untyped this.GetKeyValues().StartHintDisabled;
    }
    
    @:noCompletion
    public extern inline function set_StartHintDisabled(value:Info_node_climbStartHintDisabledChoices):Info_node_climbStartHintDisabledChoices {
	...
	**/
    public var IgnoreFacing(get,set):Info_node_climbIgnoreFacingChoices;

    @:noCompletion
    public extern inline function get_IgnoreFacing():Info_node_climbIgnoreFacingChoices {
        return untyped this.GetKeyValues().IgnoreFacing;
    }
    
    @:noCompletion
    public extern inline function set_IgnoreFacing(value:Info_node_climbIgnoreFacingChoices):Info_node_climbIgnoreFacingChoices {
	...
	**/
    public var MinimumState(get,set):Info_node_climbMinimumStateChoices;

    @:noCompletion
    public extern inline function get_MinimumState():Info_node_climbMinimumStateChoices {
        return untyped this.GetKeyValues().MinimumState;
    }
    
    @:noCompletion
    public extern inline function set_MinimumState(value:Info_node_climbMinimumStateChoices):Info_node_climbMinimumStateChoices {
	...
	**/
    public var MaximumState(get,set):Info_node_climbMaximumStateChoices;

    @:noCompletion
    public extern inline function get_MaximumState():Info_node_climbMaximumStateChoices {
        return untyped this.GetKeyValues().MaximumState;
    }
    
    @:noCompletion
    public extern inline function set_MaximumState(value:Info_node_climbMaximumStateChoices):Info_node_climbMaximumStateChoices {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Info_node_climb}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Info_node_climb}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Info_node_climb}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Info_node_climb}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Info_node_climbSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Info_node_climbSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Info_node_climbSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("info_node_climb");
    }
}

enum abstract Info_node_climbnodeFOVChoices(Int) to Int {
	var _45_DEGREES = 45;
	var _90_DEGREES = 90;
	var _180_DEGREES = 180;
	var _360_DEGREES = 360;
}
enum abstract Info_node_climbhinttypeChoices(Int) to Int {
	var NONE = 0;
	var WORLD_WINDOW = 2;
...
enum abstract Info_node_climbStartHintDisabledChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Info_node_climbMinimumStateChoices(Int) to Int {
	var IDLE = 1;
	var ALERT = 2;
	var COMBAT = 3;
}
enum abstract Info_node_climbMaximumStateChoices(Int) to Int {
	var IDLE = 1;
	var ALERT = 2;
	var COMBAT = 3;
}
enum abstract Info_node_climbIgnoreFacingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
	var DEFAULT = 2;
}
...
enum abstract Info_node_climbSpawnFlags(Int) to Int {
