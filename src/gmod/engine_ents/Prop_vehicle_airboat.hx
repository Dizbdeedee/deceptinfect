...
**/
@:forward
abstract Prop_vehicle_airboat(Entity) to Entity {
    //Inputs
	...
	**/
    public extern inline function FireEnableGun(param:bool,delay:Float) {
        untyped this.Fire("EnableGun",untyped param,delay);
    }
    
    /**
		The airboat will start to be blown around by the helicopter rotor wash.
	**/
    public extern inline function FireInputStartRotorWashForces(delay:Float) {
        untyped this.Fire("InputStartRotorWashForces",untyped null,delay);
    }
    
    /**
		The airboat will no longer be blown around by the helicopter rotor wash.
	**/
    public extern inline function FireInputStopRotorWashForces(delay:Float) {
        untyped this.Fire("InputStopRotorWashForces",untyped null,delay);
    }
	...
	**/
    ...
    /**
		Start locked
	**/
    public var VehicleLocked(get,set):Prop_vehicle_airboatVehicleLockedChoices;

    @:noCompletion
    public extern inline function get_VehicleLocked():Prop_vehicle_airboatVehicleLockedChoices {
        return untyped this.GetKeyValues().VehicleLocked;
    }
    
    @:noCompletion
    public extern inline function set_VehicleLocked(value:Prop_vehicle_airboatVehicleLockedChoices):Prop_vehicle_airboatVehicleLockedChoices {
	...
	**/
    ...
    /**
		Minimum DX Level
	**/
    public var mindxlevel(get,set):Prop_vehicle_airboatmindxlevelChoices;

    @:noCompletion
    public extern inline function get_mindxlevel():Prop_vehicle_airboatmindxlevelChoices {
        return untyped this.GetKeyValues().mindxlevel;
    }
    
    @:noCompletion
    public extern inline function set_mindxlevel(value:Prop_vehicle_airboatmindxlevelChoices):Prop_vehicle_airboatmindxlevelChoices {
    ...
    /**
		Maximum DX Level
	**/
    public var maxdxlevel(get,set):Prop_vehicle_airboatmaxdxlevelChoices;

    @:noCompletion
    public extern inline function get_maxdxlevel():Prop_vehicle_airboatmaxdxlevelChoices {
        return untyped this.GetKeyValues().maxdxlevel;
    }
    
    @:noCompletion
    public extern inline function set_maxdxlevel(value:Prop_vehicle_airboatmaxdxlevelChoices):Prop_vehicle_airboatmaxdxlevelChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Prop_vehicle_airboatgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Prop_vehicle_airboatgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Prop_vehicle_airboatgmod_allowphysgunChoices):Prop_vehicle_airboatgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    ...
    /**
		Collisions
	**/
    public var solid(get,set):Prop_vehicle_airboatsolidChoices;

    @:noCompletion
    public extern inline function get_solid():Prop_vehicle_airboatsolidChoices {
        return untyped this.GetKeyValues().solid;
    }
    
    @:noCompletion
    public extern inline function set_solid(value:Prop_vehicle_airboatsolidChoices):Prop_vehicle_airboatsolidChoices {
    ...
    /**
		Disable Shadows
	**/
    public var disableshadows(get,set):Prop_vehicle_airboatdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Prop_vehicle_airboatdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Prop_vehicle_airboatdisableshadowsChoices):Prop_vehicle_airboatdisableshadowsChoices {
	...
	**/
    public var screenspacefade(get,set):Prop_vehicle_airboatscreenspacefadeChoices;

    @:noCompletion
    public extern inline function get_screenspacefade():Prop_vehicle_airboatscreenspacefadeChoices {
        return untyped this.GetKeyValues().screenspacefade;
    }
    
    @:noCompletion
    public extern inline function set_screenspacefade(value:Prop_vehicle_airboatscreenspacefadeChoices):Prop_vehicle_airboatscreenspacefadeChoices {
	...
	**/
    public var disablevertexlighting(get,set):Prop_vehicle_airboatdisablevertexlightingChoices;

    @:noCompletion
    public extern inline function get_disablevertexlighting():Prop_vehicle_airboatdisablevertexlightingChoices {
        return untyped this.GetKeyValues().disablevertexlighting;
    }
    
    @:noCompletion
    public extern inline function set_disablevertexlighting(value:Prop_vehicle_airboatdisablevertexlightingChoices):Prop_vehicle_airboatdisablevertexlightingChoices {
	...
	**/
    public var disableselfshadowing(get,set):Prop_vehicle_airboatdisableselfshadowingChoices;

    @:noCompletion
    public extern inline function get_disableselfshadowing():Prop_vehicle_airboatdisableselfshadowingChoices {
        return untyped this.GetKeyValues().disableselfshadowing;
    }
    
    @:noCompletion
    public extern inline function set_disableselfshadowing(value:Prop_vehicle_airboatdisableselfshadowingChoices):Prop_vehicle_airboatdisableselfshadowingChoices {
	...
	**/
    public var ignorenormals(get,set):Prop_vehicle_airboatignorenormalsChoices;

    @:noCompletion
    public extern inline function get_ignorenormals():Prop_vehicle_airboatignorenormalsChoices {
        return untyped this.GetKeyValues().ignorenormals;
    }
    
    @:noCompletion
    public extern inline function set_ignorenormals(value:Prop_vehicle_airboatignorenormalsChoices):Prop_vehicle_airboatignorenormalsChoices {
	...
	**/
    public var EnableGun(get,set):Prop_vehicle_airboatEnableGunChoices;

    @:noCompletion
    public extern inline function get_EnableGun():Prop_vehicle_airboatEnableGunChoices {
        return untyped this.GetKeyValues().EnableGun;
    }
    
    @:noCompletion
    public extern inline function set_EnableGun(value:Prop_vehicle_airboatEnableGunChoices):Prop_vehicle_airboatEnableGunChoices {
        return untyped this.SetKeyValue("EnableGun",untyped value);
    }
	...
	**/
    public extern inline function OutputPlayerOn(callback:Callback<{activator:Prop_vehicle_airboat}>):CallbackLink {
	...
	**/
    public extern inline function OutputPlayerOff(callback:Callback<{activator:Prop_vehicle_airboat}>):CallbackLink {
	...
	**/
    public extern inline function OutputPressedAttack(callback:Callback<{activator:Prop_vehicle_airboat}>):CallbackLink {
	...
	**/
    public extern inline function OutputPressedAttack2(callback:Callback<{activator:Prop_vehicle_airboat}>):CallbackLink {
	...
	**/
    public extern inline function OutputAttackAxis(callback:Callback<{activator:Prop_vehicle_airboat,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputAttack2Axis(callback:Callback<{activator:Prop_vehicle_airboat,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Prop_vehicle_airboat}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Prop_vehicle_airboat}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Prop_vehicle_airboat}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Prop_vehicle_airboat}>):CallbackLink {
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("prop_vehicle_airboat");
    }
}

enum abstract Prop_vehicle_airboatsolidChoices(Int) to Int {
	var NOT_SOLID = 0;
	var USE_BOUNDING_BOX = 2;
	var USE_VPHYSICS = 6;
}
enum abstract Prop_vehicle_airboatscreenspacefadeChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_airboatmindxlevelChoices(Int) to Int {
...
enum abstract Prop_vehicle_airboatmaxdxlevelChoices(Int) to Int {
...
enum abstract Prop_vehicle_airboatignorenormalsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_airboatgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_airboatdisablevertexlightingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_airboatdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_airboatdisableselfshadowingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_airboatVehicleLockedChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_airboatEnableGunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
