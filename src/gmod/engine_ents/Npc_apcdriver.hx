...
**/
@:forward
abstract Npc_apcdriver(NPC) to Entity to NPC {
    //Inputs
	...
	**/
    public extern inline function FireDisableFiring(param:Float,delay:Float) {
        untyped this.Fire("DisableFiring",untyped param,delay);
    }
    
    /**
		Enables firing to start. Firing is enabled by default
	**/
    public extern inline function FireEnableFiring(param:Float,delay:Float) {
        untyped this.Fire("EnableFiring",untyped param,delay);
    }
	...
	**/
    public var hintlimiting(get,set):Npc_apcdriverhintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Npc_apcdriverhintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Npc_apcdriverhintlimitingChoices):Npc_apcdriverhintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Npc_apcdriversleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Npc_apcdriversleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Npc_apcdriversleepstateChoices):Npc_apcdriversleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Npc_apcdriverwakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Npc_apcdriverwakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Npc_apcdriverwakesquadChoices):Npc_apcdriverwakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Npc_apcdriverignoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Npc_apcdriverignoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Npc_apcdriverignoreunseenenemiesChoices):Npc_apcdriverignoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Npc_apcdrivergmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Npc_apcdrivergmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Npc_apcdrivergmod_allowphysgunChoices):Npc_apcdrivergmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Npc_apcdriverrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Npc_apcdriverrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Npc_apcdriverrendermodeChoices):Npc_apcdriverrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Npc_apcdriverdisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Npc_apcdriverdisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Npc_apcdriverdisablereceiveshadowsChoices):Npc_apcdriverdisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Npc_apcdriverrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Npc_apcdriverrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Npc_apcdriverrenderfxChoices):Npc_apcdriverrenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Npc_apcdriverdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Npc_apcdriverdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Npc_apcdriverdisableshadowsChoices):Npc_apcdriverdisableshadowsChoices {
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Npc_apcdriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Npc_apcdriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Npc_apcdriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Npc_apcdriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Npc_apcdriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Npc_apcdriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Npc_apcdriver,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Npc_apcdriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Npc_apcdriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Npc_apcdriver,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Npc_apcdriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Npc_apcdriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Npc_apcdriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Npc_apcdriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Npc_apcdriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Npc_apcdriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Npc_apcdriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Npc_apcdriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Npc_apcdriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Npc_apcdriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Npc_apcdriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Npc_apcdriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Npc_apcdriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Npc_apcdriver}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Npc_apcdriverSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Npc_apcdriverSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Npc_apcdriverSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("npc_apcdriver");
    }
}

enum abstract Npc_apcdriverwakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_apcdriversleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Npc_apcdriverrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Npc_apcdriverrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Npc_apcdriverignoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_apcdriverhintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_apcdrivergmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_apcdriverdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_apcdriverdisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Npc_apcdriverSpawnFlags(Int) to Int {
	...
	var NO_ROCKET_ATTACKS = 65536;
	var NO_GUN_ATTACKS = 131072;
}
