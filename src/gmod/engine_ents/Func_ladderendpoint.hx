...
**/
@:forward
abstract Func_ladderendpoint(Entity) to Entity {
    //Inputs
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Func_ladderendpoint}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Func_ladderendpoint}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Func_ladderendpoint}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Func_ladderendpoint}>):CallbackLink {
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("func_ladderendpoint");
    }
}
