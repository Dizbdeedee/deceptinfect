...
**/
@:forward
abstract Trigger_multiple(Entity) to Entity {
    //Inputs
	...
	**/
    public extern inline function FireTouchTest(delay:Float) {
        untyped this.Fire("TouchTest",untyped null,delay);
    }
    ...
    /**
		Start Disabled
	**/
    public var StartDisabled(get,set):Trigger_multipleStartDisabledChoices;

    @:noCompletion
    public extern inline function get_StartDisabled():Trigger_multipleStartDisabledChoices {
        return untyped this.GetKeyValues().StartDisabled;
    }
    
    @:noCompletion
    public extern inline function set_StartDisabled(value:Trigger_multipleStartDisabledChoices):Trigger_multipleStartDisabledChoices {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Trigger_multiple}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Trigger_multiple}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Trigger_multiple}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Trigger_multiple}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnStartTouchAll(callback:Callback<{activator:Trigger_multiple}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnEndTouch(callback:Callback<{activator:Trigger_multiple}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnEndTouchAll(callback:Callback<{activator:Trigger_multiple}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnStartTouch(callback:Callback<{activator:Trigger_multiple}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnTrigger(callback:Callback<{activator:Trigger_multiple}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnTouching(callback:Callback<{activator:Trigger_multiple}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnTouching",callback);
    }
    
    /**
		Fired when the TestTouch input is not true (nothing is touching the trigger.)
	**/
    public extern inline function OutputOnNotTouching(callback:Callback<{activator:Trigger_multiple}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnNotTouching",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Trigger_multipleSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Trigger_multipleSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Trigger_multipleSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("trigger_multiple");
    }
}

enum abstract Trigger_multipleStartDisabledChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Trigger_multipleSpawnFlags(Int) to Int {
	var CLIENTS = 1;
	var NPCS = 2;
	var PUSHABLES = 4;
