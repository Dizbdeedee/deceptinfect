...
**/
@:forward
abstract Phys_pulleyconstraint(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		...
		Add (or subtract) this amount to the rest length of the pulley rope.
	**/
    public var gearratio(get,set):Float;

    @:noCompletion
    public extern inline function get_gearratio():Float {
        return untyped this.GetKeyValues().gearratio;
    }
    
    @:noCompletion
    public extern inline function set_gearratio(value:Float):Float {
        return untyped this.SetKeyValue("gearratio",untyped value);
    }
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Phys_pulleyconstraint}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Phys_pulleyconstraint}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Phys_pulleyconstraint}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Phys_pulleyconstraint}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnBreak(callback:Callback<{activator:Phys_pulleyconstraint}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnBreak",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Phys_pulleyconstraintSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Phys_pulleyconstraintSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Phys_pulleyconstraintSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("phys_pulleyconstraint");
    }
}



enum abstract Phys_pulleyconstraintSpawnFlags(Int) to Int {
