...
**/
@:forward
abstract Env_fade(Entity) to Entity {
    //Inputs
	...
	**/
    public extern inline function FireFade(delay:Float) {
        untyped this.Fire("Fade",untyped null,delay);
    }
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Env_fade}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Env_fade}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Env_fade}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Env_fade}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnBeginFade(callback:Callback<{activator:Env_fade}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnBeginFade",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Env_fadeSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Env_fadeSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Env_fadeSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("env_fade");
    }
}



enum abstract Env_fadeSpawnFlags(Int) to Int {
	var FADE_FROM = 1;
	var MODULATE = 2;
	var STAY_OUT = 8;
}
