...
**/
@:forward
abstract Func_tank(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Bullet accuracy
	**/
    public var firespread(get,set):Func_tankfirespreadChoices;

    @:noCompletion
    public extern inline function get_firespread():Func_tankfirespreadChoices {
        return untyped this.GetKeyValues().firespread;
    }
    
    @:noCompletion
    public extern inline function set_firespread(value:Func_tankfirespreadChoices):Func_tankfirespreadChoices {
	...
	**/
    ...
    /**
		Lead Target
	**/
    public var LeadTarget(get,set):Func_tankLeadTargetChoices;

    @:noCompletion
    public extern inline function get_LeadTarget():Func_tankLeadTargetChoices {
        return untyped this.GetKeyValues().LeadTarget;
    }
    
    @:noCompletion
    public extern inline function set_LeadTarget(value:Func_tankLeadTargetChoices):Func_tankLeadTargetChoices {
	...
	**/
    ...
    /**
		Effect Handling
	**/
    public var effecthandling(get,set):Func_tankeffecthandlingChoices;

    @:noCompletion
    public extern inline function get_effecthandling():Func_tankeffecthandlingChoices {
        return untyped this.GetKeyValues().effecthandling;
    }
    
    @:noCompletion
    public extern inline function set_effecthandling(value:Func_tankeffecthandlingChoices):Func_tankeffecthandlingChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Func_tankgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Func_tankgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Func_tankgmod_allowphysgunChoices):Func_tankgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Func_tankrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Func_tankrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Func_tankrendermodeChoices):Func_tankrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Func_tankdisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Func_tankdisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Func_tankdisablereceiveshadowsChoices):Func_tankdisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Func_tankrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Func_tankrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Func_tankrenderfxChoices):Func_tankrenderfxChoices {
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Func_tankdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Func_tankdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Func_tankdisableshadowsChoices):Func_tankdisableshadowsChoices {
	...
	**/
    ...
    /**
		Ammo type
	**/
    public var ammotype(get,set):Func_tankammotypeChoices;

    @:noCompletion
    public extern inline function get_ammotype():Func_tankammotypeChoices {
        return untyped this.GetKeyValues().ammotype;
    }
    
    @:noCompletion
    public extern inline function set_ammotype(value:Func_tankammotypeChoices):Func_tankammotypeChoices {
	...
	**/
    public extern inline function OutputOnFire(callback:Callback<{activator:Func_tank}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnAquireTarget(callback:Callback<{activator:Func_tank}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLoseTarget(callback:Callback<{activator:Func_tank}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnAmmoDepleted(callback:Callback<{activator:Func_tank}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnGotController(callback:Callback<{activator:Func_tank}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostController(callback:Callback<{activator:Func_tank}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnGotPlayerController(callback:Callback<{activator:Func_tank}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerController(callback:Callback<{activator:Func_tank}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnReadyToFire(callback:Callback<{activator:Func_tank}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Func_tank}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Func_tank}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Func_tank}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Func_tank}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Func_tankSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Func_tankSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Func_tankSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("func_tank");
    }
}

enum abstract Func_tankrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Func_tankrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Func_tankgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_tankfirespreadChoices(Int) to Int {
	var PERFECT_SHOT = 0;
	var SMALL_CONE = 1;
	var MEDIUM_CONE = 2;
	var LARGE_CONE = 3;
...
enum abstract Func_tankeffecthandlingChoices(Int) to Int {
	var USE_INDIVIDUAL_SETTINGS = 0;
	var AR2 = 1;
	var COMBINE_CANNON = 2;
}
enum abstract Func_tankdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_tankdisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_tankammotypeChoices(String) to String {
	var NONE = "";
	var PISTOL = "Pistol";
	var SMG1 = "SMG1";
	var AR2 = "AR2";
...
enum abstract Func_tankLeadTargetChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Func_tankSpawnFlags(Int) to Int {
	var ACTIVE = 1;
	var ONLY_DIRECT = 16;
	var CONTROLLABLE = 32;
	var DAMAGE_KICK = 64;
	...
	var IGNORE_RANGE_WHEN_MAKING_VIEWCONE_CHECKS = 8192;
	var AIMING_ASSISTANCE_PLAYER_ONLY = 256;
}
