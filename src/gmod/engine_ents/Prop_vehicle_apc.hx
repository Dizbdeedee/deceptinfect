...
**/
@:forward
abstract Prop_vehicle_apc(Entity) to Entity {
    //Inputs
	...
	**/
    public extern inline function FireFireMissileAt(param:String,delay:Float) {
        untyped this.Fire("FireMissileAt",untyped param,delay);
    }
    
    /**
		Causes the APC to blow up.
	**/
    public extern inline function FireDestroy(delay:Float) {
        untyped this.Fire("Destroy",untyped null,delay);
    }
	...
	**/
    ...
    /**
		Start locked
	**/
    public var VehicleLocked(get,set):Prop_vehicle_apcVehicleLockedChoices;

    @:noCompletion
    public extern inline function get_VehicleLocked():Prop_vehicle_apcVehicleLockedChoices {
        return untyped this.GetKeyValues().VehicleLocked;
    }
    
    @:noCompletion
    public extern inline function set_VehicleLocked(value:Prop_vehicle_apcVehicleLockedChoices):Prop_vehicle_apcVehicleLockedChoices {
	...
	**/
    ...
    /**
		Minimum DX Level
	**/
    public var mindxlevel(get,set):Prop_vehicle_apcmindxlevelChoices;

    @:noCompletion
    public extern inline function get_mindxlevel():Prop_vehicle_apcmindxlevelChoices {
        return untyped this.GetKeyValues().mindxlevel;
    }
    
    @:noCompletion
    public extern inline function set_mindxlevel(value:Prop_vehicle_apcmindxlevelChoices):Prop_vehicle_apcmindxlevelChoices {
    ...
    /**
		Maximum DX Level
	**/
    public var maxdxlevel(get,set):Prop_vehicle_apcmaxdxlevelChoices;

    @:noCompletion
    public extern inline function get_maxdxlevel():Prop_vehicle_apcmaxdxlevelChoices {
        return untyped this.GetKeyValues().maxdxlevel;
    }
    
    @:noCompletion
    public extern inline function set_maxdxlevel(value:Prop_vehicle_apcmaxdxlevelChoices):Prop_vehicle_apcmaxdxlevelChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Prop_vehicle_apcgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Prop_vehicle_apcgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Prop_vehicle_apcgmod_allowphysgunChoices):Prop_vehicle_apcgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    ...
    /**
		Collisions
	**/
    public var solid(get,set):Prop_vehicle_apcsolidChoices;

    @:noCompletion
    public extern inline function get_solid():Prop_vehicle_apcsolidChoices {
        return untyped this.GetKeyValues().solid;
    }
    
    @:noCompletion
    public extern inline function set_solid(value:Prop_vehicle_apcsolidChoices):Prop_vehicle_apcsolidChoices {
    ...
    /**
		Disable Shadows
	**/
    public var disableshadows(get,set):Prop_vehicle_apcdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Prop_vehicle_apcdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Prop_vehicle_apcdisableshadowsChoices):Prop_vehicle_apcdisableshadowsChoices {
	...
	**/
    public var screenspacefade(get,set):Prop_vehicle_apcscreenspacefadeChoices;

    @:noCompletion
    public extern inline function get_screenspacefade():Prop_vehicle_apcscreenspacefadeChoices {
        return untyped this.GetKeyValues().screenspacefade;
    }
    
    @:noCompletion
    public extern inline function set_screenspacefade(value:Prop_vehicle_apcscreenspacefadeChoices):Prop_vehicle_apcscreenspacefadeChoices {
	...
	**/
    public var disablevertexlighting(get,set):Prop_vehicle_apcdisablevertexlightingChoices;

    @:noCompletion
    public extern inline function get_disablevertexlighting():Prop_vehicle_apcdisablevertexlightingChoices {
        return untyped this.GetKeyValues().disablevertexlighting;
    }
    
    @:noCompletion
    public extern inline function set_disablevertexlighting(value:Prop_vehicle_apcdisablevertexlightingChoices):Prop_vehicle_apcdisablevertexlightingChoices {
	...
	**/
    public var disableselfshadowing(get,set):Prop_vehicle_apcdisableselfshadowingChoices;

    @:noCompletion
    public extern inline function get_disableselfshadowing():Prop_vehicle_apcdisableselfshadowingChoices {
        return untyped this.GetKeyValues().disableselfshadowing;
    }
    
    @:noCompletion
    public extern inline function set_disableselfshadowing(value:Prop_vehicle_apcdisableselfshadowingChoices):Prop_vehicle_apcdisableselfshadowingChoices {
	...
	**/
    public var ignorenormals(get,set):Prop_vehicle_apcignorenormalsChoices;

    @:noCompletion
    public extern inline function get_ignorenormals():Prop_vehicle_apcignorenormalsChoices {
        return untyped this.GetKeyValues().ignorenormals;
    }
    
    @:noCompletion
    public extern inline function set_ignorenormals(value:Prop_vehicle_apcignorenormalsChoices):Prop_vehicle_apcignorenormalsChoices {
	...
	**/
    public var missilehint(get,set):String;

    @:noCompletion
    public extern inline function get_missilehint():String {
        return untyped this.GetKeyValues().missilehint;
    }
    
    @:noCompletion
    public extern inline function set_missilehint(value:String):String {
        return untyped this.SetKeyValue("missilehint",untyped value);
    }
	...
	**/
    public extern inline function OutputPlayerOn(callback:Callback<{activator:Prop_vehicle_apc}>):CallbackLink {
	...
	**/
    public extern inline function OutputPlayerOff(callback:Callback<{activator:Prop_vehicle_apc}>):CallbackLink {
	...
	**/
    public extern inline function OutputPressedAttack(callback:Callback<{activator:Prop_vehicle_apc}>):CallbackLink {
	...
	**/
    public extern inline function OutputPressedAttack2(callback:Callback<{activator:Prop_vehicle_apc}>):CallbackLink {
	...
	**/
    public extern inline function OutputAttackAxis(callback:Callback<{activator:Prop_vehicle_apc,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputAttack2Axis(callback:Callback<{activator:Prop_vehicle_apc,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Prop_vehicle_apc}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Prop_vehicle_apc}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Prop_vehicle_apc}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Prop_vehicle_apc}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFiredMissile(callback:Callback<{activator:Prop_vehicle_apc}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnFiredMissile",callback);
    }
    
    /**
		Fired when the APC is killed.
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Prop_vehicle_apc}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Prop_vehicle_apc}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Prop_vehicle_apc}>):CallbackLink {
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("prop_vehicle_apc");
    }
}

enum abstract Prop_vehicle_apcsolidChoices(Int) to Int {
	var NOT_SOLID = 0;
	var USE_BOUNDING_BOX = 2;
	var USE_VPHYSICS = 6;
}
enum abstract Prop_vehicle_apcscreenspacefadeChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_apcmindxlevelChoices(Int) to Int {
...
enum abstract Prop_vehicle_apcmaxdxlevelChoices(Int) to Int {
...
enum abstract Prop_vehicle_apcignorenormalsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_apcgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_apcdisablevertexlightingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_apcdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_apcdisableselfshadowingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_apcVehicleLockedChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
