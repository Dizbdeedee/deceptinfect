...
**/
@:forward
abstract Func_tanktrain(Entity) to Entity {
    //Inputs
	...
	**/
    public var velocitytype(get,set):Func_tanktrainvelocitytypeChoices;

    @:noCompletion
    public extern inline function get_velocitytype():Func_tanktrainvelocitytypeChoices {
        return untyped this.GetKeyValues().velocitytype;
    }
    
    @:noCompletion
    public extern inline function set_velocitytype(value:Func_tanktrainvelocitytypeChoices):Func_tanktrainvelocitytypeChoices {
	...
	**/
    public var orientationtype(get,set):Func_tanktrainorientationtypeChoices;

    @:noCompletion
    public extern inline function get_orientationtype():Func_tanktrainorientationtypeChoices {
        return untyped this.GetKeyValues().orientationtype;
    }
    
    @:noCompletion
    public extern inline function set_orientationtype(value:Func_tanktrainorientationtypeChoices):Func_tanktrainorientationtypeChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Func_tanktraingmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Func_tanktraingmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Func_tanktraingmod_allowphysgunChoices):Func_tanktraingmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Func_tanktrainrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Func_tanktrainrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Func_tanktrainrendermodeChoices):Func_tanktrainrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Func_tanktraindisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Func_tanktraindisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Func_tanktraindisablereceiveshadowsChoices):Func_tanktraindisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Func_tanktrainrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Func_tanktrainrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Func_tanktrainrenderfxChoices):Func_tanktrainrenderfxChoices {
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Func_tanktraindisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Func_tanktraindisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Func_tanktraindisableshadowsChoices):Func_tanktraindisableshadowsChoices {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Func_tanktrain}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Func_tanktrain}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Func_tanktrain}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Func_tanktrain}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Func_tanktrain}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnDeath",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Func_tanktrainSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Func_tanktrainSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Func_tanktrainSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("func_tanktrain");
    }
}

enum abstract Func_tanktrainvelocitytypeChoices(Int) to Int {
	var INSTANTANEOUSLY = 0;
	var LINEAR_BLEND = 1;
	var EASE_INEASE_OUT = 2;
}
enum abstract Func_tanktrainrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Func_tanktrainrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Func_tanktrainorientationtypeChoices(Int) to Int {
	var NEVER_FIXED_ORIENTATION = 0;
	var NEAR_PATHTRACKS = 1;
	var LINEAR_BLEND = 2;
	var EASE_INEASE_OUT = 3;
}
enum abstract Func_tanktraingmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_tanktraindisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_tanktraindisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Func_tanktrainSpawnFlags(Int) to Int {
	var NO_PITCH_XROT = 1;
