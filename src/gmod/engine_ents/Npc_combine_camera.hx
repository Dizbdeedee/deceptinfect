...
**/
@:forward
abstract Npc_combine_camera(NPC) to Entity to NPC {
    //Inputs
	...
	**/
    public extern inline function FireSetDefaultTargetEntity(param:String,delay:Float) {
        untyped this.Fire("SetDefaultTargetEntity",untyped param,delay);
    }
	...
	**/
    ...
    /**
		Causes the camera to become angry as if it has seen something upsetting.
	**/
    public extern inline function FireSetAngry(delay:Float) {
        untyped this.Fire("SetAngry",untyped null,delay);
    }
    
    /**
		Causes the camera to calm down if it is angry.
	**/
    public extern inline function FireSetIdle(delay:Float) {
        untyped this.Fire("SetIdle",untyped null,delay);
    }
	...
	**/
    public var hintlimiting(get,set):Npc_combine_camerahintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Npc_combine_camerahintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Npc_combine_camerahintlimitingChoices):Npc_combine_camerahintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Npc_combine_camerasleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Npc_combine_camerasleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Npc_combine_camerasleepstateChoices):Npc_combine_camerasleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Npc_combine_camerawakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Npc_combine_camerawakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Npc_combine_camerawakesquadChoices):Npc_combine_camerawakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Npc_combine_cameraignoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Npc_combine_cameraignoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Npc_combine_cameraignoreunseenenemiesChoices):Npc_combine_cameraignoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Npc_combine_cameragmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Npc_combine_cameragmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Npc_combine_cameragmod_allowphysgunChoices):Npc_combine_cameragmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Npc_combine_camerarendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Npc_combine_camerarendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Npc_combine_camerarendermodeChoices):Npc_combine_camerarendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Npc_combine_cameradisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Npc_combine_cameradisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Npc_combine_cameradisablereceiveshadowsChoices):Npc_combine_cameradisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Npc_combine_camerarenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Npc_combine_camerarenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Npc_combine_camerarenderfxChoices):Npc_combine_camerarenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Npc_combine_cameradisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Npc_combine_cameradisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Npc_combine_cameradisableshadowsChoices):Npc_combine_cameradisableshadowsChoices {
	...
	**/
    ...
    @:noCompletion
    public extern inline function get_innerradius():Int {
        return untyped this.GetKeyValues().innerradius;
    }
    
    @:noCompletion
    public extern inline function set_innerradius(value:Int):Int {
        return untyped this.SetKeyValue("innerradius",untyped value);
    }
	...
	**/
    public var outerradius(get,set):Int;

    @:noCompletion
    public extern inline function get_outerradius():Int {
        return untyped this.GetKeyValues().outerradius;
    }
    
    @:noCompletion
    public extern inline function set_outerradius(value:Int):Int {
        return untyped this.SetKeyValue("outerradius",untyped value);
    }
	...
	**/
    public var defaulttarget(get,set):String;

    @:noCompletion
    public extern inline function get_defaulttarget():String {
        return untyped this.GetKeyValues().defaulttarget;
    }
    
    @:noCompletion
    public extern inline function set_defaulttarget(value:String):String {
        return untyped this.SetKeyValue("defaulttarget",untyped value);
    }
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Npc_combine_camera}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Npc_combine_camera}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Npc_combine_camera}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Npc_combine_camera}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Npc_combine_camera}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Npc_combine_camera}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Npc_combine_camera,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Npc_combine_camera}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Npc_combine_camera}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Npc_combine_camera,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Npc_combine_camera}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Npc_combine_camera}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Npc_combine_camera}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Npc_combine_camera}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Npc_combine_camera}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Npc_combine_camera}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Npc_combine_camera}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Npc_combine_camera}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Npc_combine_camera}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Npc_combine_camera}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Npc_combine_camera}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Npc_combine_camera}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Npc_combine_camera}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Npc_combine_camera}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Npc_combine_camera}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnFoundEnemy",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Npc_combine_cameraSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Npc_combine_cameraSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Npc_combine_cameraSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("npc_combine_camera");
    }
}

enum abstract Npc_combine_camerawakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_combine_camerasleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Npc_combine_camerarendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Npc_combine_camerarenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Npc_combine_cameraignoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_combine_camerahintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_combine_cameragmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_combine_cameradisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_combine_cameradisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Npc_combine_cameraSpawnFlags(Int) to Int {
	...
	var ALWAYS_BECOME_ANGRY_ON_NEW_ENEMY = 32;
	var IGNORE_ENEMIES_SCRIPTED_TARGETS_ONLY = 64;
	var START_INACTIVE = 128;
}
