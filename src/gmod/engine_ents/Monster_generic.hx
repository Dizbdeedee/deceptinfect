...
**/
@:forward
abstract Monster_generic(Entity) to Entity {
    //Inputs
	...
	**/
    public var hintlimiting(get,set):Monster_generichintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Monster_generichintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Monster_generichintlimitingChoices):Monster_generichintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Monster_genericsleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Monster_genericsleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Monster_genericsleepstateChoices):Monster_genericsleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Monster_genericwakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Monster_genericwakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Monster_genericwakesquadChoices):Monster_genericwakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Monster_genericignoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Monster_genericignoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Monster_genericignoreunseenenemiesChoices):Monster_genericignoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Monster_genericgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Monster_genericgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Monster_genericgmod_allowphysgunChoices):Monster_genericgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Monster_genericrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Monster_genericrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Monster_genericrendermodeChoices):Monster_genericrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Monster_genericdisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Monster_genericdisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Monster_genericdisablereceiveshadowsChoices):Monster_genericdisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Monster_genericrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Monster_genericrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Monster_genericrenderfxChoices):Monster_genericrenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Monster_genericdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Monster_genericdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Monster_genericdisableshadowsChoices):Monster_genericdisableshadowsChoices {
	...
	**/
    ...
    /**
		Body
	**/
    public var body(get,set):Integer;

    @:noCompletion
    public extern inline function get_body():Integer {
        return untyped this.GetKeyValues().body;
    }
    
    @:noCompletion
    public extern inline function set_body(value:Integer):Integer {
        return untyped this.SetKeyValue("body",untyped value);
    }
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Monster_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Monster_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Monster_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Monster_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Monster_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Monster_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Monster_generic,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Monster_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Monster_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Monster_generic,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Monster_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Monster_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Monster_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Monster_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Monster_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Monster_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Monster_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Monster_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Monster_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Monster_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Monster_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Monster_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Monster_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Monster_generic}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Monster_genericSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Monster_genericSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Monster_genericSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("monster_generic");
    }
}

enum abstract Monster_genericwakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Monster_genericsleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Monster_genericrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Monster_genericrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Monster_genericignoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Monster_generichintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Monster_genericgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Monster_genericdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Monster_genericdisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Monster_genericSpawnFlags(Int) to Int {
