...
**/
@:forward
abstract Env_sprite(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Minimum DX Level
	**/
    public var mindxlevel(get,set):Env_spritemindxlevelChoices;

    @:noCompletion
    public extern inline function get_mindxlevel():Env_spritemindxlevelChoices {
        return untyped this.GetKeyValues().mindxlevel;
    }
    
    @:noCompletion
    public extern inline function set_mindxlevel(value:Env_spritemindxlevelChoices):Env_spritemindxlevelChoices {
    ...
    /**
		Maximum DX Level
	**/
    public var maxdxlevel(get,set):Env_spritemaxdxlevelChoices;

    @:noCompletion
    public extern inline function get_maxdxlevel():Env_spritemaxdxlevelChoices {
        return untyped this.GetKeyValues().maxdxlevel;
    }
    
    @:noCompletion
    public extern inline function set_maxdxlevel(value:Env_spritemaxdxlevelChoices):Env_spritemaxdxlevelChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Env_spritegmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Env_spritegmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Env_spritegmod_allowphysgunChoices):Env_spritegmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Env_spriterendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Env_spriterendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Env_spriterendermodeChoices):Env_spriterendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Env_spritedisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Env_spritedisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Env_spritedisablereceiveshadowsChoices):Env_spritedisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Env_spriterenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Env_spriterenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Env_spriterenderfxChoices):Env_spriterenderfxChoices {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Env_sprite}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Env_sprite}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Env_sprite}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Env_sprite}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Env_spriteSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Env_spriteSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Env_spriteSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("env_sprite");
    }
}

enum abstract Env_spriterendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Env_spriterenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Env_spritemindxlevelChoices(Int) to Int {
...
enum abstract Env_spritemaxdxlevelChoices(Int) to Int {
...
enum abstract Env_spritegmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Env_spritedisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Env_spriteSpawnFlags(Int) to Int {
	var START_ON = 1;
	var PLAY_ONCE = 2;
}
