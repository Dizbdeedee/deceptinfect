...
**/
@:forward
abstract Prop_combine_ball(Entity) to Entity {
    //Inputs
...
Set to 1.0 for materials as strong as flesh, smaller numbers indicate stronger materials.
	**/
    ...
    /**
		Impact damage type
	**/
    public var Damagetype(get,set):Prop_combine_ballDamagetypeChoices;

    @:noCompletion
    public extern inline function get_Damagetype():Prop_combine_ballDamagetypeChoices {
        return untyped this.GetKeyValues().Damagetype;
    }
    
    @:noCompletion
    public extern inline function set_Damagetype(value:Prop_combine_ballDamagetypeChoices):Prop_combine_ballDamagetypeChoices {
	...
	**/
    public var nodamageforces(get,set):Prop_combine_ballnodamageforcesChoices;

    @:noCompletion
    public extern inline function get_nodamageforces():Prop_combine_ballnodamageforcesChoices {
        return untyped this.GetKeyValues().nodamageforces;
    }
    
    @:noCompletion
    public extern inline function set_nodamageforces(value:Prop_combine_ballnodamageforcesChoices):Prop_combine_ballnodamageforcesChoices {
	...
	**/
    public var PerformanceMode(get,set):Prop_combine_ballPerformanceModeChoices;

    @:noCompletion
    public extern inline function get_PerformanceMode():Prop_combine_ballPerformanceModeChoices {
        return untyped this.GetKeyValues().PerformanceMode;
    }
    
    @:noCompletion
    public extern inline function set_PerformanceMode(value:Prop_combine_ballPerformanceModeChoices):Prop_combine_ballPerformanceModeChoices {
	...
	**/
    ...
    /**
		Minimum DX Level
	**/
    public var mindxlevel(get,set):Prop_combine_ballmindxlevelChoices;

    @:noCompletion
    public extern inline function get_mindxlevel():Prop_combine_ballmindxlevelChoices {
        return untyped this.GetKeyValues().mindxlevel;
    }
    
    @:noCompletion
    public extern inline function set_mindxlevel(value:Prop_combine_ballmindxlevelChoices):Prop_combine_ballmindxlevelChoices {
    ...
    /**
		Maximum DX Level
	**/
    public var maxdxlevel(get,set):Prop_combine_ballmaxdxlevelChoices;

    @:noCompletion
    public extern inline function get_maxdxlevel():Prop_combine_ballmaxdxlevelChoices {
        return untyped this.GetKeyValues().maxdxlevel;
    }
    
    @:noCompletion
    public extern inline function set_maxdxlevel(value:Prop_combine_ballmaxdxlevelChoices):Prop_combine_ballmaxdxlevelChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Prop_combine_ballgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Prop_combine_ballgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Prop_combine_ballgmod_allowphysgunChoices):Prop_combine_ballgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Prop_combine_balldisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Prop_combine_balldisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Prop_combine_balldisableshadowsChoices):Prop_combine_balldisableshadowsChoices {
	...
	**/
    public extern inline function OutputOnMotionEnabled(callback:Callback<{activator:Prop_combine_ball}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnAwakened(callback:Callback<{activator:Prop_combine_ball}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysGunPickup(callback:Callback<{activator:Prop_combine_ball}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysGunPunt(callback:Callback<{activator:Prop_combine_ball}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysGunOnlyPickup(callback:Callback<{activator:Prop_combine_ball}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysGunDrop(callback:Callback<{activator:Prop_combine_ball}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPlayerUse(callback:Callback<{activator:Prop_combine_ball}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPlayerPickup(callback:Callback<{activator:Prop_combine_ball}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnOutOfWorld(callback:Callback<{activator:Prop_combine_ball}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnBreak(callback:Callback<{activator:Prop_combine_ball}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnTakeDamage(callback:Callback<{activator:Prop_combine_ball}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHealthChanged(callback:Callback<{activator:Prop_combine_ball,data:Float}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonDetach(callback:Callback<{activator:Prop_combine_ball}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonAnimatePreStarted(callback:Callback<{activator:Prop_combine_ball}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonAnimatePullStarted(callback:Callback<{activator:Prop_combine_ball}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonPullAnimFinished(callback:Callback<{activator:Prop_combine_ball}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonAnimatePostStarted(callback:Callback<{activator:Prop_combine_ball}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnIgnite(callback:Callback<{activator:Prop_combine_ball}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Prop_combine_ball}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Prop_combine_ball}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Prop_combine_ball}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Prop_combine_ball}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Prop_combine_ballSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Prop_combine_ballSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Prop_combine_ballSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("prop_combine_ball");
    }
}

enum abstract Prop_combine_ballnodamageforcesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_combine_ballmindxlevelChoices(Int) to Int {
...
enum abstract Prop_combine_ballmaxdxlevelChoices(Int) to Int {
...
enum abstract Prop_combine_ballgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_combine_balldisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_combine_ballPerformanceModeChoices(Int) to Int {
	var NORMAL = 0;
	var NO_GIBS = 1;
	var FULL_GIBS_ON_ALL_PLATFORMS = 2;
	var REDUCED_GIBS = 3;
}
enum abstract Prop_combine_ballDamagetypeChoices(Int) to Int {
	var BLUNT = 0;
	var SHARP = 1;
}


enum abstract Prop_combine_ballSpawnFlags(Int) to Int {
	var START_ASLEEP = 1;
