...
**/
@:forward
abstract Weapon_brickbat(Weapon) to Entity to Weapon {
    //Inputs
	...
	**/
    public var gmod_allowphysgun(get,set):Weapon_brickbatgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Weapon_brickbatgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Weapon_brickbatgmod_allowphysgunChoices):Weapon_brickbatgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    ...
    /**
		BrickbatType
	**/
    public var BrickbatType(get,set):Weapon_brickbatBrickbatTypeChoices;

    @:noCompletion
    public extern inline function get_BrickbatType():Weapon_brickbatBrickbatTypeChoices {
        return untyped this.GetKeyValues().BrickbatType;
    }
    
    @:noCompletion
    public extern inline function set_BrickbatType(value:Weapon_brickbatBrickbatTypeChoices):Weapon_brickbatBrickbatTypeChoices {
        return untyped this.SetKeyValue("BrickbatType",untyped value);
    }
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Weapon_brickbat}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Weapon_brickbat}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Weapon_brickbat}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Weapon_brickbat}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPlayerUse(callback:Callback<{activator:Weapon_brickbat}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPlayerPickup(callback:Callback<{activator:Weapon_brickbat}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnNPCPickup(callback:Callback<{activator:Weapon_brickbat}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnCacheInteraction(callback:Callback<{activator:Weapon_brickbat}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnCacheInteraction",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Weapon_brickbatSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Weapon_brickbatSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Weapon_brickbatSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("weapon_brickbat");
    }
}

enum abstract Weapon_brickbatgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Weapon_brickbatBrickbatTypeChoices(Int) to Int {
	var ROCK = 0;
	var BEER_BOTTLE = 1;
	var HEADCRAB = 2;
	var CREMATOR_HEAD = 3;
...
enum abstract Weapon_brickbatSpawnFlags(Int) to Int {
