...
**/
@:forward
abstract Func_conveyor(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		ToggleDirection
	**/
    public extern inline function FireToggleDirection(delay:Float) {
        untyped this.Fire("ToggleDirection",untyped null,delay);
    }
	...
	**/
    public var gmod_allowphysgun(get,set):Func_conveyorgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Func_conveyorgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Func_conveyorgmod_allowphysgunChoices):Func_conveyorgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Func_conveyorrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Func_conveyorrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Func_conveyorrendermodeChoices):Func_conveyorrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Func_conveyordisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Func_conveyordisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Func_conveyordisablereceiveshadowsChoices):Func_conveyordisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Func_conveyorrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Func_conveyorrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Func_conveyorrenderfxChoices):Func_conveyorrenderfxChoices {
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Func_conveyordisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Func_conveyordisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Func_conveyordisableshadowsChoices):Func_conveyordisableshadowsChoices {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Func_conveyor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Func_conveyor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Func_conveyor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Func_conveyor}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Func_conveyorSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Func_conveyorSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Func_conveyorSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("func_conveyor");
    }
}

enum abstract Func_conveyorrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Func_conveyorrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Func_conveyorgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_conveyordisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_conveyordisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Func_conveyorSpawnFlags(Int) to Int {
	var NO_PUSH = 1;
	var NOT_SOLID = 2;
}
