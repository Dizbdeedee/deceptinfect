...
**/
@:forward
abstract Prop_dynamic_override(Entity) to Entity {
    //Inputs
	...
	**/
    public var PerformanceMode(get,set):Prop_dynamic_overridePerformanceModeChoices;

    @:noCompletion
    public extern inline function get_PerformanceMode():Prop_dynamic_overridePerformanceModeChoices {
        return untyped this.GetKeyValues().PerformanceMode;
    }
    
    @:noCompletion
    public extern inline function set_PerformanceMode(value:Prop_dynamic_overridePerformanceModeChoices):Prop_dynamic_overridePerformanceModeChoices {
	...
	**/
    ...
    /**
		Minimum DX Level
	**/
    public var mindxlevel(get,set):Prop_dynamic_overridemindxlevelChoices;

    @:noCompletion
    public extern inline function get_mindxlevel():Prop_dynamic_overridemindxlevelChoices {
        return untyped this.GetKeyValues().mindxlevel;
    }
    
    @:noCompletion
    public extern inline function set_mindxlevel(value:Prop_dynamic_overridemindxlevelChoices):Prop_dynamic_overridemindxlevelChoices {
    ...
    /**
		Maximum DX Level
	**/
    public var maxdxlevel(get,set):Prop_dynamic_overridemaxdxlevelChoices;

    @:noCompletion
    public extern inline function get_maxdxlevel():Prop_dynamic_overridemaxdxlevelChoices {
        return untyped this.GetKeyValues().maxdxlevel;
    }
    
    @:noCompletion
    public extern inline function set_maxdxlevel(value:Prop_dynamic_overridemaxdxlevelChoices):Prop_dynamic_overridemaxdxlevelChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Prop_dynamic_overridegmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Prop_dynamic_overridegmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Prop_dynamic_overridegmod_allowphysgunChoices):Prop_dynamic_overridegmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Prop_dynamic_overriderendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Prop_dynamic_overriderendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Prop_dynamic_overriderendermodeChoices):Prop_dynamic_overriderendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Prop_dynamic_overridedisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Prop_dynamic_overridedisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Prop_dynamic_overridedisablereceiveshadowsChoices):Prop_dynamic_overridedisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Prop_dynamic_overriderenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Prop_dynamic_overriderenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Prop_dynamic_overriderenderfxChoices):Prop_dynamic_overriderenderfxChoices {
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Prop_dynamic_overridedisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Prop_dynamic_overridedisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Prop_dynamic_overridedisableshadowsChoices):Prop_dynamic_overridedisableshadowsChoices {
	...
	**/
    ...
    /**
		Collisions
	**/
    public var solid(get,set):Prop_dynamic_overridesolidChoices;

    @:noCompletion
    public extern inline function get_solid():Prop_dynamic_overridesolidChoices {
        return untyped this.GetKeyValues().solid;
    }
    
    @:noCompletion
    public extern inline function set_solid(value:Prop_dynamic_overridesolidChoices):Prop_dynamic_overridesolidChoices {
	...
	**/
    public var RandomAnimation(get,set):Prop_dynamic_overrideRandomAnimationChoices;

    @:noCompletion
    public extern inline function get_RandomAnimation():Prop_dynamic_overrideRandomAnimationChoices {
        return untyped this.GetKeyValues().RandomAnimation;
    }
    
    @:noCompletion
    public extern inline function set_RandomAnimation(value:Prop_dynamic_overrideRandomAnimationChoices):Prop_dynamic_overrideRandomAnimationChoices {
	...
	**/
    public var DisableBoneFollowers(get,set):Prop_dynamic_overrideDisableBoneFollowersChoices;

    @:noCompletion
    public extern inline function get_DisableBoneFollowers():Prop_dynamic_overrideDisableBoneFollowersChoices {
        return untyped this.GetKeyValues().DisableBoneFollowers;
    }
    
    @:noCompletion
    public extern inline function set_DisableBoneFollowers(value:Prop_dynamic_overrideDisableBoneFollowersChoices):Prop_dynamic_overrideDisableBoneFollowersChoices {
	...
	**/
    public var HoldAnimation(get,set):Prop_dynamic_overrideHoldAnimationChoices;

    @:noCompletion
    public extern inline function get_HoldAnimation():Prop_dynamic_overrideHoldAnimationChoices {
        return untyped this.GetKeyValues().HoldAnimation;
    }
    
    @:noCompletion
    public extern inline function set_HoldAnimation(value:Prop_dynamic_overrideHoldAnimationChoices):Prop_dynamic_overrideHoldAnimationChoices {
	...
	**/
    public var AnimateEveryFrame(get,set):Prop_dynamic_overrideAnimateEveryFrameChoices;

    @:noCompletion
    public extern inline function get_AnimateEveryFrame():Prop_dynamic_overrideAnimateEveryFrameChoices {
        return untyped this.GetKeyValues().AnimateEveryFrame;
    }
    
    @:noCompletion
    public extern inline function set_AnimateEveryFrame(value:Prop_dynamic_overrideAnimateEveryFrameChoices):Prop_dynamic_overrideAnimateEveryFrameChoices {
        return untyped this.SetKeyValue("AnimateEveryFrame",untyped value);
    }
	...
	**/
    public extern inline function OutputOnBreak(callback:Callback<{activator:Prop_dynamic_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnTakeDamage(callback:Callback<{activator:Prop_dynamic_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHealthChanged(callback:Callback<{activator:Prop_dynamic_override,data:Float}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonDetach(callback:Callback<{activator:Prop_dynamic_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonAnimatePreStarted(callback:Callback<{activator:Prop_dynamic_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonAnimatePullStarted(callback:Callback<{activator:Prop_dynamic_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonPullAnimFinished(callback:Callback<{activator:Prop_dynamic_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonAnimatePostStarted(callback:Callback<{activator:Prop_dynamic_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnIgnite(callback:Callback<{activator:Prop_dynamic_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Prop_dynamic_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Prop_dynamic_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Prop_dynamic_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Prop_dynamic_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnAnimationBegun(callback:Callback<{activator:Prop_dynamic_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnAnimationDone(callback:Callback<{activator:Prop_dynamic_override}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnAnimationDone",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Prop_dynamic_overrideSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Prop_dynamic_overrideSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Prop_dynamic_overrideSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("prop_dynamic_override");
    }
}

enum abstract Prop_dynamic_overridesolidChoices(Int) to Int {
	var NOT_SOLID = 0;
	var USE_BOUNDING_BOX = 2;
	var USE_VPHYSICS = 6;
}
enum abstract Prop_dynamic_overriderendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Prop_dynamic_overriderenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Prop_dynamic_overridemindxlevelChoices(Int) to Int {
...
enum abstract Prop_dynamic_overridemaxdxlevelChoices(Int) to Int {
...
enum abstract Prop_dynamic_overridegmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_dynamic_overridedisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_dynamic_overridedisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_dynamic_overrideRandomAnimationChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_dynamic_overridePerformanceModeChoices(Int) to Int {
	var NORMAL = 0;
	var NO_GIBS = 1;
	var FULL_GIBS_ON_ALL_PLATFORMS = 2;
	var REDUCED_GIBS = 3;
}
enum abstract Prop_dynamic_overrideHoldAnimationChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_dynamic_overrideDisableBoneFollowersChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_dynamic_overrideAnimateEveryFrameChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Prop_dynamic_overrideSpawnFlags(Int) to Int {
