...
**/
@:forward
abstract Env_rotorshooter(Entity) to Entity {
    //Inputs
	...
	**/
    public var gmod_allowphysgun(get,set):Env_rotorshootergmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Env_rotorshootergmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Env_rotorshootergmod_allowphysgunChoices):Env_rotorshootergmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Env_rotorshooterrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Env_rotorshooterrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Env_rotorshooterrendermodeChoices):Env_rotorshooterrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Env_rotorshooterdisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Env_rotorshooterdisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Env_rotorshooterdisablereceiveshadowsChoices):Env_rotorshooterdisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Env_rotorshooterrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Env_rotorshooterrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Env_rotorshooterrenderfxChoices):Env_rotorshooterrenderfxChoices {
	...
	**/
    ...
    /**
		Material Sound
	**/
    public var shootsounds(get,set):Env_rotorshootershootsoundsChoices;

    @:noCompletion
    public extern inline function get_shootsounds():Env_rotorshootershootsoundsChoices {
        return untyped this.GetKeyValues().shootsounds;
    }
    
    @:noCompletion
    public extern inline function set_shootsounds(value:Env_rotorshootershootsoundsChoices):Env_rotorshootershootsoundsChoices {
    ...
    /**
		Simulate
	**/
    public var simulation(get,set):Env_rotorshootersimulationChoices;

    @:noCompletion
    public extern inline function get_simulation():Env_rotorshootersimulationChoices {
        return untyped this.GetKeyValues().simulation;
    }
    
    @:noCompletion
    public extern inline function set_simulation(value:Env_rotorshootersimulationChoices):Env_rotorshootersimulationChoices {
	...
	**/
    public var rotortime(get,set):Float;

    @:noCompletion
    public extern inline function get_rotortime():Float {
        return untyped this.GetKeyValues().rotortime;
    }
    
    @:noCompletion
    public extern inline function set_rotortime(value:Float):Float {
        return untyped this.SetKeyValue("rotortime",untyped value);
    }
	...
	**/
    public var rotortimevariance(get,set):Float;

    @:noCompletion
    public extern inline function get_rotortimevariance():Float {
        return untyped this.GetKeyValues().rotortimevariance;
    }
    
    @:noCompletion
    public extern inline function set_rotortimevariance(value:Float):Float {
        return untyped this.SetKeyValue("rotortimevariance",untyped value);
    }
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Env_rotorshooter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Env_rotorshooter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Env_rotorshooter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Env_rotorshooter}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Env_rotorshooterSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Env_rotorshooterSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Env_rotorshooterSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("env_rotorshooter");
    }
}

enum abstract Env_rotorshootersimulationChoices(Int) to Int {
	var POINT = 0;
	var PHYSICS = 1;
	var RAGDOLL = 2;
}
enum abstract Env_rotorshootershootsoundsChoices(Int) to Int {
	var NONE = -1;
	var GLASS = 0;
	var WOOD = 1;
	var METAL = 2;
...
enum abstract Env_rotorshooterrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Env_rotorshooterrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Env_rotorshootergmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Env_rotorshooterdisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Env_rotorshooterSpawnFlags(Int) to Int {
	var REPEATABLE = 1;
	var ON_FIRE = 2;
}
