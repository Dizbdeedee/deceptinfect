...
**/
@:forward
abstract Trigger_weapon_dissolve(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Start Disabled
	**/
    public var StartDisabled(get,set):Trigger_weapon_dissolveStartDisabledChoices;

    @:noCompletion
    public extern inline function get_StartDisabled():Trigger_weapon_dissolveStartDisabledChoices {
        return untyped this.GetKeyValues().StartDisabled;
    }
    
    @:noCompletion
    public extern inline function set_StartDisabled(value:Trigger_weapon_dissolveStartDisabledChoices):Trigger_weapon_dissolveStartDisabledChoices {
	...
	**/
    public var emittername(get,set):String;

    @:noCompletion
    public extern inline function get_emittername():String {
        return untyped this.GetKeyValues().emittername;
    }
    
    @:noCompletion
    public extern inline function set_emittername(value:String):String {
        return untyped this.SetKeyValue("emittername",untyped value);
    }
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Trigger_weapon_dissolve}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Trigger_weapon_dissolve}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Trigger_weapon_dissolve}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Trigger_weapon_dissolve}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnStartTouchAll(callback:Callback<{activator:Trigger_weapon_dissolve}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnEndTouch(callback:Callback<{activator:Trigger_weapon_dissolve}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnEndTouchAll(callback:Callback<{activator:Trigger_weapon_dissolve}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnStartTouch(callback:Callback<{activator:Trigger_weapon_dissolve}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDissolveWeapon(callback:Callback<{activator:Trigger_weapon_dissolve}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnDissolveWeapon",callback);
    }
    
    /**
		Fires when the trigger begins to charge the physcannon.
	**/
    public extern inline function OutputOnChargingPhyscannon(callback:Callback<{activator:Trigger_weapon_dissolve}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnChargingPhyscannon",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Trigger_weapon_dissolveSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Trigger_weapon_dissolveSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Trigger_weapon_dissolveSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("trigger_weapon_dissolve");
    }
}

enum abstract Trigger_weapon_dissolveStartDisabledChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Trigger_weapon_dissolveSpawnFlags(Int) to Int {
	var CLIENTS = 1;
	var NPCS = 2;
	var PUSHABLES = 4;
