...
**/
@:forward
abstract Npc_combinedropship(NPC) to Entity to NPC {
    //Inputs
	...
	**/
    public extern inline function FireLandLeaveCrate(param:Int,delay:Float) {
        untyped this.Fire("LandLeaveCrate",untyped param,delay);
    }
    
    /**
		Land, drop soldiers, but don't leave the crate behind. Specify the number of troops to drop off in the parameter.
	**/
    public extern inline function FireLandTakeCrate(param:Int,delay:Float) {
        untyped this.Fire("LandTakeCrate",untyped param,delay);
    }
    
    /**
		Drop Rollermines. Specify the number of mines to drop in the parameter.
	**/
    public extern inline function FireDropMines(param:Int,delay:Float) {
        untyped this.Fire("DropMines",untyped param,delay);
    }
    
    /**
		Drop the Strider you're carrying. Now.
	**/
    public extern inline function FireDropStrider(delay:Float) {
        untyped this.Fire("DropStrider",untyped null,delay);
    }
    
    /**
		Drop the APC you're carrying. Now.
	**/
    public extern inline function FireDropAPC(delay:Float) {
        untyped this.Fire("DropAPC",untyped null,delay);
    }
    
    /**
		Hover over a named target entity until told to fly to a path.
	**/
    public extern inline function FireHover(param:String,delay:Float) {
        untyped this.Fire("Hover",untyped param,delay);
    }
    
    /**
		Pickup an entity.
	**/
    public extern inline function FirePickup(param:String,delay:Float) {
        untyped this.Fire("Pickup",untyped param,delay);
    }
    
    /**
		Set my land target name.
	**/
    public extern inline function FireSetLandTarget(param:String,delay:Float) {
        untyped this.Fire("SetLandTarget",untyped param,delay);
    }
    
    /**
		Set my crate gun's range.
	**/
    public extern inline function FireSetGunRange(param:Float,delay:Float) {
        untyped this.Fire("SetGunRange",untyped param,delay);
    }
	...
	**/
    public extern inline function FireStopWaitingForDropoff(delay:Float) {
        untyped this.Fire("StopWaitingForDropoff",untyped null,delay);
    }
	...
	**/
    public var hintlimiting(get,set):Npc_combinedropshiphintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Npc_combinedropshiphintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Npc_combinedropshiphintlimitingChoices):Npc_combinedropshiphintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Npc_combinedropshipsleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Npc_combinedropshipsleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Npc_combinedropshipsleepstateChoices):Npc_combinedropshipsleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Npc_combinedropshipwakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Npc_combinedropshipwakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Npc_combinedropshipwakesquadChoices):Npc_combinedropshipwakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Npc_combinedropshipignoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Npc_combinedropshipignoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Npc_combinedropshipignoreunseenenemiesChoices):Npc_combinedropshipignoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Npc_combinedropshipgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Npc_combinedropshipgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Npc_combinedropshipgmod_allowphysgunChoices):Npc_combinedropshipgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Npc_combinedropshiprendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Npc_combinedropshiprendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Npc_combinedropshiprendermodeChoices):Npc_combinedropshiprendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Npc_combinedropshipdisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Npc_combinedropshipdisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Npc_combinedropshipdisablereceiveshadowsChoices):Npc_combinedropshipdisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Npc_combinedropshiprenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Npc_combinedropshiprenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Npc_combinedropshiprenderfxChoices):Npc_combinedropshiprenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Npc_combinedropshipdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Npc_combinedropshipdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Npc_combinedropshipdisableshadowsChoices):Npc_combinedropshipdisableshadowsChoices {
	...
	**/
    ...
    /**
		Land target name
	**/
    public var LandTarget(get,set):String;

    @:noCompletion
    public extern inline function get_LandTarget():String {
        return untyped this.GetKeyValues().LandTarget;
    }
    
    @:noCompletion
    public extern inline function set_LandTarget(value:String):String {
        return untyped this.SetKeyValue("LandTarget",untyped value);
    }
	...
	**/
    public var GunRange(get,set):Float;

    @:noCompletion
    public extern inline function get_GunRange():Float {
        return untyped this.GetKeyValues().GunRange;
    }
    
    @:noCompletion
    public extern inline function set_GunRange(value:Float):Float {
        return untyped this.SetKeyValue("GunRange",untyped value);
    }
    
    /**
		Name of Rollermine Template
	...
	**/
    public var RollermineTemplate(get,set):String;

    @:noCompletion
    public extern inline function get_RollermineTemplate():String {
        return untyped this.GetKeyValues().RollermineTemplate;
    }
    
    @:noCompletion
    public extern inline function set_RollermineTemplate(value:String):String {
        return untyped this.SetKeyValue("RollermineTemplate",untyped value);
    }
    
    /**
		Name of Template NPC 1
	**/
    public var NPCTemplate(get,set):String;

    @:noCompletion
    public extern inline function get_NPCTemplate():String {
        return untyped this.GetKeyValues().NPCTemplate;
    }
    
    @:noCompletion
    public extern inline function set_NPCTemplate(value:String):String {
        return untyped this.SetKeyValue("NPCTemplate",untyped value);
    }
    
    /**
		Name of Template NPC 2
	**/
    public var NPCTemplate2(get,set):String;

    @:noCompletion
    public extern inline function get_NPCTemplate2():String {
        return untyped this.GetKeyValues().NPCTemplate2;
    }
    
    @:noCompletion
    public extern inline function set_NPCTemplate2(value:String):String {
        return untyped this.SetKeyValue("NPCTemplate2",untyped value);
    }
    
    /**
		Name of Template NPC 3
	**/
    public var NPCTemplate3(get,set):String;

    @:noCompletion
    public extern inline function get_NPCTemplate3():String {
        return untyped this.GetKeyValues().NPCTemplate3;
    }
    
    @:noCompletion
    public extern inline function set_NPCTemplate3(value:String):String {
        return untyped this.SetKeyValue("NPCTemplate3",untyped value);
    }
    
    /**
		Name of Template NPC 4
	**/
    public var NPCTemplate4(get,set):String;

    @:noCompletion
    public extern inline function get_NPCTemplate4():String {
        return untyped this.GetKeyValues().NPCTemplate4;
    }
    
    @:noCompletion
    public extern inline function set_NPCTemplate4(value:String):String {
        return untyped this.SetKeyValue("NPCTemplate4",untyped value);
    }
    
    /**
		Name of Template NPC 5
	**/
    public var NPCTemplate5(get,set):String;

    @:noCompletion
    public extern inline function get_NPCTemplate5():String {
        return untyped this.GetKeyValues().NPCTemplate5;
    }
    
    @:noCompletion
    public extern inline function set_NPCTemplate5(value:String):String {
        return untyped this.SetKeyValue("NPCTemplate5",untyped value);
    }
    
    /**
		Name of Template NPC 6
	**/
    public var NPCTemplate6(get,set):String;

    @:noCompletion
    public extern inline function get_NPCTemplate6():String {
        return untyped this.GetKeyValues().NPCTemplate6;
    }
    
    @:noCompletion
    public extern inline function set_NPCTemplate6(value:String):String {
        return untyped this.SetKeyValue("NPCTemplate6",untyped value);
    }
    
    /**
		Name of dustoff point for NPC 1
	**/
    public var Dustoff1(get,set):String;

    @:noCompletion
    public extern inline function get_Dustoff1():String {
        return untyped this.GetKeyValues().Dustoff1;
    }
    
    @:noCompletion
    public extern inline function set_Dustoff1(value:String):String {
        return untyped this.SetKeyValue("Dustoff1",untyped value);
    }
    
    /**
		Name of dustoff point for NPC 2
	**/
    public var Dustoff2(get,set):String;

    @:noCompletion
    public extern inline function get_Dustoff2():String {
        return untyped this.GetKeyValues().Dustoff2;
    }
    
    @:noCompletion
    public extern inline function set_Dustoff2(value:String):String {
        return untyped this.SetKeyValue("Dustoff2",untyped value);
    }
    
    /**
		Name of dustoff point for NPC 3
	**/
    public var Dustoff3(get,set):String;

    @:noCompletion
    public extern inline function get_Dustoff3():String {
        return untyped this.GetKeyValues().Dustoff3;
    }
    
    @:noCompletion
    public extern inline function set_Dustoff3(value:String):String {
        return untyped this.SetKeyValue("Dustoff3",untyped value);
    }
    
    /**
		Name of dustoff point for NPC 4
	**/
    public var Dustoff4(get,set):String;

    @:noCompletion
    public extern inline function get_Dustoff4():String {
        return untyped this.GetKeyValues().Dustoff4;
    }
    
    @:noCompletion
    public extern inline function set_Dustoff4(value:String):String {
        return untyped this.SetKeyValue("Dustoff4",untyped value);
    }
    
    /**
		Name of dustoff point for NPC 5
	**/
    public var Dustoff5(get,set):String;

    @:noCompletion
    public extern inline function get_Dustoff5():String {
        return untyped this.GetKeyValues().Dustoff5;
    }
    
    @:noCompletion
    public extern inline function set_Dustoff5(value:String):String {
        return untyped this.SetKeyValue("Dustoff5",untyped value);
    }
    
    /**
		Name of dustoff point for NPC 6
	**/
    public var Dustoff6(get,set):String;

    @:noCompletion
    public extern inline function get_Dustoff6():String {
        return untyped this.GetKeyValues().Dustoff6;
    }
    
    @:noCompletion
    public extern inline function set_Dustoff6(value:String):String {
        return untyped this.SetKeyValue("Dustoff6",untyped value);
    }
    
    /**
		Name of the APC to drop
	**/
    public var APCVehicleName(get,set):String;

    @:noCompletion
    public extern inline function get_APCVehicleName():String {
        return untyped this.GetKeyValues().APCVehicleName;
    }
    
    @:noCompletion
    public extern inline function set_APCVehicleName(value:String):String {
        return untyped this.SetKeyValue("APCVehicleName",untyped value);
    }
    
    /**
		Invulnerable
	**/
    public var Invulnerable(get,set):Choices;

    @:noCompletion
    public extern inline function get_Invulnerable():Choices {
        return untyped this.GetKeyValues().Invulnerable;
    }
    
    @:noCompletion
    public extern inline function set_Invulnerable(value:Choices):Choices {
        return untyped this.SetKeyValue("Invulnerable",untyped value);
    }
    
    /**
		Crate Type
	**/
    public var CrateType(get,set):Choices;

    @:noCompletion
    public extern inline function get_CrateType():Choices {
        return untyped this.GetKeyValues().CrateType;
    }
    
    @:noCompletion
    public extern inline function set_CrateType(value:Choices):Choices {
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Npc_combinedropship,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Npc_combinedropship,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFinishedDropoff(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnFinishedDropoff",callback);
    }
    
    /**
		Fires when the dropship has finished a pickup.
	**/
    public extern inline function OutputOnFinishedPickup(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnFinishedPickup",callback);
    }
	...
	**/
    public extern inline function OutputOnCrateShotDownBeforeDropoff(callback:Callback<{activator:Npc_combinedropship,data:Float}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnCrateShotDownBeforeDropoff",callback);
    }
    
    /**
		Fires when the container was shot down after it dropped off soldiers.
	**/
    public extern inline function OutputOnCrateShotDownAfterDropoff(callback:Callback<{activator:Npc_combinedropship}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnCrateShotDownAfterDropoff",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Npc_combinedropshipSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Npc_combinedropshipSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Npc_combinedropshipSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("npc_combinedropship");
    }
}

enum abstract Npc_combinedropshipwakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_combinedropshipsleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Npc_combinedropshiprendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Npc_combinedropshiprenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Npc_combinedropshipignoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_combinedropshiphintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_combinedropshipgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_combinedropshipdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_combinedropshipdisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Npc_combinedropshipSpawnFlags(Int) to Int {
	var NO_ROTORWASH = 32;
	var AWAIT_INPUT = 64;
	...
	var WAIT_FOR_INPUT_BEFORE_DROPOFF = 32768;
}
