...
**/
@:forward
abstract Func_wall_toggle(Entity) to Entity {
    //Inputs
	...
	**/
    public var gmod_allowphysgun(get,set):Func_wall_togglegmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Func_wall_togglegmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Func_wall_togglegmod_allowphysgunChoices):Func_wall_togglegmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Func_wall_togglerendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Func_wall_togglerendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Func_wall_togglerendermodeChoices):Func_wall_togglerendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Func_wall_toggledisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Func_wall_toggledisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Func_wall_toggledisablereceiveshadowsChoices):Func_wall_toggledisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Func_wall_togglerenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Func_wall_togglerenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Func_wall_togglerenderfxChoices):Func_wall_togglerenderfxChoices {
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Func_wall_toggledisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Func_wall_toggledisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Func_wall_toggledisableshadowsChoices):Func_wall_toggledisableshadowsChoices {
...
This also includes the context menu properties!
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Func_wall_toggle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Func_wall_toggle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Func_wall_toggle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Func_wall_toggle}>):CallbackLink {
	...
	**/
    ...
    public extern inline function addSpawnFlag(spawnflag:Func_wall_toggleSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Func_wall_toggleSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Func_wall_toggleSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("func_wall_toggle");
    }
}

enum abstract Func_wall_togglerendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Func_wall_togglerenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Func_wall_togglegmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_wall_toggledisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_wall_toggledisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Func_wall_toggleSpawnFlags(Int) to Int {
	var STARTS_INVISIBLE = 1;
}
