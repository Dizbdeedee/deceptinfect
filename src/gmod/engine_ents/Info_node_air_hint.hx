...
**/
@:forward
abstract Info_node_air_hint(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Hint
	**/
    public var hinttype(get,set):Info_node_air_hinthinttypeChoices;

    @:noCompletion
    public extern inline function get_hinttype():Info_node_air_hinthinttypeChoices {
        return untyped this.GetKeyValues().hinttype;
    }
    
    @:noCompletion
    public extern inline function set_hinttype(value:Info_node_air_hinthinttypeChoices):Info_node_air_hinthinttypeChoices {
	...
	**/
    public var nodeFOV(get,set):Info_node_air_hintnodeFOVChoices;

    @:noCompletion
    public extern inline function get_nodeFOV():Info_node_air_hintnodeFOVChoices {
        return untyped this.GetKeyValues().nodeFOV;
    }
    
    @:noCompletion
    public extern inline function set_nodeFOV(value:Info_node_air_hintnodeFOVChoices):Info_node_air_hintnodeFOVChoices {
    ...
    /**
		Start Hint Disabled
	**/
    public var StartHintDisabled(get,set):Info_node_air_hintStartHintDisabledChoices;

    @:noCompletion
    public extern inline function get_StartHintDisabled():Info_node_air_hintStartHintDisabledChoices {
        return untyped this.GetKeyValues().StartHintDisabled;
    }
    
    @:noCompletion
    public extern inline function set_StartHintDisabled(value:Info_node_air_hintStartHintDisabledChoices):Info_node_air_hintStartHintDisabledChoices {
	...
	**/
    public var IgnoreFacing(get,set):Info_node_air_hintIgnoreFacingChoices;

    @:noCompletion
    public extern inline function get_IgnoreFacing():Info_node_air_hintIgnoreFacingChoices {
        return untyped this.GetKeyValues().IgnoreFacing;
    }
    
    @:noCompletion
    public extern inline function set_IgnoreFacing(value:Info_node_air_hintIgnoreFacingChoices):Info_node_air_hintIgnoreFacingChoices {
	...
	**/
    public var MinimumState(get,set):Info_node_air_hintMinimumStateChoices;

    @:noCompletion
    public extern inline function get_MinimumState():Info_node_air_hintMinimumStateChoices {
        return untyped this.GetKeyValues().MinimumState;
    }
    
    @:noCompletion
    public extern inline function set_MinimumState(value:Info_node_air_hintMinimumStateChoices):Info_node_air_hintMinimumStateChoices {
	...
	**/
    public var MaximumState(get,set):Info_node_air_hintMaximumStateChoices;

    @:noCompletion
    public extern inline function get_MaximumState():Info_node_air_hintMaximumStateChoices {
        return untyped this.GetKeyValues().MaximumState;
    }
    
    @:noCompletion
    public extern inline function set_MaximumState(value:Info_node_air_hintMaximumStateChoices):Info_node_air_hintMaximumStateChoices {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Info_node_air_hint}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Info_node_air_hint}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Info_node_air_hint}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Info_node_air_hint}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Info_node_air_hintSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Info_node_air_hintSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Info_node_air_hintSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("info_node_air_hint");
    }
}

enum abstract Info_node_air_hintnodeFOVChoices(Int) to Int {
	var _45_DEGREES = 45;
	var _90_DEGREES = 90;
	var _180_DEGREES = 180;
	var _360_DEGREES = 360;
}
enum abstract Info_node_air_hinthinttypeChoices(Int) to Int {
	var NONE = 0;
	var WORLD_WINDOW = 2;
...
enum abstract Info_node_air_hintStartHintDisabledChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Info_node_air_hintMinimumStateChoices(Int) to Int {
	var IDLE = 1;
	var ALERT = 2;
	var COMBAT = 3;
}
enum abstract Info_node_air_hintMaximumStateChoices(Int) to Int {
	var IDLE = 1;
	var ALERT = 2;
	var COMBAT = 3;
}
enum abstract Info_node_air_hintIgnoreFacingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
	var DEFAULT = 2;
}
...
enum abstract Info_node_air_hintSpawnFlags(Int) to Int {
