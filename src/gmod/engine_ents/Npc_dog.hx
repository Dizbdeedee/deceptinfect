...
**/
@:forward
abstract Npc_dog(NPC) to Entity to NPC {
    //Inputs
	...
	**/
    public extern inline function FireSetPickupTarget(param:String,delay:Float) {
        untyped this.Fire("SetPickupTarget",untyped param,delay);
    }
	...
	**/
    public extern inline function FireStartCatchThrowBehavior(param:String,delay:Float) {
        untyped this.Fire("StartCatchThrowBehavior",untyped param,delay);
    }
    
    /**
		Stop the catch and throw behavior.
	**/
    public extern inline function FireStopCatchThrowBehavior(param:String,delay:Float) {
        untyped this.Fire("StopCatchThrowBehavior",untyped param,delay);
    }
    
    /**
		Tells d0g the physgun just picked up an object.
	**/
    public extern inline function FirePlayerPickupObject(delay:Float) {
        untyped this.Fire("PlayerPickupObject",untyped null,delay);
    }
    
    /**
		Tells d0g to wait for the player to throw an object at him.
	**/
    public extern inline function FireStartWaitAndCatch(delay:Float) {
        untyped this.Fire("StartWaitAndCatch",untyped null,delay);
    }
    
    /**
		Tells d0g to stop waiting for the player.
	**/
    public extern inline function FireStopWaitAndCatch(delay:Float) {
        untyped this.Fire("StopWaitAndCatch",untyped null,delay);
    }
    
    /**
		Used to pass in a modifier for d0g's object flight arc.
	**/
    public extern inline function FireSetThrowArcModifier(param:Float,delay:Float) {
        untyped this.Fire("SetThrowArcModifier",untyped param,delay);
    }
    
    /**
		Set d0g's throw target (pass in !player if you want the player)
	**/
    public extern inline function FireSetThrowTarget(param:String,delay:Float) {
        untyped this.Fire("SetThrowTarget",untyped param,delay);
    }
    
    /**
		Turn dog's bone followers off
	**/
    public extern inline function FireTurnBoneFollowersOff(delay:Float) {
        untyped this.Fire("TurnBoneFollowersOff",untyped null,delay);
    }
    
    /**
		Turn dog's bone followers on
	**/
    public extern inline function FireTurnBoneFollowersOn(delay:Float) {
        untyped this.Fire("TurnBoneFollowersOn",untyped null,delay);
    }
	...
	**/
    public var hintlimiting(get,set):Npc_doghintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Npc_doghintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Npc_doghintlimitingChoices):Npc_doghintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Npc_dogsleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Npc_dogsleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Npc_dogsleepstateChoices):Npc_dogsleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Npc_dogwakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Npc_dogwakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Npc_dogwakesquadChoices):Npc_dogwakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Npc_dogignoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Npc_dogignoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Npc_dogignoreunseenenemiesChoices):Npc_dogignoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Npc_doggmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Npc_doggmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Npc_doggmod_allowphysgunChoices):Npc_doggmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Npc_dogrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Npc_dogrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Npc_dogrendermodeChoices):Npc_dogrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Npc_dogdisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Npc_dogdisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Npc_dogdisablereceiveshadowsChoices):Npc_dogdisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Npc_dogrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Npc_dogrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Npc_dogrenderfxChoices):Npc_dogrenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Npc_dogdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Npc_dogdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Npc_dogdisableshadowsChoices):Npc_dogdisableshadowsChoices {
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Npc_dog}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Npc_dog}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Npc_dog}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Npc_dog}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Npc_dog}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Npc_dog}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Npc_dog,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Npc_dog}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Npc_dog}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Npc_dog,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Npc_dog}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Npc_dog}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Npc_dog}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Npc_dog}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Npc_dog}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Npc_dog}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Npc_dog}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Npc_dog}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Npc_dog}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Npc_dog}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Npc_dog}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Npc_dog}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Npc_dog}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Npc_dog}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDogThrow(callback:Callback<{activator:Npc_dog}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnDogThrow",callback);
    }
    
    /**
		Fires when dog picks up an object.
	**/
    public extern inline function OutputOnDogPickup(callback:Callback<{activator:Npc_dog}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnDogPickup",callback);
    }
    
    /**
		Fires when dog catches an object.
	**/
    public extern inline function OutputOnDogCatch(callback:Callback<{activator:Npc_dog}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnDogCatch",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Npc_dogSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Npc_dogSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Npc_dogSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("npc_dog");
    }
}

enum abstract Npc_dogwakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_dogsleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Npc_dogrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Npc_dogrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Npc_dogignoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_doghintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_doggmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_dogdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_dogdisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Npc_dogSpawnFlags(Int) to Int {
