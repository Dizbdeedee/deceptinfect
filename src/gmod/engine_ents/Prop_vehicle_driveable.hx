...
**/
@:forward
abstract Prop_vehicle_driveable(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Start locked
	**/
    public var VehicleLocked(get,set):Prop_vehicle_driveableVehicleLockedChoices;

    @:noCompletion
    public extern inline function get_VehicleLocked():Prop_vehicle_driveableVehicleLockedChoices {
        return untyped this.GetKeyValues().VehicleLocked;
    }
    
    @:noCompletion
    public extern inline function set_VehicleLocked(value:Prop_vehicle_driveableVehicleLockedChoices):Prop_vehicle_driveableVehicleLockedChoices {
	...
	**/
    ...
    /**
		Minimum DX Level
	**/
    public var mindxlevel(get,set):Prop_vehicle_driveablemindxlevelChoices;

    @:noCompletion
    public extern inline function get_mindxlevel():Prop_vehicle_driveablemindxlevelChoices {
        return untyped this.GetKeyValues().mindxlevel;
    }
    
    @:noCompletion
    public extern inline function set_mindxlevel(value:Prop_vehicle_driveablemindxlevelChoices):Prop_vehicle_driveablemindxlevelChoices {
    ...
    /**
		Maximum DX Level
	**/
    public var maxdxlevel(get,set):Prop_vehicle_driveablemaxdxlevelChoices;

    @:noCompletion
    public extern inline function get_maxdxlevel():Prop_vehicle_driveablemaxdxlevelChoices {
        return untyped this.GetKeyValues().maxdxlevel;
    }
    
    @:noCompletion
    public extern inline function set_maxdxlevel(value:Prop_vehicle_driveablemaxdxlevelChoices):Prop_vehicle_driveablemaxdxlevelChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Prop_vehicle_driveablegmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Prop_vehicle_driveablegmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Prop_vehicle_driveablegmod_allowphysgunChoices):Prop_vehicle_driveablegmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    ...
    /**
		Collisions
	**/
    public var solid(get,set):Prop_vehicle_driveablesolidChoices;

    @:noCompletion
    public extern inline function get_solid():Prop_vehicle_driveablesolidChoices {
        return untyped this.GetKeyValues().solid;
    }
    
    @:noCompletion
    public extern inline function set_solid(value:Prop_vehicle_driveablesolidChoices):Prop_vehicle_driveablesolidChoices {
    ...
    /**
		Disable Shadows
	**/
    public var disableshadows(get,set):Prop_vehicle_driveabledisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Prop_vehicle_driveabledisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Prop_vehicle_driveabledisableshadowsChoices):Prop_vehicle_driveabledisableshadowsChoices {
	...
	**/
    public var screenspacefade(get,set):Prop_vehicle_driveablescreenspacefadeChoices;

    @:noCompletion
    public extern inline function get_screenspacefade():Prop_vehicle_driveablescreenspacefadeChoices {
        return untyped this.GetKeyValues().screenspacefade;
    }
    
    @:noCompletion
    public extern inline function set_screenspacefade(value:Prop_vehicle_driveablescreenspacefadeChoices):Prop_vehicle_driveablescreenspacefadeChoices {
	...
	**/
    public var disablevertexlighting(get,set):Prop_vehicle_driveabledisablevertexlightingChoices;

    @:noCompletion
    public extern inline function get_disablevertexlighting():Prop_vehicle_driveabledisablevertexlightingChoices {
        return untyped this.GetKeyValues().disablevertexlighting;
    }
    
    @:noCompletion
    public extern inline function set_disablevertexlighting(value:Prop_vehicle_driveabledisablevertexlightingChoices):Prop_vehicle_driveabledisablevertexlightingChoices {
	...
	**/
    public var disableselfshadowing(get,set):Prop_vehicle_driveabledisableselfshadowingChoices;

    @:noCompletion
    public extern inline function get_disableselfshadowing():Prop_vehicle_driveabledisableselfshadowingChoices {
        return untyped this.GetKeyValues().disableselfshadowing;
    }
    
    @:noCompletion
    public extern inline function set_disableselfshadowing(value:Prop_vehicle_driveabledisableselfshadowingChoices):Prop_vehicle_driveabledisableselfshadowingChoices {
	...
	**/
    public var ignorenormals(get,set):Prop_vehicle_driveableignorenormalsChoices;

    @:noCompletion
    public extern inline function get_ignorenormals():Prop_vehicle_driveableignorenormalsChoices {
        return untyped this.GetKeyValues().ignorenormals;
    }
    
    @:noCompletion
    public extern inline function set_ignorenormals(value:Prop_vehicle_driveableignorenormalsChoices):Prop_vehicle_driveableignorenormalsChoices {
	...
	**/
    public extern inline function OutputPlayerOn(callback:Callback<{activator:Prop_vehicle_driveable}>):CallbackLink {
	...
	**/
    public extern inline function OutputPlayerOff(callback:Callback<{activator:Prop_vehicle_driveable}>):CallbackLink {
	...
	**/
    public extern inline function OutputPressedAttack(callback:Callback<{activator:Prop_vehicle_driveable}>):CallbackLink {
	...
	**/
    public extern inline function OutputPressedAttack2(callback:Callback<{activator:Prop_vehicle_driveable}>):CallbackLink {
	...
	**/
    public extern inline function OutputAttackAxis(callback:Callback<{activator:Prop_vehicle_driveable,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputAttack2Axis(callback:Callback<{activator:Prop_vehicle_driveable,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Prop_vehicle_driveable}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Prop_vehicle_driveable}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Prop_vehicle_driveable}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Prop_vehicle_driveable}>):CallbackLink {
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("prop_vehicle_driveable");
    }
}

enum abstract Prop_vehicle_driveablesolidChoices(Int) to Int {
	var NOT_SOLID = 0;
	var USE_BOUNDING_BOX = 2;
	var USE_VPHYSICS = 6;
}
enum abstract Prop_vehicle_driveablescreenspacefadeChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_driveablemindxlevelChoices(Int) to Int {
...
enum abstract Prop_vehicle_driveablemaxdxlevelChoices(Int) to Int {
...
enum abstract Prop_vehicle_driveableignorenormalsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_driveablegmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_driveabledisablevertexlightingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_driveabledisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_driveabledisableselfshadowingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_driveableVehicleLockedChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
