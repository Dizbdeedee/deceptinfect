...
**/
@:forward
abstract Weapon_smg1(Weapon) to Entity to Weapon {
    //Inputs
	...
	**/
    public var gmod_allowphysgun(get,set):Weapon_smg1gmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Weapon_smg1gmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Weapon_smg1gmod_allowphysgunChoices):Weapon_smg1gmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Weapon_smg1}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Weapon_smg1}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Weapon_smg1}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Weapon_smg1}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPlayerUse(callback:Callback<{activator:Weapon_smg1}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPlayerPickup(callback:Callback<{activator:Weapon_smg1}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnNPCPickup(callback:Callback<{activator:Weapon_smg1}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnCacheInteraction(callback:Callback<{activator:Weapon_smg1}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnCacheInteraction",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Weapon_smg1SpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Weapon_smg1SpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Weapon_smg1SpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("weapon_smg1");
    }
}

enum abstract Weapon_smg1gmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Weapon_smg1SpawnFlags(Int) to Int {
