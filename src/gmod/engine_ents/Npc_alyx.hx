...
**/
@:forward
abstract Npc_alyx(NPC) to Entity to NPC {
    //Inputs
	...
	**/
    public extern inline function FireAllowInteraction(delay:Float) {
        untyped this.Fire("AllowInteraction",untyped null,delay);
    }
    
    /**
		Disallow Alyx's 'hacking' AI.
	**/
    public extern inline function FireDisallowInteraction(delay:Float) {
        untyped this.Fire("DisallowInteraction",untyped null,delay);
    }
    
    /**
		Enables or disables Alyx's darkness speech ('where are you', etc).
	**/
    public extern inline function FireAllowDarknessSpeech(param:bool,delay:Float) {
        untyped this.Fire("AllowDarknessSpeech",untyped param,delay);
    }
    
    /**
		Sets Alyx to take her animation and cycle position from another entity.
	**/
    public extern inline function FireSetAnimLockedEntity(param:String,delay:Float) {
        untyped this.Fire("SetAnimLockedEntity",untyped param,delay);
    }
    
    /**
		Stops Alyx from taking her animation locking from another character.
	**/
    public extern inline function FireClearAnimLockedEntity(delay:Float) {
        untyped this.Fire("ClearAnimLockedEntity",untyped null,delay);
    }
    
    /**
		Gives or removes the EMP tool.
	**/
    public extern inline function FireGiveEMP(param:bool,delay:Float) {
        untyped this.Fire("GiveEMP",untyped param,delay);
    }
    
    /**
		Make Alyx enter the vehicle specified by name.
	**/
    public extern inline function FireEnterVehicle(param:String,delay:Float) {
        untyped this.Fire("EnterVehicle",untyped param,delay);
    }
    
    /**
		Make Alyx enter the vehicle specified by name immediately via teleportation.
	**/
    public extern inline function FireEnterVehicleImmediately(param:String,delay:Float) {
        untyped this.Fire("EnterVehicleImmediately",untyped param,delay);
    }
    
    /**
		Make Alyx exit the vehicle she's in.
	**/
    public extern inline function FireExitVehicle(delay:Float) {
        untyped this.Fire("ExitVehicle",untyped null,delay);
    }
    
    /**
		Stops Alyx from trying to enter the vehicle if she's outside of it.
	**/
    public extern inline function FireCancelEnterVehicle(delay:Float) {
        untyped this.Fire("CancelEnterVehicle",untyped null,delay);
    }
	...
	**/
    public var hintlimiting(get,set):Npc_alyxhintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Npc_alyxhintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Npc_alyxhintlimitingChoices):Npc_alyxhintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Npc_alyxsleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Npc_alyxsleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Npc_alyxsleepstateChoices):Npc_alyxsleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Npc_alyxwakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Npc_alyxwakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Npc_alyxwakesquadChoices):Npc_alyxwakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Npc_alyxignoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Npc_alyxignoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Npc_alyxignoreunseenenemiesChoices):Npc_alyxignoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Npc_alyxgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Npc_alyxgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Npc_alyxgmod_allowphysgunChoices):Npc_alyxgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var AlwaysTransition(get,set):Npc_alyxAlwaysTransitionChoices;

    @:noCompletion
    public extern inline function get_AlwaysTransition():Npc_alyxAlwaysTransitionChoices {
        return untyped this.GetKeyValues().AlwaysTransition;
    }
    
    @:noCompletion
    public extern inline function set_AlwaysTransition(value:Npc_alyxAlwaysTransitionChoices):Npc_alyxAlwaysTransitionChoices {
	...
	**/
    public var DontPickupWeapons(get,set):Npc_alyxDontPickupWeaponsChoices;

    @:noCompletion
    public extern inline function get_DontPickupWeapons():Npc_alyxDontPickupWeaponsChoices {
        return untyped this.GetKeyValues().DontPickupWeapons;
    }
    
    @:noCompletion
    public extern inline function set_DontPickupWeapons(value:Npc_alyxDontPickupWeaponsChoices):Npc_alyxDontPickupWeaponsChoices {
	...
	**/
    public var GameEndAlly(get,set):Npc_alyxGameEndAllyChoices;

    @:noCompletion
    public extern inline function get_GameEndAlly():Npc_alyxGameEndAllyChoices {
        return untyped this.GetKeyValues().GameEndAlly;
    }
    
    @:noCompletion
    public extern inline function set_GameEndAlly(value:Npc_alyxGameEndAllyChoices):Npc_alyxGameEndAllyChoices {
	...
	**/
    public var rendermode(get,set):Npc_alyxrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Npc_alyxrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Npc_alyxrendermodeChoices):Npc_alyxrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Npc_alyxdisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Npc_alyxdisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Npc_alyxdisablereceiveshadowsChoices):Npc_alyxdisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Npc_alyxrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Npc_alyxrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Npc_alyxrenderfxChoices):Npc_alyxrenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Npc_alyxdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Npc_alyxdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Npc_alyxdisableshadowsChoices):Npc_alyxdisableshadowsChoices {
	...
	**/
    public var DontUseSpeechSemaphore(get,set):Npc_alyxDontUseSpeechSemaphoreChoices;

    @:noCompletion
    public extern inline function get_DontUseSpeechSemaphore():Npc_alyxDontUseSpeechSemaphoreChoices {
        return untyped this.GetKeyValues().DontUseSpeechSemaphore;
    }
    
    @:noCompletion
    public extern inline function set_DontUseSpeechSemaphore(value:Npc_alyxDontUseSpeechSemaphoreChoices):Npc_alyxDontUseSpeechSemaphoreChoices {
	...
	**/
    ...
    /**
		Weapons
	**/
    public var additionalequipment(get,set):Npc_alyxadditionalequipmentChoices;

    @:noCompletion
    public extern inline function get_additionalequipment():Npc_alyxadditionalequipmentChoices {
        return untyped this.GetKeyValues().additionalequipment;
    }
    
    @:noCompletion
    public extern inline function set_additionalequipment(value:Npc_alyxadditionalequipmentChoices):Npc_alyxadditionalequipmentChoices {
	...
	**/
    public var ShouldHaveEMP(get,set):Npc_alyxShouldHaveEMPChoices;

    @:noCompletion
    public extern inline function get_ShouldHaveEMP():Npc_alyxShouldHaveEMPChoices {
        return untyped this.GetKeyValues().ShouldHaveEMP;
    }
    
    @:noCompletion
    public extern inline function set_ShouldHaveEMP(value:Npc_alyxShouldHaveEMPChoices):Npc_alyxShouldHaveEMPChoices {
        return untyped this.SetKeyValue("ShouldHaveEMP",untyped value);
    }
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Npc_alyx,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Npc_alyx,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWeaponPickup(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFinishInteractWithObject(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnFinishInteractWithObject",callback);
    }
    
    /**
		Fires when a player +USEs Alyx.
	**/
    public extern inline function OutputOnPlayerUse(callback:Callback<{activator:Npc_alyx}>):CallbackLink {
	...
	**/
    ...
    public extern inline function addSpawnFlag(spawnflag:Npc_alyxSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Npc_alyxSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Npc_alyxSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("npc_alyx");
    }
}

enum abstract Npc_alyxwakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_alyxsleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Npc_alyxrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Npc_alyxrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Npc_alyxignoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_alyxhintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_alyxgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_alyxdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_alyxdisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_alyxadditionalequipmentChoices(String) to String {
	var ALYX_GUN = "weapon_alyxgun";
	var SHOTGUN = "weapon_shotgun";
	var NOTHING = "0";
}
enum abstract Npc_alyxShouldHaveEMPChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_alyxGameEndAllyChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_alyxDontUseSpeechSemaphoreChoices(Int) to Int {
	var NO_USE_SPEECH_SEMAPHORE = 0;
	var YES_DONT_USE_SPEECH_SEMAPHORE = 1;
}
enum abstract Npc_alyxDontPickupWeaponsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_alyxAlwaysTransitionChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Npc_alyxSpawnFlags(Int) to Int {
