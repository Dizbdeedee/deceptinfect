...
**/
@:forward
abstract Func_tank_combine_cannon(Entity) to Entity {
    //Inputs
	...
	**/
    public extern inline function FireDisableHarrass(delay:Float) {
        untyped this.Fire("DisableHarrass",untyped null,delay);
    }
    
    /**
		Allow the cannon to track and pester a player who is hiding (DEFAULT)
	**/
    public extern inline function FireEnableHarrass(delay:Float) {
        untyped this.Fire("EnableHarrass",untyped null,delay);
    }
	...
	**/
    ...
    /**
		Bullet accuracy
	**/
    public var firespread(get,set):Func_tank_combine_cannonfirespreadChoices;

    @:noCompletion
    public extern inline function get_firespread():Func_tank_combine_cannonfirespreadChoices {
        return untyped this.GetKeyValues().firespread;
    }
    
    @:noCompletion
    public extern inline function set_firespread(value:Func_tank_combine_cannonfirespreadChoices):Func_tank_combine_cannonfirespreadChoices {
	...
	**/
    ...
    /**
		Lead Target
	**/
    public var LeadTarget(get,set):Func_tank_combine_cannonLeadTargetChoices;

    @:noCompletion
    public extern inline function get_LeadTarget():Func_tank_combine_cannonLeadTargetChoices {
        return untyped this.GetKeyValues().LeadTarget;
    }
    
    @:noCompletion
    public extern inline function set_LeadTarget(value:Func_tank_combine_cannonLeadTargetChoices):Func_tank_combine_cannonLeadTargetChoices {
	...
	**/
    ...
    /**
		Effect Handling
	**/
    public var effecthandling(get,set):Func_tank_combine_cannoneffecthandlingChoices;

    @:noCompletion
    public extern inline function get_effecthandling():Func_tank_combine_cannoneffecthandlingChoices {
        return untyped this.GetKeyValues().effecthandling;
    }
    
    @:noCompletion
    public extern inline function set_effecthandling(value:Func_tank_combine_cannoneffecthandlingChoices):Func_tank_combine_cannoneffecthandlingChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Func_tank_combine_cannongmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Func_tank_combine_cannongmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Func_tank_combine_cannongmod_allowphysgunChoices):Func_tank_combine_cannongmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Func_tank_combine_cannonrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Func_tank_combine_cannonrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Func_tank_combine_cannonrendermodeChoices):Func_tank_combine_cannonrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Func_tank_combine_cannondisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Func_tank_combine_cannondisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Func_tank_combine_cannondisablereceiveshadowsChoices):Func_tank_combine_cannondisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Func_tank_combine_cannonrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Func_tank_combine_cannonrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Func_tank_combine_cannonrenderfxChoices):Func_tank_combine_cannonrenderfxChoices {
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Func_tank_combine_cannondisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Func_tank_combine_cannondisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Func_tank_combine_cannondisableshadowsChoices):Func_tank_combine_cannondisableshadowsChoices {
	...
	**/
    ...
    /**
		Ammo type
	**/
    public var ammotype(get,set):Func_tank_combine_cannonammotypeChoices;

    @:noCompletion
    public extern inline function get_ammotype():Func_tank_combine_cannonammotypeChoices {
        return untyped this.GetKeyValues().ammotype;
    }
    
    @:noCompletion
    public extern inline function set_ammotype(value:Func_tank_combine_cannonammotypeChoices):Func_tank_combine_cannonammotypeChoices {
	...
	**/
    public extern inline function OutputOnFire(callback:Callback<{activator:Func_tank_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnAquireTarget(callback:Callback<{activator:Func_tank_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLoseTarget(callback:Callback<{activator:Func_tank_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnAmmoDepleted(callback:Callback<{activator:Func_tank_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnGotController(callback:Callback<{activator:Func_tank_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostController(callback:Callback<{activator:Func_tank_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnGotPlayerController(callback:Callback<{activator:Func_tank_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerController(callback:Callback<{activator:Func_tank_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnReadyToFire(callback:Callback<{activator:Func_tank_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Func_tank_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Func_tank_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Func_tank_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Func_tank_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnShotAtPlayer(callback:Callback<{activator:Func_tank_combine_cannon}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnShotAtPlayer",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Func_tank_combine_cannonSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Func_tank_combine_cannonSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Func_tank_combine_cannonSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("func_tank_combine_cannon");
    }
}

enum abstract Func_tank_combine_cannonrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Func_tank_combine_cannonrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Func_tank_combine_cannongmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_tank_combine_cannonfirespreadChoices(Int) to Int {
	var PERFECT_SHOT = 0;
	var SMALL_CONE = 1;
	var MEDIUM_CONE = 2;
	var LARGE_CONE = 3;
...
enum abstract Func_tank_combine_cannoneffecthandlingChoices(Int) to Int {
	var USE_INDIVIDUAL_SETTINGS = 0;
	var AR2 = 1;
	var COMBINE_CANNON = 2;
}
enum abstract Func_tank_combine_cannondisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_tank_combine_cannondisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_tank_combine_cannonammotypeChoices(String) to String {
	var NONE = "";
	var PISTOL = "Pistol";
	var SMG1 = "SMG1";
	var AR2 = "AR2";
	var COMBINE_HEAVY_CANNON = "CombineHeavyCannon";
}
enum abstract Func_tank_combine_cannonLeadTargetChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Func_tank_combine_cannonSpawnFlags(Int) to Int {
	var ACTIVE = 1;
	var ONLY_DIRECT = 16;
	var CONTROLLABLE = 32;
	var DAMAGE_KICK = 64;
