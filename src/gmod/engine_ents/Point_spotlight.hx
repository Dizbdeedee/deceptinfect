...
**/
@:forward
abstract Point_spotlight(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Change the spotlight beam color.
	**/
    ...
    /**
		Forcibly update the spotlight beam position
	**/
    public extern inline function FireForceUpdate(delay:Float) {
        untyped this.Fire("ForceUpdate",untyped null,delay);
    }
	...
	**/
    ...
    /**
		Minimum DX Level
	**/
    public var mindxlevel(get,set):Point_spotlightmindxlevelChoices;

    @:noCompletion
    public extern inline function get_mindxlevel():Point_spotlightmindxlevelChoices {
        return untyped this.GetKeyValues().mindxlevel;
    }
    
    @:noCompletion
    public extern inline function set_mindxlevel(value:Point_spotlightmindxlevelChoices):Point_spotlightmindxlevelChoices {
    ...
    /**
		Maximum DX Level
	**/
    public var maxdxlevel(get,set):Point_spotlightmaxdxlevelChoices;

    @:noCompletion
    public extern inline function get_maxdxlevel():Point_spotlightmaxdxlevelChoices {
        return untyped this.GetKeyValues().maxdxlevel;
    }
    
    @:noCompletion
    public extern inline function set_maxdxlevel(value:Point_spotlightmaxdxlevelChoices):Point_spotlightmaxdxlevelChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Point_spotlightgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Point_spotlightgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Point_spotlightgmod_allowphysgunChoices):Point_spotlightgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Point_spotlightrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Point_spotlightrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Point_spotlightrendermodeChoices):Point_spotlightrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Point_spotlightdisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Point_spotlightdisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Point_spotlightdisablereceiveshadowsChoices):Point_spotlightdisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Point_spotlightrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Point_spotlightrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Point_spotlightrenderfxChoices):Point_spotlightrenderfxChoices {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Point_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Point_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Point_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Point_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLightOn(callback:Callback<{activator:Point_spotlight}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLightOff(callback:Callback<{activator:Point_spotlight}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnLightOff",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Point_spotlightSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Point_spotlightSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Point_spotlightSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("point_spotlight");
    }
}

enum abstract Point_spotlightrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Point_spotlightrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Point_spotlightmindxlevelChoices(Int) to Int {
...
enum abstract Point_spotlightmaxdxlevelChoices(Int) to Int {
...
enum abstract Point_spotlightgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Point_spotlightdisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Point_spotlightSpawnFlags(Int) to Int {
	var START_ON = 1;
