...
**/
@:forward
abstract Trigger_playermovement(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Start Disabled
	**/
    public var StartDisabled(get,set):Trigger_playermovementStartDisabledChoices;

    @:noCompletion
    public extern inline function get_StartDisabled():Trigger_playermovementStartDisabledChoices {
        return untyped this.GetKeyValues().StartDisabled;
    }
    
    @:noCompletion
    public extern inline function set_StartDisabled(value:Trigger_playermovementStartDisabledChoices):Trigger_playermovementStartDisabledChoices {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Trigger_playermovement}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Trigger_playermovement}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Trigger_playermovement}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Trigger_playermovement}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnStartTouchAll(callback:Callback<{activator:Trigger_playermovement}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnEndTouch(callback:Callback<{activator:Trigger_playermovement}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnEndTouchAll(callback:Callback<{activator:Trigger_playermovement}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnStartTouch(callback:Callback<{activator:Trigger_playermovement}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnStartTouch",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Trigger_playermovementSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Trigger_playermovementSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Trigger_playermovementSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("trigger_playermovement");
    }
}

enum abstract Trigger_playermovementStartDisabledChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Trigger_playermovementSpawnFlags(Int) to Int {
	var CLIENTS = 1;
	var NPCS = 2;
	var PUSHABLES = 4;
	...
	var OBSOLETE_UNCHECK_ME = 16;
	var DISABLE_AUTO_PLAYER_MOVEMENT = 128;
	var AUTODUCK_WHILE_IN_TRIGGER = 2048;
}
