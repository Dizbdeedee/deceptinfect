...
**/
@:forward
abstract Func_rotating(Entity) to Entity {
    //Inputs
	...
	**/
    public extern inline function FireStopAtStartPos(delay:Float) {
        untyped this.Fire("StopAtStartPos",untyped null,delay);
    }
	...
	**/
    public var gmod_allowphysgun(get,set):Func_rotatinggmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Func_rotatinggmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Func_rotatinggmod_allowphysgunChoices):Func_rotatinggmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Func_rotatingrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Func_rotatingrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Func_rotatingrendermodeChoices):Func_rotatingrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Func_rotatingdisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Func_rotatingdisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Func_rotatingdisablereceiveshadowsChoices):Func_rotatingdisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Func_rotatingrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Func_rotatingrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Func_rotatingrenderfxChoices):Func_rotatingrenderfxChoices {
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Func_rotatingdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Func_rotatingdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Func_rotatingdisableshadowsChoices):Func_rotatingdisableshadowsChoices {
	...
	**/
    public var fanfriction(get,set):Int;

    @:noCompletion
    public extern inline function get_fanfriction():Int {
        return untyped this.GetKeyValues().fanfriction;
    }
    
    @:noCompletion
    public extern inline function set_fanfriction(value:Int):Int {
        return untyped this.SetKeyValue("fanfriction",untyped value);
    }
	...
	**/
    ...
    /**
		Solid Type
	**/
    public var solidbsp(get,set):Func_rotatingsolidbspChoices;

    @:noCompletion
    public extern inline function get_solidbsp():Func_rotatingsolidbspChoices {
        return untyped this.GetKeyValues().solidbsp;
    }
    
    @:noCompletion
    public extern inline function set_solidbsp(value:Func_rotatingsolidbspChoices):Func_rotatingsolidbspChoices {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Func_rotating}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Func_rotating}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Func_rotating}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Func_rotating}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Func_rotatingSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Func_rotatingSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Func_rotatingSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("func_rotating");
    }
}

enum abstract Func_rotatingsolidbspChoices(Int) to Int {
	var VPHYSICS = 0;
	var BSP = 1;
}
enum abstract Func_rotatingrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Func_rotatingrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Func_rotatinggmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_rotatingdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_rotatingdisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Func_rotatingSpawnFlags(Int) to Int {
	var START_ON = 1;
	var REVERSE_DIRECTION = 2;
	var X_AXIS = 4;
	var Y_AXIS = 8;
	var ACCDCC = 16;
	var FAN_PAIN = 32;
	var NOT_SOLID = 64;
	var SMALL_SOUND_RADIUS = 128;
	var MEDIUM_SOUND_RADIUS = 256;
	var LARGE_SOUND_RADIUS = 512;
}
