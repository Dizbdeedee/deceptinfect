...
**/
@:forward
abstract Npc_bullseye(NPC) to Entity to NPC {
    //Inputs
	...
	**/
    public var hintlimiting(get,set):Npc_bullseyehintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Npc_bullseyehintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Npc_bullseyehintlimitingChoices):Npc_bullseyehintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Npc_bullseyesleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Npc_bullseyesleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Npc_bullseyesleepstateChoices):Npc_bullseyesleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Npc_bullseyewakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Npc_bullseyewakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Npc_bullseyewakesquadChoices):Npc_bullseyewakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Npc_bullseyeignoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Npc_bullseyeignoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Npc_bullseyeignoreunseenenemiesChoices):Npc_bullseyeignoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Npc_bullseyegmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Npc_bullseyegmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Npc_bullseyegmod_allowphysgunChoices):Npc_bullseyegmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Npc_bullseyerendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Npc_bullseyerendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Npc_bullseyerendermodeChoices):Npc_bullseyerendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Npc_bullseyedisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Npc_bullseyedisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Npc_bullseyedisablereceiveshadowsChoices):Npc_bullseyedisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Npc_bullseyerenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Npc_bullseyerenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Npc_bullseyerenderfxChoices):Npc_bullseyerenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Npc_bullseyedisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Npc_bullseyedisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Npc_bullseyedisableshadowsChoices):Npc_bullseyedisableshadowsChoices {
	...
	**/
    public var minangle(get,set):String;

    @:noCompletion
    public extern inline function get_minangle():String {
        return untyped this.GetKeyValues().minangle;
    }
    
    @:noCompletion
    public extern inline function set_minangle(value:String):String {
        return untyped this.SetKeyValue("minangle",untyped value);
    }
	...
	**/
    public var mindist(get,set):String;

    @:noCompletion
    public extern inline function get_mindist():String {
        return untyped this.GetKeyValues().mindist;
    }
    
    @:noCompletion
    public extern inline function set_mindist(value:String):String {
	...
	**/
    public var autoaimradius(get,set):Float;

    @:noCompletion
    public extern inline function get_autoaimradius():Float {
        return untyped this.GetKeyValues().autoaimradius;
    }
    
    @:noCompletion
    public extern inline function set_autoaimradius(value:Float):Float {
        return untyped this.SetKeyValue("autoaimradius",untyped value);
    }
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Npc_bullseye}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Npc_bullseye}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Npc_bullseye}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Npc_bullseye}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Npc_bullseye}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Npc_bullseye}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Npc_bullseye,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Npc_bullseye}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Npc_bullseye}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Npc_bullseye,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Npc_bullseye}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Npc_bullseye}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Npc_bullseye}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Npc_bullseye}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Npc_bullseye}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Npc_bullseye}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Npc_bullseye}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Npc_bullseye}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Npc_bullseye}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Npc_bullseye}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Npc_bullseye}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Npc_bullseye}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Npc_bullseye}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Npc_bullseye}>):CallbackLink {
    ...
    /**
		Fires when targeted
	**/
    public extern inline function OutputOnTargeted(callback:Callback<{activator:Npc_bullseye}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnTargeted",callback);
    }
    
    /**
		Fires when no longer targeted
	**/
    public extern inline function OutputOnReleased(callback:Callback<{activator:Npc_bullseye}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnReleased",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Npc_bullseyeSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Npc_bullseyeSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Npc_bullseyeSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("npc_bullseye");
    }
}

enum abstract Npc_bullseyewakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_bullseyesleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Npc_bullseyerendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Npc_bullseyerenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Npc_bullseyeignoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_bullseyehintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_bullseyegmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_bullseyedisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_bullseyedisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Npc_bullseyeSpawnFlags(Int) to Int {
	...
	var NOT_SOLID = 65536;
	var TAKE_NO_DAMAGE = 131072;
	var ENEMY_DAMAGE_ONLY = 262144;
	var BLEED = 524288;
	var PERFECT_ACCURACY = 1048576;
	var COLLIDE_AGAINST_PHYSICS_OBJECTS_CREATES_VPHYSICS_SHADOW = 2097152;
}
