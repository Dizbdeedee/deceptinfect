...
**/
@:forward
abstract Npc_advisor(NPC) to Entity to NPC {
    //Inputs
	...
	**/
    ...
    /**
		Advisor will throw an object once per this many seconds (plus a little more)
	**/
    public extern inline function FireSetThrowRate(param:Float,delay:Float) {
        untyped this.Fire("SetThrowRate",untyped param,delay);
    }
    
    /**
		Advisor will immediately start levitating all objects with this name
	**/
    public extern inline function FireWrenchImmediate(param:String,delay:Float) {
        untyped this.Fire("WrenchImmediate",untyped param,delay);
    }
    
    /**
		Advisor will stage this many objects at once, then barrage the player.
	**/
    public extern inline function FireSetStagingNum(param:Int,delay:Float) {
        untyped this.Fire("SetStagingNum",untyped param,delay);
    }
    
    /**
		Advisor will wrench the player to this point in the air. Use a null param to let go.
	**/
    public extern inline function FirePinPlayer(param:String,delay:Float) {
        untyped this.Fire("PinPlayer",untyped param,delay);
    }
    
    /**
		Start a psychic-TK effect beam from the advisor to the specified object. You must remember to turn it off later.
	**/
    public extern inline function FireBeamOn(param:String,delay:Float) {
        untyped this.Fire("BeamOn",untyped param,delay);
    }
    
    /**
		Turn off a psychic-TK effect beam from the advisor to the specified object.
	**/
    public extern inline function FireBeamOff(param:String,delay:Float) {
        untyped this.Fire("BeamOff",untyped param,delay);
    }
    
    /**
		Turn on an entity light at my location. Please remember to turn this off.
	**/
    public extern inline function FireELightOn(delay:Float) {
        untyped this.Fire("ELightOn",untyped null,delay);
    }
    
    /**
		Turn off my entity light.
	**/
    public extern inline function FireELightOff(delay:Float) {
        untyped this.Fire("ELightOff",untyped null,delay);
    }
    
    /**
		
	**/
    public extern inline function FireDoNothing(delay:Float) {
        untyped this.Fire("DoNothing",untyped null,delay);
    }
	...
	**/
    public var hintlimiting(get,set):Npc_advisorhintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Npc_advisorhintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Npc_advisorhintlimitingChoices):Npc_advisorhintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Npc_advisorsleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Npc_advisorsleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Npc_advisorsleepstateChoices):Npc_advisorsleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Npc_advisorwakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Npc_advisorwakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Npc_advisorwakesquadChoices):Npc_advisorwakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Npc_advisorignoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Npc_advisorignoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Npc_advisorignoreunseenenemiesChoices):Npc_advisorignoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Npc_advisorgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Npc_advisorgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Npc_advisorgmod_allowphysgunChoices):Npc_advisorgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Npc_advisorrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Npc_advisorrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Npc_advisorrendermodeChoices):Npc_advisorrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Npc_advisordisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Npc_advisordisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Npc_advisordisablereceiveshadowsChoices):Npc_advisordisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Npc_advisorrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Npc_advisorrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Npc_advisorrenderfxChoices):Npc_advisorrenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Npc_advisordisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Npc_advisordisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Npc_advisordisableshadowsChoices):Npc_advisordisableshadowsChoices {
	...
	**/
    public var levitationarea(get,set):String;

    @:noCompletion
    public extern inline function get_levitationarea():String {
        return untyped this.GetKeyValues().levitationarea;
    }
    
    @:noCompletion
    public extern inline function set_levitationarea(value:String):String {
        return untyped this.SetKeyValue("levitationarea",untyped value);
    }
    
    /**
		Levitation Goal Bottom

		Objects will levitate at least this high
	**/
    public var levitategoal_bottom(get,set):String;

    @:noCompletion
    public extern inline function get_levitategoal_bottom():String {
        return untyped this.GetKeyValues().levitategoal_bottom;
    }
    
    @:noCompletion
    public extern inline function set_levitategoal_bottom(value:String):String {
        return untyped this.SetKeyValue("levitategoal_bottom",untyped value);
    }
    ...
    /**
		...
		Objects will levitate at least this high
	**/
    public var levitategoal_top(get,set):String;

    @:noCompletion
    public extern inline function get_levitategoal_top():String {
        return untyped this.GetKeyValues().levitategoal_top;
    }
    
    @:noCompletion
    public extern inline function set_levitategoal_top(value:String):String {
        return untyped this.SetKeyValue("levitategoal_top",untyped value);
    }
    
    /**
		Staging Position Names

		All entities with this name will be considered staging positions for the throw behavior.
	**/
    public var staging_ent_names(get,set):String;

    @:noCompletion
    public extern inline function get_staging_ent_names():String {
        return untyped this.GetKeyValues().staging_ent_names;
    }
    
    @:noCompletion
    public extern inline function set_staging_ent_names(value:String):String {
        return untyped this.SetKeyValue("staging_ent_names",untyped value);
    }
	...
	**/
    public var priority_grab_name(get,set):String;

    @:noCompletion
    public extern inline function get_priority_grab_name():String {
        return untyped this.GetKeyValues().priority_grab_name;
    }
    
    @:noCompletion
    public extern inline function set_priority_grab_name(value:String):String {
        return untyped this.SetKeyValue("priority_grab_name",untyped value);
    }
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Npc_advisor,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Npc_advisor,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    
    /**
		Fires just before I pick something to hurl
	**/
    public extern inline function OutputOnPickingThrowable(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnPickingThrowable",callback);
    }
    
    /**
		Fires when I trigger the warning green glow before tossing
	**/
    public extern inline function OutputOnThrowWarn(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnThrowWarn",callback);
    }
    
    /**
		Fires just after I throw something
	**/
    public extern inline function OutputOnThrow(callback:Callback<{activator:Npc_advisor}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnThrow",callback);
    }
    
    /**
		When I am damaged, my hitpoints thereafter
	**/
    public extern inline function OutputOnHealthIsNow(callback:Callback<{activator:Npc_advisor,data:Int}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnHealthIsNow",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Npc_advisorSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Npc_advisorSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Npc_advisorSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("npc_advisor");
    }
}

enum abstract Npc_advisorwakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_advisorsleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Npc_advisorrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Npc_advisorrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Npc_advisorignoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_advisorhintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_advisorgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_advisordisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_advisordisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Npc_advisorSpawnFlags(Int) to Int {
