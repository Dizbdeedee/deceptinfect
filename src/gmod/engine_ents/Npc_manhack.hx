...
**/
@:forward
abstract Npc_manhack(NPC) to Entity to NPC {
    //Inputs
	...
	**/
    public extern inline function FireDisableSwarm(delay:Float) {
        untyped this.Fire("DisableSwarm",untyped null,delay);
    }
    
    /**
		Causes the manhack to stop being packed up.
	**/
    public extern inline function FireUnpack(delay:Float) {
        untyped this.Fire("Unpack",untyped null,delay);
    }
	...
	**/
    public var hintlimiting(get,set):Npc_manhackhintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Npc_manhackhintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Npc_manhackhintlimitingChoices):Npc_manhackhintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Npc_manhacksleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Npc_manhacksleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Npc_manhacksleepstateChoices):Npc_manhacksleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Npc_manhackwakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Npc_manhackwakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Npc_manhackwakesquadChoices):Npc_manhackwakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Npc_manhackignoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Npc_manhackignoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Npc_manhackignoreunseenenemiesChoices):Npc_manhackignoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Npc_manhackgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Npc_manhackgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Npc_manhackgmod_allowphysgunChoices):Npc_manhackgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Npc_manhackrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Npc_manhackrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Npc_manhackrendermodeChoices):Npc_manhackrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Npc_manhackdisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Npc_manhackdisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Npc_manhackdisablereceiveshadowsChoices):Npc_manhackdisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Npc_manhackrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Npc_manhackrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Npc_manhackrenderfxChoices):Npc_manhackrenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Npc_manhackdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Npc_manhackdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Npc_manhackdisableshadowsChoices):Npc_manhackdisableshadowsChoices {
	...
	**/
    public var ignoreclipbrushes(get,set):Npc_manhackignoreclipbrushesChoices;

    @:noCompletion
    public extern inline function get_ignoreclipbrushes():Npc_manhackignoreclipbrushesChoices {
        return untyped this.GetKeyValues().ignoreclipbrushes;
    }
    
    @:noCompletion
    public extern inline function set_ignoreclipbrushes(value:Npc_manhackignoreclipbrushesChoices):Npc_manhackignoreclipbrushesChoices {
        return untyped this.SetKeyValue("ignoreclipbrushes",untyped value);
    }
	...
	**/
    public extern inline function OutputOnAlyxStartedInteraction(callback:Callback<{activator:Npc_manhack}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnAlyxFinishedInteraction(callback:Callback<{activator:Npc_manhack}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Npc_manhack}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Npc_manhack}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Npc_manhack}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Npc_manhack}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Npc_manhack}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Npc_manhack}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Npc_manhack,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Npc_manhack}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Npc_manhack}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Npc_manhack,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Npc_manhack}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Npc_manhack}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Npc_manhack}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Npc_manhack}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Npc_manhack}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Npc_manhack}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Npc_manhack}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Npc_manhack}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Npc_manhack}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Npc_manhack}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Npc_manhack}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Npc_manhack}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Npc_manhack}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Npc_manhack}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Npc_manhackSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Npc_manhackSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Npc_manhackSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("npc_manhack");
    }
}

enum abstract Npc_manhackwakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_manhacksleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Npc_manhackrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Npc_manhackrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Npc_manhackignoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_manhackignoreclipbrushesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_manhackhintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_manhackgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_manhackdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_manhackdisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Npc_manhackSpawnFlags(Int) to Int {
	...
	var START_PACKED_UP_FOLDED_AND_ENGINE_OFF = 65536;
	var DONT_USE_ANY_DAMAGE_EFFECTS = 131072;
	var USE_AIR_NODES = 262144;
	var NO_DANGER_SOUNDS = 1048576;
}
