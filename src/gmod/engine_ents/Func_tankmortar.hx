...
**/
@:forward
abstract Func_tankmortar(Entity) to Entity {
    //Inputs
	...
	**/
    public extern inline function FireFireAtWill(delay:Float) {
        untyped this.Fire("FireAtWill",untyped null,delay);
    }
	...
	**/
    ...
    /**
		Bullet accuracy
	**/
    public var firespread(get,set):Func_tankmortarfirespreadChoices;

    @:noCompletion
    public extern inline function get_firespread():Func_tankmortarfirespreadChoices {
        return untyped this.GetKeyValues().firespread;
    }
    
    @:noCompletion
    public extern inline function set_firespread(value:Func_tankmortarfirespreadChoices):Func_tankmortarfirespreadChoices {
	...
	**/
    ...
    /**
		Lead Target
	**/
    public var LeadTarget(get,set):Func_tankmortarLeadTargetChoices;

    @:noCompletion
    public extern inline function get_LeadTarget():Func_tankmortarLeadTargetChoices {
        return untyped this.GetKeyValues().LeadTarget;
    }
    
    @:noCompletion
    public extern inline function set_LeadTarget(value:Func_tankmortarLeadTargetChoices):Func_tankmortarLeadTargetChoices {
	...
	**/
    ...
    /**
		Effect Handling
	**/
    public var effecthandling(get,set):Func_tankmortareffecthandlingChoices;

    @:noCompletion
    public extern inline function get_effecthandling():Func_tankmortareffecthandlingChoices {
        return untyped this.GetKeyValues().effecthandling;
    }
    
    @:noCompletion
    public extern inline function set_effecthandling(value:Func_tankmortareffecthandlingChoices):Func_tankmortareffecthandlingChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Func_tankmortargmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Func_tankmortargmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Func_tankmortargmod_allowphysgunChoices):Func_tankmortargmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Func_tankmortarrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Func_tankmortarrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Func_tankmortarrendermodeChoices):Func_tankmortarrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Func_tankmortardisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Func_tankmortardisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Func_tankmortardisablereceiveshadowsChoices):Func_tankmortardisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Func_tankmortarrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Func_tankmortarrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Func_tankmortarrenderfxChoices):Func_tankmortarrenderfxChoices {
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Func_tankmortardisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Func_tankmortardisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Func_tankmortardisableshadowsChoices):Func_tankmortardisableshadowsChoices {
	...
	**/
    public var firedelay(get,set):String;

    @:noCompletion
    public extern inline function get_firedelay():String {
        return untyped this.GetKeyValues().firedelay;
    }
    
    @:noCompletion
    public extern inline function set_firedelay(value:String):String {
        return untyped this.SetKeyValue("firedelay",untyped value);
    }
    
    /**
		Firing start sound

		Sound of the mortar firing
	**/
    public var firestartsound(get,set):String;

    @:noCompletion
    public extern inline function get_firestartsound():String {
        return untyped this.GetKeyValues().firestartsound;
    }
    
    @:noCompletion
    public extern inline function set_firestartsound(value:String):String {
        return untyped this.SetKeyValue("firestartsound",untyped value);
    }
    
    /**
		Firing end sound
	**/
    public var fireendsound(get,set):String;

    @:noCompletion
    public extern inline function get_fireendsound():String {
        return untyped this.GetKeyValues().fireendsound;
    }
    
    @:noCompletion
    public extern inline function set_fireendsound(value:String):String {
        return untyped this.SetKeyValue("fireendsound",untyped value);
    }
	...
	**/
    public var incomingsound(get,set):String;

    @:noCompletion
    public extern inline function get_incomingsound():String {
        return untyped this.GetKeyValues().incomingsound;
    }
    
    @:noCompletion
    public extern inline function set_incomingsound(value:String):String {
        return untyped this.SetKeyValue("incomingsound",untyped value);
    }
	...
	**/
    public var warningtime(get,set):Float;

    @:noCompletion
    public extern inline function get_warningtime():Float {
        return untyped this.GetKeyValues().warningtime;
    }
    
    @:noCompletion
    public extern inline function set_warningtime(value:Float):Float {
        return untyped this.SetKeyValue("warningtime",untyped value);
    }
	...
	**/
    public var firevariance(get,set):Float;

    @:noCompletion
    public extern inline function get_firevariance():Float {
        return untyped this.GetKeyValues().firevariance;
    }
    
    @:noCompletion
    public extern inline function set_firevariance(value:Float):Float {
        return untyped this.SetKeyValue("firevariance",untyped value);
    }
	...
	**/
    public extern inline function OutputOnFire(callback:Callback<{activator:Func_tankmortar}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnAquireTarget(callback:Callback<{activator:Func_tankmortar}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLoseTarget(callback:Callback<{activator:Func_tankmortar}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnAmmoDepleted(callback:Callback<{activator:Func_tankmortar}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnGotController(callback:Callback<{activator:Func_tankmortar}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostController(callback:Callback<{activator:Func_tankmortar}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnGotPlayerController(callback:Callback<{activator:Func_tankmortar}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerController(callback:Callback<{activator:Func_tankmortar}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnReadyToFire(callback:Callback<{activator:Func_tankmortar}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Func_tankmortar}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Func_tankmortar}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Func_tankmortar}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Func_tankmortar}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Func_tankmortarSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Func_tankmortarSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Func_tankmortarSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("func_tankmortar");
    }
}

enum abstract Func_tankmortarrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Func_tankmortarrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Func_tankmortargmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_tankmortarfirespreadChoices(Int) to Int {
	var PERFECT_SHOT = 0;
	var SMALL_CONE = 1;
	var MEDIUM_CONE = 2;
	var LARGE_CONE = 3;
...
enum abstract Func_tankmortareffecthandlingChoices(Int) to Int {
	var USE_INDIVIDUAL_SETTINGS = 0;
	var AR2 = 1;
	var COMBINE_CANNON = 2;
}
enum abstract Func_tankmortardisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_tankmortardisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_tankmortarLeadTargetChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Func_tankmortarSpawnFlags(Int) to Int {
	var ACTIVE = 1;
	var ONLY_DIRECT = 16;
	var CONTROLLABLE = 32;
	var DAMAGE_KICK = 64;
