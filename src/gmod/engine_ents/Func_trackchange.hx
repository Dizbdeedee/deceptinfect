...
**/
@:forward
abstract Func_trackchange(Entity) to Entity {
    //Inputs
	...
	**/
    public var gmod_allowphysgun(get,set):Func_trackchangegmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Func_trackchangegmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Func_trackchangegmod_allowphysgunChoices):Func_trackchangegmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var movesnd(get,set):Func_trackchangemovesndChoices;

    @:noCompletion
    public extern inline function get_movesnd():Func_trackchangemovesndChoices {
        return untyped this.GetKeyValues().movesnd;
    }
    
    @:noCompletion
    public extern inline function set_movesnd(value:Func_trackchangemovesndChoices):Func_trackchangemovesndChoices {
	...
	**/
    public var stopsnd(get,set):Func_trackchangestopsndChoices;

    @:noCompletion
    public extern inline function get_stopsnd():Func_trackchangestopsndChoices {
        return untyped this.GetKeyValues().stopsnd;
    }
    
    @:noCompletion
    public extern inline function set_stopsnd(value:Func_trackchangestopsndChoices):Func_trackchangestopsndChoices {
	...
	**/
    public var rendermode(get,set):Func_trackchangerendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Func_trackchangerendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Func_trackchangerendermodeChoices):Func_trackchangerendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Func_trackchangedisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Func_trackchangedisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Func_trackchangedisablereceiveshadowsChoices):Func_trackchangedisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Func_trackchangerenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Func_trackchangerenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Func_trackchangerenderfxChoices):Func_trackchangerenderfxChoices {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Func_trackchange}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Func_trackchange}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Func_trackchange}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Func_trackchange}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Func_trackchangeSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Func_trackchangeSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Func_trackchangeSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("func_trackchange");
    }
}

enum abstract Func_trackchangestopsndChoices(Int) to Int {
	var NO_SOUND = 0;
...
enum abstract Func_trackchangerendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Func_trackchangerenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Func_trackchangemovesndChoices(Int) to Int {
	var NO_SOUND = 0;
	var BIG_ELEV_1 = 1;
	var BIG_ELEV_2 = 2;
	var TECH_ELEV_1 = 3;
...
enum abstract Func_trackchangegmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_trackchangedisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Func_trackchangeSpawnFlags(Int) to Int {
