...
**/
@:forward
abstract Func_movelinear(Entity) to Entity {
    //Inputs
	...
	**/
    public var gmod_allowphysgun(get,set):Func_movelineargmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Func_movelineargmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Func_movelineargmod_allowphysgunChoices):Func_movelineargmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Func_movelinearrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Func_movelinearrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Func_movelinearrendermodeChoices):Func_movelinearrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Func_movelineardisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Func_movelineardisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Func_movelineardisablereceiveshadowsChoices):Func_movelineardisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Func_movelinearrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Func_movelinearrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Func_movelinearrenderfxChoices):Func_movelinearrenderfxChoices {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Func_movelinear}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Func_movelinear}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Func_movelinear}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Func_movelinear}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFullyOpen(callback:Callback<{activator:Func_movelinear}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFullyClosed(callback:Callback<{activator:Func_movelinear}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnFullyClosed",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Func_movelinearSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Func_movelinearSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Func_movelinearSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("func_movelinear");
    }
}

enum abstract Func_movelinearrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Func_movelinearrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Func_movelineargmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_movelineardisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Func_movelinearSpawnFlags(Int) to Int {
	var NOT_SOLID = 8;
}
