...
**/
@:forward
abstract Ai_goal_lead(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Run instead of Walk
	**/
    public var Run(get,set):Ai_goal_leadRunChoices;

    @:noCompletion
    public extern inline function get_Run():Ai_goal_leadRunChoices {
        return untyped this.GetKeyValues().Run;
    }
    
    @:noCompletion
    public extern inline function set_Run(value:Ai_goal_leadRunChoices):Ai_goal_leadRunChoices {
    ...
    /**
		Retrieve player?
	**/
    public var Retrieve(get,set):Ai_goal_leadRetrieveChoices;

    @:noCompletion
    public extern inline function get_Retrieve():Ai_goal_leadRetrieveChoices {
        return untyped this.GetKeyValues().Retrieve;
    }
    
    @:noCompletion
    public extern inline function set_Retrieve(value:Ai_goal_leadRetrieveChoices):Ai_goal_leadRetrieveChoices {
	...
	**/
    public var ComingBackWaitForSpeak(get,set):Ai_goal_leadComingBackWaitForSpeakChoices;

    @:noCompletion
    public extern inline function get_ComingBackWaitForSpeak():Ai_goal_leadComingBackWaitForSpeakChoices {
        return untyped this.GetKeyValues().ComingBackWaitForSpeak;
    }
    
    @:noCompletion
    public extern inline function set_ComingBackWaitForSpeak(value:Ai_goal_leadComingBackWaitForSpeakChoices):Ai_goal_leadComingBackWaitForSpeakChoices {
	...
	**/
    public var RetrieveWaitForSpeak(get,set):Ai_goal_leadRetrieveWaitForSpeakChoices;

    @:noCompletion
    public extern inline function get_RetrieveWaitForSpeak():Ai_goal_leadRetrieveWaitForSpeakChoices {
        return untyped this.GetKeyValues().RetrieveWaitForSpeak;
    }
    
    @:noCompletion
    public extern inline function set_RetrieveWaitForSpeak(value:Ai_goal_leadRetrieveWaitForSpeakChoices):Ai_goal_leadRetrieveWaitForSpeakChoices {
	...
	**/
    public var DontSpeakStart(get,set):Ai_goal_leadDontSpeakStartChoices;

    @:noCompletion
    public extern inline function get_DontSpeakStart():Ai_goal_leadDontSpeakStartChoices {
        return untyped this.GetKeyValues().DontSpeakStart;
    }
    
    @:noCompletion
    public extern inline function set_DontSpeakStart(value:Ai_goal_leadDontSpeakStartChoices):Ai_goal_leadDontSpeakStartChoices {
    ...
    /**
		Lead during combat?
	**/
    public var LeadDuringCombat(get,set):Ai_goal_leadLeadDuringCombatChoices;

    @:noCompletion
    public extern inline function get_LeadDuringCombat():Ai_goal_leadLeadDuringCombatChoices {
        return untyped this.GetKeyValues().LeadDuringCombat;
    }
    
    @:noCompletion
    public extern inline function set_LeadDuringCombat(value:Ai_goal_leadLeadDuringCombatChoices):Ai_goal_leadLeadDuringCombatChoices {
    ...
    /**
		Gag Leader?
	**/
    public var GagLeader(get,set):Ai_goal_leadGagLeaderChoices;

    @:noCompletion
    public extern inline function get_GagLeader():Ai_goal_leadGagLeaderChoices {
        return untyped this.GetKeyValues().GagLeader;
    }
    
    @:noCompletion
    public extern inline function set_GagLeader(value:Ai_goal_leadGagLeaderChoices):Ai_goal_leadGagLeaderChoices {
	...
	**/
    public var SearchType(get,set):Ai_goal_leadSearchTypeChoices;

    @:noCompletion
    public extern inline function get_SearchType():Ai_goal_leadSearchTypeChoices {
        return untyped this.GetKeyValues().SearchType;
    }
    
    @:noCompletion
    public extern inline function set_SearchType(value:Ai_goal_leadSearchTypeChoices):Ai_goal_leadSearchTypeChoices {
	...
	**/
    public extern inline function OutputOnArrival(callback:Callback<{activator:Ai_goal_lead}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnArrivalDone(callback:Callback<{activator:Ai_goal_lead}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSuccess(callback:Callback<{activator:Ai_goal_lead}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFailure(callback:Callback<{activator:Ai_goal_lead}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDone(callback:Callback<{activator:Ai_goal_lead}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Ai_goal_lead}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Ai_goal_lead}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Ai_goal_lead}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Ai_goal_lead}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Ai_goal_leadSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Ai_goal_leadSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Ai_goal_leadSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("ai_goal_lead");
    }
}

enum abstract Ai_goal_leadSearchTypeChoices(Int) to Int {
	var ENTITY_NAME = 0;
	var CLASSNAME = 1;
}
enum abstract Ai_goal_leadRunChoices(String) to String {
	var NO = "0";
	var YES = "1";
}
enum abstract Ai_goal_leadRetrieveWaitForSpeakChoices(Int) to Int {
	var NO_START_LEADING_WHILE_SPEAKING = 0;
	var YES_WAIT_FOR_SPEECH_TO_FINISH = 1;
}
enum abstract Ai_goal_leadRetrieveChoices(Int) to Int {
	var NO_JUST_IDLE_AND_WAIT = 0;
	var YES_MOVE_TO_RETRIEVE = 1;
}
enum abstract Ai_goal_leadLeadDuringCombatChoices(Int) to Int {
	var NO_STOP_TO_FIGHT_RESUME_LEADING_WHEN_SAFE = 0;
	var YES_LEAD_WHILE_FIGHTING = 1;
}
enum abstract Ai_goal_leadGagLeaderChoices(Int) to Int {
...
enum abstract Ai_goal_leadDontSpeakStartChoices(Int) to Int {
	var YES_SPEAK_THE_START_GREETING = 0;
	var NO_DONT_SPEAK_THE_GREETING = 1;
}
enum abstract Ai_goal_leadComingBackWaitForSpeakChoices(Int) to Int {
	var NO_COME_BACK_WHILE_SPEAKING = 0;
	var YES_WAIT_FOR_SPEECH_TO_FINISH = 1;
}


enum abstract Ai_goal_leadSpawnFlags(Int) to Int {
