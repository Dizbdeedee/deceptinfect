...
**/
@:forward
abstract Trigger_gravity(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Start Disabled
	**/
    public var StartDisabled(get,set):Trigger_gravityStartDisabledChoices;

    @:noCompletion
    public extern inline function get_StartDisabled():Trigger_gravityStartDisabledChoices {
        return untyped this.GetKeyValues().StartDisabled;
    }
    
    @:noCompletion
    public extern inline function set_StartDisabled(value:Trigger_gravityStartDisabledChoices):Trigger_gravityStartDisabledChoices {
	...
	**/
    ...
    /**
		Gravity (0-1)
	**/
    public var gravity(get,set):Int;

    @:noCompletion
    public extern inline function get_gravity():Int {
        return untyped this.GetKeyValues().gravity;
    }
    
    @:noCompletion
    public extern inline function set_gravity(value:Int):Int {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Trigger_gravity}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Trigger_gravity}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Trigger_gravity}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Trigger_gravity}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnStartTouchAll(callback:Callback<{activator:Trigger_gravity}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnEndTouch(callback:Callback<{activator:Trigger_gravity}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnEndTouchAll(callback:Callback<{activator:Trigger_gravity}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnStartTouch(callback:Callback<{activator:Trigger_gravity}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnStartTouch",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Trigger_gravitySpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Trigger_gravitySpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Trigger_gravitySpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("trigger_gravity");
    }
}

enum abstract Trigger_gravityStartDisabledChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Trigger_gravitySpawnFlags(Int) to Int {
	var CLIENTS = 1;
	var NPCS = 2;
	var PUSHABLES = 4;
