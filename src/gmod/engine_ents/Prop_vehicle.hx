...
**/
@:forward
abstract Prop_vehicle(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Steer the vehicle +/-1
	**/
    public extern inline function FireSteer(param:Float,delay:Float) {
        untyped this.Fire("Steer",untyped param,delay);
    }
    
    /**
		Throttle +/-1
	**/
    public extern inline function FireThrottle(param:Float,delay:Float) {
        untyped this.Fire("Throttle",untyped param,delay);
    }
	...
	**/
    ...
    /**
		Minimum DX Level
	**/
    public var mindxlevel(get,set):Prop_vehiclemindxlevelChoices;

    @:noCompletion
    public extern inline function get_mindxlevel():Prop_vehiclemindxlevelChoices {
        return untyped this.GetKeyValues().mindxlevel;
    }
    
    @:noCompletion
    public extern inline function set_mindxlevel(value:Prop_vehiclemindxlevelChoices):Prop_vehiclemindxlevelChoices {
    ...
    /**
		Maximum DX Level
	**/
    public var maxdxlevel(get,set):Prop_vehiclemaxdxlevelChoices;

    @:noCompletion
    public extern inline function get_maxdxlevel():Prop_vehiclemaxdxlevelChoices {
        return untyped this.GetKeyValues().maxdxlevel;
    }
    
    @:noCompletion
    public extern inline function set_maxdxlevel(value:Prop_vehiclemaxdxlevelChoices):Prop_vehiclemaxdxlevelChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Prop_vehiclegmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Prop_vehiclegmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Prop_vehiclegmod_allowphysgunChoices):Prop_vehiclegmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    ...
    /**
		Collisions
	**/
    public var solid(get,set):Prop_vehiclesolidChoices;

    @:noCompletion
    public extern inline function get_solid():Prop_vehiclesolidChoices {
        return untyped this.GetKeyValues().solid;
    }
    
    @:noCompletion
    public extern inline function set_solid(value:Prop_vehiclesolidChoices):Prop_vehiclesolidChoices {
    ...
    /**
		Disable Shadows
	**/
    public var disableshadows(get,set):Prop_vehicledisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Prop_vehicledisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Prop_vehicledisableshadowsChoices):Prop_vehicledisableshadowsChoices {
	...
	**/
    public var screenspacefade(get,set):Prop_vehiclescreenspacefadeChoices;

    @:noCompletion
    public extern inline function get_screenspacefade():Prop_vehiclescreenspacefadeChoices {
        return untyped this.GetKeyValues().screenspacefade;
    }
    
    @:noCompletion
    public extern inline function set_screenspacefade(value:Prop_vehiclescreenspacefadeChoices):Prop_vehiclescreenspacefadeChoices {
	...
	**/
    public var disablevertexlighting(get,set):Prop_vehicledisablevertexlightingChoices;

    @:noCompletion
    public extern inline function get_disablevertexlighting():Prop_vehicledisablevertexlightingChoices {
        return untyped this.GetKeyValues().disablevertexlighting;
    }
    
    @:noCompletion
    public extern inline function set_disablevertexlighting(value:Prop_vehicledisablevertexlightingChoices):Prop_vehicledisablevertexlightingChoices {
	...
	**/
    public var disableselfshadowing(get,set):Prop_vehicledisableselfshadowingChoices;

    @:noCompletion
    public extern inline function get_disableselfshadowing():Prop_vehicledisableselfshadowingChoices {
        return untyped this.GetKeyValues().disableselfshadowing;
    }
    
    @:noCompletion
    public extern inline function set_disableselfshadowing(value:Prop_vehicledisableselfshadowingChoices):Prop_vehicledisableselfshadowingChoices {
	...
	**/
    public var ignorenormals(get,set):Prop_vehicleignorenormalsChoices;

    @:noCompletion
    public extern inline function get_ignorenormals():Prop_vehicleignorenormalsChoices {
        return untyped this.GetKeyValues().ignorenormals;
    }
    
    @:noCompletion
    public extern inline function set_ignorenormals(value:Prop_vehicleignorenormalsChoices):Prop_vehicleignorenormalsChoices {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Prop_vehicle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Prop_vehicle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Prop_vehicle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Prop_vehicle}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Prop_vehicleSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Prop_vehicleSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Prop_vehicleSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("prop_vehicle");
    }
}

enum abstract Prop_vehiclesolidChoices(Int) to Int {
	var NOT_SOLID = 0;
	var USE_BOUNDING_BOX = 2;
	var USE_VPHYSICS = 6;
}
enum abstract Prop_vehiclescreenspacefadeChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehiclemindxlevelChoices(Int) to Int {
...
enum abstract Prop_vehiclemaxdxlevelChoices(Int) to Int {
...
enum abstract Prop_vehicleignorenormalsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehiclegmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicledisablevertexlightingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicledisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicledisableselfshadowingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Prop_vehicleSpawnFlags(Int) to Int {
	var ALWAYS_THINK_RUN_PHYSICS_EVERY_FRAME = 1;
}
