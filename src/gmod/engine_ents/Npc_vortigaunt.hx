...
**/
@:forward
abstract Npc_vortigaunt(NPC) to Entity to NPC {
    //Inputs
	...
	**/
    public extern inline function FireEnableArmorRecharge(delay:Float) {
        untyped this.Fire("EnableArmorRecharge",untyped null,delay);
    }
    
    /**
		Do not allow armor recharging on players
	**/
    public extern inline function FireDisableArmorRecharge(delay:Float) {
        untyped this.Fire("DisableArmorRecharge",untyped null,delay);
    }
    
    /**
		Causes the vortigaunt to extract bugbait from the named target passed in.
	**/
    public extern inline function FireExtractBugbait(param:String,delay:Float) {
        untyped this.Fire("ExtractBugbait",untyped param,delay);
    }
    
    /**
		Force the vortigaunt to charge the named target.
	**/
    public extern inline function FireChargeTarget(param:String,delay:Float) {
        untyped this.Fire("ChargeTarget",untyped param,delay);
    }
    
    /**
		Allow the vortigaunt to start regenerating his health over time, like vital allies.
	**/
    public extern inline function FireEnableHealthRegeneration(delay:Float) {
        untyped this.Fire("EnableHealthRegeneration",untyped null,delay);
    }
    
    /**
		Stop the vortigaunt from regenerating his health. (Default behavior)
	**/
    public extern inline function FireDisableHealthRegeneration(delay:Float) {
        untyped this.Fire("DisableHealthRegeneration",untyped null,delay);
    }
    
    /**
		If true, turn blue. If false, turn green. (Episodic).
	**/
    public extern inline function FireTurnBlue(param:bool,delay:Float) {
        untyped this.Fire("TurnBlue",untyped param,delay);
    }
    
    /**
		If true, turn black. If false, be seen. (Episodic).
	**/
    public extern inline function FireTurnBlack(param:bool,delay:Float) {
        untyped this.Fire("TurnBlack",untyped param,delay);
    }
    
    /**
		Begin to override our animations for 'carrying' an NPC. (Episodic)
	**/
    public extern inline function FireBeginCarryNPC(delay:Float) {
        untyped this.Fire("BeginCarryNPC",untyped null,delay);
    }
    
    /**
		Stop overriding our animations for 'carrying' an NPC. (Episodic)
	**/
    public extern inline function FireEndCarryNPC(delay:Float) {
        untyped this.Fire("EndCarryNPC",untyped null,delay);
    }
	...
	**/
    public var hintlimiting(get,set):Npc_vortigaunthintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Npc_vortigaunthintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Npc_vortigaunthintlimitingChoices):Npc_vortigaunthintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Npc_vortigauntsleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Npc_vortigauntsleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Npc_vortigauntsleepstateChoices):Npc_vortigauntsleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Npc_vortigauntwakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Npc_vortigauntwakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Npc_vortigauntwakesquadChoices):Npc_vortigauntwakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Npc_vortigauntignoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Npc_vortigauntignoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Npc_vortigauntignoreunseenenemiesChoices):Npc_vortigauntignoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Npc_vortigauntgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Npc_vortigauntgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Npc_vortigauntgmod_allowphysgunChoices):Npc_vortigauntgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var AlwaysTransition(get,set):Npc_vortigauntAlwaysTransitionChoices;

    @:noCompletion
    public extern inline function get_AlwaysTransition():Npc_vortigauntAlwaysTransitionChoices {
        return untyped this.GetKeyValues().AlwaysTransition;
    }
    
    @:noCompletion
    public extern inline function set_AlwaysTransition(value:Npc_vortigauntAlwaysTransitionChoices):Npc_vortigauntAlwaysTransitionChoices {
	...
	**/
    public var DontPickupWeapons(get,set):Npc_vortigauntDontPickupWeaponsChoices;

    @:noCompletion
    public extern inline function get_DontPickupWeapons():Npc_vortigauntDontPickupWeaponsChoices {
        return untyped this.GetKeyValues().DontPickupWeapons;
    }
    
    @:noCompletion
    public extern inline function set_DontPickupWeapons(value:Npc_vortigauntDontPickupWeaponsChoices):Npc_vortigauntDontPickupWeaponsChoices {
	...
	**/
    public var GameEndAlly(get,set):Npc_vortigauntGameEndAllyChoices;

    @:noCompletion
    public extern inline function get_GameEndAlly():Npc_vortigauntGameEndAllyChoices {
        return untyped this.GetKeyValues().GameEndAlly;
    }
    
    @:noCompletion
    public extern inline function set_GameEndAlly(value:Npc_vortigauntGameEndAllyChoices):Npc_vortigauntGameEndAllyChoices {
	...
	**/
    public var rendermode(get,set):Npc_vortigauntrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Npc_vortigauntrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Npc_vortigauntrendermodeChoices):Npc_vortigauntrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Npc_vortigauntdisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Npc_vortigauntdisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Npc_vortigauntdisablereceiveshadowsChoices):Npc_vortigauntdisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Npc_vortigauntrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Npc_vortigauntrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Npc_vortigauntrenderfxChoices):Npc_vortigauntrenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Npc_vortigauntdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Npc_vortigauntdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Npc_vortigauntdisableshadowsChoices):Npc_vortigauntdisableshadowsChoices {
	...
	**/
    public var DontUseSpeechSemaphore(get,set):Npc_vortigauntDontUseSpeechSemaphoreChoices;

    @:noCompletion
    public extern inline function get_DontUseSpeechSemaphore():Npc_vortigauntDontUseSpeechSemaphoreChoices {
        return untyped this.GetKeyValues().DontUseSpeechSemaphore;
    }
    
    @:noCompletion
    public extern inline function set_DontUseSpeechSemaphore(value:Npc_vortigauntDontUseSpeechSemaphoreChoices):Npc_vortigauntDontUseSpeechSemaphoreChoices {
	...
	**/
    public var ArmorRechargeEnabled(get,set):Npc_vortigauntArmorRechargeEnabledChoices;

    @:noCompletion
    public extern inline function get_ArmorRechargeEnabled():Npc_vortigauntArmorRechargeEnabledChoices {
        return untyped this.GetKeyValues().ArmorRechargeEnabled;
    }
    
    @:noCompletion
    public extern inline function set_ArmorRechargeEnabled(value:Npc_vortigauntArmorRechargeEnabledChoices):Npc_vortigauntArmorRechargeEnabledChoices {
        return untyped this.SetKeyValue("ArmorRechargeEnabled",untyped value);
    }
	...
	**/
    public var HealthRegenerateEnabled(get,set):Npc_vortigauntHealthRegenerateEnabledChoices;

    @:noCompletion
    public extern inline function get_HealthRegenerateEnabled():Npc_vortigauntHealthRegenerateEnabledChoices {
        return untyped this.GetKeyValues().HealthRegenerateEnabled;
    }
    
    @:noCompletion
    public extern inline function set_HealthRegenerateEnabled(value:Npc_vortigauntHealthRegenerateEnabledChoices):Npc_vortigauntHealthRegenerateEnabledChoices {
        return untyped this.SetKeyValue("HealthRegenerateEnabled",untyped value);
    }
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Npc_vortigaunt,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Npc_vortigaunt,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWeaponPickup(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFinishedExtractingBugbait(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnFinishedExtractingBugbait",callback);
    }
    
    /**
		Fires when the vortigaunt's finished extracting the tau cannon from the jeep.
	**/
    public extern inline function OutputOnFinishedExtractingTauCannon(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnFinishedExtractingTauCannon",callback);
    }
    
    /**
		Fires when the vortigaunt has finished charging a target.
	**/
    public extern inline function OutputOnFinishedChargingTarget(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnFinishedChargingTarget",callback);
    }
    
    /**
		Fires when a player +USEs the vortigaunt.
	**/
    public extern inline function OutputOnPlayerUse(callback:Callback<{activator:Npc_vortigaunt}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnPlayerUse",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Npc_vortigauntSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Npc_vortigauntSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Npc_vortigauntSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("npc_vortigaunt");
    }
}

enum abstract Npc_vortigauntwakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_vortigauntsleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Npc_vortigauntrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Npc_vortigauntrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Npc_vortigauntignoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_vortigaunthintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_vortigauntgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_vortigauntdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_vortigauntdisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_vortigauntHealthRegenerateEnabledChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_vortigauntGameEndAllyChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_vortigauntDontUseSpeechSemaphoreChoices(Int) to Int {
	var NO_USE_SPEECH_SEMAPHORE = 0;
	var YES_DONT_USE_SPEECH_SEMAPHORE = 1;
}
enum abstract Npc_vortigauntDontPickupWeaponsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_vortigauntArmorRechargeEnabledChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_vortigauntAlwaysTransitionChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Npc_vortigauntSpawnFlags(Int) to Int {
