...
**/
@:forward
abstract Npc_enemyfinder_combinecannon(NPC) to Entity to NPC {
    //Inputs
	...
	**/
    ...
    /**
		Gives this enemyfinder a 180 degree viewcone for the number of seconds specified in the parameter override
	**/
    public extern inline function FireSetWideFOVForSeconds(param:Float,delay:Float) {
        untyped this.Fire("SetWideFOVForSeconds",untyped param,delay);
    }
	...
	**/
    public var hintlimiting(get,set):Npc_enemyfinder_combinecannonhintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Npc_enemyfinder_combinecannonhintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Npc_enemyfinder_combinecannonhintlimitingChoices):Npc_enemyfinder_combinecannonhintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Npc_enemyfinder_combinecannonsleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Npc_enemyfinder_combinecannonsleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Npc_enemyfinder_combinecannonsleepstateChoices):Npc_enemyfinder_combinecannonsleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Npc_enemyfinder_combinecannonwakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Npc_enemyfinder_combinecannonwakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Npc_enemyfinder_combinecannonwakesquadChoices):Npc_enemyfinder_combinecannonwakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Npc_enemyfinder_combinecannonignoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Npc_enemyfinder_combinecannonignoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Npc_enemyfinder_combinecannonignoreunseenenemiesChoices):Npc_enemyfinder_combinecannonignoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Npc_enemyfinder_combinecannongmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Npc_enemyfinder_combinecannongmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Npc_enemyfinder_combinecannongmod_allowphysgunChoices):Npc_enemyfinder_combinecannongmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Npc_enemyfinder_combinecannonrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Npc_enemyfinder_combinecannonrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Npc_enemyfinder_combinecannonrendermodeChoices):Npc_enemyfinder_combinecannonrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Npc_enemyfinder_combinecannondisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Npc_enemyfinder_combinecannondisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Npc_enemyfinder_combinecannondisablereceiveshadowsChoices):Npc_enemyfinder_combinecannondisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Npc_enemyfinder_combinecannonrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Npc_enemyfinder_combinecannonrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Npc_enemyfinder_combinecannonrenderfxChoices):Npc_enemyfinder_combinecannonrenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Npc_enemyfinder_combinecannondisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Npc_enemyfinder_combinecannondisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Npc_enemyfinder_combinecannondisableshadowsChoices):Npc_enemyfinder_combinecannondisableshadowsChoices {
	...
	**/
    ...
    /**
		Min Search Dist
	**/
    public var MinSearchDist(get,set):Int;

    @:noCompletion
    public extern inline function get_MinSearchDist():Int {
        return untyped this.GetKeyValues().MinSearchDist;
    }
    
    @:noCompletion
    public extern inline function set_MinSearchDist(value:Int):Int {
        return untyped this.SetKeyValue("MinSearchDist",untyped value);
    }
    
    /**
		Max Search Dist
	**/
    public var MaxSearchDist(get,set):Int;

    @:noCompletion
    public extern inline function get_MaxSearchDist():Int {
        return untyped this.GetKeyValues().MaxSearchDist;
    }
    
    @:noCompletion
    public extern inline function set_MaxSearchDist(value:Int):Int {
        return untyped this.SetKeyValue("MaxSearchDist",untyped value);
    }
    
    /**
		Name of entity to snap to

		Since it can be hard to position these entities with respect to the func_tank brushwork, you can specify an entity name here and this enemyfinder will position itself at the center of that entity.
	**/
    public var SnapToEnt(get,set):String;

    @:noCompletion
    public extern inline function get_SnapToEnt():String {
        return untyped this.GetKeyValues().SnapToEnt;
    }
    
    @:noCompletion
    public extern inline function set_SnapToEnt(value:String):String {
        return untyped this.SetKeyValue("SnapToEnt",untyped value);
    }
	...
	**/
    public var freepass_timetotrigger(get,set):Float;

    @:noCompletion
    public extern inline function get_freepass_timetotrigger():Float {
        return untyped this.GetKeyValues().freepass_timetotrigger;
    }
    
    @:noCompletion
    public extern inline function set_freepass_timetotrigger(value:Float):Float {
        return untyped this.SetKeyValue("freepass_timetotrigger",untyped value);
    }
	...
	**/
    public var freepass_duration(get,set):Float;

    @:noCompletion
    public extern inline function get_freepass_duration():Float {
        return untyped this.GetKeyValues().freepass_duration;
    }
    
    @:noCompletion
    public extern inline function set_freepass_duration(value:Float):Float {
        return untyped this.SetKeyValue("freepass_duration",untyped value);
    }
	...
	**/
    public var freepass_movetolerance(get,set):Float;

    @:noCompletion
    public extern inline function get_freepass_movetolerance():Float {
        return untyped this.GetKeyValues().freepass_movetolerance;
    }
    
    @:noCompletion
    public extern inline function set_freepass_movetolerance(value:Float):Float {
        return untyped this.SetKeyValue("freepass_movetolerance",untyped value);
    }
	...
	**/
    public var freepass_refillrate(get,set):Float;

    @:noCompletion
    public extern inline function get_freepass_refillrate():Float {
        return untyped this.GetKeyValues().freepass_refillrate;
    }
    
    @:noCompletion
    public extern inline function set_freepass_refillrate(value:Float):Float {
        return untyped this.SetKeyValue("freepass_refillrate",untyped value);
    }
	...
	**/
    public var freepass_peektime(get,set):Float;

    @:noCompletion
    public extern inline function get_freepass_peektime():Float {
        return untyped this.GetKeyValues().freepass_peektime;
    }
    
    @:noCompletion
    public extern inline function set_freepass_peektime(value:Float):Float {
        return untyped this.SetKeyValue("freepass_peektime",untyped value);
    }
    
    /**
		Start On
	**/
    public var StartOn(get,set):Npc_enemyfinder_combinecannonStartOnChoices;

    @:noCompletion
    public extern inline function get_StartOn():Npc_enemyfinder_combinecannonStartOnChoices {
        return untyped this.GetKeyValues().StartOn;
    }
    
    @:noCompletion
    public extern inline function set_StartOn(value:Npc_enemyfinder_combinecannonStartOnChoices):Npc_enemyfinder_combinecannonStartOnChoices {
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Npc_enemyfinder_combinecannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Npc_enemyfinder_combinecannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Npc_enemyfinder_combinecannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Npc_enemyfinder_combinecannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Npc_enemyfinder_combinecannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Npc_enemyfinder_combinecannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Npc_enemyfinder_combinecannon,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Npc_enemyfinder_combinecannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Npc_enemyfinder_combinecannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Npc_enemyfinder_combinecannon,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Npc_enemyfinder_combinecannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Npc_enemyfinder_combinecannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Npc_enemyfinder_combinecannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Npc_enemyfinder_combinecannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Npc_enemyfinder_combinecannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Npc_enemyfinder_combinecannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Npc_enemyfinder_combinecannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Npc_enemyfinder_combinecannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Npc_enemyfinder_combinecannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Npc_enemyfinder_combinecannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Npc_enemyfinder_combinecannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Npc_enemyfinder_combinecannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Npc_enemyfinder_combinecannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Npc_enemyfinder_combinecannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemies(callback:Callback<{activator:Npc_enemyfinder_combinecannon}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnLostEnemies",callback);
    }
    
    /**
		Fires when the enemy finder acquires enemies.
	**/
    public extern inline function OutputOnAcquireEnemies(callback:Callback<{activator:Npc_enemyfinder_combinecannon}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnAcquireEnemies",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Npc_enemyfinder_combinecannonSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Npc_enemyfinder_combinecannonSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Npc_enemyfinder_combinecannonSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("npc_enemyfinder_combinecannon");
    }
}

enum abstract Npc_enemyfinder_combinecannonwakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_enemyfinder_combinecannonsleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Npc_enemyfinder_combinecannonrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Npc_enemyfinder_combinecannonrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Npc_enemyfinder_combinecannonignoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_enemyfinder_combinecannonhintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_enemyfinder_combinecannongmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_enemyfinder_combinecannondisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_enemyfinder_combinecannondisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_enemyfinder_combinecannonStartOnChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Npc_enemyfinder_combinecannonSpawnFlags(Int) to Int {
	...
	var CHECK_VISIBILITY = 65536;
	var APC_VISIBILITY_CHECKS = 131072;
	var SHORT_MEMORY = 262144;
	var CAN_BE_AN_ENEMY = 524288;
}
