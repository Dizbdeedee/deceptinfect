...
**/
@:forward
abstract Npc_hunter(NPC) to Entity to NPC {
    //Inputs
	...
	**/
    ...
    /**
		Sets the name of the strider that this hunter should follow.
	**/
    public extern inline function FireFollowStrider(param:String,delay:Float) {
        untyped this.Fire("FollowStrider",untyped param,delay);
    }
	...
	**/
    ...
    /**
		Hunter will shoot minigun at the named target.
	**/
    ...
    /**
		Forces the hunter to be melee-only.
	**/
    public extern inline function FireDisableShooting(delay:Float) {
        untyped this.Fire("DisableShooting",untyped null,delay);
    }
    
    /**
		Allows the hunter to use range attacks or melee attacks.
	**/
    public extern inline function FireEnableShooting(delay:Float) {
        untyped this.Fire("EnableShooting",untyped null,delay);
    }
    
    /**
		Disables the delay between range attacks for squads of hunters, allowing them to shoot as frequently as they wish.
	**/
    public extern inline function FireDisableSquadShootDelay(delay:Float) {
        untyped this.Fire("DisableSquadShootDelay",untyped null,delay);
    }
    
    /**
		Enables the delay between range attacks for squads of hunters.
	**/
    public extern inline function FireEnableSquadShootDelay(delay:Float) {
        untyped this.Fire("EnableSquadShootDelay",untyped null,delay);
    }
    
    /**
		Used mainly for scripted attacks against bullseyes. Enables the hunter to shoot without having to plant first.
	**/
    public extern inline function FireEnableUnplantedShooting(delay:Float) {
        untyped this.Fire("EnableUnplantedShooting",untyped null,delay);
    }
    
    /**
		Returns the hunter to normal after a call to EnableUnplantedShooting.
	**/
    public extern inline function FireDisableUnplantedShooting(delay:Float) {
        untyped this.Fire("DisableUnplantedShooting",untyped null,delay);
    }
    
    /**
		Hunter will instantly do the defensive physics blast.
	**/
    public extern inline function FireDoPhysicsBlast(delay:Float) {
        untyped this.Fire("DoPhysicsBlast",untyped null,delay);
    }
	...
	**/
    ...
    /**
		UNUSED: Prevents the hunter from crouch walking.
	**/
    public extern inline function FireDisableCrouchWalk(delay:Float) {
        untyped this.Fire("DisableCrouchWalk",untyped null,delay);
    }
    
    /**
		UNUSED: Allows the hunter to crouch walk.
	**/
    public extern inline function FireEnableCrouchWalk(delay:Float) {
        untyped this.Fire("EnableCrouchWalk",untyped null,delay);
    }
    
    /**
		Pass in the name of info_targets to shoot at when I can't shoot at the player.
	**/
    public extern inline function FireUseSiegeTargets(param:String,delay:Float) {
        untyped this.Fire("UseSiegeTargets",untyped param,delay);
    }
	...
	**/
    public var hintlimiting(get,set):Npc_hunterhintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Npc_hunterhintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Npc_hunterhintlimitingChoices):Npc_hunterhintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Npc_huntersleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Npc_huntersleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Npc_huntersleepstateChoices):Npc_huntersleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Npc_hunterwakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Npc_hunterwakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Npc_hunterwakesquadChoices):Npc_hunterwakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Npc_hunterignoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Npc_hunterignoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Npc_hunterignoreunseenenemiesChoices):Npc_hunterignoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Npc_huntergmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Npc_huntergmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Npc_huntergmod_allowphysgunChoices):Npc_huntergmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Npc_hunterrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Npc_hunterrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Npc_hunterrendermodeChoices):Npc_hunterrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Npc_hunterdisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Npc_hunterdisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Npc_hunterdisablereceiveshadowsChoices):Npc_hunterdisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Npc_hunterrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Npc_hunterrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Npc_hunterrenderfxChoices):Npc_hunterrenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Npc_hunterdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Npc_hunterdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Npc_hunterdisableshadowsChoices):Npc_hunterdisableshadowsChoices {
	...
	**/
    ...
    /**
		...
		The name of the strider that this hunter should follow.
	**/
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Npc_hunter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Npc_hunter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Npc_hunter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Npc_hunter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Npc_hunter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Npc_hunter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Npc_hunter,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Npc_hunter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Npc_hunter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Npc_hunter,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Npc_hunter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Npc_hunter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Npc_hunter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Npc_hunter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Npc_hunter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Npc_hunter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Npc_hunter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Npc_hunter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Npc_hunter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Npc_hunter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Npc_hunter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Npc_hunter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Npc_hunter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Npc_hunter}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Npc_hunterSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Npc_hunterSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Npc_hunterSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("npc_hunter");
    }
}

enum abstract Npc_hunterwakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_huntersleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Npc_hunterrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Npc_hunterrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Npc_hunterignoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_hunterhintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_huntergmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_hunterdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_hunterdisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Npc_hunterSpawnFlags(Int) to Int {
