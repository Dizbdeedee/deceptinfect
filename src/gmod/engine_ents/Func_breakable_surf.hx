...
**/
@:forward
abstract Func_breakable_surf(Entity) to Entity {
    //Inputs
	...
	**/
    public extern inline function FireShatter(param:Vector,delay:Float) {
        untyped this.Fire("Shatter",untyped param,delay);
    }
	...
	**/
    public var PerformanceMode(get,set):Func_breakable_surfPerformanceModeChoices;

    @:noCompletion
    public extern inline function get_PerformanceMode():Func_breakable_surfPerformanceModeChoices {
        return untyped this.GetKeyValues().PerformanceMode;
    }
    
    @:noCompletion
    public extern inline function set_PerformanceMode(value:Func_breakable_surfPerformanceModeChoices):Func_breakable_surfPerformanceModeChoices {
	...
	**/
    public var propdata(get,set):Func_breakable_surfpropdataChoices;

    @:noCompletion
    public extern inline function get_propdata():Func_breakable_surfpropdataChoices {
        return untyped this.GetKeyValues().propdata;
    }
    
    @:noCompletion
    public extern inline function set_propdata(value:Func_breakable_surfpropdataChoices):Func_breakable_surfpropdataChoices {
	...
	**/
    public var material(get,set):Func_breakable_surfmaterialChoices;

    @:noCompletion
    public extern inline function get_material():Func_breakable_surfmaterialChoices {
        return untyped this.GetKeyValues().material;
    }
    
    @:noCompletion
    public extern inline function set_material(value:Func_breakable_surfmaterialChoices):Func_breakable_surfmaterialChoices {
	...
	**/
    public var explosion(get,set):Func_breakable_surfexplosionChoices;

    @:noCompletion
    public extern inline function get_explosion():Func_breakable_surfexplosionChoices {
        return untyped this.GetKeyValues().explosion;
    }
    
    @:noCompletion
    public extern inline function set_explosion(value:Func_breakable_surfexplosionChoices):Func_breakable_surfexplosionChoices {
	...
	**/
    public var nodamageforces(get,set):Func_breakable_surfnodamageforcesChoices;

    @:noCompletion
    public extern inline function get_nodamageforces():Func_breakable_surfnodamageforcesChoices {
        return untyped this.GetKeyValues().nodamageforces;
    }
    
    @:noCompletion
    public extern inline function set_nodamageforces(value:Func_breakable_surfnodamageforcesChoices):Func_breakable_surfnodamageforcesChoices {
	...
	**/
    public var spawnobject(get,set):Func_breakable_surfspawnobjectChoices;

    @:noCompletion
    public extern inline function get_spawnobject():Func_breakable_surfspawnobjectChoices {
        return untyped this.GetKeyValues().spawnobject;
    }
    
    @:noCompletion
    public extern inline function set_spawnobject(value:Func_breakable_surfspawnobjectChoices):Func_breakable_surfspawnobjectChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Func_breakable_surfgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Func_breakable_surfgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Func_breakable_surfgmod_allowphysgunChoices):Func_breakable_surfgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Func_breakable_surfrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Func_breakable_surfrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Func_breakable_surfrendermodeChoices):Func_breakable_surfrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Func_breakable_surfdisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Func_breakable_surfdisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Func_breakable_surfdisablereceiveshadowsChoices):Func_breakable_surfdisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Func_breakable_surfrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Func_breakable_surfrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Func_breakable_surfrenderfxChoices):Func_breakable_surfrenderfxChoices {
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Func_breakable_surfdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Func_breakable_surfdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Func_breakable_surfdisableshadowsChoices):Func_breakable_surfdisableshadowsChoices {
	...
	**/
    public var fragility(get,set):Int;

    @:noCompletion
    public extern inline function get_fragility():Int {
        return untyped this.GetKeyValues().fragility;
    }
    
    @:noCompletion
    public extern inline function set_fragility(value:Int):Int {
        return untyped this.SetKeyValue("fragility",untyped value);
    }
    
    /**
		Surface Type
	**/
    public var surfacetype(get,set):Func_breakable_surfsurfacetypeChoices;

    @:noCompletion
    public extern inline function get_surfacetype():Func_breakable_surfsurfacetypeChoices {
        return untyped this.GetKeyValues().surfacetype;
    }
    
    @:noCompletion
    public extern inline function set_surfacetype(value:Func_breakable_surfsurfacetypeChoices):Func_breakable_surfsurfacetypeChoices {
        return untyped this.SetKeyValue("surfacetype",untyped value);
    }
	...
	**/
    public extern inline function OutputOnBreak(callback:Callback<{activator:Func_breakable_surf}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnTakeDamage(callback:Callback<{activator:Func_breakable_surf}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHealthChanged(callback:Callback<{activator:Func_breakable_surf,data:Float}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonDetach(callback:Callback<{activator:Func_breakable_surf}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonAnimatePreStarted(callback:Callback<{activator:Func_breakable_surf}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonAnimatePullStarted(callback:Callback<{activator:Func_breakable_surf}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonPullAnimFinished(callback:Callback<{activator:Func_breakable_surf}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonAnimatePostStarted(callback:Callback<{activator:Func_breakable_surf}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Func_breakable_surf}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Func_breakable_surf}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Func_breakable_surf}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Func_breakable_surf}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Func_breakable_surfSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Func_breakable_surfSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Func_breakable_surfSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("func_breakable_surf");
    }
}

enum abstract Func_breakable_surfsurfacetypeChoices(Int) to Int {
	var GLASS = 0;
	var TILE = 1;
}
enum abstract Func_breakable_surfspawnobjectChoices(Int) to Int {
	var ITEMBATTERY = 1;
	var ITEMHEALTHKIT = 2;
...
enum abstract Func_breakable_surfrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Func_breakable_surfrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Func_breakable_surfpropdataChoices(Int) to Int {
	var NONE = 0;
	var WOODENTINY = 1;
	var WOODENSMALL = 2;
	var WOODENMEDIUM = 3;
...
enum abstract Func_breakable_surfnodamageforcesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_breakable_surfmaterialChoices(Int) to Int {
	var GLASS = 0;
	var WOOD = 1;
	var METAL = 2;
	var FLESH = 3;
...
enum abstract Func_breakable_surfgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_breakable_surfexplosionChoices(Int) to Int {
	var RANDOM = 0;
	var RELATIVE_TO_ATTACK = 1;
	var USE_PRECISE_GIB_DIR = 2;
}
enum abstract Func_breakable_surfdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_breakable_surfdisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_breakable_surfPerformanceModeChoices(Int) to Int {
	var NORMAL = 0;
	var NO_GIBS = 1;
...
enum abstract Func_breakable_surfSpawnFlags(Int) to Int {
	...
	var PHYSICS_DAMAGE_DECALS = 1;
	var TAKE_DAMAGE_FROM_HELD_OBJECTS = 2;
}
