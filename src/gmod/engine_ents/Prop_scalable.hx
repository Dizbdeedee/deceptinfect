...
**/
@:forward
abstract Prop_scalable(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Scales the prop in one Axis. Params: <New Size> <Time>
	**/
	...
	**/
    public var gmod_allowphysgun(get,set):Prop_scalablegmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Prop_scalablegmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Prop_scalablegmod_allowphysgunChoices):Prop_scalablegmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Prop_scalablerendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Prop_scalablerendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Prop_scalablerendermodeChoices):Prop_scalablerendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Prop_scalabledisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Prop_scalabledisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Prop_scalabledisablereceiveshadowsChoices):Prop_scalabledisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Prop_scalablerenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Prop_scalablerenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Prop_scalablerenderfxChoices):Prop_scalablerenderfxChoices {
	...
	**/
    public var disableshadows(get,set):Prop_scalabledisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Prop_scalabledisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Prop_scalabledisableshadowsChoices):Prop_scalabledisableshadowsChoices {
	...
	**/
    public extern inline function OutputOnIgnite(callback:Callback<{activator:Prop_scalable}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Prop_scalable}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Prop_scalable}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Prop_scalable}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Prop_scalable}>):CallbackLink {
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("prop_scalable");
    }
}

enum abstract Prop_scalablerendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Prop_scalablerenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Prop_scalablegmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_scalabledisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_scalabledisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
