...
**/
@:forward
abstract Func_tankapcrocket(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Fire a burst of rockets cause we're dying.
	**/
    public extern inline function FireDeathVolley(delay:Float) {
        untyped this.Fire("DeathVolley",untyped null,delay);
    }
	...
	**/
    ...
    /**
		Bullet accuracy
	**/
    public var firespread(get,set):Func_tankapcrocketfirespreadChoices;

    @:noCompletion
    public extern inline function get_firespread():Func_tankapcrocketfirespreadChoices {
        return untyped this.GetKeyValues().firespread;
    }
    
    @:noCompletion
    public extern inline function set_firespread(value:Func_tankapcrocketfirespreadChoices):Func_tankapcrocketfirespreadChoices {
	...
	**/
    ...
    /**
		Lead Target
	**/
    public var LeadTarget(get,set):Func_tankapcrocketLeadTargetChoices;

    @:noCompletion
    public extern inline function get_LeadTarget():Func_tankapcrocketLeadTargetChoices {
        return untyped this.GetKeyValues().LeadTarget;
    }
    
    @:noCompletion
    public extern inline function set_LeadTarget(value:Func_tankapcrocketLeadTargetChoices):Func_tankapcrocketLeadTargetChoices {
	...
	**/
    ...
    /**
		Effect Handling
	**/
    public var effecthandling(get,set):Func_tankapcrocketeffecthandlingChoices;

    @:noCompletion
    public extern inline function get_effecthandling():Func_tankapcrocketeffecthandlingChoices {
        return untyped this.GetKeyValues().effecthandling;
    }
    
    @:noCompletion
    public extern inline function set_effecthandling(value:Func_tankapcrocketeffecthandlingChoices):Func_tankapcrocketeffecthandlingChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Func_tankapcrocketgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Func_tankapcrocketgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Func_tankapcrocketgmod_allowphysgunChoices):Func_tankapcrocketgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Func_tankapcrocketrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Func_tankapcrocketrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Func_tankapcrocketrendermodeChoices):Func_tankapcrocketrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Func_tankapcrocketdisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Func_tankapcrocketdisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Func_tankapcrocketdisablereceiveshadowsChoices):Func_tankapcrocketdisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Func_tankapcrocketrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Func_tankapcrocketrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Func_tankapcrocketrenderfxChoices):Func_tankapcrocketrenderfxChoices {
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Func_tankapcrocketdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Func_tankapcrocketdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Func_tankapcrocketdisableshadowsChoices):Func_tankapcrocketdisableshadowsChoices {
	...
	**/
    public var rocketspeed(get,set):Float;

    @:noCompletion
    public extern inline function get_rocketspeed():Float {
        return untyped this.GetKeyValues().rocketspeed;
    }
    
    @:noCompletion
    public extern inline function set_rocketspeed(value:Float):Float {
        return untyped this.SetKeyValue("rocketspeed",untyped value);
    }
	...
	**/
    public var burstcount(get,set):Int;

    @:noCompletion
    public extern inline function get_burstcount():Int {
        return untyped this.GetKeyValues().burstcount;
    }
    
    @:noCompletion
    public extern inline function set_burstcount(value:Int):Int {
        return untyped this.SetKeyValue("burstcount",untyped value);
    }
	...
	**/
    public extern inline function OutputOnFire(callback:Callback<{activator:Func_tankapcrocket}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnAquireTarget(callback:Callback<{activator:Func_tankapcrocket}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLoseTarget(callback:Callback<{activator:Func_tankapcrocket}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnAmmoDepleted(callback:Callback<{activator:Func_tankapcrocket}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnGotController(callback:Callback<{activator:Func_tankapcrocket}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostController(callback:Callback<{activator:Func_tankapcrocket}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnGotPlayerController(callback:Callback<{activator:Func_tankapcrocket}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerController(callback:Callback<{activator:Func_tankapcrocket}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnReadyToFire(callback:Callback<{activator:Func_tankapcrocket}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Func_tankapcrocket}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Func_tankapcrocket}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Func_tankapcrocket}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Func_tankapcrocket}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Func_tankapcrocketSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Func_tankapcrocketSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Func_tankapcrocketSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("func_tankapcrocket");
    }
}

enum abstract Func_tankapcrocketrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Func_tankapcrocketrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Func_tankapcrocketgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_tankapcrocketfirespreadChoices(Int) to Int {
	var PERFECT_SHOT = 0;
	var SMALL_CONE = 1;
	var MEDIUM_CONE = 2;
	var LARGE_CONE = 3;
...
enum abstract Func_tankapcrocketeffecthandlingChoices(Int) to Int {
	var USE_INDIVIDUAL_SETTINGS = 0;
	var AR2 = 1;
	var COMBINE_CANNON = 2;
}
enum abstract Func_tankapcrocketdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_tankapcrocketdisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_tankapcrocketLeadTargetChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Func_tankapcrocketSpawnFlags(Int) to Int {
	var ACTIVE = 1;
	var ONLY_DIRECT = 16;
	var CONTROLLABLE = 32;
	var DAMAGE_KICK = 64;
