...
**/
@:forward
abstract Func_tankrocket(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Bullet accuracy
	**/
    public var firespread(get,set):Func_tankrocketfirespreadChoices;

    @:noCompletion
    public extern inline function get_firespread():Func_tankrocketfirespreadChoices {
        return untyped this.GetKeyValues().firespread;
    }
    
    @:noCompletion
    public extern inline function set_firespread(value:Func_tankrocketfirespreadChoices):Func_tankrocketfirespreadChoices {
	...
	**/
    ...
    /**
		Lead Target
	**/
    public var LeadTarget(get,set):Func_tankrocketLeadTargetChoices;

    @:noCompletion
    public extern inline function get_LeadTarget():Func_tankrocketLeadTargetChoices {
        return untyped this.GetKeyValues().LeadTarget;
    }
    
    @:noCompletion
    public extern inline function set_LeadTarget(value:Func_tankrocketLeadTargetChoices):Func_tankrocketLeadTargetChoices {
	...
	**/
    ...
    /**
		Effect Handling
	**/
    public var effecthandling(get,set):Func_tankrocketeffecthandlingChoices;

    @:noCompletion
    public extern inline function get_effecthandling():Func_tankrocketeffecthandlingChoices {
        return untyped this.GetKeyValues().effecthandling;
    }
    
    @:noCompletion
    public extern inline function set_effecthandling(value:Func_tankrocketeffecthandlingChoices):Func_tankrocketeffecthandlingChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Func_tankrocketgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Func_tankrocketgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Func_tankrocketgmod_allowphysgunChoices):Func_tankrocketgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Func_tankrocketrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Func_tankrocketrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Func_tankrocketrendermodeChoices):Func_tankrocketrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Func_tankrocketdisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Func_tankrocketdisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Func_tankrocketdisablereceiveshadowsChoices):Func_tankrocketdisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Func_tankrocketrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Func_tankrocketrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Func_tankrocketrenderfxChoices):Func_tankrocketrenderfxChoices {
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Func_tankrocketdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Func_tankrocketdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Func_tankrocketdisableshadowsChoices):Func_tankrocketdisableshadowsChoices {
	...
	**/
    public extern inline function OutputOnFire(callback:Callback<{activator:Func_tankrocket}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnAquireTarget(callback:Callback<{activator:Func_tankrocket}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLoseTarget(callback:Callback<{activator:Func_tankrocket}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnAmmoDepleted(callback:Callback<{activator:Func_tankrocket}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnGotController(callback:Callback<{activator:Func_tankrocket}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostController(callback:Callback<{activator:Func_tankrocket}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnGotPlayerController(callback:Callback<{activator:Func_tankrocket}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerController(callback:Callback<{activator:Func_tankrocket}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnReadyToFire(callback:Callback<{activator:Func_tankrocket}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Func_tankrocket}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Func_tankrocket}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Func_tankrocket}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Func_tankrocket}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Func_tankrocketSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Func_tankrocketSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Func_tankrocketSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("func_tankrocket");
    }
}

enum abstract Func_tankrocketrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Func_tankrocketrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Func_tankrocketgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_tankrocketfirespreadChoices(Int) to Int {
	var PERFECT_SHOT = 0;
	var SMALL_CONE = 1;
	var MEDIUM_CONE = 2;
	var LARGE_CONE = 3;
...
enum abstract Func_tankrocketeffecthandlingChoices(Int) to Int {
	var USE_INDIVIDUAL_SETTINGS = 0;
	var AR2 = 1;
	var COMBINE_CANNON = 2;
}
enum abstract Func_tankrocketdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_tankrocketdisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_tankrocketLeadTargetChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Func_tankrocketSpawnFlags(Int) to Int {
	var ACTIVE = 1;
	var ONLY_DIRECT = 16;
	var CONTROLLABLE = 32;
	var DAMAGE_KICK = 64;
