...
**/
@:forward
abstract Prop_physics_override(Entity) to Entity {
    //Inputs
...
Set to 1.0 for materials as strong as flesh, smaller numbers indicate stronger materials.
	**/
    ...
    /**
		Impact damage type
	**/
    public var Damagetype(get,set):Prop_physics_overrideDamagetypeChoices;

    @:noCompletion
    public extern inline function get_Damagetype():Prop_physics_overrideDamagetypeChoices {
        return untyped this.GetKeyValues().Damagetype;
    }
    
    @:noCompletion
    public extern inline function set_Damagetype(value:Prop_physics_overrideDamagetypeChoices):Prop_physics_overrideDamagetypeChoices {
	...
	**/
    public var nodamageforces(get,set):Prop_physics_overridenodamageforcesChoices;

    @:noCompletion
    public extern inline function get_nodamageforces():Prop_physics_overridenodamageforcesChoices {
        return untyped this.GetKeyValues().nodamageforces;
    }
    
    @:noCompletion
    public extern inline function set_nodamageforces(value:Prop_physics_overridenodamageforcesChoices):Prop_physics_overridenodamageforcesChoices {
	...
	**/
    public var PerformanceMode(get,set):Prop_physics_overridePerformanceModeChoices;

    @:noCompletion
    public extern inline function get_PerformanceMode():Prop_physics_overridePerformanceModeChoices {
        return untyped this.GetKeyValues().PerformanceMode;
    }
    
    @:noCompletion
    public extern inline function set_PerformanceMode(value:Prop_physics_overridePerformanceModeChoices):Prop_physics_overridePerformanceModeChoices {
	...
	**/
    ...
    /**
		Minimum DX Level
	**/
    public var mindxlevel(get,set):Prop_physics_overridemindxlevelChoices;

    @:noCompletion
    public extern inline function get_mindxlevel():Prop_physics_overridemindxlevelChoices {
        return untyped this.GetKeyValues().mindxlevel;
    }
    
    @:noCompletion
    public extern inline function set_mindxlevel(value:Prop_physics_overridemindxlevelChoices):Prop_physics_overridemindxlevelChoices {
    ...
    /**
		Maximum DX Level
	**/
    public var maxdxlevel(get,set):Prop_physics_overridemaxdxlevelChoices;

    @:noCompletion
    public extern inline function get_maxdxlevel():Prop_physics_overridemaxdxlevelChoices {
        return untyped this.GetKeyValues().maxdxlevel;
    }
    
    @:noCompletion
    public extern inline function set_maxdxlevel(value:Prop_physics_overridemaxdxlevelChoices):Prop_physics_overridemaxdxlevelChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Prop_physics_overridegmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Prop_physics_overridegmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Prop_physics_overridegmod_allowphysgunChoices):Prop_physics_overridegmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Prop_physics_overridedisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Prop_physics_overridedisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Prop_physics_overridedisableshadowsChoices):Prop_physics_overridedisableshadowsChoices {
	...
	**/
    public extern inline function OutputOnMotionEnabled(callback:Callback<{activator:Prop_physics_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnAwakened(callback:Callback<{activator:Prop_physics_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysGunPickup(callback:Callback<{activator:Prop_physics_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysGunPunt(callback:Callback<{activator:Prop_physics_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysGunOnlyPickup(callback:Callback<{activator:Prop_physics_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysGunDrop(callback:Callback<{activator:Prop_physics_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPlayerUse(callback:Callback<{activator:Prop_physics_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPlayerPickup(callback:Callback<{activator:Prop_physics_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnOutOfWorld(callback:Callback<{activator:Prop_physics_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnBreak(callback:Callback<{activator:Prop_physics_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnTakeDamage(callback:Callback<{activator:Prop_physics_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHealthChanged(callback:Callback<{activator:Prop_physics_override,data:Float}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonDetach(callback:Callback<{activator:Prop_physics_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonAnimatePreStarted(callback:Callback<{activator:Prop_physics_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonAnimatePullStarted(callback:Callback<{activator:Prop_physics_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonPullAnimFinished(callback:Callback<{activator:Prop_physics_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonAnimatePostStarted(callback:Callback<{activator:Prop_physics_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnIgnite(callback:Callback<{activator:Prop_physics_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Prop_physics_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Prop_physics_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Prop_physics_override}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Prop_physics_override}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Prop_physics_overrideSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Prop_physics_overrideSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Prop_physics_overrideSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("prop_physics_override");
    }
}

enum abstract Prop_physics_overridenodamageforcesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_physics_overridemindxlevelChoices(Int) to Int {
...
enum abstract Prop_physics_overridemaxdxlevelChoices(Int) to Int {
...
enum abstract Prop_physics_overridegmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_physics_overridedisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_physics_overridePerformanceModeChoices(Int) to Int {
	var NORMAL = 0;
	var NO_GIBS = 1;
	var FULL_GIBS_ON_ALL_PLATFORMS = 2;
	var REDUCED_GIBS = 3;
}
enum abstract Prop_physics_overrideDamagetypeChoices(Int) to Int {
	var BLUNT = 0;
	var SHARP = 1;
}


enum abstract Prop_physics_overrideSpawnFlags(Int) to Int {
	var START_ASLEEP = 1;
