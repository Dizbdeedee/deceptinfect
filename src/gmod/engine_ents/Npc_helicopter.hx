...
**/
@:forward
abstract Npc_helicopter(NPC) to Entity to NPC {
    //Inputs
	...
	**/
    ...
    /**
		GunOn
	**/
    public extern inline function FireGunOn(delay:Float) {
        untyped this.Fire("GunOn",untyped null,delay);
    }
    
    /**
		GunOff
	**/
    public extern inline function FireGunOff(delay:Float) {
        untyped this.Fire("GunOff",untyped null,delay);
    }
    
    /**
		MissileOn
	**/
    public extern inline function FireMissileOn(delay:Float) {
        untyped this.Fire("MissileOn",untyped null,delay);
    }
    
    /**
		MissileOff
	**/
    public extern inline function FireMissileOff(delay:Float) {
        untyped this.Fire("MissileOff",untyped null,delay);
    }
    
    /**
		Turns on rotor wash effects
	**/
    public extern inline function FireEnableRotorWash(delay:Float) {
        untyped this.Fire("EnableRotorWash",untyped null,delay);
    }
    
    /**
		Turns off rotor wash effects
	**/
    public extern inline function FireDisableRotorWash(delay:Float) {
        untyped this.Fire("DisableRotorWash",untyped null,delay);
    }
	...
	**/
    public extern inline function FireStartBombingVehicle(delay:Float) {
        untyped this.Fire("StartBombingVehicle",untyped null,delay);
    }
    
    /**
		Starts the chopper trailing enemy vehicles and shooting at them.
	**/
    public extern inline function FireStartTrailingVehicle(delay:Float) {
        untyped this.Fire("StartTrailingVehicle",untyped null,delay);
    }
    
    /**
		Starts the chopper in the mode where he always stops at nav points instead of stopping anywhere in between nav points.
	**/
    public extern inline function FireStartDefaultBehavior(delay:Float) {
        untyped this.Fire("StartDefaultBehavior",untyped null,delay);
    }
	...
	**/
    public extern inline function FireStartAlwaysLeadingVehicle(delay:Float) {
        untyped this.Fire("StartAlwaysLeadingVehicle",untyped null,delay);
    }
    
    /**
		Starts the chopper dropping bombs randomly + shooting at the player.
	**/
    public extern inline function FireStartSprinkleBehavior(delay:Float) {
        untyped this.Fire("StartSprinkleBehavior",untyped null,delay);
    }
    
    /**
		Starts the chopper bullrushing the player.
	**/
    public extern inline function FireStartBullrushBehavior(delay:Float) {
        untyped this.Fire("StartBullrushBehavior",untyped null,delay);
    }
    
    /**
		Sets the chopper health as a percentage of max health
	**/
    public extern inline function FireSetHealthFraction(param:Float,delay:Float) {
        untyped this.Fire("SetHealthFraction",untyped param,delay);
    }
    
    /**
		Starts the chopper being deadly to on-foot players
	**/
    public extern inline function FireEnableDeadlyShooting(delay:Float) {
        untyped this.Fire("EnableDeadlyShooting",untyped null,delay);
    }
    
    /**
		Stops the chopper being deadly to on-foot players
	**/
    public extern inline function FireDisableDeadlyShooting(delay:Float) {
        untyped this.Fire("DisableDeadlyShooting",untyped null,delay);
    }
    
    /**
		The chopper will fire in short bursts. Good for on-foot experiences
	**/
    public extern inline function FireStartNormalShooting(delay:Float) {
        untyped this.Fire("StartNormalShooting",untyped null,delay);
    }
    
    /**
		The chopper fires in long bursts
	**/
    public extern inline function FireStartLongCycleShooting(delay:Float) {
        untyped this.Fire("StartLongCycleShooting",untyped null,delay);
    }
    
    /**
		The chopper fires continuously.
	**/
    public extern inline function FireStartContinuousShooting(delay:Float) {
        untyped this.Fire("StartContinuousShooting",untyped null,delay);
    }
    
    /**
		The chopper fires normal bursts, but does not 'charge up' the gun. Fires immediately.
	**/
    public extern inline function FireStartFastShooting(delay:Float) {
        untyped this.Fire("StartFastShooting",untyped null,delay);
    }
    
    /**
		Allows the helicopter to fire immediately if he's not in the middle of charging or firing
	**/
    public extern inline function FireResetIdleTime(delay:Float) {
        untyped this.Fire("ResetIdleTime",untyped null,delay);
    }
    
    /**
		Instantly snaps the orientation of the helicopter (Pitch Yaw Roll)
	**/
	...
	**/
    public extern inline function FireDropBomb(delay:Float) {
        untyped this.Fire("DropBomb",untyped null,delay);
    }
    
    /**
		Immediately drops a bomb directly downwards
	**/
    public extern inline function FireDropBombStraightDown(delay:Float) {
        untyped this.Fire("DropBombStraightDown",untyped null,delay);
    }
    
    /**
		Immediately drops a bomb directly at the target destination, but only if the player isn't right there
	**/
    public extern inline function FireDropBombAtTarget(param:String,delay:Float) {
        untyped this.Fire("DropBombAtTarget",untyped param,delay);
    }
    
    /**
		Immediately drops a bomb directly at the target destination, no matter whether it's fair or not.
	**/
    public extern inline function FireDropBombAtTargetAlways(param:String,delay:Float) {
        untyped this.Fire("DropBombAtTargetAlways",untyped param,delay);
    }
    
    /**
		Add a delay before the next bomb is dropped
	**/
    public extern inline function FireDropBombDelay(param:Float,delay:Float) {
        untyped this.Fire("DropBombDelay",untyped param,delay);
    }
    
    /**
		Makes the helicopter take no more damage
	**/
    public extern inline function FireBecomeIndestructible(delay:Float) {
        untyped this.Fire("BecomeIndestructible",untyped null,delay);
    }
    
    /**
		When the helicopter moves, he will not check for visibility from the path_track to the enemy to cull out path_tracks
	**/
    public extern inline function FireDisablePathVisibilityTests(delay:Float) {
        untyped this.Fire("DisablePathVisibilityTests",untyped null,delay);
    }
    
    /**
		When the helicopter moves, he will only move to path_tracks that have line-of-sight to the enemy
	**/
    public extern inline function FireEnablePathVisibilityTests(delay:Float) {
        untyped this.Fire("EnablePathVisibilityTests",untyped null,delay);
    }
    
    /**
		Starts the helicopter constantly dropping megabombs until StopCarpetBombing input
	**/
    public extern inline function FireStartCarpetBombing(delay:Float) {
        untyped this.Fire("StartCarpetBombing",untyped null,delay);
    }
    
    /**
		Stop the carpet bombing behavior
	**/
    public extern inline function FireStopCarpetBombing(delay:Float) {
        untyped this.Fire("StopCarpetBombing",untyped null,delay);
    }
	...
	**/
    public var hintlimiting(get,set):Npc_helicopterhintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Npc_helicopterhintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Npc_helicopterhintlimitingChoices):Npc_helicopterhintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Npc_helicoptersleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Npc_helicoptersleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Npc_helicoptersleepstateChoices):Npc_helicoptersleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Npc_helicopterwakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Npc_helicopterwakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Npc_helicopterwakesquadChoices):Npc_helicopterwakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Npc_helicopterignoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Npc_helicopterignoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Npc_helicopterignoreunseenenemiesChoices):Npc_helicopterignoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Npc_helicoptergmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Npc_helicoptergmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Npc_helicoptergmod_allowphysgunChoices):Npc_helicoptergmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Npc_helicopterrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Npc_helicopterrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Npc_helicopterrendermodeChoices):Npc_helicopterrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Npc_helicopterdisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Npc_helicopterdisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Npc_helicopterdisablereceiveshadowsChoices):Npc_helicopterdisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Npc_helicopterrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Npc_helicopterrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Npc_helicopterrenderfxChoices):Npc_helicopterrenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Npc_helicopterdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Npc_helicopterdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Npc_helicopterdisableshadowsChoices):Npc_helicopterdisableshadowsChoices {
	...
	**/
    public var GracePeriod(get,set):Float;

    @:noCompletion
    public extern inline function get_GracePeriod():Float {
        return untyped this.GetKeyValues().GracePeriod;
    }
    
    @:noCompletion
    public extern inline function set_GracePeriod(value:Float):Float {
        return untyped this.SetKeyValue("GracePeriod",untyped value);
    }
	...
	**/
    public var PatrolSpeed(get,set):Float;

    @:noCompletion
    public extern inline function get_PatrolSpeed():Float {
        return untyped this.GetKeyValues().PatrolSpeed;
    }
    
    @:noCompletion
    public extern inline function set_PatrolSpeed(value:Float):Float {
        return untyped this.SetKeyValue("PatrolSpeed",untyped value);
    }
    
    /**
		Non-combat (Do not precache gibs)
	**/
    public var noncombat(get,set):Npc_helicopternoncombatChoices;

    @:noCompletion
    public extern inline function get_noncombat():Npc_helicopternoncombatChoices {
        return untyped this.GetKeyValues().noncombat;
    }
    
    @:noCompletion
    public extern inline function set_noncombat(value:Npc_helicopternoncombatChoices):Npc_helicopternoncombatChoices {
        return untyped this.SetKeyValue("noncombat",untyped value);
    }
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Npc_helicopter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Npc_helicopter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Npc_helicopter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Npc_helicopter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Npc_helicopter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Npc_helicopter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Npc_helicopter,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Npc_helicopter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Npc_helicopter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Npc_helicopter,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Npc_helicopter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Npc_helicopter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Npc_helicopter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Npc_helicopter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Npc_helicopter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Npc_helicopter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Npc_helicopter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Npc_helicopter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Npc_helicopter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Npc_helicopter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Npc_helicopter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Npc_helicopter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Npc_helicopter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Npc_helicopter}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHealthChanged(callback:Callback<{activator:Npc_helicopter,data:Int}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnHealthChanged",callback);
    }
    
    /**
		Fires the instant the helicopter is killed
	**/
    public extern inline function OutputOnShotDown(callback:Callback<{activator:Npc_helicopter}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnShotDown",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Npc_helicopterSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Npc_helicopterSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Npc_helicopterSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("npc_helicopter");
    }
}

enum abstract Npc_helicopterwakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_helicoptersleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Npc_helicopterrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Npc_helicopterrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Npc_helicopternoncombatChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_helicopterignoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_helicopterhintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_helicoptergmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_helicopterdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_helicopterdisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Npc_helicopterSpawnFlags(Int) to Int {
	var NO_ROTORWASH = 32;
	var AWAIT_INPUT = 64;
	...
	var LOUD_ROTOR_WASH_SOUND = 65536;
	var ELECTRICAL_DRONE = 131072;
	var HELICOPTER_LIGHTS = 262144;
	var IGNORE_AVOID_SPHERESBOXES = 524288;
	var MORE_AGGRESSIVE_ATTACKS = 1048576;
	var CAST_LONG_SHADOW = 2097152;
}
