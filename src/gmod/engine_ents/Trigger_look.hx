...
**/
@:forward
abstract Trigger_look(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Start Disabled
	**/
    public var StartDisabled(get,set):Trigger_lookStartDisabledChoices;

    @:noCompletion
    public extern inline function get_StartDisabled():Trigger_lookStartDisabledChoices {
        return untyped this.GetKeyValues().StartDisabled;
    }
    
    @:noCompletion
    public extern inline function set_StartDisabled(value:Trigger_lookStartDisabledChoices):Trigger_lookStartDisabledChoices {
	...
	**/
    public var LookTime(get,set):String;

    @:noCompletion
    public extern inline function get_LookTime():String {
        return untyped this.GetKeyValues().LookTime;
    }
    
    @:noCompletion
    public extern inline function set_LookTime(value:String):String {
        return untyped this.SetKeyValue("LookTime",untyped value);
    }
 ...
 -1.0 = all directions).
	...
	**/
    ...
    @:noCompletion
    public extern inline function get_Timeout():Float {
        return untyped this.GetKeyValues().Timeout;
    }
    
    @:noCompletion
    public extern inline function set_Timeout(value:Float):Float {
        return untyped this.SetKeyValue("Timeout",untyped value);
    }
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Trigger_look}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Trigger_look}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Trigger_look}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Trigger_look}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnStartTouchAll(callback:Callback<{activator:Trigger_look}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnEndTouch(callback:Callback<{activator:Trigger_look}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnEndTouchAll(callback:Callback<{activator:Trigger_look}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnStartTouch(callback:Callback<{activator:Trigger_look}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnStartTouch",callback);
    }
    
    /**
		Fired when the trigger is activated.
	**/
    public extern inline function OutputOnTrigger(callback:Callback<{activator:Trigger_look}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnTimeout(callback:Callback<{activator:Trigger_look}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnTimeout",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Trigger_lookSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Trigger_lookSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Trigger_lookSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("trigger_look");
    }
}

enum abstract Trigger_lookStartDisabledChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Trigger_lookSpawnFlags(Int) to Int {
	var CLIENTS = 1;
	var NPCS = 2;
	var PUSHABLES = 4;
	...
	var FIRE_ONCE = 128;
	var USE_VELOCITY_INSTEAD_OF_FACING = 256;
}
