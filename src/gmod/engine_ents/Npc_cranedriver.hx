...
**/
@:forward
abstract Npc_cranedriver(NPC) to Entity to NPC {
    //Inputs
	...
	**/
    public extern inline function FireStartFiring(delay:Float) {
        untyped this.Fire("StartFiring",untyped null,delay);
    }
    
    /**
		Tell the driver to stop attacking nearby enemies with the vehicle's weaponry.
	**/
    public extern inline function FireStopFiring(delay:Float) {
        untyped this.Fire("StopFiring",untyped null,delay);
    }
    
    /**
		Tell the driver to go to a specific path corner and continue from there.
	**/
    public extern inline function FireGotoPathCorner(param:String,delay:Float) {
        untyped this.Fire("GotoPathCorner",untyped param,delay);
    }
    
    /**
		Force the driver to pickup the specified entity (by targetname)
	**/
    public extern inline function FireForcePickup(param:String,delay:Float) {
        untyped this.Fire("ForcePickup",untyped param,delay);
    }
    
    /**
		Force the driver to drop the currently held object at the specified entity's location.
	**/
    public extern inline function FireForceDrop(param:String,delay:Float) {
        untyped this.Fire("ForceDrop",untyped param,delay);
    }
	...
	**/
    public var hintlimiting(get,set):Npc_cranedriverhintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Npc_cranedriverhintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Npc_cranedriverhintlimitingChoices):Npc_cranedriverhintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Npc_cranedriversleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Npc_cranedriversleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Npc_cranedriversleepstateChoices):Npc_cranedriversleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Npc_cranedriverwakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Npc_cranedriverwakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Npc_cranedriverwakesquadChoices):Npc_cranedriverwakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Npc_cranedriverignoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Npc_cranedriverignoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Npc_cranedriverignoreunseenenemiesChoices):Npc_cranedriverignoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Npc_cranedrivergmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Npc_cranedrivergmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Npc_cranedrivergmod_allowphysgunChoices):Npc_cranedrivergmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Npc_cranedriverrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Npc_cranedriverrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Npc_cranedriverrendermodeChoices):Npc_cranedriverrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Npc_cranedriverdisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Npc_cranedriverdisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Npc_cranedriverdisablereceiveshadowsChoices):Npc_cranedriverdisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Npc_cranedriverrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Npc_cranedriverrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Npc_cranedriverrenderfxChoices):Npc_cranedriverrenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Npc_cranedriverdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Npc_cranedriverdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Npc_cranedriverdisableshadowsChoices):Npc_cranedriverdisableshadowsChoices {
	...
	**/
    ...
    /**
		Vehicle to drive
	**/
    public var vehicle(get,set):String;

    @:noCompletion
    public extern inline function get_vehicle():String {
        return untyped this.GetKeyValues().vehicle;
    }
    
    @:noCompletion
    public extern inline function set_vehicle(value:String):String {
        return untyped this.SetKeyValue("vehicle",untyped value);
    }
    
    /**
		Pause time before dropping a ForceDrop specified object.
	**/
    public var releasepause(get,set):Float;

    @:noCompletion
    public extern inline function get_releasepause():Float {
        return untyped this.GetKeyValues().releasepause;
    }
    
    @:noCompletion
    public extern inline function set_releasepause(value:Float):Float {
        return untyped this.SetKeyValue("releasepause",untyped value);
    }
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Npc_cranedriver,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Npc_cranedriver,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPickedUpObject(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnPickedUpObject",callback);
    }
    
    /**
		Fired when the ForceDrop specified object has been dropped.
	**/
    public extern inline function OutputOnDroppedObject(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnDroppedObject",callback);
    }
    
    /**
		Fired at the start of the pause before dropping the ForceDrop specified object.
	**/
    public extern inline function OutputOnPausingBeforeDrop(callback:Callback<{activator:Npc_cranedriver}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnPausingBeforeDrop",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Npc_cranedriverSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Npc_cranedriverSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Npc_cranedriverSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("npc_cranedriver");
    }
}

enum abstract Npc_cranedriverwakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_cranedriversleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Npc_cranedriverrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Npc_cranedriverrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Npc_cranedriverignoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_cranedriverhintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_cranedrivergmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_cranedriverdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_cranedriverdisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Npc_cranedriverSpawnFlags(Int) to Int {
