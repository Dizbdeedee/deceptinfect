...
**/
@:forward
abstract Weapon_striderbuster(Entity) to Entity {
    //Inputs
...
Set to 1.0 for materials as strong as flesh, smaller numbers indicate stronger materials.
	**/
    ...
    /**
		Impact damage type
	**/
    public var Damagetype(get,set):Weapon_striderbusterDamagetypeChoices;

    @:noCompletion
    public extern inline function get_Damagetype():Weapon_striderbusterDamagetypeChoices {
        return untyped this.GetKeyValues().Damagetype;
    }
    
    @:noCompletion
    public extern inline function set_Damagetype(value:Weapon_striderbusterDamagetypeChoices):Weapon_striderbusterDamagetypeChoices {
	...
	**/
    public var nodamageforces(get,set):Weapon_striderbusternodamageforcesChoices;

    @:noCompletion
    public extern inline function get_nodamageforces():Weapon_striderbusternodamageforcesChoices {
        return untyped this.GetKeyValues().nodamageforces;
    }
    
    @:noCompletion
    public extern inline function set_nodamageforces(value:Weapon_striderbusternodamageforcesChoices):Weapon_striderbusternodamageforcesChoices {
	...
	**/
    public var PerformanceMode(get,set):Weapon_striderbusterPerformanceModeChoices;

    @:noCompletion
    public extern inline function get_PerformanceMode():Weapon_striderbusterPerformanceModeChoices {
        return untyped this.GetKeyValues().PerformanceMode;
    }
    
    @:noCompletion
    public extern inline function set_PerformanceMode(value:Weapon_striderbusterPerformanceModeChoices):Weapon_striderbusterPerformanceModeChoices {
	...
	**/
    ...
    /**
		Minimum DX Level
	**/
    public var mindxlevel(get,set):Weapon_striderbustermindxlevelChoices;

    @:noCompletion
    public extern inline function get_mindxlevel():Weapon_striderbustermindxlevelChoices {
        return untyped this.GetKeyValues().mindxlevel;
    }
    
    @:noCompletion
    public extern inline function set_mindxlevel(value:Weapon_striderbustermindxlevelChoices):Weapon_striderbustermindxlevelChoices {
    ...
    /**
		Maximum DX Level
	**/
    public var maxdxlevel(get,set):Weapon_striderbustermaxdxlevelChoices;

    @:noCompletion
    public extern inline function get_maxdxlevel():Weapon_striderbustermaxdxlevelChoices {
        return untyped this.GetKeyValues().maxdxlevel;
    }
    
    @:noCompletion
    public extern inline function set_maxdxlevel(value:Weapon_striderbustermaxdxlevelChoices):Weapon_striderbustermaxdxlevelChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Weapon_striderbustergmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Weapon_striderbustergmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Weapon_striderbustergmod_allowphysgunChoices):Weapon_striderbustergmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Weapon_striderbusterdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Weapon_striderbusterdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Weapon_striderbusterdisableshadowsChoices):Weapon_striderbusterdisableshadowsChoices {
	...
	**/
    ...
    /**
		...
		This striderbuster is not armed (to be used for training).
	**/
    public var dud(get,set):Weapon_striderbusterdudChoices;

    @:noCompletion
    public extern inline function get_dud():Weapon_striderbusterdudChoices {
        return untyped this.GetKeyValues().dud;
    }
    
    @:noCompletion
    public extern inline function set_dud(value:Weapon_striderbusterdudChoices):Weapon_striderbusterdudChoices {
        return untyped this.SetKeyValue("dud",untyped value);
    }
	...
	**/
    public extern inline function OutputOnMotionEnabled(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnAwakened(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysGunPickup(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysGunPunt(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysGunOnlyPickup(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysGunDrop(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPlayerUse(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPlayerPickup(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnOutOfWorld(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnBreak(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnTakeDamage(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHealthChanged(callback:Callback<{activator:Weapon_striderbuster,data:Float}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonDetach(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonAnimatePreStarted(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonAnimatePullStarted(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonPullAnimFinished(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonAnimatePostStarted(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnIgnite(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    
    /**
		Fired when the striderbuster successfully attaches to a strider.
	**/
    public extern inline function OutputOnAttachToStrider(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnAttachToStrider",callback);
    }
    
    /**
		Fired when the striderbuster detonates.
	**/
    public extern inline function OutputOnDetonate(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnDetonate",callback);
    }
    
    /**
		Fired when the striderbuster shatters without detonating.
	**/
    public extern inline function OutputOnShatter(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnShatter",callback);
    }
    
    /**
		Fired when the striderbuster shatters after being shot down by Hunters
	**/
    public extern inline function OutputOnShotDown(callback:Callback<{activator:Weapon_striderbuster}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnShotDown",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Weapon_striderbusterSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Weapon_striderbusterSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Weapon_striderbusterSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("weapon_striderbuster");
    }
}

enum abstract Weapon_striderbusternodamageforcesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Weapon_striderbustermindxlevelChoices(Int) to Int {
...
enum abstract Weapon_striderbustermaxdxlevelChoices(Int) to Int {
...
enum abstract Weapon_striderbustergmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Weapon_striderbusterdudChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Weapon_striderbusterdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Weapon_striderbusterPerformanceModeChoices(Int) to Int {
	var NORMAL = 0;
	var NO_GIBS = 1;
	var FULL_GIBS_ON_ALL_PLATFORMS = 2;
	var REDUCED_GIBS = 3;
}
enum abstract Weapon_striderbusterDamagetypeChoices(Int) to Int {
	var BLUNT = 0;
	var SHARP = 1;
}


enum abstract Weapon_striderbusterSpawnFlags(Int) to Int {
	var START_ASLEEP = 1;
	...
	var DONT_USE_GAMEWEAPONMANAGER = 8388608;
}
