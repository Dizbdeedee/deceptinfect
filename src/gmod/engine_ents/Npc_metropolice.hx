...
**/
@:forward
abstract Npc_metropolice(NPC) to Entity to NPC {
    //Inputs
	...
	**/
    public extern inline function FireEnableManhackToss(delay:Float) {
        untyped this.Fire("EnableManhackToss",untyped null,delay);
    }
    
    /**
		Causes the NPC to police the area defined by an ai_goal_police
	**/
    public extern inline function FireSetPoliceGoal(param:String,delay:Float) {
        untyped this.Fire("SetPoliceGoal",untyped param,delay);
    }
    
    /**
		Set the baton to active
	**/
    public extern inline function FireActivateBaton(delay:Float) {
        untyped this.Fire("ActivateBaton",untyped null,delay);
    }
	...
	**/
    public var hintlimiting(get,set):Npc_metropolicehintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Npc_metropolicehintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Npc_metropolicehintlimitingChoices):Npc_metropolicehintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Npc_metropolicesleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Npc_metropolicesleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Npc_metropolicesleepstateChoices):Npc_metropolicesleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Npc_metropolicewakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Npc_metropolicewakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Npc_metropolicewakesquadChoices):Npc_metropolicewakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Npc_metropoliceignoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Npc_metropoliceignoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Npc_metropoliceignoreunseenenemiesChoices):Npc_metropoliceignoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Npc_metropolicegmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Npc_metropolicegmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Npc_metropolicegmod_allowphysgunChoices):Npc_metropolicegmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var waitingtorappel(get,set):Npc_metropolicewaitingtorappelChoices;

    @:noCompletion
    public extern inline function get_waitingtorappel():Npc_metropolicewaitingtorappelChoices {
        return untyped this.GetKeyValues().waitingtorappel;
    }
    
    @:noCompletion
    public extern inline function set_waitingtorappel(value:Npc_metropolicewaitingtorappelChoices):Npc_metropolicewaitingtorappelChoices {
	...
	**/
    public var rendermode(get,set):Npc_metropolicerendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Npc_metropolicerendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Npc_metropolicerendermodeChoices):Npc_metropolicerendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Npc_metropolicedisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Npc_metropolicedisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Npc_metropolicedisablereceiveshadowsChoices):Npc_metropolicedisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Npc_metropolicerenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Npc_metropolicerenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Npc_metropolicerenderfxChoices):Npc_metropolicerenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Npc_metropolicedisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Npc_metropolicedisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Npc_metropolicedisableshadowsChoices):Npc_metropolicedisableshadowsChoices {
	...
	**/
    ...
    /**
		Weapons
	**/
    public var additionalequipment(get,set):Npc_metropoliceadditionalequipmentChoices;

    @:noCompletion
    public extern inline function get_additionalequipment():Npc_metropoliceadditionalequipmentChoices {
        return untyped this.GetKeyValues().additionalequipment;
    }
    
    @:noCompletion
    public extern inline function set_additionalequipment(value:Npc_metropoliceadditionalequipmentChoices):Npc_metropoliceadditionalequipmentChoices {
    ...
    /**
		Number of Manhacks
	**/
    public var manhacks(get,set):Choices;

    @:noCompletion
    public extern inline function get_manhacks():Choices {
        return untyped this.GetKeyValues().manhacks;
    }
    
    @:noCompletion
    public extern inline function set_manhacks(value:Choices):Choices {
        return untyped this.SetKeyValue("manhacks",untyped value);
    }
    
    /**
		Pistol starts drawn
	**/
    public var weapondrawn(get,set):Choices;

    @:noCompletion
    public extern inline function get_weapondrawn():Choices {
        return untyped this.GetKeyValues().weapondrawn;
    }
    
    @:noCompletion
    public extern inline function set_weapondrawn(value:Choices):Choices {
        return untyped this.SetKeyValue("weapondrawn",untyped value);
    }
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Npc_metropolice,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Npc_metropolice,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnRappelTouchdown(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnStunnedPlayer(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnStunnedPlayer",callback);
    }
    
    /**
		Fires if the player hits me with the cupcop can. ONLY use for x360 achievement.
	**/
    public extern inline function OutputOnCupCopped(callback:Callback<{activator:Npc_metropolice}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnCupCopped",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Npc_metropoliceSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Npc_metropoliceSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Npc_metropoliceSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("npc_metropolice");
    }
}

enum abstract Npc_metropolicewakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_metropolicewaitingtorappelChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_metropolicesleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Npc_metropolicerendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Npc_metropolicerenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Npc_metropoliceignoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_metropolicehintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_metropolicegmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_metropolicedisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_metropolicedisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_metropoliceadditionalequipmentChoices(String) to String {
...
enum abstract Npc_metropoliceSpawnFlags(Int) to Int {
	...
	var SIMPLE_COPS = 131072;
	var RAPPEL_UNCHECK_THIS_IF_IT_IS_CHECKED = 262144;
	var ALWAYS_STITCH = 524288;
	var NO_CHATTER = 1048576;
	var ARREST_ENEMIES = 2097152;
	var NO_FAR_STITCHING = 4194304;
	var PREVENT_MANHACK_TOSS = 8388608;
	var ALLOWED_TO_RESPOND_TO_THROWN_OBJECTS = 16777216;
	var MIDRANGE_ATTACKS_HALFWAY_BETWEEN_NORMAL__LONGRANGE = 33554432;
}
