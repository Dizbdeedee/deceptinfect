...
**/
@:forward
abstract Item_ammo_smg1(Entity) to Entity {
    //Inputs
	...
	**/
    public var gmod_allowphysgun(get,set):Item_ammo_smg1gmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Item_ammo_smg1gmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Item_ammo_smg1gmod_allowphysgunChoices):Item_ammo_smg1gmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Item_ammo_smg1disableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Item_ammo_smg1disableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Item_ammo_smg1disableshadowsChoices):Item_ammo_smg1disableshadowsChoices {
	...
	**/
    public extern inline function OutputOnPlayerTouch(callback:Callback<{activator:Item_ammo_smg1}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnCacheInteraction(callback:Callback<{activator:Item_ammo_smg1}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Item_ammo_smg1}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Item_ammo_smg1}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Item_ammo_smg1}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Item_ammo_smg1}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Item_ammo_smg1SpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Item_ammo_smg1SpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Item_ammo_smg1SpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("item_ammo_smg1");
    }
}

enum abstract Item_ammo_smg1gmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Item_ammo_smg1disableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Item_ammo_smg1SpawnFlags(Int) to Int {
