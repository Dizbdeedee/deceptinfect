...
**/
@:forward
abstract Move_rope(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Minimum DX Level
	**/
    public var mindxlevel(get,set):Move_ropemindxlevelChoices;

    @:noCompletion
    public extern inline function get_mindxlevel():Move_ropemindxlevelChoices {
        return untyped this.GetKeyValues().mindxlevel;
    }
    
    @:noCompletion
    public extern inline function set_mindxlevel(value:Move_ropemindxlevelChoices):Move_ropemindxlevelChoices {
    ...
    /**
		Maximum DX Level
	**/
    public var maxdxlevel(get,set):Move_ropemaxdxlevelChoices;

    @:noCompletion
    public extern inline function get_maxdxlevel():Move_ropemaxdxlevelChoices {
        return untyped this.GetKeyValues().maxdxlevel;
    }
    
    @:noCompletion
    public extern inline function set_maxdxlevel(value:Move_ropemaxdxlevelChoices):Move_ropemaxdxlevelChoices {
	...
	**/
    ...
    /**
		Type
	**/
    public var Type(get,set):Move_ropeTypeChoices;

    @:noCompletion
    public extern inline function get_Type():Move_ropeTypeChoices {
        return untyped this.GetKeyValues().Type;
    }
    
    @:noCompletion
    public extern inline function set_Type(value:Move_ropeTypeChoices):Move_ropeTypeChoices {
	...
	**/
    public var Barbed(get,set):Move_ropeBarbedChoices;

    @:noCompletion
    public extern inline function get_Barbed():Move_ropeBarbedChoices {
        return untyped this.GetKeyValues().Barbed;
    }
    
    @:noCompletion
    public extern inline function set_Barbed(value:Move_ropeBarbedChoices):Move_ropeBarbedChoices {
	...
	**/
    ...
    /**
		Collide with world
	**/
    public var Collide(get,set):Move_ropeCollideChoices;

    @:noCompletion
    public extern inline function get_Collide():Move_ropeCollideChoices {
        return untyped this.GetKeyValues().Collide;
    }
    
    @:noCompletion
    public extern inline function set_Collide(value:Move_ropeCollideChoices):Move_ropeCollideChoices {
	...
	**/
    public var Dangling(get,set):Move_ropeDanglingChoices;

    @:noCompletion
    public extern inline function get_Dangling():Move_ropeDanglingChoices {
        return untyped this.GetKeyValues().Dangling;
    }
    
    @:noCompletion
    public extern inline function set_Dangling(value:Move_ropeDanglingChoices):Move_ropeDanglingChoices {
	...
	**/
    public var Breakable(get,set):Move_ropeBreakableChoices;

    @:noCompletion
    public extern inline function get_Breakable():Move_ropeBreakableChoices {
        return untyped this.GetKeyValues().Breakable;
    }
    
    @:noCompletion
    public extern inline function set_Breakable(value:Move_ropeBreakableChoices):Move_ropeBreakableChoices {
	...
	**/
    public var NoWind(get,set):Move_ropeNoWindChoices;

    @:noCompletion
    public extern inline function get_NoWind():Move_ropeNoWindChoices {
        return untyped this.GetKeyValues().NoWind;
    }
    
    @:noCompletion
    public extern inline function set_NoWind(value:Move_ropeNoWindChoices):Move_ropeNoWindChoices {
	...
	**/
    public var PositionInterpolator(get,set):Move_ropePositionInterpolatorChoices;

    @:noCompletion
    public extern inline function get_PositionInterpolator():Move_ropePositionInterpolatorChoices {
        return untyped this.GetKeyValues().PositionInterpolator;
    }
    
    @:noCompletion
    public extern inline function set_PositionInterpolator(value:Move_ropePositionInterpolatorChoices):Move_ropePositionInterpolatorChoices {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Move_rope}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Move_rope}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Move_rope}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Move_rope}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Move_ropeSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Move_ropeSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Move_ropeSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("move_rope");
    }
}

enum abstract Move_ropemindxlevelChoices(Int) to Int {
...
enum abstract Move_ropemaxdxlevelChoices(Int) to Int {
...
enum abstract Move_ropeTypeChoices(Int) to Int {
	var ROPE = 0;
	var SEMIRIGID = 1;
	var RIGID = 2;
}
enum abstract Move_ropePositionInterpolatorChoices(Int) to Int {
	var LINEAR = 0;
	var CATMULLROM_SPLINE = 1;
	var ROPE = 2;
}
enum abstract Move_ropeNoWindChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Move_ropeDanglingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Move_ropeCollideChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Move_ropeBreakableChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Move_ropeBarbedChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Move_ropeSpawnFlags(Int) to Int {
	var AUTO_RESIZE = 1;
}
