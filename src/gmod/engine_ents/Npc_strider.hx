...
**/
@:forward
abstract Npc_strider(NPC) to Entity to NPC {
    //Inputs
	...
	**/
    public extern inline function FireSetMinigunTime(param:Float,delay:Float) {
        untyped this.Fire("SetMinigunTime",untyped param,delay);
    }
    
    /**
		Strider will shoot minigun at this
	**/
    public extern inline function FireSetMinigunTarget(param:String,delay:Float) {
        untyped this.Fire("SetMinigunTarget",untyped param,delay);
    }
    
    /**
		Disables the minigun until further notice by the EnableMinigun input.
	**/
    public extern inline function FireDisableMinigun(delay:Float) {
        untyped this.Fire("DisableMinigun",untyped null,delay);
    }
    
    /**
		Enables the minigun if it was disabled by the DisableMinigun input.
	**/
    public extern inline function FireEnableMinigun(delay:Float) {
        untyped this.Fire("EnableMinigun",untyped null,delay);
    }
    
    /**
		Strider will shoot cannon at this
	**/
    public extern inline function FireSetCannonTarget(param:String,delay:Float) {
        untyped this.Fire("SetCannonTarget",untyped param,delay);
    }
    
    /**
		Strider will flick anyone he's skewered
	**/
    public extern inline function FireFlickRagdoll(delay:Float) {
        untyped this.Fire("FlickRagdoll",untyped null,delay);
    }
	...
	**/
    ...
    /**
		Crouch down
	**/
    public extern inline function FireCrouch(delay:Float) {
        untyped this.Fire("Crouch",untyped null,delay);
    }
    
    /**
		Crouch instantly. This makes the Strider pop to a crouch. Do not do this where players can observe.
	**/
    public extern inline function FireCrouchInstantly(delay:Float) {
        untyped this.Fire("CrouchInstantly",untyped null,delay);
    }
    
    /**
		Stand up from crouch
	**/
    public extern inline function FireStand(delay:Float) {
        untyped this.Fire("Stand",untyped null,delay);
    }
    
    /**
		Set a path for the strider to patrol. The strider will first move to the closest point on the path
	**/
    public extern inline function FireSetTargetPath(param:String,delay:Float) {
        untyped this.Fire("SetTargetPath",untyped param,delay);
    }
    
    /**
		Clear the strider patrol path
	**/
    public extern inline function FireClearTargetPath(delay:Float) {
        untyped this.Fire("ClearTargetPath",untyped null,delay);
    }
    
    /**
		Use aggressive behavior. Fire faster, more frequently
	**/
    public extern inline function FireEnableAggressiveBehavior(delay:Float) {
        untyped this.Fire("EnableAggressiveBehavior",untyped null,delay);
    }
    
    /**
		Stop using aggressive behavior. (Revert to normal)
	**/
    public extern inline function FireDisableAggressiveBehavior(delay:Float) {
        untyped this.Fire("DisableAggressiveBehavior",untyped null,delay);
    }
    
    /**
		Stop shooting the minigun for a period of time (specify seconds as parameter)
	**/
    public extern inline function FireStopShootingMinigunForSeconds(param:Float,delay:Float) {
        untyped this.Fire("StopShootingMinigunForSeconds",untyped param,delay);
    }
    
    /**
		Prevent the Strider from crouching
	**/
    public extern inline function FireDisableCrouch(delay:Float) {
        untyped this.Fire("DisableCrouch",untyped null,delay);
    }
    
    /**
		Prevent the Strider from seeking Line of Sight to target. (Hold position)
	**/
    public extern inline function FireDisableMoveToLOS(delay:Float) {
        untyped this.Fire("DisableMoveToLOS",untyped null,delay);
    }
    
    /**
		Disable collision with a given object.
	**/
    public extern inline function FireDisableCollisionWith(param:String,delay:Float) {
        untyped this.Fire("DisableCollisionWith",untyped param,delay);
    }
    
    /**
		Reenable collision with a given object.
	**/
    public extern inline function FireEnableCollisionWith(param:String,delay:Float) {
        untyped this.Fire("EnableCollisionWith",untyped param,delay);
    }
    
    /**
		Scale the movement speed of the strider
	**/
    public extern inline function FireScaleGroundSpeed(param:Float,delay:Float) {
        untyped this.Fire("ScaleGroundSpeed",untyped param,delay);
    }
	...
	**/
    public var hintlimiting(get,set):Npc_striderhintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Npc_striderhintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Npc_striderhintlimitingChoices):Npc_striderhintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Npc_stridersleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Npc_stridersleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Npc_stridersleepstateChoices):Npc_stridersleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Npc_striderwakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Npc_striderwakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Npc_striderwakesquadChoices):Npc_striderwakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Npc_striderignoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Npc_striderignoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Npc_striderignoreunseenenemiesChoices):Npc_striderignoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Npc_stridergmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Npc_stridergmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Npc_stridergmod_allowphysgunChoices):Npc_stridergmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Npc_striderrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Npc_striderrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Npc_striderrendermodeChoices):Npc_striderrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Npc_striderdisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Npc_striderdisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Npc_striderdisablereceiveshadowsChoices):Npc_striderdisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Npc_striderrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Npc_striderrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Npc_striderrenderfxChoices):Npc_striderrenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Npc_striderdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Npc_striderdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Npc_striderdisableshadowsChoices):Npc_striderdisableshadowsChoices {
	...
	**/
    ...
    /**
		...
		Standard strider
	**/
    public var model(get,set):Npc_stridermodelChoices;

    @:noCompletion
    public extern inline function get_model():Npc_stridermodelChoices {
        return untyped this.GetKeyValues().model;
    }
    
    @:noCompletion
    public extern inline function set_model(value:Npc_stridermodelChoices):Npc_stridermodelChoices {
	...
	**/
    public var disablephysics(get,set):Npc_striderdisablephysicsChoices;

    @:noCompletion
    public extern inline function get_disablephysics():Npc_striderdisablephysicsChoices {
        return untyped this.GetKeyValues().disablephysics;
    }
    
    @:noCompletion
    public extern inline function set_disablephysics(value:Npc_striderdisablephysicsChoices):Npc_striderdisablephysicsChoices {
        return untyped this.SetKeyValue("disablephysics",untyped value);
    }
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Npc_strider}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Npc_strider}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Npc_strider}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Npc_strider}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Npc_strider}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Npc_strider}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Npc_strider,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Npc_strider}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Npc_strider}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Npc_strider,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Npc_strider}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Npc_strider}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Npc_strider}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Npc_strider}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Npc_strider}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Npc_strider}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Npc_strider}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Npc_strider}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Npc_strider}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Npc_strider}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Npc_strider}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Npc_strider}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Npc_strider}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Npc_strider}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Npc_striderSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Npc_striderSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Npc_striderSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("npc_strider");
    }
}

enum abstract Npc_striderwakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_stridersleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Npc_striderrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Npc_striderrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Npc_stridermodelChoices(String) to String {
	var STANDARD_STRIDER = "models/combine_strider.mdl";
	var THE_STRIDER_THAT_FIGHTS_DOG = "models/combine_strider_vsdog.mdl";
}
enum abstract Npc_striderignoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_striderhintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_stridergmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_striderdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_striderdisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_striderdisablephysicsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Npc_striderSpawnFlags(Int) to Int {
	...
	var CAN_STOMP_PLAYER = 65536;
	var MINIMAL_DAMAGE_TAKEN_FROM_NPCS_1_POINT_PER_MISSILE = 131072;
}
