...
**/
@:forward
abstract Npc_combine_cannon(NPC) to Entity to NPC {
    //Inputs
	...
	**/
    public var hintlimiting(get,set):Npc_combine_cannonhintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Npc_combine_cannonhintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Npc_combine_cannonhintlimitingChoices):Npc_combine_cannonhintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Npc_combine_cannonsleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Npc_combine_cannonsleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Npc_combine_cannonsleepstateChoices):Npc_combine_cannonsleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Npc_combine_cannonwakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Npc_combine_cannonwakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Npc_combine_cannonwakesquadChoices):Npc_combine_cannonwakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Npc_combine_cannonignoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Npc_combine_cannonignoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Npc_combine_cannonignoreunseenenemiesChoices):Npc_combine_cannonignoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Npc_combine_cannongmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Npc_combine_cannongmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Npc_combine_cannongmod_allowphysgunChoices):Npc_combine_cannongmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Npc_combine_cannonrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Npc_combine_cannonrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Npc_combine_cannonrendermodeChoices):Npc_combine_cannonrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Npc_combine_cannondisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Npc_combine_cannondisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Npc_combine_cannondisablereceiveshadowsChoices):Npc_combine_cannondisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Npc_combine_cannonrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Npc_combine_cannonrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Npc_combine_cannonrenderfxChoices):Npc_combine_cannonrenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Npc_combine_cannondisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Npc_combine_cannondisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Npc_combine_cannondisableshadowsChoices):Npc_combine_cannondisableshadowsChoices {
	...
	**/
    ...
    /**
		...
		Radius distance at which the cannon is able to aquire enemies.
	**/
    public var sightdist(get,set):Float;

    @:noCompletion
    public extern inline function get_sightdist():Float {
        return untyped this.GetKeyValues().sightdist;
    }
    
    @:noCompletion
    public extern inline function set_sightdist(value:Float):Float {
        return untyped this.SetKeyValue("sightdist",untyped value);
    }
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Npc_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Npc_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Npc_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Npc_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Npc_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Npc_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Npc_combine_cannon,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Npc_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Npc_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Npc_combine_cannon,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Npc_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Npc_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Npc_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Npc_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Npc_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Npc_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Npc_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Npc_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Npc_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Npc_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Npc_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Npc_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Npc_combine_cannon}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Npc_combine_cannon}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Npc_combine_cannonSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Npc_combine_cannonSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Npc_combine_cannonSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("npc_combine_cannon");
    }
}

enum abstract Npc_combine_cannonwakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_combine_cannonsleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Npc_combine_cannonrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Npc_combine_cannonrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Npc_combine_cannonignoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_combine_cannonhintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_combine_cannongmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_combine_cannondisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_combine_cannondisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Npc_combine_cannonSpawnFlags(Int) to Int {
