...
**/
@:forward
abstract Npc_monk(NPC) to Entity to NPC {
    //Inputs
	...
	**/
    ...
    /**
		Make every shot at a zombie a headshot
	**/
    public extern inline function FirePerfectAccuracyOn(delay:Float) {
        untyped this.Fire("PerfectAccuracyOn",untyped null,delay);
    }
    
    /**
		Return to normal accuracy
	**/
    public extern inline function FirePerfectAccuracyOff(delay:Float) {
        untyped this.Fire("PerfectAccuracyOff",untyped null,delay);
    }
	...
	**/
    public var hintlimiting(get,set):Npc_monkhintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Npc_monkhintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Npc_monkhintlimitingChoices):Npc_monkhintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Npc_monksleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Npc_monksleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Npc_monksleepstateChoices):Npc_monksleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Npc_monkwakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Npc_monkwakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Npc_monkwakesquadChoices):Npc_monkwakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Npc_monkignoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Npc_monkignoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Npc_monkignoreunseenenemiesChoices):Npc_monkignoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Npc_monkgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Npc_monkgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Npc_monkgmod_allowphysgunChoices):Npc_monkgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Npc_monkrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Npc_monkrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Npc_monkrendermodeChoices):Npc_monkrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Npc_monkdisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Npc_monkdisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Npc_monkdisablereceiveshadowsChoices):Npc_monkdisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Npc_monkrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Npc_monkrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Npc_monkrenderfxChoices):Npc_monkrenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Npc_monkdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Npc_monkdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Npc_monkdisableshadowsChoices):Npc_monkdisableshadowsChoices {
	...
	**/
    public var DontUseSpeechSemaphore(get,set):Npc_monkDontUseSpeechSemaphoreChoices;

    @:noCompletion
    public extern inline function get_DontUseSpeechSemaphore():Npc_monkDontUseSpeechSemaphoreChoices {
        return untyped this.GetKeyValues().DontUseSpeechSemaphore;
    }
    
    @:noCompletion
    public extern inline function set_DontUseSpeechSemaphore(value:Npc_monkDontUseSpeechSemaphoreChoices):Npc_monkDontUseSpeechSemaphoreChoices {
	...
	**/
    ...
    /**
		Weapons
	**/
    public var additionalequipment(get,set):Npc_monkadditionalequipmentChoices;

    @:noCompletion
    public extern inline function get_additionalequipment():Npc_monkadditionalequipmentChoices {
        return untyped this.GetKeyValues().additionalequipment;
    }
    
    @:noCompletion
    public extern inline function set_additionalequipment(value:Npc_monkadditionalequipmentChoices):Npc_monkadditionalequipmentChoices {
    ...
    /**
		Has Gun
	**/
    public var HasGun(get,set):Npc_monkHasGunChoices;

    @:noCompletion
    public extern inline function get_HasGun():Npc_monkHasGunChoices {
        return untyped this.GetKeyValues().HasGun;
    }
    
    @:noCompletion
    public extern inline function set_HasGun(value:Npc_monkHasGunChoices):Npc_monkHasGunChoices {
        return untyped this.SetKeyValue("HasGun",untyped value);
    }
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Npc_monk}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Npc_monk}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Npc_monk}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Npc_monk}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Npc_monk}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Npc_monk}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Npc_monk,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Npc_monk}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Npc_monk}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Npc_monk,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Npc_monk}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Npc_monk}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Npc_monk}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Npc_monk}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Npc_monk}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Npc_monk}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Npc_monk}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Npc_monk}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Npc_monk}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Npc_monk}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Npc_monk}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Npc_monk}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Npc_monk}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Npc_monk}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Npc_monkSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Npc_monkSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Npc_monkSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("npc_monk");
    }
}

enum abstract Npc_monkwakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_monksleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Npc_monkrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Npc_monkrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Npc_monkignoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_monkhintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_monkgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_monkdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_monkdisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_monkadditionalequipmentChoices(String) to String {
	var ANNABELLE = "weapon_annabelle";
...
enum abstract Npc_monkHasGunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_monkDontUseSpeechSemaphoreChoices(Int) to Int {
	var NO_USE_SPEECH_SEMAPHORE = 0;
	var YES_DONT_USE_SPEECH_SEMAPHORE = 1;
}


enum abstract Npc_monkSpawnFlags(Int) to Int {
