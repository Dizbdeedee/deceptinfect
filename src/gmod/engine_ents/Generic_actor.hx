...
**/
@:forward
abstract Generic_actor(Entity) to Entity {
    //Inputs
	...
	**/
    public var hintlimiting(get,set):Generic_actorhintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Generic_actorhintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Generic_actorhintlimitingChoices):Generic_actorhintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Generic_actorsleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Generic_actorsleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Generic_actorsleepstateChoices):Generic_actorsleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Generic_actorwakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Generic_actorwakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Generic_actorwakesquadChoices):Generic_actorwakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Generic_actorignoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Generic_actorignoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Generic_actorignoreunseenenemiesChoices):Generic_actorignoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Generic_actorgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Generic_actorgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Generic_actorgmod_allowphysgunChoices):Generic_actorgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Generic_actorrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Generic_actorrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Generic_actorrendermodeChoices):Generic_actorrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Generic_actordisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Generic_actordisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Generic_actordisablereceiveshadowsChoices):Generic_actordisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Generic_actorrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Generic_actorrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Generic_actorrenderfxChoices):Generic_actorrenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Generic_actordisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Generic_actordisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Generic_actordisableshadowsChoices):Generic_actordisableshadowsChoices {
	...
	**/
    ...
    /**
		Hull type
	**/
    public var hull_name(get,set):Generic_actorhull_nameChoices;

    @:noCompletion
    public extern inline function get_hull_name():Generic_actorhull_nameChoices {
        return untyped this.GetKeyValues().hull_name;
    }
    
    @:noCompletion
    public extern inline function set_hull_name(value:Generic_actorhull_nameChoices):Generic_actorhull_nameChoices {
        return untyped this.SetKeyValue("hull_name",untyped value);
    }
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Generic_actor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Generic_actor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Generic_actor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Generic_actor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Generic_actor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Generic_actor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Generic_actor,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Generic_actor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Generic_actor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Generic_actor,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Generic_actor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Generic_actor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Generic_actor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Generic_actor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Generic_actor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Generic_actor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Generic_actor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Generic_actor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Generic_actor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Generic_actor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Generic_actor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Generic_actor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Generic_actor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Generic_actor}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Generic_actorSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Generic_actorSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Generic_actorSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("generic_actor");
    }
}

enum abstract Generic_actorwakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Generic_actorsleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Generic_actorrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Generic_actorrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Generic_actorignoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Generic_actorhull_nameChoices(String) to String {
	var HUMAN = "HUMAN_HULL";
	var WIDE = "WIDE_HUMAN_HULL";
	var TINY = "TINY_HULL";
	var MEDIUM = "MEDIUM_HULL";
	var LARGE = "LARGE_HULL";
}
enum abstract Generic_actorhintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Generic_actorgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Generic_actordisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Generic_actordisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Generic_actorSpawnFlags(Int) to Int {
