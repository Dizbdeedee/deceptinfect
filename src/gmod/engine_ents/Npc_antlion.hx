...
**/
@:forward
abstract Npc_antlion(NPC) to Entity to NPC {
    //Inputs
	...
	**/
    public extern inline function FireBurrow(delay:Float) {
        untyped this.Fire("Burrow",untyped null,delay);
    }
    
    /**
		Burrow into the ground and remove the antlion
	**/
    public extern inline function FireBurrowAway(delay:Float) {
        untyped this.Fire("BurrowAway",untyped null,delay);
    }
    
    /**
		Fight to position
	**/
    public extern inline function FireFightToPosition(param:String,delay:Float) {
        untyped this.Fire("FightToPosition",untyped param,delay);
    }
    
    /**
		Allow non-navigational jumping
	**/
    public extern inline function FireEnableJump(delay:Float) {
        untyped this.Fire("EnableJump",untyped null,delay);
    }
    
    /**
		Disallow non-navigational jumping
	**/
    public extern inline function FireDisableJump(delay:Float) {
        untyped this.Fire("DisableJump",untyped null,delay);
    }
    
    /**
		Ignore bugbait
	**/
    public extern inline function FireIgnoreBugbait(delay:Float) {
        untyped this.Fire("IgnoreBugbait",untyped null,delay);
    }
    
    /**
		Hear bugbait
	**/
    public extern inline function FireHearBugbait(delay:Float) {
        untyped this.Fire("HearBugbait",untyped null,delay);
    }
	...
	**/
    public var hintlimiting(get,set):Npc_antlionhintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Npc_antlionhintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Npc_antlionhintlimitingChoices):Npc_antlionhintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Npc_antlionsleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Npc_antlionsleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Npc_antlionsleepstateChoices):Npc_antlionsleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Npc_antlionwakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Npc_antlionwakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Npc_antlionwakesquadChoices):Npc_antlionwakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Npc_antlionignoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Npc_antlionignoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Npc_antlionignoreunseenenemiesChoices):Npc_antlionignoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Npc_antliongmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Npc_antliongmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Npc_antliongmod_allowphysgunChoices):Npc_antliongmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Npc_antlionrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Npc_antlionrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Npc_antlionrendermodeChoices):Npc_antlionrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Npc_antliondisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Npc_antliondisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Npc_antliondisablereceiveshadowsChoices):Npc_antliondisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Npc_antlionrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Npc_antlionrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Npc_antlionrenderfxChoices):Npc_antlionrenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Npc_antliondisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Npc_antliondisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Npc_antliondisableshadowsChoices):Npc_antliondisableshadowsChoices {
	...
	**/
    ...
    /**
		Start Burrowed
	**/
    public var startburrowed(get,set):Npc_antlionstartburrowedChoices;

    @:noCompletion
    public extern inline function get_startburrowed():Npc_antlionstartburrowedChoices {
        return untyped this.GetKeyValues().startburrowed;
    }
    
    @:noCompletion
    public extern inline function set_startburrowed(value:Npc_antlionstartburrowedChoices):Npc_antlionstartburrowedChoices {
	...
	**/
    public var eludedist(get,set):Int;

    @:noCompletion
    public extern inline function get_eludedist():Int {
        return untyped this.GetKeyValues().eludedist;
    }
    
    @:noCompletion
    public extern inline function set_eludedist(value:Int):Int {
        return untyped this.SetKeyValue("eludedist",untyped value);
    }
    
    /**
		Ignore Bugbait
	**/
    public var ignorebugbait(get,set):Npc_antlionignorebugbaitChoices;

    @:noCompletion
    public extern inline function get_ignorebugbait():Npc_antlionignorebugbaitChoices {
        return untyped this.GetKeyValues().ignorebugbait;
    }
    
    @:noCompletion
    public extern inline function set_ignorebugbait(value:Npc_antlionignorebugbaitChoices):Npc_antlionignorebugbaitChoices {
	...
	**/
    public var unburroweffects(get,set):Npc_antlionunburroweffectsChoices;

    @:noCompletion
    public extern inline function get_unburroweffects():Npc_antlionunburroweffectsChoices {
        return untyped this.GetKeyValues().unburroweffects;
    }
    
    @:noCompletion
    public extern inline function set_unburroweffects(value:Npc_antlionunburroweffectsChoices):Npc_antlionunburroweffectsChoices {
        return untyped this.SetKeyValue("unburroweffects",untyped value);
    }
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Npc_antlion}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Npc_antlion}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Npc_antlion}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Npc_antlion}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Npc_antlion}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Npc_antlion}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Npc_antlion,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Npc_antlion}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Npc_antlion}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Npc_antlion,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Npc_antlion}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Npc_antlion}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Npc_antlion}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Npc_antlion}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Npc_antlion}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Npc_antlion}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Npc_antlion}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Npc_antlion}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Npc_antlion}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Npc_antlion}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Npc_antlion}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Npc_antlion}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Npc_antlion}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Npc_antlion}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnReachedFightGoal(callback:Callback<{activator:Npc_antlion}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnReachedFightGoal",callback);
    }
    
    /**
		Fires when the antlion unburrows
	**/
    public extern inline function OutputOnUnBurrowed(callback:Callback<{activator:Npc_antlion}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUnBurrowed",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Npc_antlionSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Npc_antlionSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Npc_antlionSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("npc_antlion");
    }
}

enum abstract Npc_antlionwakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_antlionunburroweffectsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_antlionstartburrowedChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_antlionsleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Npc_antlionrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Npc_antlionrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Npc_antlionignoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_antlionignorebugbaitChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_antlionhintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_antliongmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_antliondisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_antliondisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Npc_antlionSpawnFlags(Int) to Int {
	...
	var BURROW_WHEN_ELUDED = 65536;
	var USE_GROUND_CHECKS = 131072;
	var WORKER_TYPE = 262144;
}
