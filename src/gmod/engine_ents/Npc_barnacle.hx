...
**/
@:forward
abstract Npc_barnacle(NPC) to Entity to NPC {
    //Inputs
	...
	**/
    ...
    /**
		Drop tongue
	**/
    public extern inline function FireDropTongue(delay:Float) {
        untyped this.Fire("DropTongue",untyped null,delay);
    }
    
    /**
		Set Drop Tongue speed
	**/
    public extern inline function FireSetDropTongueSpeed(param:Int,delay:Float) {
        untyped this.Fire("SetDropTongueSpeed",untyped param,delay);
    }
    
    /**
		Let go of anything I am holding.
	**/
    public extern inline function FireLetGo(delay:Float) {
        untyped this.Fire("LetGo",untyped null,delay);
    }
	...
	**/
    public var hintlimiting(get,set):Npc_barnaclehintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Npc_barnaclehintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Npc_barnaclehintlimitingChoices):Npc_barnaclehintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Npc_barnaclesleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Npc_barnaclesleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Npc_barnaclesleepstateChoices):Npc_barnaclesleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Npc_barnaclewakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Npc_barnaclewakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Npc_barnaclewakesquadChoices):Npc_barnaclewakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Npc_barnacleignoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Npc_barnacleignoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Npc_barnacleignoreunseenenemiesChoices):Npc_barnacleignoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Npc_barnaclegmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Npc_barnaclegmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Npc_barnaclegmod_allowphysgunChoices):Npc_barnaclegmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Npc_barnaclerendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Npc_barnaclerendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Npc_barnaclerendermodeChoices):Npc_barnaclerendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Npc_barnacledisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Npc_barnacledisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Npc_barnacledisablereceiveshadowsChoices):Npc_barnacledisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Npc_barnaclerenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Npc_barnaclerenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Npc_barnaclerenderfxChoices):Npc_barnaclerenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Npc_barnacledisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Npc_barnacledisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Npc_barnacledisableshadowsChoices):Npc_barnacledisableshadowsChoices {
	...
	**/
    public var RestDist(get,set):Float;

    @:noCompletion
    public extern inline function get_RestDist():Float {
        return untyped this.GetKeyValues().RestDist;
    }
    
    @:noCompletion
    public extern inline function set_RestDist(value:Float):Float {
        return untyped this.SetKeyValue("RestDist",untyped value);
    }
	...
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Npc_barnacle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Npc_barnacle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Npc_barnacle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Npc_barnacle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Npc_barnacle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Npc_barnacle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Npc_barnacle,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Npc_barnacle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Npc_barnacle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Npc_barnacle,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Npc_barnacle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Npc_barnacle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Npc_barnacle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Npc_barnacle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Npc_barnacle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Npc_barnacle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Npc_barnacle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Npc_barnacle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Npc_barnacle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Npc_barnacle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Npc_barnacle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Npc_barnacle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Npc_barnacle}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Npc_barnacle}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnUser4",callback);
    }
    
    /**
		When I attach my tongue to something
	**/
    public extern inline function OutputOnGrab(callback:Callback<{activator:Npc_barnacle,data:String}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnGrab",callback);
    }
    
    /**
		When I let go of something
	**/
    public extern inline function OutputOnRelease(callback:Callback<{activator:Npc_barnacle,data:String}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnRelease",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Npc_barnacleSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Npc_barnacleSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Npc_barnacleSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("npc_barnacle");
    }
}

enum abstract Npc_barnaclewakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_barnaclesleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Npc_barnaclerendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Npc_barnaclerenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Npc_barnacleignoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_barnaclehintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_barnaclegmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_barnacledisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_barnacledisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Npc_barnacleSpawnFlags(Int) to Int {
	...
	var CHEAP_DEATH = 65536;
	var AMBUSH_MODE = 131072;
}
