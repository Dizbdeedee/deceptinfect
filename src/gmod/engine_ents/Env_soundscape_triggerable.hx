...
**/
@:forward
abstract Env_soundscape_triggerable(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Start Disabled
	**/
    public var StartDisabled(get,set):Env_soundscape_triggerableStartDisabledChoices;

    @:noCompletion
    public extern inline function get_StartDisabled():Env_soundscape_triggerableStartDisabledChoices {
        return untyped this.GetKeyValues().StartDisabled;
    }
    
    @:noCompletion
    public extern inline function set_StartDisabled(value:Env_soundscape_triggerableStartDisabledChoices):Env_soundscape_triggerableStartDisabledChoices {
	...
	**/
    public var soundscape(get,set):Env_soundscape_triggerablesoundscapeChoices;

    @:noCompletion
    public extern inline function get_soundscape():Env_soundscape_triggerablesoundscapeChoices {
        return untyped this.GetKeyValues().soundscape;
    }
    
    @:noCompletion
    public extern inline function set_soundscape(value:Env_soundscape_triggerablesoundscapeChoices):Env_soundscape_triggerablesoundscapeChoices {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Env_soundscape_triggerable}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Env_soundscape_triggerable}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Env_soundscape_triggerable}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Env_soundscape_triggerable}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPlay(callback:Callback<{activator:Env_soundscape_triggerable}>):CallbackLink {
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("env_soundscape_triggerable");
    }
}

enum abstract Env_soundscape_triggerablesoundscapeChoices(String) to String {
	var NOTHING = "Nothing";
...
enum abstract Env_soundscape_triggerableStartDisabledChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
