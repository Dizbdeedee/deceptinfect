...
**/
@:forward
abstract Item_suitcharger(Entity) to Entity {
    //Inputs
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Item_suitcharger}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Item_suitcharger}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Item_suitcharger}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Item_suitcharger}>):CallbackLink {
    ...
    /**
		Remaining Charge.
	**/
    public extern inline function OutputOutRemainingCharge(callback:Callback<{activator:Item_suitcharger,data:Float}>):CallbackLink {
    ...
    /**
		Half-Empty
	**/
    public extern inline function OutputOnHalfEmpty(callback:Callback<{activator:Item_suitcharger}>):CallbackLink {
    ...
    /**
		Empty
	**/
    public extern inline function OutputOnEmpty(callback:Callback<{activator:Item_suitcharger}>):CallbackLink {
    ...
    /**
		Recharged to full.
	**/
    public extern inline function OutputOnFull(callback:Callback<{activator:Item_suitcharger}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPlayerUse(callback:Callback<{activator:Item_suitcharger}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnPlayerUse",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Item_suitchargerSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Item_suitchargerSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Item_suitchargerSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("item_suitcharger");
    }
}



enum abstract Item_suitchargerSpawnFlags(Int) to Int {
	var CITADEL_RECHARGER = 8192;
	var KLEINERS_RECHARGER = 16384;
}
