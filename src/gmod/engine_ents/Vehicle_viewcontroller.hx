...
**/
@:forward
abstract Vehicle_viewcontroller(Entity) to Entity {
    //Inputs
	...
	**/
    public extern inline function FireForcePlayerIn(param:String,delay:Float) {
        untyped this.Fire("ForcePlayerIn",untyped param,delay);
    }
    
    /**
		Force the player out of the vehicle.
	**/
    public extern inline function FireForcePlayerOut(delay:Float) {
        untyped this.Fire("ForcePlayerOut",untyped null,delay);
    }
	...
	**/
    ...
    /**
		Start locked
	**/
    public var VehicleLocked(get,set):Vehicle_viewcontrollerVehicleLockedChoices;

    @:noCompletion
    public extern inline function get_VehicleLocked():Vehicle_viewcontrollerVehicleLockedChoices {
        return untyped this.GetKeyValues().VehicleLocked;
    }
    
    @:noCompletion
    public extern inline function set_VehicleLocked(value:Vehicle_viewcontrollerVehicleLockedChoices):Vehicle_viewcontrollerVehicleLockedChoices {
	...
	**/
    ...
    /**
		Minimum DX Level
	**/
    public var mindxlevel(get,set):Vehicle_viewcontrollermindxlevelChoices;

    @:noCompletion
    public extern inline function get_mindxlevel():Vehicle_viewcontrollermindxlevelChoices {
        return untyped this.GetKeyValues().mindxlevel;
    }
    
    @:noCompletion
    public extern inline function set_mindxlevel(value:Vehicle_viewcontrollermindxlevelChoices):Vehicle_viewcontrollermindxlevelChoices {
    ...
    /**
		Maximum DX Level
	**/
    public var maxdxlevel(get,set):Vehicle_viewcontrollermaxdxlevelChoices;

    @:noCompletion
    public extern inline function get_maxdxlevel():Vehicle_viewcontrollermaxdxlevelChoices {
        return untyped this.GetKeyValues().maxdxlevel;
    }
    
    @:noCompletion
    public extern inline function set_maxdxlevel(value:Vehicle_viewcontrollermaxdxlevelChoices):Vehicle_viewcontrollermaxdxlevelChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Vehicle_viewcontrollergmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Vehicle_viewcontrollergmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Vehicle_viewcontrollergmod_allowphysgunChoices):Vehicle_viewcontrollergmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    ...
    /**
		Collisions
	**/
    public var solid(get,set):Vehicle_viewcontrollersolidChoices;

    @:noCompletion
    public extern inline function get_solid():Vehicle_viewcontrollersolidChoices {
        return untyped this.GetKeyValues().solid;
    }
    
    @:noCompletion
    public extern inline function set_solid(value:Vehicle_viewcontrollersolidChoices):Vehicle_viewcontrollersolidChoices {
    ...
    /**
		Disable Shadows
	**/
    public var disableshadows(get,set):Vehicle_viewcontrollerdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Vehicle_viewcontrollerdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Vehicle_viewcontrollerdisableshadowsChoices):Vehicle_viewcontrollerdisableshadowsChoices {
	...
	**/
    public var screenspacefade(get,set):Vehicle_viewcontrollerscreenspacefadeChoices;

    @:noCompletion
    public extern inline function get_screenspacefade():Vehicle_viewcontrollerscreenspacefadeChoices {
        return untyped this.GetKeyValues().screenspacefade;
    }
    
    @:noCompletion
    public extern inline function set_screenspacefade(value:Vehicle_viewcontrollerscreenspacefadeChoices):Vehicle_viewcontrollerscreenspacefadeChoices {
	...
	**/
    public var disablevertexlighting(get,set):Vehicle_viewcontrollerdisablevertexlightingChoices;

    @:noCompletion
    public extern inline function get_disablevertexlighting():Vehicle_viewcontrollerdisablevertexlightingChoices {
        return untyped this.GetKeyValues().disablevertexlighting;
    }
    
    @:noCompletion
    public extern inline function set_disablevertexlighting(value:Vehicle_viewcontrollerdisablevertexlightingChoices):Vehicle_viewcontrollerdisablevertexlightingChoices {
	...
	**/
    public var disableselfshadowing(get,set):Vehicle_viewcontrollerdisableselfshadowingChoices;

    @:noCompletion
    public extern inline function get_disableselfshadowing():Vehicle_viewcontrollerdisableselfshadowingChoices {
        return untyped this.GetKeyValues().disableselfshadowing;
    }
    
    @:noCompletion
    public extern inline function set_disableselfshadowing(value:Vehicle_viewcontrollerdisableselfshadowingChoices):Vehicle_viewcontrollerdisableselfshadowingChoices {
	...
	**/
    public var ignorenormals(get,set):Vehicle_viewcontrollerignorenormalsChoices;

    @:noCompletion
    public extern inline function get_ignorenormals():Vehicle_viewcontrollerignorenormalsChoices {
        return untyped this.GetKeyValues().ignorenormals;
    }
    
    @:noCompletion
    public extern inline function set_ignorenormals(value:Vehicle_viewcontrollerignorenormalsChoices):Vehicle_viewcontrollerignorenormalsChoices {
	...
	**/
    public extern inline function OutputPlayerOn(callback:Callback<{activator:Vehicle_viewcontroller}>):CallbackLink {
	...
	**/
    public extern inline function OutputPlayerOff(callback:Callback<{activator:Vehicle_viewcontroller}>):CallbackLink {
	...
	**/
    public extern inline function OutputPressedAttack(callback:Callback<{activator:Vehicle_viewcontroller}>):CallbackLink {
	...
	**/
    public extern inline function OutputPressedAttack2(callback:Callback<{activator:Vehicle_viewcontroller}>):CallbackLink {
	...
	**/
    public extern inline function OutputAttackAxis(callback:Callback<{activator:Vehicle_viewcontroller,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputAttack2Axis(callback:Callback<{activator:Vehicle_viewcontroller,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Vehicle_viewcontroller}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Vehicle_viewcontroller}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Vehicle_viewcontroller}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Vehicle_viewcontroller}>):CallbackLink {
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("vehicle_viewcontroller");
    }
}

enum abstract Vehicle_viewcontrollersolidChoices(Int) to Int {
	var NOT_SOLID = 0;
	var USE_BOUNDING_BOX = 2;
	var USE_VPHYSICS = 6;
}
enum abstract Vehicle_viewcontrollerscreenspacefadeChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Vehicle_viewcontrollermindxlevelChoices(Int) to Int {
...
enum abstract Vehicle_viewcontrollermaxdxlevelChoices(Int) to Int {
...
enum abstract Vehicle_viewcontrollerignorenormalsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Vehicle_viewcontrollergmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Vehicle_viewcontrollerdisablevertexlightingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Vehicle_viewcontrollerdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Vehicle_viewcontrollerdisableselfshadowingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Vehicle_viewcontrollerVehicleLockedChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
