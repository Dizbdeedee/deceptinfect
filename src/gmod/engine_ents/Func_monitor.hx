...
**/
@:forward
abstract Func_monitor(Entity) to Entity {
    //Inputs
	...
	**/
    public extern inline function FireSetCamera(param:String,delay:Float) {
        untyped this.Fire("SetCamera",untyped param,delay);
    }
    ...
    /**
		Start Disabled
	**/
    public var StartDisabled(get,set):Func_monitorStartDisabledChoices;

    @:noCompletion
    public extern inline function get_StartDisabled():Func_monitorStartDisabledChoices {
        return untyped this.GetKeyValues().StartDisabled;
    }
    
    @:noCompletion
    public extern inline function set_StartDisabled(value:Func_monitorStartDisabledChoices):Func_monitorStartDisabledChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Func_monitorgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Func_monitorgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Func_monitorgmod_allowphysgunChoices):Func_monitorgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var InputFilter(get,set):Func_monitorInputFilterChoices;

    @:noCompletion
    public extern inline function get_InputFilter():Func_monitorInputFilterChoices {
        return untyped this.GetKeyValues().InputFilter;
    }
    
    @:noCompletion
    public extern inline function set_InputFilter(value:Func_monitorInputFilterChoices):Func_monitorInputFilterChoices {
	...
	**/
    public var rendermode(get,set):Func_monitorrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Func_monitorrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Func_monitorrendermodeChoices):Func_monitorrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Func_monitordisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Func_monitordisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Func_monitordisablereceiveshadowsChoices):Func_monitordisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Func_monitorrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Func_monitorrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Func_monitorrenderfxChoices):Func_monitorrenderfxChoices {
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Func_monitordisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Func_monitordisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Func_monitordisableshadowsChoices):Func_monitordisableshadowsChoices {
...
This also includes the context menu properties!
	...
	**/
    public var Solidity(get,set):Func_monitorSolidityChoices;

    @:noCompletion
    public extern inline function get_Solidity():Func_monitorSolidityChoices {
        return untyped this.GetKeyValues().Solidity;
    }
    
    @:noCompletion
    public extern inline function set_Solidity(value:Func_monitorSolidityChoices):Func_monitorSolidityChoices {
	...
	**/
    public var invert_exclusion(get,set):Func_monitorinvert_exclusionChoices;

    @:noCompletion
    public extern inline function get_invert_exclusion():Func_monitorinvert_exclusionChoices {
        return untyped this.GetKeyValues().invert_exclusion;
    }
    
    @:noCompletion
    public extern inline function set_invert_exclusion(value:Func_monitorinvert_exclusionChoices):Func_monitorinvert_exclusionChoices {
	...
	**/
    public var solidbsp(get,set):Func_monitorsolidbspChoices;

    @:noCompletion
    public extern inline function get_solidbsp():Func_monitorsolidbspChoices {
        return untyped this.GetKeyValues().solidbsp;
    }
    
    @:noCompletion
    public extern inline function set_solidbsp(value:Func_monitorsolidbspChoices):Func_monitorsolidbspChoices {
	...
	**/
    public var vrad_brush_cast_shadows(get,set):Func_monitorvrad_brush_cast_shadowsChoices;

    @:noCompletion
    public extern inline function get_vrad_brush_cast_shadows():Func_monitorvrad_brush_cast_shadowsChoices {
        return untyped this.GetKeyValues().vrad_brush_cast_shadows;
    }
    
    @:noCompletion
    public extern inline function set_vrad_brush_cast_shadows(value:Func_monitorvrad_brush_cast_shadowsChoices):Func_monitorvrad_brush_cast_shadowsChoices {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Func_monitor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Func_monitor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Func_monitor}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Func_monitor}>):CallbackLink {
	...
	**/
    ...
    public extern inline function addSpawnFlag(spawnflag:Func_monitorSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Func_monitorSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Func_monitorSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("func_monitor");
    }
}

enum abstract Func_monitorvrad_brush_cast_shadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_monitorsolidbspChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_monitorrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Func_monitorrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Func_monitorinvert_exclusionChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_monitorgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_monitordisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_monitordisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_monitorStartDisabledChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_monitorSolidityChoices(Int) to Int {
	var TOGGLE = 0;
	var NEVER_SOLID = 1;
	var ALWAYS_SOLID = 2;
}
enum abstract Func_monitorInputFilterChoices(Int) to Int {
...
enum abstract Func_monitorSpawnFlags(Int) to Int {
