...
**/
@:forward
abstract Vgui_screen(Entity) to Entity {
    //Inputs
	...
	**/
    public extern inline function FireSetActive(delay:Float) {
        untyped this.Fire("SetActive",untyped null,delay);
    }
    
    /**
		Make the vgui screen invisible.
	**/
    public extern inline function FireSetInactive(delay:Float) {
        untyped this.Fire("SetInactive",untyped null,delay);
    }
	...
	**/
    ...
    /**
		Panel Name
	**/
    public var panelname(get,set):String;

    @:noCompletion
    public extern inline function get_panelname():String {
        return untyped this.GetKeyValues().panelname;
    }
    
    @:noCompletion
    public extern inline function set_panelname(value:String):String {
        return untyped this.SetKeyValue("panelname",untyped value);
    }
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Vgui_screen}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Vgui_screen}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Vgui_screen}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Vgui_screen}>):CallbackLink {
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("vgui_screen");
    }
}
