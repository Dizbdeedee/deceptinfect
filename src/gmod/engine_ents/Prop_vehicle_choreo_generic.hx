...
**/
@:forward
abstract Prop_vehicle_choreo_generic(Entity) to Entity {
    //Inputs
	...
	**/
    public extern inline function FireEnterVehicle(delay:Float) {
        untyped this.Fire("EnterVehicle",untyped null,delay);
    }
    
    /**
		Forces the activator (or player) into the vehicle without enter/exit animations.
	**/
    public extern inline function FireEnterVehicleImmediate(delay:Float) {
        untyped this.Fire("EnterVehicleImmediate",untyped null,delay);
    }
	...
	**/
    ...
    /**
		Set true to prevent Gordon from looking around *at all*. Set false to let him look within limits.
	**/
    public extern inline function FireViewlock(param:bool,delay:Float) {
        untyped this.Fire("Viewlock",untyped param,delay);
    }
	...
	**/
    ...
    /**
		Start locked
	**/
    public var VehicleLocked(get,set):Prop_vehicle_choreo_genericVehicleLockedChoices;

    @:noCompletion
    public extern inline function get_VehicleLocked():Prop_vehicle_choreo_genericVehicleLockedChoices {
        return untyped this.GetKeyValues().VehicleLocked;
    }
    
    @:noCompletion
    public extern inline function set_VehicleLocked(value:Prop_vehicle_choreo_genericVehicleLockedChoices):Prop_vehicle_choreo_genericVehicleLockedChoices {
	...
	**/
    ...
    /**
		Minimum DX Level
	**/
    public var mindxlevel(get,set):Prop_vehicle_choreo_genericmindxlevelChoices;

    @:noCompletion
    public extern inline function get_mindxlevel():Prop_vehicle_choreo_genericmindxlevelChoices {
        return untyped this.GetKeyValues().mindxlevel;
    }
    
    @:noCompletion
    public extern inline function set_mindxlevel(value:Prop_vehicle_choreo_genericmindxlevelChoices):Prop_vehicle_choreo_genericmindxlevelChoices {
    ...
    /**
		Maximum DX Level
	**/
    public var maxdxlevel(get,set):Prop_vehicle_choreo_genericmaxdxlevelChoices;

    @:noCompletion
    public extern inline function get_maxdxlevel():Prop_vehicle_choreo_genericmaxdxlevelChoices {
        return untyped this.GetKeyValues().maxdxlevel;
    }
    
    @:noCompletion
    public extern inline function set_maxdxlevel(value:Prop_vehicle_choreo_genericmaxdxlevelChoices):Prop_vehicle_choreo_genericmaxdxlevelChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Prop_vehicle_choreo_genericgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Prop_vehicle_choreo_genericgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Prop_vehicle_choreo_genericgmod_allowphysgunChoices):Prop_vehicle_choreo_genericgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    ...
    /**
		Collisions
	**/
    public var solid(get,set):Prop_vehicle_choreo_genericsolidChoices;

    @:noCompletion
    public extern inline function get_solid():Prop_vehicle_choreo_genericsolidChoices {
        return untyped this.GetKeyValues().solid;
    }
    
    @:noCompletion
    public extern inline function set_solid(value:Prop_vehicle_choreo_genericsolidChoices):Prop_vehicle_choreo_genericsolidChoices {
    ...
    /**
		Disable Shadows
	**/
    public var disableshadows(get,set):Prop_vehicle_choreo_genericdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Prop_vehicle_choreo_genericdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Prop_vehicle_choreo_genericdisableshadowsChoices):Prop_vehicle_choreo_genericdisableshadowsChoices {
	...
	**/
    public var screenspacefade(get,set):Prop_vehicle_choreo_genericscreenspacefadeChoices;

    @:noCompletion
    public extern inline function get_screenspacefade():Prop_vehicle_choreo_genericscreenspacefadeChoices {
        return untyped this.GetKeyValues().screenspacefade;
    }
    
    @:noCompletion
    public extern inline function set_screenspacefade(value:Prop_vehicle_choreo_genericscreenspacefadeChoices):Prop_vehicle_choreo_genericscreenspacefadeChoices {
	...
	**/
    public var disablevertexlighting(get,set):Prop_vehicle_choreo_genericdisablevertexlightingChoices;

    @:noCompletion
    public extern inline function get_disablevertexlighting():Prop_vehicle_choreo_genericdisablevertexlightingChoices {
        return untyped this.GetKeyValues().disablevertexlighting;
    }
    
    @:noCompletion
    public extern inline function set_disablevertexlighting(value:Prop_vehicle_choreo_genericdisablevertexlightingChoices):Prop_vehicle_choreo_genericdisablevertexlightingChoices {
	...
	**/
    public var disableselfshadowing(get,set):Prop_vehicle_choreo_genericdisableselfshadowingChoices;

    @:noCompletion
    public extern inline function get_disableselfshadowing():Prop_vehicle_choreo_genericdisableselfshadowingChoices {
        return untyped this.GetKeyValues().disableselfshadowing;
    }
    
    @:noCompletion
    public extern inline function set_disableselfshadowing(value:Prop_vehicle_choreo_genericdisableselfshadowingChoices):Prop_vehicle_choreo_genericdisableselfshadowingChoices {
	...
	**/
    public var ignorenormals(get,set):Prop_vehicle_choreo_genericignorenormalsChoices;

    @:noCompletion
    public extern inline function get_ignorenormals():Prop_vehicle_choreo_genericignorenormalsChoices {
        return untyped this.GetKeyValues().ignorenormals;
    }
    
    @:noCompletion
    public extern inline function set_ignorenormals(value:Prop_vehicle_choreo_genericignorenormalsChoices):Prop_vehicle_choreo_genericignorenormalsChoices {
	...
	**/
    ...
    /**
		Ignore Move Parent on Exit

		Should the player ignore this vehicle's move parent went performing exit checks.
	**/
    public var ignoremoveparent(get,set):Prop_vehicle_choreo_genericignoremoveparentChoices;

    @:noCompletion
    public extern inline function get_ignoremoveparent():Prop_vehicle_choreo_genericignoremoveparentChoices {
        return untyped this.GetKeyValues().ignoremoveparent;
    }
    
    @:noCompletion
    public extern inline function set_ignoremoveparent(value:Prop_vehicle_choreo_genericignoremoveparentChoices):Prop_vehicle_choreo_genericignoremoveparentChoices {
        return untyped this.SetKeyValue("ignoremoveparent",untyped value);
    }
    
    /**
		Ignore Player collision

		The player wont collide against this vehicle when moving around.
	**/
    public var ignoreplayer(get,set):Prop_vehicle_choreo_genericignoreplayerChoices;

    @:noCompletion
    public extern inline function get_ignoreplayer():Prop_vehicle_choreo_genericignoreplayerChoices {
        return untyped this.GetKeyValues().ignoreplayer;
    }
    
    @:noCompletion
    public extern inline function set_ignoreplayer(value:Prop_vehicle_choreo_genericignoreplayerChoices):Prop_vehicle_choreo_genericignoreplayerChoices {
        return untyped this.SetKeyValue("ignoreplayer",untyped value);
    }
	...
	**/
    public extern inline function OutputPlayerOn(callback:Callback<{activator:Prop_vehicle_choreo_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputPlayerOff(callback:Callback<{activator:Prop_vehicle_choreo_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputPressedAttack(callback:Callback<{activator:Prop_vehicle_choreo_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputPressedAttack2(callback:Callback<{activator:Prop_vehicle_choreo_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputAttackAxis(callback:Callback<{activator:Prop_vehicle_choreo_generic,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputAttack2Axis(callback:Callback<{activator:Prop_vehicle_choreo_generic,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Prop_vehicle_choreo_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Prop_vehicle_choreo_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Prop_vehicle_choreo_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Prop_vehicle_choreo_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnOpen(callback:Callback<{activator:Prop_vehicle_choreo_generic}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnClose(callback:Callback<{activator:Prop_vehicle_choreo_generic}>):CallbackLink {
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("prop_vehicle_choreo_generic");
    }
}

enum abstract Prop_vehicle_choreo_genericsolidChoices(Int) to Int {
	var NOT_SOLID = 0;
	var USE_BOUNDING_BOX = 2;
	var USE_VPHYSICS = 6;
}
enum abstract Prop_vehicle_choreo_genericscreenspacefadeChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_choreo_genericmindxlevelChoices(Int) to Int {
...
enum abstract Prop_vehicle_choreo_genericmaxdxlevelChoices(Int) to Int {
...
enum abstract Prop_vehicle_choreo_genericignoreplayerChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_choreo_genericignorenormalsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_choreo_genericignoremoveparentChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_choreo_genericgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_choreo_genericdisablevertexlightingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_choreo_genericdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_choreo_genericdisableselfshadowingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_vehicle_choreo_genericVehicleLockedChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
