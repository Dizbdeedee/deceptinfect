...
**/
@:forward
abstract Prop_dynamic_ornament(Entity) to Entity {
    //Inputs
	...
	**/
    public extern inline function FireSetAttached(param:String,delay:Float) {
        untyped this.Fire("SetAttached",untyped param,delay);
    }
    
    /**
		Detach from the Target Entity and become invisible. The ornament can be re-attached with the SetAttached input.
	**/
    public extern inline function FireDetach(param:String,delay:Float) {
        untyped this.Fire("Detach",untyped param,delay);
    }
	...
	**/
    public var PerformanceMode(get,set):Prop_dynamic_ornamentPerformanceModeChoices;

    @:noCompletion
    public extern inline function get_PerformanceMode():Prop_dynamic_ornamentPerformanceModeChoices {
        return untyped this.GetKeyValues().PerformanceMode;
    }
    
    @:noCompletion
    public extern inline function set_PerformanceMode(value:Prop_dynamic_ornamentPerformanceModeChoices):Prop_dynamic_ornamentPerformanceModeChoices {
	...
	**/
    ...
    /**
		Minimum DX Level
	**/
    public var mindxlevel(get,set):Prop_dynamic_ornamentmindxlevelChoices;

    @:noCompletion
    public extern inline function get_mindxlevel():Prop_dynamic_ornamentmindxlevelChoices {
        return untyped this.GetKeyValues().mindxlevel;
    }
    
    @:noCompletion
    public extern inline function set_mindxlevel(value:Prop_dynamic_ornamentmindxlevelChoices):Prop_dynamic_ornamentmindxlevelChoices {
    ...
    /**
		Maximum DX Level
	**/
    public var maxdxlevel(get,set):Prop_dynamic_ornamentmaxdxlevelChoices;

    @:noCompletion
    public extern inline function get_maxdxlevel():Prop_dynamic_ornamentmaxdxlevelChoices {
        return untyped this.GetKeyValues().maxdxlevel;
    }
    
    @:noCompletion
    public extern inline function set_maxdxlevel(value:Prop_dynamic_ornamentmaxdxlevelChoices):Prop_dynamic_ornamentmaxdxlevelChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Prop_dynamic_ornamentgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Prop_dynamic_ornamentgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Prop_dynamic_ornamentgmod_allowphysgunChoices):Prop_dynamic_ornamentgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Prop_dynamic_ornamentrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Prop_dynamic_ornamentrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Prop_dynamic_ornamentrendermodeChoices):Prop_dynamic_ornamentrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Prop_dynamic_ornamentdisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Prop_dynamic_ornamentdisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Prop_dynamic_ornamentdisablereceiveshadowsChoices):Prop_dynamic_ornamentdisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Prop_dynamic_ornamentrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Prop_dynamic_ornamentrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Prop_dynamic_ornamentrenderfxChoices):Prop_dynamic_ornamentrenderfxChoices {
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Prop_dynamic_ornamentdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Prop_dynamic_ornamentdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Prop_dynamic_ornamentdisableshadowsChoices):Prop_dynamic_ornamentdisableshadowsChoices {
	...
	**/
    ...
    /**
		Collisions
	**/
    public var solid(get,set):Prop_dynamic_ornamentsolidChoices;

    @:noCompletion
    public extern inline function get_solid():Prop_dynamic_ornamentsolidChoices {
        return untyped this.GetKeyValues().solid;
    }
    
    @:noCompletion
    public extern inline function set_solid(value:Prop_dynamic_ornamentsolidChoices):Prop_dynamic_ornamentsolidChoices {
	...
	**/
    public var RandomAnimation(get,set):Prop_dynamic_ornamentRandomAnimationChoices;

    @:noCompletion
    public extern inline function get_RandomAnimation():Prop_dynamic_ornamentRandomAnimationChoices {
        return untyped this.GetKeyValues().RandomAnimation;
    }
    
    @:noCompletion
    public extern inline function set_RandomAnimation(value:Prop_dynamic_ornamentRandomAnimationChoices):Prop_dynamic_ornamentRandomAnimationChoices {
	...
	**/
    public var DisableBoneFollowers(get,set):Prop_dynamic_ornamentDisableBoneFollowersChoices;

    @:noCompletion
    public extern inline function get_DisableBoneFollowers():Prop_dynamic_ornamentDisableBoneFollowersChoices {
        return untyped this.GetKeyValues().DisableBoneFollowers;
    }
    
    @:noCompletion
    public extern inline function set_DisableBoneFollowers(value:Prop_dynamic_ornamentDisableBoneFollowersChoices):Prop_dynamic_ornamentDisableBoneFollowersChoices {
	...
	**/
    public var HoldAnimation(get,set):Prop_dynamic_ornamentHoldAnimationChoices;

    @:noCompletion
    public extern inline function get_HoldAnimation():Prop_dynamic_ornamentHoldAnimationChoices {
        return untyped this.GetKeyValues().HoldAnimation;
    }
    
    @:noCompletion
    public extern inline function set_HoldAnimation(value:Prop_dynamic_ornamentHoldAnimationChoices):Prop_dynamic_ornamentHoldAnimationChoices {
	...
	**/
    public var InitialOwner(get,set):String;

    @:noCompletion
    public extern inline function get_InitialOwner():String {
        return untyped this.GetKeyValues().InitialOwner;
    }
    
    @:noCompletion
    public extern inline function set_InitialOwner(value:String):String {
        return untyped this.SetKeyValue("InitialOwner",untyped value);
    }
	...
	**/
    public extern inline function OutputOnBreak(callback:Callback<{activator:Prop_dynamic_ornament}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnTakeDamage(callback:Callback<{activator:Prop_dynamic_ornament}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHealthChanged(callback:Callback<{activator:Prop_dynamic_ornament,data:Float}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonDetach(callback:Callback<{activator:Prop_dynamic_ornament}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonAnimatePreStarted(callback:Callback<{activator:Prop_dynamic_ornament}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonAnimatePullStarted(callback:Callback<{activator:Prop_dynamic_ornament}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonPullAnimFinished(callback:Callback<{activator:Prop_dynamic_ornament}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysCannonAnimatePostStarted(callback:Callback<{activator:Prop_dynamic_ornament}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnIgnite(callback:Callback<{activator:Prop_dynamic_ornament}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Prop_dynamic_ornament}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Prop_dynamic_ornament}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Prop_dynamic_ornament}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Prop_dynamic_ornament}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnAnimationBegun(callback:Callback<{activator:Prop_dynamic_ornament}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnAnimationDone(callback:Callback<{activator:Prop_dynamic_ornament}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnAnimationDone",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Prop_dynamic_ornamentSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Prop_dynamic_ornamentSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Prop_dynamic_ornamentSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("prop_dynamic_ornament");
    }
}

enum abstract Prop_dynamic_ornamentsolidChoices(Int) to Int {
	var NOT_SOLID = 0;
}
enum abstract Prop_dynamic_ornamentrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Prop_dynamic_ornamentrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Prop_dynamic_ornamentmindxlevelChoices(Int) to Int {
...
enum abstract Prop_dynamic_ornamentmaxdxlevelChoices(Int) to Int {
...
enum abstract Prop_dynamic_ornamentgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_dynamic_ornamentdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_dynamic_ornamentdisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_dynamic_ornamentRandomAnimationChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_dynamic_ornamentPerformanceModeChoices(Int) to Int {
	var NORMAL = 0;
	var NO_GIBS = 1;
	var FULL_GIBS_ON_ALL_PLATFORMS = 2;
	var REDUCED_GIBS = 3;
}
enum abstract Prop_dynamic_ornamentHoldAnimationChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Prop_dynamic_ornamentDisableBoneFollowersChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Prop_dynamic_ornamentSpawnFlags(Int) to Int {
