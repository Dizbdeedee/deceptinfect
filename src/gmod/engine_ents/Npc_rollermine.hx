...
**/
@:forward
abstract Npc_rollermine(NPC) to Entity to NPC {
    //Inputs
    
    /**
		Shutdown this target.
	**/
    public extern inline function FireInteractivePowerDown(delay:Float) {
        untyped this.Fire("InteractivePowerDown",untyped null,delay);
    }
	...
	**/
    public var hintlimiting(get,set):Npc_rollerminehintlimitingChoices;

    @:noCompletion
    public extern inline function get_hintlimiting():Npc_rollerminehintlimitingChoices {
        return untyped this.GetKeyValues().hintlimiting;
    }
    
    @:noCompletion
    public extern inline function set_hintlimiting(value:Npc_rollerminehintlimitingChoices):Npc_rollerminehintlimitingChoices {
	...
	**/
    public var sleepstate(get,set):Npc_rollerminesleepstateChoices;

    @:noCompletion
    public extern inline function get_sleepstate():Npc_rollerminesleepstateChoices {
        return untyped this.GetKeyValues().sleepstate;
    }
    
    @:noCompletion
    public extern inline function set_sleepstate(value:Npc_rollerminesleepstateChoices):Npc_rollerminesleepstateChoices {
	...
	**/
    public var wakesquad(get,set):Npc_rollerminewakesquadChoices;

    @:noCompletion
    public extern inline function get_wakesquad():Npc_rollerminewakesquadChoices {
        return untyped this.GetKeyValues().wakesquad;
    }
    
    @:noCompletion
    public extern inline function set_wakesquad(value:Npc_rollerminewakesquadChoices):Npc_rollerminewakesquadChoices {
	...
	**/
    public var ignoreunseenenemies(get,set):Npc_rollermineignoreunseenenemiesChoices;

    @:noCompletion
    public extern inline function get_ignoreunseenenemies():Npc_rollermineignoreunseenenemiesChoices {
        return untyped this.GetKeyValues().ignoreunseenenemies;
    }
    
    @:noCompletion
    public extern inline function set_ignoreunseenenemies(value:Npc_rollermineignoreunseenenemiesChoices):Npc_rollermineignoreunseenenemiesChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Npc_rollerminegmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Npc_rollerminegmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Npc_rollerminegmod_allowphysgunChoices):Npc_rollerminegmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var rendermode(get,set):Npc_rollerminerendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Npc_rollerminerendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Npc_rollerminerendermodeChoices):Npc_rollerminerendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Npc_rollerminedisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Npc_rollerminedisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Npc_rollerminedisablereceiveshadowsChoices):Npc_rollerminedisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Npc_rollerminerenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Npc_rollerminerenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Npc_rollerminerenderfxChoices):Npc_rollerminerenderfxChoices {
	...
	**/
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Npc_rollerminedisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Npc_rollerminedisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Npc_rollerminedisableshadowsChoices):Npc_rollerminedisableshadowsChoices {
	...
	**/
    ...
    /**
		Start Buried
	**/
    public var startburied(get,set):Npc_rollerminestartburiedChoices;

    @:noCompletion
    public extern inline function get_startburied():Npc_rollerminestartburiedChoices {
        return untyped this.GetKeyValues().startburied;
    }
    
    @:noCompletion
    public extern inline function set_startburied(value:Npc_rollerminestartburiedChoices):Npc_rollerminestartburiedChoices {
        return untyped this.SetKeyValue("startburied",untyped value);
    }
    
    /**
		Sight Distance
	**/
    public var uniformsightdist(get,set):Npc_rollermineuniformsightdistChoices;

    @:noCompletion
    public extern inline function get_uniformsightdist():Npc_rollermineuniformsightdistChoices {
        return untyped this.GetKeyValues().uniformsightdist;
    }
    
    @:noCompletion
    public extern inline function set_uniformsightdist(value:Npc_rollermineuniformsightdistChoices):Npc_rollermineuniformsightdistChoices {
        return untyped this.SetKeyValue("uniformsightdist",untyped value);
    }
	...
	**/
    public extern inline function OutputOnAlyxStartedInteraction(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnAlyxStartedInteraction",callback);
    }
    
    /**
		Fired when Alyx has finished interacting with this entity.
	**/
    public extern inline function OutputOnAlyxFinishedInteraction(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnAlyxFinishedInteraction",callback);
    }
    
    /**
		Fired when this NPC takes damage.
	**/
    public extern inline function OutputOnDamaged(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDeath(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHalfHealth(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearWorld(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearPlayer(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnHearCombat(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundEnemy(callback:Callback<{activator:Npc_rollermine,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemyLOS(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostEnemy(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnFoundPlayer(callback:Callback<{activator:Npc_rollermine,data:String}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayerLOS(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnLostPlayer(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayer(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDamagedByPlayerSquad(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnDenyCommanderUse(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnSleep(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnWake(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionStarted(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionAborted(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnForcedInteractionFinished(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnPhysGunPickup(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
    ...
    /**
		Released by physgun
	**/
    public extern inline function OutputOnPhysGunDrop(callback:Callback<{activator:Npc_rollermine}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnPhysGunDrop",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Npc_rollermineSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Npc_rollermineSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Npc_rollermineSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("npc_rollermine");
    }
}

enum abstract Npc_rollerminewakesquadChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_rollermineuniformsightdistChoices(Int) to Int {
	var IGNORE_DISTANT_TARGETS_NOT_IN_A_VEHICLE_DEFAULT = 0;
	var EQUAL_VISIBILITY_FOR_ALL_TARGETS = 1;
}
enum abstract Npc_rollerminestartburiedChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_rollerminesleepstateChoices(Int) to Int {
	var NONE = 0;
...
enum abstract Npc_rollerminerendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Npc_rollerminerenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Npc_rollermineignoreunseenenemiesChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_rollerminehintlimitingChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_rollerminegmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_rollerminedisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Npc_rollerminedisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Npc_rollermineSpawnFlags(Int) to Int {
	...
	var FRIENDLY = 65536;
	var USE_PROPPHYSICS_COLLISION_RULES = 131072;
}
