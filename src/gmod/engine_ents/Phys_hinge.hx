...
**/
@:forward
abstract Phys_hinge(Entity) to Entity {
    //Inputs
	...
	**/
    public extern inline function FireSetAngularVelocity(param:Float,delay:Float) {
        untyped this.Fire("SetAngularVelocity",untyped param,delay);
    }
	...
	**/
    public var hingefriction(get,set):Float;

    @:noCompletion
    public extern inline function get_hingefriction():Float {
        return untyped this.GetKeyValues().hingefriction;
    }
    
    @:noCompletion
    public extern inline function set_hingefriction(value:Float):Float {
        return untyped this.SetKeyValue("hingefriction",untyped value);
    }
    
    /**
		Hinge Axis
	**/
    public var hingeaxis(get,set):String;

    @:noCompletion
    public extern inline function get_hingeaxis():String {
        return untyped this.GetKeyValues().hingeaxis;
    }
    
    @:noCompletion
    public extern inline function set_hingeaxis(value:String):String {
        return untyped this.SetKeyValue("hingeaxis",untyped value);
    }
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Phys_hinge}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Phys_hinge}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Phys_hinge}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Phys_hinge}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnBreak(callback:Callback<{activator:Phys_hinge}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnBreak",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Phys_hingeSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Phys_hingeSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Phys_hingeSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("phys_hinge");
    }
}



enum abstract Phys_hingeSpawnFlags(Int) to Int {
