...
**/
@:forward
abstract Func_reflective_glass(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Start Disabled
	**/
    public var StartDisabled(get,set):Func_reflective_glassStartDisabledChoices;

    @:noCompletion
    public extern inline function get_StartDisabled():Func_reflective_glassStartDisabledChoices {
        return untyped this.GetKeyValues().StartDisabled;
    }
    
    @:noCompletion
    public extern inline function set_StartDisabled(value:Func_reflective_glassStartDisabledChoices):Func_reflective_glassStartDisabledChoices {
	...
	**/
    public var gmod_allowphysgun(get,set):Func_reflective_glassgmod_allowphysgunChoices;

    @:noCompletion
    public extern inline function get_gmod_allowphysgun():Func_reflective_glassgmod_allowphysgunChoices {
        return untyped this.GetKeyValues().gmod_allowphysgun;
    }
    
    @:noCompletion
    public extern inline function set_gmod_allowphysgun(value:Func_reflective_glassgmod_allowphysgunChoices):Func_reflective_glassgmod_allowphysgunChoices {
...
This also includes the context menu properties!
	...
	**/
    public var InputFilter(get,set):Func_reflective_glassInputFilterChoices;

    @:noCompletion
    public extern inline function get_InputFilter():Func_reflective_glassInputFilterChoices {
        return untyped this.GetKeyValues().InputFilter;
    }
    
    @:noCompletion
    public extern inline function set_InputFilter(value:Func_reflective_glassInputFilterChoices):Func_reflective_glassInputFilterChoices {
	...
	**/
    public var rendermode(get,set):Func_reflective_glassrendermodeChoices;

    @:noCompletion
    public extern inline function get_rendermode():Func_reflective_glassrendermodeChoices {
        return untyped this.GetKeyValues().rendermode;
    }
    
    @:noCompletion
    public extern inline function set_rendermode(value:Func_reflective_glassrendermodeChoices):Func_reflective_glassrendermodeChoices {
	...
	**/
    public var disablereceiveshadows(get,set):Func_reflective_glassdisablereceiveshadowsChoices;

    @:noCompletion
    public extern inline function get_disablereceiveshadows():Func_reflective_glassdisablereceiveshadowsChoices {
        return untyped this.GetKeyValues().disablereceiveshadows;
    }
    
    @:noCompletion
    public extern inline function set_disablereceiveshadows(value:Func_reflective_glassdisablereceiveshadowsChoices):Func_reflective_glassdisablereceiveshadowsChoices {
    ...
    /**
		Render FX
	**/
    public var renderfx(get,set):Func_reflective_glassrenderfxChoices;

    @:noCompletion
    public extern inline function get_renderfx():Func_reflective_glassrenderfxChoices {
        return untyped this.GetKeyValues().renderfx;
    }
    
    @:noCompletion
    public extern inline function set_renderfx(value:Func_reflective_glassrenderfxChoices):Func_reflective_glassrenderfxChoices {
    ...
    /**
		Disable shadows
	**/
    public var disableshadows(get,set):Func_reflective_glassdisableshadowsChoices;

    @:noCompletion
    public extern inline function get_disableshadows():Func_reflective_glassdisableshadowsChoices {
        return untyped this.GetKeyValues().disableshadows;
    }
    
    @:noCompletion
    public extern inline function set_disableshadows(value:Func_reflective_glassdisableshadowsChoices):Func_reflective_glassdisableshadowsChoices {
...
This also includes the context menu properties!
	...
	**/
    public var Solidity(get,set):Func_reflective_glassSolidityChoices;

    @:noCompletion
    public extern inline function get_Solidity():Func_reflective_glassSolidityChoices {
        return untyped this.GetKeyValues().Solidity;
    }
    
    @:noCompletion
    public extern inline function set_Solidity(value:Func_reflective_glassSolidityChoices):Func_reflective_glassSolidityChoices {
	...
	**/
    public var invert_exclusion(get,set):Func_reflective_glassinvert_exclusionChoices;

    @:noCompletion
    public extern inline function get_invert_exclusion():Func_reflective_glassinvert_exclusionChoices {
        return untyped this.GetKeyValues().invert_exclusion;
    }
    
    @:noCompletion
    public extern inline function set_invert_exclusion(value:Func_reflective_glassinvert_exclusionChoices):Func_reflective_glassinvert_exclusionChoices {
	...
	**/
    public var solidbsp(get,set):Func_reflective_glasssolidbspChoices;

    @:noCompletion
    public extern inline function get_solidbsp():Func_reflective_glasssolidbspChoices {
        return untyped this.GetKeyValues().solidbsp;
    }
    
    @:noCompletion
    public extern inline function set_solidbsp(value:Func_reflective_glasssolidbspChoices):Func_reflective_glasssolidbspChoices {
	...
	**/
    public var vrad_brush_cast_shadows(get,set):Func_reflective_glassvrad_brush_cast_shadowsChoices;

    @:noCompletion
    public extern inline function get_vrad_brush_cast_shadows():Func_reflective_glassvrad_brush_cast_shadowsChoices {
        return untyped this.GetKeyValues().vrad_brush_cast_shadows;
    }
    
    @:noCompletion
    public extern inline function set_vrad_brush_cast_shadows(value:Func_reflective_glassvrad_brush_cast_shadowsChoices):Func_reflective_glassvrad_brush_cast_shadowsChoices {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Func_reflective_glass}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Func_reflective_glass}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Func_reflective_glass}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Func_reflective_glass}>):CallbackLink {
	...
	**/
    ...
    public extern inline function addSpawnFlag(spawnflag:Func_reflective_glassSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Func_reflective_glassSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Func_reflective_glassSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("func_reflective_glass");
    }
}

enum abstract Func_reflective_glassvrad_brush_cast_shadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_reflective_glasssolidbspChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_reflective_glassrendermodeChoices(Int) to Int {
	var NORMAL = 0;
	var COLOR = 1;
	var TEXTURE = 2;
	var GLOW = 3;
...
enum abstract Func_reflective_glassrenderfxChoices(Int) to Int {
	var NORMAL = 0;
	var SLOW_PULSE = 1;
	var FAST_PULSE = 2;
...
enum abstract Func_reflective_glassinvert_exclusionChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_reflective_glassgmod_allowphysgunChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_reflective_glassdisableshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_reflective_glassdisablereceiveshadowsChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_reflective_glassStartDisabledChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}
enum abstract Func_reflective_glassSolidityChoices(Int) to Int {
	var TOGGLE = 0;
	var NEVER_SOLID = 1;
	var ALWAYS_SOLID = 2;
}
enum abstract Func_reflective_glassInputFilterChoices(Int) to Int {
...
enum abstract Func_reflective_glassSpawnFlags(Int) to Int {
