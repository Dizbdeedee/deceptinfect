...
**/
@:forward
abstract Trigger_soundscape(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Start Disabled
	**/
    public var StartDisabled(get,set):Trigger_soundscapeStartDisabledChoices;

    @:noCompletion
    public extern inline function get_StartDisabled():Trigger_soundscapeStartDisabledChoices {
        return untyped this.GetKeyValues().StartDisabled;
    }
    
    @:noCompletion
    public extern inline function set_StartDisabled(value:Trigger_soundscapeStartDisabledChoices):Trigger_soundscapeStartDisabledChoices {
	...
	**/
    ...
    /**
		Soundscape
	**/
    public var soundscape(get,set):String;

    @:noCompletion
    public extern inline function get_soundscape():String {
        return untyped this.GetKeyValues().soundscape;
    }
    
    @:noCompletion
    public extern inline function set_soundscape(value:String):String {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Trigger_soundscape}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Trigger_soundscape}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Trigger_soundscape}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Trigger_soundscape}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnStartTouchAll(callback:Callback<{activator:Trigger_soundscape}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnEndTouch(callback:Callback<{activator:Trigger_soundscape}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnEndTouchAll(callback:Callback<{activator:Trigger_soundscape}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnStartTouch(callback:Callback<{activator:Trigger_soundscape}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnStartTouch",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Trigger_soundscapeSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Trigger_soundscapeSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Trigger_soundscapeSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("trigger_soundscape");
    }
}

enum abstract Trigger_soundscapeStartDisabledChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Trigger_soundscapeSpawnFlags(Int) to Int {
	var CLIENTS = 1;
	var NPCS = 2;
	var PUSHABLES = 4;
