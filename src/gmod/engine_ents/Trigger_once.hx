...
**/
@:forward
abstract Trigger_once(Entity) to Entity {
    //Inputs
	...
	**/
    ...
    /**
		Start Disabled
	**/
    public var StartDisabled(get,set):Trigger_onceStartDisabledChoices;

    @:noCompletion
    public extern inline function get_StartDisabled():Trigger_onceStartDisabledChoices {
        return untyped this.GetKeyValues().StartDisabled;
    }
    
    @:noCompletion
    public extern inline function set_StartDisabled(value:Trigger_onceStartDisabledChoices):Trigger_onceStartDisabledChoices {
	...
	**/
    public extern inline function OutputOnUser1(callback:Callback<{activator:Trigger_once}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser2(callback:Callback<{activator:Trigger_once}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser3(callback:Callback<{activator:Trigger_once}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnUser4(callback:Callback<{activator:Trigger_once}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnStartTouch(callback:Callback<{activator:Trigger_once}>):CallbackLink {
	...
	**/
    public extern inline function OutputOnTrigger(callback:Callback<{activator:Trigger_once}>):CallbackLink {
        return gmod.OutputRunner.addOutput(this,"OnTrigger",callback);
    }
    

    
    public extern inline function addSpawnFlag(spawnflag:Trigger_onceSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.bor(spawnflag,this.GetKeyValues().spawnflags));
    }

    public extern inline function removeSpawnFlag(spawnflag:Trigger_onceSpawnFlags) {
        this.SetKeyValue("spawnflags",gmod.libs.BitLib.band(gmod.libs.BitLib.bnot(spawnflag),this.GetKeyValues().spawnflags));    
    }

    public extern inline function setSpawnFlags(spawnflags:Array<Trigger_onceSpawnFlags>) {
        var cur:Float = 0;
    ...
    public extern inline function new() {
        this = cast gmod.libs.EntsLib.Create("trigger_once");
    }
}

enum abstract Trigger_onceStartDisabledChoices(Int) to Int {
	var NO = 0;
	var YES = 1;
}


enum abstract Trigger_onceSpawnFlags(Int) to Int {
	var CLIENTS = 1;
	var NPCS = 2;
	var PUSHABLES = 4;
