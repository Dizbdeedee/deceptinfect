...
enum abstract EntityClass<T:Entity>(String) from String to String {
    var info_player_start:EntityClass<NPC>;
...
// class Stuff {
//     public static function test<T:Entity>(x:EntityClass<T>):T {
//         return null;
//     }

//     public static function test2() {
//         var eck = test(info_player_start);
//         var mycustomEnt = new EntityClass<NPC>("eck");
//         var npc = test(info_player_start);
