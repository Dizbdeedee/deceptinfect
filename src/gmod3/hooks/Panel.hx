...
extern class Panel {
    ...
    **/
    ...
    /**
        ***INTERNAL:**  
		...
		Called by .  when the panel starts being dragged. 
    ...
    **/
    ...
    @:hook
    public function OnKeyCodePressed(keyCode:Float):Bool;
    ...
    **/
    ...
    /**
        ***INTERNAL:**  
		...
		Called by :  when the panel object is released after being dragged. 
    ...
    **/
    ...
    @:hook
    public function OnMousePressed(keyCode:Float):Bool;
    ...
    **/
    ...
    @:hook
    public function OnKeyCodeReleased(keyCode:Float):Bool;
    ...
    **/
    ...
    @:hook
    public function OnMouseReleased(keyCode:Float):Bool;
