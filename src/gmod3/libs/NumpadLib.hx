...
@:native("numpad")extern class NumpadLib {
    ...
    **/
    ...
    public static function Deactivate(ply:Player, key:Float, isButton:Bool):Void;
    ...
    **/
    ...
    public static function Activate(ply:Player, key:Float, isButton:Bool):Void;
    ...
    **/
    ...
    public static function OnUp(ply:Player, key:Float, name:String, vargs:Rest<Dynamic>):Float;
    ...
    **/
    ...
    public static function OnDown(ply:Player, key:Float, name:String, vargs:Rest<Dynamic>):Float;
    ...
    **/
    ...
    public static function Toggle(ply:Player, key:Float):Void;
