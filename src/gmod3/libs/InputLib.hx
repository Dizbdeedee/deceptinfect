...
@:native("input")extern class InputLib {
    ...
    **/
    ...
    public static function GetKeyCode(button:String):Float;
    ...
    **/
    ...
    public static function WasMouseReleased(key:Float):Bool;
    ...
    **/
    ...
    public static function WasMousePressed(key:Float):Bool;
    ...
    **/
    ...
    public static function WasKeyReleased(key:Float):Bool;
    ...
    **/
    ...
    public static function IsMouseDown(mouseKey:Float):Bool;
    ...
    **/
    ...
    public static function IsKeyDown(key:Float):Bool;
    ...
    **/
    ...
    public static function LookupKeyBinding(key:Float):String;
    ...
    **/
    ...
    public static function IsButtonDown(button:Float):Bool;
    ...
    **/
    ...
    public static function GetKeyName(button:Float):String;
    ...
    **/
    ...
    public static function WasKeyTyped(key:Float):Bool;
    ...
    **/
    ...
    public static function WasMouseDoublePressed(button:Float):Bool;
    ...
    **/
    ...
    public static function CheckKeyTrapping():Float;
    ...
    **/
    ...
    public static function WasKeyPressed(key:Float):Bool;
