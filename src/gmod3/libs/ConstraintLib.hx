...
@:native("constraint")extern class ConstraintLib {
    ...
    **/
    ...
    public static function Motor(Ent1:Entity, Ent2:Entity, Bone1:Float, Bone2:Float, LPos1:Vector, LPos2:Vector, friction:Float, torque:Float, forcetime:Float, nocollide:Float, toggle:Float, pl:Player, forcelimit:Float, numpadkey_fwd:Float, numpadkey_bwd:Float, direction:Float, LocalAxis:Vector):ConstraintLibMotorReturn;
    ...
    **/
    ...
    public static function Winch(pl:Player, Ent1:Entity, Ent2:Entity, Bone1:Float, Bone2:Float, LPos1:Vector, LPos2:Vector, width:Float, fwd_bind:Float, bwd_bind:Float, fwd_speed:Float, bwd_speed:Float, material:String, toggle:Bool):ConstraintLibWinchReturn;
    ...
    **/
    ...
    public static function Muscle(pl:Player, Ent1:Entity, Ent2:Entity, Bone1:Float, Bone2:Float, LPos1:Vector, LPos2:Vector, Length1:Float, Length2:Float, width:Float, key:Float, fixed:Float, period:Float, amplitude:Float, starton:Bool, material:String):ConstraintLibMuscleReturn;
    ...
    **/
    ...
    public static function Hydraulic(pl:Player, Ent1:Entity, Ent2:Entity, Bone1:Float, Bone2:Float, LPos1:Vector, LPos2:Vector, Length1:Float, Length2:Float, width:Float, key:Float, fixed:Float, speed:Float, material:String):ConstraintLibHydraulicReturn;
