...
extern class Panel {
    ...
    **/
    ...
    /**
        ***INTERNAL:**  
		...
		Used to run commands within a  window.   
		Name | Description
		--- | ---
    ...
    **/
    ...
    public function DragMousePress(mouseCode:Float):Void;
    ...
    **/
    ...
    /**
        ***INTERNAL:**  
		...
		Used by :  to apply the  property to a panel object. This calls : .   
		Name | Description
		--- | ---
    ...
    **/
    ...
    public function SetSelectionCanvas(selCanvas:Any):Void;
    ...
    **/
    ...
    public function SetBGColor(color:Float, g:Float, b:Float, a:Float):Void;
    ...
    **/
    @:deprecated
    public function GWEN_SetDock(dockState:String):Void;
    ...
    **/
    ...
    /**
        ***INTERNAL:**  
		...
		Called to end a drag and hover action. This resets the panel's :  method, and is primarily used by . . 
    ...
    **/
    ...
    /**
        ***INTERNAL:**  
		...
		Used by :  to apply the  property to a panel.   
		Name | Description
		--- | ---
    ...
    **/
    ...
    /**
        ***INTERNAL:**  
		...
		Called by :  when a user clicks one mouse button whilst dragging with another.   
    ...
    **/
    ...
    public function AlphaTo(alpha:Float, duration:Float, ?delay:Float, callback:Function):Void;
    ...
    **/
    ...
    public function NewAnimation(length:Float, ?delay:Float, ?ease:Float, ?callback:Function):AnyTable;
    ...
    **/
    ...
    /**
        ***INTERNAL:**  
		...
		Used by :  to apply the  property to a , ,  or . This calls  on one of the previously listed methods.   
		Name | Description
		--- | ---
    ...
    **/
    ...
    public function Dock(dockType:Float):Void;
    ...
    **/
    ...
    public function SizeTo(?sizeW:Float, ?sizeH:Float, time:Float, ?delay:Float, ?ease:Float, callback:Function):Void;
    ...
    **/
    ...
    public function MoveTo(posX:Float, posY:Float, time:Float, ?delay:Float, ?ease:Float, callback:Function):Void;
    ...
    **/
    ...
    /**
        ***INTERNAL:**  
		...
		Called by .  to perform actions on an object that is dragged and hovered over another.   
		Name | Description
		--- | ---
    ...
    **/
    ...
    public function MoveBy(moveX:Float, moveY:Float, time:Float, ?delay:Float, ?ease:Float, ?callback:Function):Void;
    ...
    **/
    ...
    public function DragMouseRelease(mouseCode:Float):Bool;
    ...
    **/
    ...
    /**
        ***INTERNAL:**  
		...
		Used by :  to apply the  property to a panel. This calls : .   
		Name | Description
		--- | ---
    ...
    **/
    ...
    public function IsSelectionCanvas():Any;
    
    
    /**
        ***INTERNAL:**  
		
		Used by :  to apply the  property to a . This does exactly the same as : , but exists to cater for the seperate GWEN properties.   
		Name | Description
		--- | ---
    ...
    **/
    ...
    public function SetFGColor(color:Float, g:Float, b:Float, a:Float):Void;
