...
Main.main = function() 
  ...
  player.GetByID(0):SetObserverMode(_G.OBS_MODE_CHASE);
end
...
__deceptinfect__DI_Player_DI_Player_Impl_._new = function(p) 
  local di_ply = __deceptinfect__DI_Player__DI_Player.new(p);
  p._DI_Player = di_ply;
  local this1 = di_ply;
  do return this1 end;
end
__deceptinfect__DI_Player_DI_Player_Impl_.fromPlayer = function(p) 
  do return p._DI_Player end;
end
...
__deceptinfect_DeceptInfect.prototype.PlayerInitialSpawn = function(self,player,transition) 
  __deceptinfect__DI_Player_DI_Player_Impl_._new(player);
  local _g = self.currentState;
  if (_g[1] == 1) then 
    local _g1 = _g[2];
    player:KillSilent();
...
__deceptinfect_DeceptInfect.prototype.PlayerCanHearPlayersVoice = function(self,listener,talker) 
  ...
  do return _hx_tab_array({[0]=true, true}, 2) end
end
...
__deceptinfect_Game.prototype.addPlayers = function(self) 
  ...
  while (player:hasNext()) do 
    ...
    self.players:push(player1._DI_Player);
  end;
end
...
__deceptinfect_InfectionComponent.prototype.baseInfection = function(self) 
end
__deceptinfect_InfectionComponent.prototype.onInfected = function(self) 
end
...
__gmod__MultiReturnHelper_MultiReturnHelper_Impl_.multiReturnTable = function(rtns) 
  local ret = ({});
  local _g = 0;
  local _g1 = rtns.length;
  while (_g < _g1) do 
    _g = _g + 1;
    local idx = _g - 1;
    ret[idx + 1] = rtns[idx];
  end;
  local this1 = _hx_table.unpack(ret);
  do return this1 end;
end
