...
__deceptinfect_GameManager.cleanup = function() 
  ...
  while (ent:hasNext()) do 
    ...
    if (__deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_game_CleanupEnt)[ent][1] == 1) then 
      if (_g[1] == 1) then 
        __haxe_Log.trace(ent, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/GameManager.hx",lineNumber=197,className="deceptinfect.GameManager",methodName="cleanup"}));
        _g[2].entity:Remove();
      end;
    end;
...
__deceptinfect_GameManager.newWin = function(x) 
  local tmp = x[1];
  if (tmp) == 0 then 
    __haxe_Log.trace("Humans win", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/GameManager.hx",lineNumber=234,className="deceptinfect.GameManager",methodName="newWin"}));
  elseif (tmp) == 1 then 
    __haxe_Log.trace("Infected win", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/GameManager.hx",lineNumber=236,className="deceptinfect.GameManager",methodName="newWin"}));
  elseif (tmp) == 2 then 
    __haxe_Log.trace("Draw. Boring...", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/GameManager.hx",lineNumber=238,className="deceptinfect.GameManager",methodName="newWin"})); end;
...
__deceptinfect_WeaponSystem.prototype.run_server = function(self) 
  ...
  if (_g[1] == 2) then 
    if (_g[2].totalGameTime > self.timevalues:get(self.currentStage)) then 
      ...
      while (ent:hasNext()) do 
        local ent = ent:next();
        local _g = __deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_game_AliveComponent)[ent];
...
__deceptinfect_ecswip_DamagePenaltyHidden.prototype = _hx_e();
...
__deceptinfect_ecswip_GrabAccepter.prototype = _hx_e();
...
_hxClasses["deceptinfect.ecswip.GrabAcceptState"] = __deceptinfect_ecswip_GrabAcceptState;
...
__deceptinfect_ecswip_GrabProducer.prototype = _hx_e();
...
_hxClasses["deceptinfect.ecswip.SearchingState"] = __deceptinfect_ecswip_SearchingState;
...
_hxClasses["deceptinfect.ecswip.GrabProduceState"] = __deceptinfect_ecswip_GrabProduceState;
    ...
    if (_g[1] == 1) then 
      ...
      if (_g.grabState[1] == 1) then 
        ...
        if (_g.damage >= _g.threshold) then 
          ...
          _g:set_grabState(__deceptinfect_ecswip_GrabProduceState.NOT_READY(__deceptinfect_util_Cooldown.COOLDOWN(_G.CurTime() + _g.nextCooldown)));
        end;
      end;
    end;
  end;
      ...
      if (_g1[1] == 0) then 
        ...
        if (_g1[1] == 2) then 
          if (_g.grabState[1] == 0) then 
            __haxe_Log.trace(Std.string("c_accpet ") .. Std.string(Std.string(_g.grabState)), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/ecswip/GrabSystem.hx",lineNumber=245,className="deceptinfect.ecswip.GrabSystem",methodName="attemptGrab"}));
  ...
  if (_g[1] == 1) then 
    ...
    if (_hx_tmp[1] == 0) then 
      if (_hx_tmp[2][1] == 0) then 
        _g:set_grabState(__deceptinfect_ecswip_GrabProduceState.READY(__deceptinfect_ecswip_SearchingState.SEARCHING));
      end;
    end;
  end;
end
__deceptinfect_ecswip_GrabSystem.requestStopSearch = function(attack) 
  ...
  if (_g[1] == 1) then 
    ...
    if (_hx_tmp[1] == 0) then 
      ...
      if (tmp) == 1 then 
        _g:set_grabState(__deceptinfect_ecswip_GrabProduceState.READY(__deceptinfect_ecswip_SearchingState.NOT_SEARCHING));
      elseif (tmp) == 2 then 
        _g:set_grabState(__deceptinfect_ecswip_GrabProduceState.READY(__deceptinfect_ecswip_SearchingState.NOT_SEARCHING));else end;
    end;
  end;
end
      ...
      if (_g.grabState[1] == 0) then 
        if (_g1[1] == 0) then 
          ...
          if (tmp) == 1 then 
            ...
            if (_g.numTargeting >= _g.overwhelm) then 
              __deceptinfect_ecswip_GrabSystem.attemptGrab(attack, vic);
            end;
          elseif (tmp) == 2 then 
            __haxe_Log.trace(_g.grabState, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/ecswip/GrabSystem.hx",lineNumber=289,className="deceptinfect.ecswip.GrabSystem",methodName="attemptTarget"}));
          ...
          if (tmp) == 1 then 
            ...
            while (victim:hasNext()) do 
              ...
              if (attack ~= victim) then 
                local _g = __deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_game_AliveComponent)[victim];
                local _g1 = __deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_ecswip_VirtualPosition)[victim];
                local _g2 = __deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_ecswip_GrabAccepter)[victim];
                if (_g2[1] == 1) then 
                  if (_g1[1] == 1) then 
                    if (_g[1] == 1) then 
                      local _hx_tmp;
        ...
        elseif (tmp) == 1 then 
          ...
          if (_g[1] == 1) then 
            ...
            elseif (tmp) == 1 then 
              ...
              retrieve_comp.grabState = __deceptinfect_ecswip_GrabAcceptState.UNAVALIABLE(__deceptinfect_util_Cooldown.UNAVALIABLE); end;
          else
...
__deceptinfect_ecswip_HiddenHealthComponent.prototype = _hx_e();
...
__deceptinfect_ecswip_SpectateComponent.prototype = _hx_e();
  ...
  while (entity:hasNext()) do repeat 
    ...
    if (_g[1] == 1) then 
      ...
      if (_g.acceptingInfection[1] == 0) then 
        local _g1 = __deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_game_AliveComponent)[entity];
        ...
        if (_g1[1] == 0) then 
          local _g1 = _g1[2];
          local base = __deceptinfect_infection_InfectionSystem.getBaseInfection(_g);
          local _g2 = __deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_infection_RateComponent)[entity];
          local rate = (function() 
            local _hx_1
            if (_g2[1] == 1) then 
            _hx_1 = __deceptinfect_infection_InfectionSystem.calcInfectionFromRates(_g2[2]); else 
            _hx_1 = _g.rate; end
            return _hx_1
          end )();
          rate = rate + 1;
          ...
          __deceptinfect_infection_InfectionSystem.fixUpInfection(_g);
          local _g2 = __deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_ecswip_PlayerComponent)[entity];
          if (_g2[1] == 1) then 
            __deceptinfect_infection_InfectionSystem.net_inf:send(_hx_o({__fields__={infection=true},infection=_g1[0]}), _g2[2].player, true);
            totalInf = totalInf + _g:getInfValue();
            numPlayers = numPlayers + 1;
          end;
          _g.rate = rate;
          if (_g.infection[1] == 1) then 
            __deceptinfect_infection_InfectionSystem.onInfected(entity);
          end;
        else
          totalInf = totalInf + _g:getInfValue();
          numPlayers = numPlayers + 1;
...
__deceptinfect_infection_InfectionSystem.prototype.makeInfected = function(self,ent) 
  ...
  if (_g[1] == 1) then 
    ...
    __haxe_Log.trace(Std.string("infection : ") .. Std.string(Std.string(_g.infection)), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/infection/InfectionSystem.hx",lineNumber=141,className="deceptinfect.infection.InfectionSystem",methodName="makeInfected"}));
  end;
end
...
__deceptinfect_game_WinSystem.prototype.run_server = function(self) 
  ...
  while (ent:hasNext()) do 
    local ent = ent:next();
    local _g = __deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_game_NestComponent)[ent];
    if (_g[1] == 1) then 
...
__deceptinfect_game_BatterySystem.prototype.run_server = function(self) 
  ...
  while (ents:hasNext()) do 
    ...
    local _g = __deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_game_BatteryAccepter)[ents];
    if (_g[1] == 1) then 
      local _g = _g[2];
      ...
      if (_g.charge > _g.satisfy) then 
        _g.status = __deceptinfect_game_AccepterStatus.SATISIFED;
      end;
      if (_g.status[1] == 1) then 
        if (_g.charge < _g.satisfy) then 
          _g.status = __deceptinfect_game_AccepterStatus.AVALIABLE;
        end;
      end;
    end;
  end;
...
__deceptinfect_game_SpawnPointTable.prototype.getRandom = function(self) 
  ...
  __haxe_Log.trace(Std.string("index chosen ") .. Std.string(choose), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/game/SpawnSystem.hx",lineNumber=245,className="deceptinfect.game.SpawnPointTable",methodName="getRandom"}));
...
__deceptinfect_game_SpawnSystem.prototype.run_server = function(self) 
  ...
  while (ent:hasNext()) do 
    ...
    local _g1 = __deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_game_Spawned)[ent];
    if (_g1[1] == 1) then 
      local _g1 = _g1[2];
      if (_g[1] == 1) then 
        if (_g1.spawn.vec:DistToSqr(_g[2]:get_pos()) > 8100) then 
          ...
          __deceptinfect_ecswip_ComponentManager.removeComponent(__deceptinfect_game_Spawned, ent);
        end;
      end;
    end;
  end;
...
__deceptinfect_game_NestSystem.prototype.run_server = function(self) 
  ...
  while (ent:hasNext()) do 
    ...
    local _g1 = __deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_game_NestComponent)[ent];
    if (_g1[1] == 1) then 
      local _g1 = _g1[2];
      if (_g[1] == 1) then 
        local _g = _g[2];
        ...
        end)(_hx_tab_array({[0]=_g1.rate_threshold_max}, 1), _hx_tab_array({[0]=_g1.rate_threshold_min}, 1), _hx_tab_array({[0]=__deceptinfect_infection_InfectionSystem.averageInfection}, 1));
...
__deceptinfect_game_EvacSystem.prototype.run_server = function(self) 
  ...
  while (ent:hasNext()) do 
    local ent = ent:next();
    local _g = __deceptinfect_GameManager.state;
    local _g1 = __deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_game_EvacZone)[ent];
    if (_g1[1] == 1) then 
      if (_g[1] == 2) then 
        local c_evac = _g1[2];
...
__deceptinfect_game_RagdollSystem.prototype.endSlowMotion = function(self,x) 
  ...
  while (ent:hasNext()) do 
    local ent = ent:next();
    local _g = __deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_ecswip_GEntityComponent)[ent];
    local _g1 = __deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_game_Statue)[ent];
    if (__deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_game_Ragdoll)[ent][1] == 1) then 
      if (_g1[1] == 1) then 
        if (_g[1] == 1) then 
          local _hx_tmp;
          _hx_tmp = _g[2].entity;
...
__deceptinfect_game_RagdollSystem.prototype.stateChange = function(self,newstate) 
  ...
  elseif (tmp) == 3 then 
    ...
    while (ent:hasNext()) do 
      ...
      local _g = __deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_game_Ragdoll)[ent];
  ...
  if (_g[1] == 0) then 
    ...
    while (ent:hasNext()) do 
      local ent = ent:next();
      local _g = __deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_ecswip_GEntityComponent)[ent];
      if (__deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_game_Statue)[ent][1] == 1) then 
        if (_g[1] == 1) then 
  ...
  while (ent:hasNext()) do 
    ...
    if (_g1[1] == 1) then 
      if (_g[1] == 1) then 
        ...
        local _g = __deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_game_Statue)[ent];
        if (_g[1] ~= 1) then 
    ...
    if (_g[1] == 1) then 
      ...
      if (_g[1] == 0) then 
        local id = _g[2];
        local _g = __deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_game_StatInfo)[id];
...
__deceptinfect_ents_Di_nest.prototype.Think = function(self) 
  ...
  while (ent:hasNext()) do 
    local ent = ent:next();
    local this1 = self.id;
    local _g = __deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_game_NestComponent)[this1];
    local _g1 = __deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_infection_InfectedComponent)[ent];
    local _g2 = __deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_ecswip_PlayerComponent)[ent];
    if (_g2[1] == 1) then 
      local _g2 = _g2[2];
...
__deceptinfect_game_AliveComponent.prototype = _hx_e();
...
__deceptinfect_game_BatteryAccepter.prototype = _hx_e();
...
_hxClasses["deceptinfect.game.AccepterStatus"] = __deceptinfect_game_AccepterStatus;
...
__deceptinfect_game_BatterySource.prototype = _hx_e();
...
__deceptinfect_game_CleanupEnt.prototype = _hx_e();
...
__deceptinfect_game_EvacZone.prototype = _hx_e();
...
_hxClasses["deceptinfect.game.EvacState"] = __deceptinfect_game_EvacState;
...
__deceptinfect_game_FlareComponent.prototype = _hx_e();
...
__deceptinfect_game_InEvacZone.prototype = _hx_e();
...
__deceptinfect_game_NestComponent.prototype = _hx_e();
...
_hxClasses["deceptinfect.game.NestState"] = __deceptinfect_game_NestState;
...
__deceptinfect_game_Ragdoll.prototype = _hx_e();
...
_hxClasses["deceptinfect.game.RagdollReveal"] = __deceptinfect_game_RagdollReveal;
...
__deceptinfect_game_Spawn.prototype.getRandomSpawnMinDistAway = function(self,curSpawns) 
  ...
  while (_g < curSpawns.length) do 
    ...
    __haxe_Log.trace(Std.string(Std.string(Std.string("id : ") .. Std.string(_sp)) .. Std.string(" stuff : ")) .. Std.string(((function() 
      ...
      return _hx_1
    end )())), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/game/SpawnSystem.hx",lineNumber=70,className="deceptinfect.game.Spawn",methodName="getRandomSpawnMinDistAway"}));
    local _g = __haxe_iterators_MapKeyValueIterator.new(sp.distStore);
    while (_g:hasNext()) do 
      local _g = _g:next();
      local id = _g.key;
      local dist = _g.value;
      __haxe_Log.trace(Std.string(Std.string(Std.string(Std.string(Std.string("my id : ") .. Std.string(_sp)) .. Std.string(" thier id : ")) .. Std.string(id)) .. Std.string(" boogie : ")) .. Std.string(Std.string(self.parent.spawns[id].claimed)), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/game/SpawnSystem.hx",lineNumber=73,className="deceptinfect.game.Spawn",methodName="getRandomSpawnMinDistAway"}));
      if (self.parent.spawns[id].claimed == __deceptinfect_game_SpawnClaim.UNCLAIMED) then 
        local ret = total.h[id];
        if (ret == __haxe_ds_IntMap.tnull) then 
          ret = nil;
        end;
        __haxe_Log.trace(ret, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/game/SpawnSystem.hx",lineNumber=75,className="deceptinfect.game.Spawn",methodName="getRandomSpawnMinDistAway"}));
        local ret = total.h[id];
        if (ret == __haxe_ds_IntMap.tnull) then 
          ret = nil;
        end;
        ...
        if (ret > max) then 
          ...
          local max1 = ret;
          max = max1;
          __haxe_Log.trace(Std.string("new max ") .. Std.string(max1), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/game/SpawnSystem.hx",lineNumber=84,className="deceptinfect.game.Spawn",methodName="getRandomSpawnMinDistAway"}));
        end;
        local ret = total.h[id];
        if (ret == __haxe_ds_IntMap.tnull) then 
          ret = nil;
        ...
        if (ret < min) then 
          ...
          local min1 = ret;
          min = min1;
          __haxe_Log.trace(Std.string("new min ") .. Std.string(min1), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/game/SpawnSystem.hx",lineNumber=88,className="deceptinfect.game.Spawn",methodName="getRandomSpawnMinDistAway"}));
        end;
      end;
    end;
  end;
  ...
  if (luckydraw.length == 0) then 
    __haxe_Log.trace("Not enough spawns far away enough to use algo.", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/game/SpawnSystem.hx",lineNumber=103,className="deceptinfect.game.Spawn",methodName="getRandomSpawnMinDistAway"}));
    local id = self:getRandomFarAwaySpawn();
    __haxe_Log.trace(Std.string("id chosen ") .. Std.string(id), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/game/SpawnSystem.hx",lineNumber=105,className="deceptinfect.game.Spawn",methodName="getRandomSpawnMinDistAway"}));
    do return self.parent.spawns[id] end;
  else
    local index = _G.math.random(0, luckydraw.length - 1);
    local id = luckydraw[index];
    __haxe_Log.trace(luckydraw, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/game/SpawnSystem.hx",lineNumber=111,className="deceptinfect.game.Spawn",methodName="getRandomSpawnMinDistAway"}));
    __haxe_Log.trace(Std.string(Std.string(Std.string("id chosen ") .. Std.string(id)) .. Std.string(" index ")) .. Std.string(index), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/game/SpawnSystem.hx",lineNumber=112,className="deceptinfect.game.Spawn",methodName="getRandomSpawnMinDistAway"}));
    do return self.parent.spawns[id] end;
  end;
end
...
__deceptinfect_game_Spawn.prototype.spawn = function(self,ent) 
  ...
  if (_g[1] == 0) then 
    ...
    __deceptinfect_ecswip_ComponentManager.addComponent(__deceptinfect_game_Spawned.new(self), _g);
  end;
end
...
__deceptinfect_game_BoundsSpawn.prototype.spawn = function(self,ent) 
  ...
  if (_g[1] == 0) then 
    local _g = _g[2];
    __haxe_Log.trace(_g, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/game/SpawnSystem.hx",lineNumber=200,className="deceptinfect.game.BoundsSpawn",methodName="spawn"}));
    __deceptinfect_ecswip_ComponentManager.addComponent(__deceptinfect_game_Spawned.new(self), _g);
  end;
...
__deceptinfect_game_Spawned.prototype = _hx_e();
