...
__gmod_gamemode_GM.__name__ = "gmod.gamemode.GM"
...
__deceptinfect_DeceptInfect.prototype.PlayerButtonUp = function(self,ply,button) 
  ...
  elseif (button) == _G.KEY_M then 
    __haxe_Log.trace(__deceptinfect_ecswip_ComponentManager.components.h[__deceptinfect_ecswip_PlayerComponent], _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/DeceptInfect.hx",lineNumber=174,className="deceptinfect.DeceptInfect",methodName="PlayerButtonUp"}));
...
__deceptinfect_DeceptInfect.prototype.IsSpawnpointSuitable = function(self,ply,spawnpoint,makeSuitable) 
  ...
  if (tracehit.HitWorld) then 
    __haxe_Log.trace("not valid..", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/DeceptInfect.hx",lineNumber=306,className="deceptinfect.DeceptInfect",methodName="IsSpawnpointSuitable"}));
    do return false end;
  end;
  do return true end
end
__deceptinfect_DeceptInfect.prototype.PlayerSelectSpawn = function(self,ply,transition) 
  ...
  __haxe_Log.trace("Could not find a spawn!", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/DeceptInfect.hx",lineNumber=323,className="deceptinfect.DeceptInfect",methodName="PlayerSelectSpawn"}));
  do return nil end
end
...
__gmod_sent_ENT.prototype["self"]= nil;
...
__deceptinfect_game_Spawn.prototype.getRandomSpawnMinDistAway = function(self,curSpawns) 
  ...
  while (_g < curSpawns.length) do 
    ...
    __haxe_Log.trace(Std.string(Std.string(Std.string("id : ") .. Std.string(_sp)) .. Std.string(" stuff : ")) .. Std.string(((function() 
      ...
      return _hx_1
    end )())), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/game/SpawnSystem.hx",lineNumber=71,className="deceptinfect.game.Spawn",methodName="getRandomSpawnMinDistAway"}));
...
__deceptinfect_game_Spawn.prototype.spawn = function(self,ent) 
  ...
  if (_g[1] == 0) then 
    local _g = _g[2];
    __haxe_Log.trace(_g, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/game/SpawnSystem.hx",lineNumber=138,className="deceptinfect.game.Spawn",methodName="spawn"}));
...
__deceptinfect_game_BoundsSpawn.prototype.spawn = function(self,ent) 
  ...
  if (_g[1] == 0) then 
    local _g = _g[2];
    __haxe_Log.trace(_g, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/game/SpawnSystem.hx",lineNumber=201,className="deceptinfect.game.BoundsSpawn",methodName="spawn"}));
    __deceptinfect_ecswip_ComponentManager.addComponent(__deceptinfect_game_Spawned.new(self), _g);
  end;
...
__gmod_swep_SWEP.prototype = _hx_e();
