...
__deceptinfect_DeceptInfect.prototype.playerDeath = function(self,victim) 
  __deceptinfect_ecswip_ComponentManager.removeComponent(20, victim.id);
...
__deceptinfect_GameManager.initPlayer = function(ply) 
  ...
  local fam = __deceptinfect_ecswip_ComponentManager.components_3[id];
  if (fam[1][id] == nil) then 
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, p, infcomp);
  else
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, p, infcomp);
  end;
  local id = 7;
  local fam = __deceptinfect_ecswip_ComponentManager.components_3[id];
  if (fam[1][id] == nil) then 
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, p, spec);
  else
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, p, spec);
  end;
  local id = 30;
  local fam = __deceptinfect_ecswip_ComponentManager.components_3[id];
  if (fam[1][id] == nil) then 
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, p, rate);
  else
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, p, rate);
  end;
  local id = 8;
  local fam = __deceptinfect_ecswip_ComponentManager.components_3[id];
  if (fam[1][id] == nil) then 
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, p, health);
  else
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, p, health);
  end;
  local id = 9;
  local fam = __deceptinfect_ecswip_ComponentManager.components_3[id];
  if (fam[1][id] == nil) then 
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, p, grabaccept);
  else
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, p, grabaccept);
  end;
  local id = 27;
  local fam = __deceptinfect_ecswip_ComponentManager.components_3[id];
  if (fam[1][id] == nil) then 
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, p, radaccept);
  else
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, p, radaccept);
  end;
  local id = 34;
  local fam = __deceptinfect_ecswip_ComponentManager.components_3[id];
  if (fam[1][id] == nil) then 
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, p, virpos);
  else
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, p, virpos);
  end;
  local id = 20;
  local x = __deceptinfect_game_components_AliveComponent.new();
  local fam = __deceptinfect_ecswip_ComponentManager.components_3[id];
  if (fam[1][id] == nil) then 
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, p, x);
  else
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, p, x);
  end;
  local id = 13;
  local fam = __deceptinfect_ecswip_ComponentManager.components_3[id];
  if (fam[1][id] == nil) then 
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, p, vic);
  else
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, p, vic);
  end;
  local id = 28;
  local fam = __deceptinfect_ecswip_ComponentManager.components_3[id];
  if (fam[1][id] == nil) then 
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, p, contam);
  else
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, p, contam);
  end;
  local g = __deceptinfect_game_GeigerCounter.new();
  local id = 21;
  local fam = __deceptinfect_ecswip_ComponentManager.components_3[id];
  if (fam[1][id] == nil) then 
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, p, g);
  else
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, p, g);
  end;
end
...
__deceptinfect_GameManager.set_state = function(x) 
  ...
  __haxe_Log.trace(Std.string("set state... ") .. Std.string(Std.string(x)), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/GameManager.hx",lineNumber=180,className="deceptinfect.GameManager",methodName="set_state"}));
  __deceptinfect_GameManager.stateTrig.handlers:invoke(x);
...
__deceptinfect_GameManager.cleanup = function() 
  ...
  while (ent_nextV ~= nil) do 
    ...
    if (_g) == "di_battery" or (_g) == "di_charger" or (_g) == "di_evac_zone" or (_g) == "di_flare" or (_g) == "di_nest" then 
      __haxe_Log.trace("removing entiti", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/GameManager.hx",lineNumber=208,className="deceptinfect.GameManager",methodName="cleanup"}));
      v:Remove();else end;
  end;
...
__deceptinfect_GameManager.initInfectedPlayer = function(x) 
  ...
  local fam = __deceptinfect_ecswip_ComponentManager.components_3[id];
  if (fam[1][id] == nil) then 
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, x, x1);
  else
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, x, x1);
  end;
  local id = 10;
  ...
  __deceptinfect_ecswip_ComponentManager.getComponentForIDSure(19, x);
  ...
  local id = 34;
  local x = __deceptinfect_ecswip_VirtualPosition.new(__deceptinfect_ecswip_ChooseVirPos.ENT(__deceptinfect_ecswip_ComponentManager.getComponentForIDSure(29, x).entity));
  local fam = __deceptinfect_ecswip_ComponentManager.components_3[id];
  if (fam[1][id] == nil) then 
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, rad, x);
  else
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, rad, x);
  end;
end
...
__deceptinfect_ecswip_ComponentManager.addGEnt = function(x) 
  ...
  local fam = __deceptinfect_ecswip_ComponentManager.components_3[id1];
  if (fam[1][id1] == nil) then 
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, id, x1);
  else
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, id, x1);
  end;
  local id1 = 34;
  local x = __deceptinfect_ecswip_VirtualPosition.new(__deceptinfect_ecswip_ChooseVirPos.ENT(x));
  local fam = __deceptinfect_ecswip_ComponentManager.components_3[id1];
  if (fam[1][id1] == nil) then 
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, id, x);
  else
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, id, x);
  end;
  do return id end;
end
...
__deceptinfect_abilities_FormSystem.changeForm = function(ent) 
  local c_form = __deceptinfect_ecswip_ComponentManager.getComponentForIDSure(17, ent);
  local g_ent = __deceptinfect_ecswip_ComponentManager.getComponentForIDSure(29, ent).entity;
...
__deceptinfect_client_GeigerSystem.testGeiger = function(x) 
  ...
  local fam = __deceptinfect_ecswip_ComponentManager.components_3[id];
  if (fam[1][id] == nil) then 
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, to, xdee);
  else
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, to, xdee);
  end;
  local diid = x.id;
  local fam = __deceptinfect_ecswip_ComponentManager.components_3[36];
  local replEnt = (function() 
    local _hx_1
    if (fam[1][diid] == nil) then 
    _hx_1 = nil; else 
    _hx_1 = fam[3][fam[1][diid]]; end
    return _hx_1
  end )();
  if (replEnt ~= nil) then 
    if (replEnt.ids.h[21] == nil) then 
      local _this = replEnt.ids;
      _this.h[21] = true;
    end;
  else
    local replEnt = __deceptinfect_ecswip_ReplicatedEntity.new();
    local id = 36;
    local to = x.id;
    local fam = __deceptinfect_ecswip_ComponentManager.components_3[id];
    if (fam[1][id] == nil) then 
      __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, to, replEnt);
    else
      __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, to, replEnt);
    end;
    local _this = replEnt.ids;
    _this.h[21] = true;
  end;
  xdee.replicated = __deceptinfect_ecswip_ReplicatedTarget.SOME(__deceptinfect_ecswip_SomeTargets.CURRENT_PLAYER);
  xdee.geiger = 0.5;
end
...
__deceptinfect_client_GeigerSystem.testGeiger2 = function(x) 
  local count = __deceptinfect_ecswip_ComponentManager.getComponentForIDSure(21, x.id);
  count.geiger = 0;
  count.replicated = __deceptinfect_ecswip_ReplicatedTarget.NONE;
  __deceptinfect_ecswip_SystemManager.getSystem(__deceptinfect_game_ClientTranslateSystem):enqueueComponent(x.id, count, __deceptinfect_ecswip_ReplicatedTarget.SOME(__deceptinfect_ecswip_SomeTargets.CURRENT_PLAYER));
end
...
__deceptinfect_client_GeigerSystem.prototype.run_server = function(self) 
  ...
  local __n = 0;
  local __lowest = __compArr[21][4];
  local __lowest_comp = 21;
  __n = __compArr[19][4];
  ...
  while (_g < _g1) do 
    ...
    if (((__compArr[21][1][ent] ~= nil) and (__compArr[19][1][ent] ~= nil)) and (__compArr[38][1][ent] ~= nil)) then 
      local this1 = __compArr[21];
      local this2 = __compArr[19];
...
__deceptinfect_ecswip_GrabSystem.grabStop = function(attack) 
  local c_produce = __deceptinfect_ecswip_ComponentManager.getComponentForIDSure(10, attack);
  local attackPos = __deceptinfect_ecswip_ComponentManager.getComponentForIDSure(34, attack):get_pos();
  local vic;
  ...
  local vicPos = __deceptinfect_ecswip_ComponentManager.getComponentForIDSure(34, vic):get_pos();
...
__deceptinfect_ecswip_GrabSystem.target = function(attacker,victim) 
  ...
  local c_produce = __deceptinfect_ecswip_ComponentManager.getComponentForIDSure(10, attacker);
  local _this = c_accept.targeting;
  _this.h[c_produce] = true;
  _this.k[c_produce] = true;
...
__deceptinfect_ecswip_GrabSystem.prototype.run_server = function(self) 
  ...
  while (_g < _g1) do 
    ...
    if ((__compArr[10][1][attack] ~= nil) and (__compArr[29][1][attack] ~= nil)) then 
      local this1 = __compArr[10];
      local _g = this1[3][this1[1][attack]];
      local this1 = __compArr[29];
      ...
      if (tmp) == 0 then 
        ...
        if (tmp) == 1 then 
          ...
          while (_g2 < _g3) do repeat 
            ...
            if ((__compArr[9][1][victim] ~= nil) and (__compArr[34][1][victim] ~= nil)) then 
              ...
              if ((__deceptinfect_ecswip_ComponentManager.components_3[20][1][victim] == nil) and (__deceptinfect_ecswip_ComponentManager.components_3[2][1][victim] == nil)) then 
                break;
              end;
        ...
        elseif (tmp) == 2 then 
          local _g2 = _g2[2];
          local prevPos = __deceptinfect_ecswip_ComponentManager.getComponentForIDSure(34, _g2):get_pos();
...
__deceptinfect_infection_systems_InfectionSystem.getBaseInfection = function(inf) 
  ...
  elseif (tmp) == 1 then 
    ...
    if (_g[1] == 2) then 
      ...
      __haxe_Log.trace("Not currently playing...", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/infection/systems/InfectionSystem.hx",lineNumber=164,className="deceptinfect.infection.systems.InfectionSystem",methodName="getBaseInfection"}));
...
__deceptinfect_infection_systems_InfectionSystem.fixUpInfection = function(infection) 
  ...
  if (_g[1] == 0) then 
    ...
    if (_g[0] < 0) then 
      ...
      if (_g[0] >= 100) then 
        __haxe_Log.trace("Now infected :)", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/infection/systems/InfectionSystem.hx",lineNumber=180,className="deceptinfect.infection.systems.InfectionSystem",methodName="fixUpInfection"}));
...
__deceptinfect_infection_systems_InfectionSystem.prototype.run_server = function(self) 
  ...
  while (_g < __lowest) do repeat 
    ...
    local __int_id = _g - 1;
    local ent = __lowestInt[__int_id];
    if (__compArr[19][1][ent] ~= nil) then 
      ...
      if (_g1[1] == 0) then 
        ...
        if (_g.acceptingInfection[1] == 0) then 
          if ((__deceptinfect_ecswip_ComponentManager.components_3[38][1][ent] ~= nil) and (__deceptinfect_ecswip_ComponentManager.components_3[20][1][ent] == nil)) then 
            break;
          end;
...
__deceptinfect_radiation_RadiationSystem.testRadiation = function(vec) 
  ...
  local fam = __deceptinfect_ecswip_ComponentManager.components_3[id];
  if (fam[1][id] == nil) then 
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, ent, x);
  else
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, ent, x);
  end;
end
...
__deceptinfect_radiation_RadiationSystem.prototype.run_server = function(self) 
  local __compArr = __deceptinfect_ecswip_ComponentManager.components_3;
  local __n = 0;
  local __lowest = __compArr[27][4];
  local __lowest_comp = 27;
  __n = __compArr[30][4];
  if (__n < __lowest) then 
    __lowest = __n;
    __lowest_comp = 30;
  ...
  while (_g < _g1) do 
    ...
    local __int_id = _g - 1;
    local ent = __lowestInt[__int_id];
    if ((((__compArr[27][1][ent] ~= nil) and (__compArr[30][1][ent] ~= nil)) and (__compArr[34][1][ent] ~= nil)) and (__compArr[13][1][ent] ~= nil)) then 
      local this1 = __compArr[27];
      local _g = this1[3][this1[1][ent]];
      local this1 = __compArr[30];
      ...
      local __compArr = __deceptinfect_ecswip_ComponentManager.components_3;
      local __n = 0;
      local __lowest = __compArr[32][4];
      local __lowest_comp = 32;
      __n = __compArr[34][4];
      if (__n < __lowest) then 
        __lowest = __n;
        __lowest_comp = 34;
      ...
      while (_g2 < _g4) do 
        ...
        if (((__compArr[32][1][produce] ~= nil) and (__compArr[34][1][produce] ~= nil)) and (__compArr[31][1][produce] ~= nil)) then 
          local this1 = __compArr[32];
    ...
    if (_g[1] == 1) then 
      ...
      if (_g1[1] == 1) then 
        if (_g.spawn.vec:DistToSqr(_g1[2]:get_pos()) > 8100) then 
          ...
          __deceptinfect_ecswip_ComponentManager.removeComponent(43, ent);
        end;
      end;
    end;
  end;
    ...
    if (_g[1] == 1) then 
      if (_g1[1] == 1) then 
        ...
        if (not tooclose) then 
          ...
          __deceptinfect_ecswip_ComponentManager.removeComponent(16, ent);
        end;
      end;
    end;
  end;
...
__deceptinfect_game_EvacSystem.prototype.leave = function(self,ent,evac) 
  ...
  if (_g[1] == 1) then 
    ...
    __deceptinfect_ecswip_ComponentManager.removeComponent(42, ent);
  end;
end
...
__deceptinfect_game_RagdollSystem.prototype.playerRagdoll = function(self,owner,ragdoll) 
  if (owner:IsPlayer()) then 
    ...
    if (_g[1] == 1) then 
      ...
      local ret = this1;
      ret[0] = v;
      __deceptinfect_ecswip_ComponentManager.getComponentForIDSure(22, di_ragdoll.id).reveal = __deceptinfect_game_components_RagdollReveal.WAIT(ret);
    end;
  end;
...
__deceptinfect_game_RagdollSystem.prototype.playerStatue = function(self,plyr,inf) 
  ...
  local fam = __deceptinfect_ecswip_ComponentManager.components_3[id];
  if (fam[1][id] == nil) then 
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, to, c_stat);
  else
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, to, c_stat);
  end;
  local id = 44;
...
__deceptinfect_game_RagdollSystem.prototype.newRagdoll = function(self,owner,old) 
  ...
  rag:Spawn();
  __deceptinfect_ecswip_ComponentManager.getComponentForIDSure(22, rag.id).owner = owner.id;
  local _g = 0;
...
__deceptinfect_game_RagdollSystem.prototype.reveal = function(self,rag) 
  ...
  local c_rag = __deceptinfect_ecswip_ComponentManager.getComponentForIDSure(22, newmodel.id);
  c_rag.reveal = __deceptinfect_game_components_RagdollReveal.REVEAL;
  c_rag.owner = __deceptinfect_ecswip_ComponentManager.getComponentForIDSure(22, rag.id).owner;
          ...
          if (_hx_tmp[1] == 1) then 
            ...
            if (t > _g.threshold) then 
              ...
              elseif (inf1) == 1 then 
                isinfected = true;
                inf = 100.0; end;
              __deceptinfect_infection_systems_InfectionLookSystem.infectioninfo:send(_hx_o({__fields__={target=true,isinfected=true,inf=true},target=__deceptinfect_ecswip_ComponentManager.getComponentForIDSure(38, _g2).player,isinfected=isinfected,inf=inf}), _g1, true);
...
__deceptinfect_radiation_ContaminationSystem.prototype.run_server = function(self) 
  local __compArr = __deceptinfect_ecswip_ComponentManager.components_3;
  local __n = 0;
  local __lowest = __compArr[13][4];
  local __lowest_comp = 13;
  __n = __compArr[28][4];
  if (__n < __lowest) then 
    __lowest = __n;
    __lowest_comp = 28;
  ...
  while (_g < _g1) do 
    ...
    if (((__compArr[13][1][vic] ~= nil) and (__compArr[28][1][vic] ~= nil)) and (__compArr[34][1][vic] ~= nil)) then 
      local this1 = __compArr[13];
      local _g = this1[3][this1[1][vic]];
      local this1 = __compArr[28];
      ...
      local __compArr = __deceptinfect_ecswip_ComponentManager.components_3;
      local __n = 0;
      local __lowest = __compArr[31][4];
      local __lowest_comp = 31;
      __n = __compArr[33][4];
      if (__n < __lowest) then 
        __lowest = __n;
        __lowest_comp = 33;
      ...
      while (_g < _g1) do repeat 
        ...
        local __int_id = _g - 1;
        local produce = __lowestInt[__int_id];
        if (((__compArr[31][1][produce] ~= nil) and (__compArr[33][1][produce] ~= nil)) and (__compArr[34][1][produce] ~= nil)) then 
          local this1 = __compArr[31];
          local _g = this1[3][this1[1][produce]];
          local this1 = __compArr[33];
          local _g1 = this1[3][this1[1][produce]];
          local this1 = __compArr[34];
          local _g2 = this1[3][this1[1][produce]];
          local _g3 = _g2:get_pos();
            ...
            if (time > c_contamProduce.check) then 
              ...
              if (randRoll < c_contamProduce.chance) then 
                ...
                elseif (rad1) == 2 then 
                  ...
                  local c_rs = __deceptinfect_ecswip_ComponentManager.getComponentForIDSure(31, rad1);
                  c_rs.lifetime = t;
...
__deceptinfect_radiation_RadSourceSystem.prototype.newRadSource = function(self,rso,attatch,base) 
  ...
  local fam = __deceptinfect_ecswip_ComponentManager.components_3[id];
  if (fam[1][id] == nil) then 
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, rad, c_rs);
  else
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, rad, c_rs);
  end;
  c_rs.base = (function() 
    local _hx_1
    if (base == nil) then 
...
__deceptinfect_radiation_RadSourceSystem.prototype.attatchRad = function(self,rad,vic) 
  local c_rs = __deceptinfect_ecswip_ComponentManager.getComponentForIDSure(31, rad);
  c_rs.attatch = vic;
  local c_rv;
  local id = 13;
  local _g;
  ...
  local fam = __deceptinfect_ecswip_ComponentManager.components_3[id];
  if (fam[1][id] == nil) then 
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, rad, c_vir);
  else
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, rad, c_vir);
  end;
  local id = 14;
...
__deceptinfect_radiation_RadSourceSystem.prototype.disengage = function(self,radsource,vic) 
  local c_rs = __deceptinfect_ecswip_ComponentManager.getComponentForIDSure(31, radsource);
  c_rs.attatch = nil;
  local id = 13;
  local _g;
  if (__deceptinfect_ecswip_ComponentManager.components_3[id][1][vic] ~= nil) then 
  ...
  __deceptinfect_ecswip_ComponentManager.removeComponent(34, radsource);
end
...
__deceptinfect_items_ScannerSystem.prototype.scan_target = function(self,scan,target) 
  local c_scan = __deceptinfect_ecswip_ComponentManager.getComponentForIDSure(41, scan);
  local id = 38;
  local _g;
...
__deceptinfect_game_ClientTranslateSystem.prototype.enqueueComponent = function(self,owner,comp,target) 
  local id = 35;
  local x = __deceptinfect_ecswip_ReplicateOnce.new();
  local fam = __deceptinfect_ecswip_ComponentManager.components_3[id];
  if (fam[1][id] == nil) then 
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, owner, x);
  else
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, owner, x);
  end;
end
...
__deceptinfect_ents_Di_evac_zone.prototype.StartTouch = function(self,ent) 
  ...
  if (_g[1] == 0) then 
    if (__deceptinfect_ecswip_ComponentManager.components_3[25][1][self.id] ~= nil) then 
      __deceptinfect_ecswip_SystemManager.getSystem(__deceptinfect_game_EvacSystem):leave(_g[2], __deceptinfect_ecswip_ComponentManager.getComponentForIDSure(25, self.id));
    end;
  end;
end
...
__deceptinfect_ents_Di_nest.prototype.Think = function(self) 
  __deceptinfect_ecswip_ComponentManager.getComponentForIDSure(24, self.id);
  local _g = 0;
  local _g1 = __deceptinfect_ecswip_ComponentManager.entities;
  while (_g < _g1) do 
    _g = _g + 1;
...
__deceptinfect_ents_Di_puddle.prototype.Think = function(self) 
  ...
  local tmp = _g[1];
  if (tmp) == 0 then 
    local inf = __deceptinfect_ecswip_ComponentManager.getComponentForIDSure(19, self.id);
...
__deceptinfect_game_ClientReplicationMachine.prototype.reset = function(self) 
end
__deceptinfect_game_ClientReplicationMachine.prototype.iterate = function(self) 
  self:reset();
  local __compArr = __deceptinfect_ecswip_ComponentManager.components_3;
  local __lowest = __compArr[36][4];
  local __lowest_comp = 36;
  local __lowestInt = __compArr[__lowest_comp][2];
  local _g = 1;
  while (_g < __lowest) do 
    ...
    local __int_id = _g - 1;
    local ent = __lowestInt[__int_id];
    if (__compArr[36][1][ent] ~= nil) then 
      local this1 = __compArr[36];
      local _g = this1[3][this1[1][ent]];
      self.added = __haxe_ds_ObjectMap.new();
      ...
      while (compID:hasNext()) do 
        ...
        elseif (tmp) == 1 then 
          ...
          elseif (tmp) == 1 then 
            arr = _g[2];
          elseif (tmp) == 2 then 
            local fam = __deceptinfect_ecswip_ComponentManager.components_3[38];
            local ply = (function() 
              local _hx_4
          ...
          elseif (tmp) == 3 then 
            ...
            while (_g < _g1) do 
              ...
              local __int_id = _g - 1;
              local ent = __lowestInt[__int_id];
              if ((__compArr[37][1][ent] ~= nil) and (__compArr[38][1][ent] ~= nil)) then 
                local this1 = __compArr[38];
...
__deceptinfect_game_ClientReplicationMachine.prototype.iterateSendOnce = function(self) 
  local __compArr = __deceptinfect_ecswip_ComponentManager.components_3;
  local __lowest = __compArr[35][4];
  local __lowest_comp = 35;
  local __lowestInt = __compArr[__lowest_comp][2];
  local _g = 1;
  while (_g < __lowest) do 
    _g = _g + 1;
    local __int_id = _g - 1;
    local ent = __lowestInt[__int_id];
    if (__compArr[35][1][ent] ~= nil) then 
      local this1 = __compArr[35];
      local _g = this1[3][this1[1][ent]];
      self.added = __haxe_ds_ObjectMap.new();
      self.addedReliable = __haxe_ds_ObjectMap.new();
      local compID = _g.ids:keys();
      ...
      __deceptinfect_ecswip_ComponentManager.removeComponent(35, ent);
    end;
  end;
...
__deceptinfect_game_Spawn.prototype.spawn = function(self,ent) 
  ...
  if (_g[1] == 0) then 
    ...
    local fam = __deceptinfect_ecswip_ComponentManager.components_3[id];
    if (fam[1][id] == nil) then 
      __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, _g, x);
    else
      __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, _g, x);
    end;
  end;
end
...
__deceptinfect_game_SpawnSystemNav.spawnItem = function(x) 
  ...
  if (_G.IsValid(navmesh)) then 
    ...
    if (traceResult.Hit) then 
      ...
      local fam = __deceptinfect_ecswip_ComponentManager.components_3[id];
      if (fam[1][id] == nil) then 
        __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, to, c_itemOwner);
      else
        __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, to, c_itemOwner);
      end;
...
local _hx_static_init = function()
  ...
  _hxClasses.Array = Array;
  Array.__name__ = "Array";
  __deceptinfect_ecswip_ComponentManager.initComponent(17, "FormComponent");
  __deceptinfect_ecswip_ComponentManager.initComponent(29, "GEntityComponent");
  __deceptinfect_ecswip_ComponentManager.initComponent(38, "PlayerComponent");
  __deceptinfect_ecswip_ComponentManager.initComponent(36, "ReplicatedEntity");
  __deceptinfect_ecswip_ComponentManager.initComponent(35, "ReplicateOnce");
  __deceptinfect_ecswip_ComponentManager.initComponent(34, "VirtualPosition");
  __deceptinfect_ecswip_ComponentManager.initComponent(21, "GeigerCounter");
  __deceptinfect_ecswip_ComponentManager.initComponent(20, "AliveComponent");
  __deceptinfect_ecswip_ComponentManager.initComponent(15, "BatteryAccepter");
  __deceptinfect_ecswip_ComponentManager.initComponent(0, "BatterySource");
  __deceptinfect_ecswip_ComponentManager.initComponent(12, "CleanupEnt");
  __deceptinfect_ecswip_ComponentManager.initComponent(25, "EvacZone");
  __deceptinfect_ecswip_ComponentManager.initComponent(23, "FlareComponent");
  __deceptinfect_ecswip_ComponentManager.initComponent(42, "InEvacZone");
  __deceptinfect_ecswip_ComponentManager.initComponent(26, "ItemOwner");
  __deceptinfect_ecswip_ComponentManager.initComponent(44, "KeepRestart");
  __deceptinfect_ecswip_ComponentManager.initComponent(24, "NestComponent");
  __deceptinfect_ecswip_ComponentManager.initComponent(4, "RagInfo");
  __deceptinfect_ecswip_ComponentManager.initComponent(22, "Ragdoll");
  __deceptinfect_ecswip_ComponentManager.initComponent(43, "Spawned");
  __deceptinfect_ecswip_ComponentManager.initComponent(5, "StatInfo");
  __deceptinfect_ecswip_ComponentManager.initComponent(45, "Statue");
  __deceptinfect_ecswip_ComponentManager.initComponent(3, "InfVunerability");
  __deceptinfect_ecswip_ComponentManager.initComponent(37, "InfectedComponent");
  __deceptinfect_ecswip_ComponentManager.initComponent(19, "InfectionComponent");
  __deceptinfect_ecswip_ComponentManager.initComponent(6, "InfectionLookInfo");
  __deceptinfect_ecswip_ComponentManager.initComponent(30, "RateComponent");
  __deceptinfect_ecswip_ComponentManager.initComponent(11, "DamagePenaltyHidden");
  ...
  __deceptinfect_ecswip_ComponentManager.initComponent(10, "GrabProducer");
  ...
  __deceptinfect_ecswip_ComponentManager.initComponent(41, "ScannerComponent");
  __deceptinfect_ecswip_ComponentManager.initComponent(28, "ContaminationAccepter");
  __deceptinfect_ecswip_ComponentManager.initComponent(33, "ContaminationProducer");
  __deceptinfect_ecswip_ComponentManager.initComponent(31, "RadSource");
  __deceptinfect_ecswip_ComponentManager.initComponent(13, "RadVictim");
  __deceptinfect_ecswip_ComponentManager.initComponent(27, "RadiationAccepter");
  __deceptinfect_ecswip_ComponentManager.initComponent(32, "RadiationProducer");
  __deceptinfect_ecswip_ComponentManager.initComponent(39, "S_Break");
  __deceptinfect_ecswip_ComponentManager.initComponent(40, "S_Explode");
  __deceptinfect_ecswip_ComponentManager.initComponent(14, "Contaminated");
  __deceptinfect_ecswip_ComponentManager.initComponent(16, "Walkthroughable");__hxbit_Serializer.UID = 0;
  ...
  __deceptinfect_abilities_FormComponent.compID = 17;
  
  __deceptinfect_ecswip_GEntityComponent.compID = 29;
  ...
  __deceptinfect_ecswip_PlayerComponent.compID = 38;
  ...
  __deceptinfect_ecswip_ReplicatedEntity.compID = 36;
  
  __deceptinfect_ecswip_ReplicateOnce.compID = 35;
  ...
  __deceptinfect_ecswip_VirtualPosition.compID = 34;
  ...
  __deceptinfect_game_GeigerCounter.compID = 21;
  ...
  __deceptinfect_game_components_AliveComponent.compID = 20;
  
  __deceptinfect_game_components_BatteryAccepter.compID = 15;
  
  __deceptinfect_game_components_BatterySource.compID = 0;
  
  __deceptinfect_game_components_CleanupEnt.compID = 12;
  
  __deceptinfect_game_components_EvacZone.compID = 25;
  
  __deceptinfect_game_components_FlareComponent.compID = 23;
  
  __deceptinfect_game_components_InEvacZone.compID = 42;
  ...
  __deceptinfect_game_components_ItemOwner.compID = 26;
  
  __deceptinfect_game_components_KeepRestart.compID = 44;
  
  __deceptinfect_game_components_NestComponent.compID = 24;
  
  __deceptinfect_game_components_RagInfo.compID = 4;
  
  __deceptinfect_game_components_Ragdoll.compID = 22;
  
  __deceptinfect_game_components_Spawned.compID = 43;
  
  __deceptinfect_game_components_StatInfo.compID = 5;
  
  __deceptinfect_game_components_Statue.compID = 45;
  
  __deceptinfect_infection_InfVunerability.compID = 3;
  
  __deceptinfect_infection_InfectedComponent.compID = 37;
  
  __deceptinfect_infection_InfectionComponent.compID = 19;
  ...
  __deceptinfect_infection_RateComponent.compID = 30;
  
  __deceptinfect_infection_components_DamagePenaltyHidden.compID = 11;
  
  __deceptinfect_infection_components_GrabAccepter.compID = 9;
  
  __deceptinfect_infection_components_GrabDraw.compID = 1;
  
  __deceptinfect_infection_components_GrabProducer.compID = 10;
  ...
  __deceptinfect_items_ScannerComponent.compID = 41;
  
  __deceptinfect_radiation_ContaminationAccepter.compID = 28;
  
  __deceptinfect_radiation_ContaminationProducer.compID = 33;
  
  __deceptinfect_radiation_RadSource.compID = 31;
  
  __deceptinfect_radiation_RadVictim.compID = 13;
  
  __deceptinfect_radiation_RadiationAccepter.compID = 27;
  
  __deceptinfect_radiation_RadiationProducer.compID = 32;
  ...
  __deceptinfect_sabotage_S_Break.compID = 39;
  
  __deceptinfect_sabotage_S_Explode.compID = 40;
  
  __deceptinfect_statuses_Contaminated.compID = 14;
  
  __deceptinfect_statuses_Walkthroughable.compID = 16;
  
  __deceptinfect_util_Util.mappy_2 = __haxe_ds_IntMap.new();
  
  __gmod_helpers_macros_include_Build.buildIdent = "Sierra Papa";
