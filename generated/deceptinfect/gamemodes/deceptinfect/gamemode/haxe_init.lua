...
Main.main = function() 
  ...
  if (eck ~= false) then 
    ...
    local um_lnext = _hx_1_p_next;
    local _hx_2_init_index, _hx_2_init_value = um_lnext(x, _hx_1_p_index);
    local um_nextV = _hx_2_init_value;
    local um_i = _hx_2_init_index;
    while (um_nextV ~= nil) do 
      local _hx_3_nextResult_index, _hx_3_nextResult_value = um_lnext(x, um_i);
      um_i = _hx_3_nextResult_index;
      um_nextV = _hx_3_nextResult_value;
    end;
    local x = b:ReadLumpTexData();
    local _hx_4_p_next, _hx_4_p_table, _hx_4_p_index = _G.ipairs(x);
    local face_lnext = _hx_4_p_next;
    local _hx_5_init_index, _hx_5_init_value = face_lnext(x, _hx_4_p_index);
    local face_nextV = _hx_5_init_value;
    local face_i = _hx_5_init_index;
    while (face_nextV ~= nil) do 
      local v = face_nextV;
      local _hx_6_nextResult_index, _hx_6_nextResult_value = face_lnext(x, face_i);
      face_i = _hx_6_nextResult_index;
      face_nextV = _hx_6_nextResult_value;
    ...
    local str_lnext = _hx_7_p_next;
    local _hx_8_init_index, _hx_8_init_value = str_lnext(x, _hx_7_p_index);
    local str_nextV = _hx_8_init_value;
    local str_i = _hx_8_init_index;
    while (str_nextV ~= nil) do 
      local v = str_nextV;
      local _hx_9_nextResult_index, _hx_9_nextResult_value = str_lnext(x, str_i);
      str_i = _hx_9_nextResult_index;
      str_nextV = _hx_9_nextResult_value;
      local _hx_10_mat_a, _hx_10_mat_b = _G.Material(v);
      __haxe_Log.trace(_hx_10_mat_a, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/Main.hx",lineNumber=93,className="Main",methodName="main"}));
      if (not _hx_10_mat_a:IsError()) then 
        local tmp;
        local tmp1;
        local _this = _hx_10_mat_a:GetName();
        ...
        if (tmp) then 
          _hx_10_mat_a:SetString("$basetexture", "color/white");
          local mat = _hx_10_mat_a;
  ...
  local _hx_14_p_next, _hx_14_p_table, _hx_14_p_index = _G.ipairs(x);
  local ent_lnext = _hx_14_p_next;
  local _hx_15_init_index, _hx_15_init_value = ent_lnext(x, _hx_14_p_index);
  local ent_nextV = _hx_15_init_value;
  local ent_i = _hx_15_init_index;
  while (ent_nextV ~= nil) do 
    local v = ent_nextV;
    local _hx_16_nextResult_index, _hx_16_nextResult_value = ent_lnext(x, ent_i);
    ent_i = _hx_16_nextResult_index;
    ent_nextV = _hx_16_nextResult_value;
    v:Fire("TurnOn");
  end;
end
...
local _hx_static_init = function()
  ...
  __gmod_helpers_macros_include_Build.buildIdent = "Lima Foxtrot";
