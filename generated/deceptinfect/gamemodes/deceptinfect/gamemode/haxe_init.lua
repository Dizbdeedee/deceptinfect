...
__deceptinfect_DeceptInfect.prototype.PlayerDeath = function(self,victim,inflictor,attacker) 
  __haxe_Log.trace("Player ded!", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/DeceptInfect.hx",lineNumber=124,className="deceptinfect.DeceptInfect",methodName="PlayerDeath"}));
end
...
__deceptinfect_DeceptInfect.prototype.PlayerButtonUp = function(self,ply,button) 
  ...
  elseif (button) == _G.KEY_M then 
    __haxe_Log.trace(__deceptinfect_ecswip_ComponentManager.components.h[__deceptinfect_ecswip_PlayerComponent], _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/DeceptInfect.hx",lineNumber=166,className="deceptinfect.DeceptInfect",methodName="PlayerButtonUp"}));
...
__deceptinfect_DeceptInfect.prototype.IsSpawnpointSuitable = function(self,ply,spawnpoint,makeSuitable) 
  ...
  local ent = __gmod_PairTools.iterator(blockers);
  ...
  if (tracehit.HitWorld) then 
    __haxe_Log.trace("not valid..", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/DeceptInfect.hx",lineNumber=298,className="deceptinfect.DeceptInfect",methodName="IsSpawnpointSuitable"}));
    do return false end;
  end;
  do return true end
end
__deceptinfect_DeceptInfect.prototype.PlayerSelectSpawn = function(self,ply,transition) 
  ...
  __haxe_Log.trace("Could not find a spawn!", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/DeceptInfect.hx",lineNumber=315,className="deceptinfect.DeceptInfect",methodName="PlayerSelectSpawn"}));
  do return nil end
end
...
__deceptinfect_GameManager.cleanup = function() 
  ...
  while (ent:hasNext()) do 
    ...
    if (__deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_game_CleanupEnt)[ent][1] == 1) then 
      if (_g[1] == 1) then 
        __haxe_Log.trace(ent, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/GameManager.hx",lineNumber=196,className="deceptinfect.GameManager",methodName="cleanup"}));
        _g[2].entity:Remove();
      end;
    end;
...
__deceptinfect_TestObject.prototype.testplayer= nil;
...
__deceptinfect_TestObject.prototype.__host= nil;
__deceptinfect_TestObject.prototype.__bits= nil;
__deceptinfect_TestObject.prototype.__next= nil;
...
__deceptinfect_util_TimeKeep.prototype.initTime = function(self,key) 
  if (not (self.times.h[key] ~= nil)) then 
    self.times.h[key] = 0;
  end;
end
...
__hxbit_NetworkHost.prototype.rpcUID= nil;
...
__hxbit_NetworkStats.prototype.curRPC= nil;
