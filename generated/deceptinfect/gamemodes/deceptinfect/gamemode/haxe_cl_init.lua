...
local NETMESSAGE_net_proxy36 = _hx_e()
...
NETMESSAGE_net_proxy36.new = function() 
  local self = _hx_new(NETMESSAGE_net_proxy36.prototype)
  NETMESSAGE_net_proxy36.super(self)
  return self
end
NETMESSAGE_net_proxy36.super = function(self) 
  self.signalTrigger = __tink_core_SignalTrigger.new();
  self.signal = self.signalTrigger;
  _G.net.Receive("net_proxy36", _hx_bind(self,self.receive));
end
_hxClasses["NETMESSAGE_net_proxy36"] = NETMESSAGE_net_proxy36
NETMESSAGE_net_proxy36.__name__ = "NETMESSAGE_net_proxy36"
NETMESSAGE_net_proxy36.prototype = _hx_e();
NETMESSAGE_net_proxy36.prototype.receive = function(self) 
  local seralizer = __hxbit_Serializer.new();
  seralizer:setInput(__haxe_io_Bytes.ofString(_G.net.ReadData(_G.net.BytesLeft())), 0);
  local c = __deceptinfect_game_components_ItemReveal;
  local c1 = __deceptinfect_ecswip_NetProxy;
  local data = _hx_o({__fields__={item=true,proxy=true},item=seralizer:getRef(c, c.__clid),proxy=seralizer:getRef(c1, c1.__clid)});
  self.signalTrigger.handlers:invoke(data);
end

NETMESSAGE_net_proxy36.prototype.__class__ =  NETMESSAGE_net_proxy36
...
__deceptinfect_GameManager.cleanup = function() 
  ...
  while (_g < _g1) do 
    _g = _g + 1;
    local ent = _g - 1;
    if (__deceptinfect_ecswip_ComponentManager.components_2[39][ent][1] ~= 1) then 
...
__deceptinfect_GameManager.gameStateChanged = function(x) 
  __haxe_Log.trace(Std.string("game state changed ") .. Std.string(Std.string(x)), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/GameManager.hx",lineNumber=319,className="deceptinfect.GameManager",methodName="gameStateChanged"}));
...
__deceptinfect_client_Hud.targetID = function() 
  ...
  if (_g[1] == 0) then 
    local _hx_tmp = __deceptinfect_ecswip_ComponentManager.components_2[24][_g[2]];
    if (_hx_tmp[1] == 1) then 
...
__deceptinfect_client_Hud.infectionMeter = function() 
  ...
  if (_g1[1] == 0) then 
    local _hx_tmp = __deceptinfect_ecswip_ComponentManager.components_2[24][_g1[2]];
    if (_hx_tmp[1] == 1) then 
      if (_g[1] == 2) then 
        inf = _hx_tmp[2];
      else
...
__deceptinfect_ecswip_GrabSystem.updateSig = function(data) 
  if (__deceptinfect_ecswip_GrabSystem.activeDraws.h[data.index] == nil) then 
    __haxe_Log.trace(Std.string("activated grab ") .. Std.string(data.index), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/ecswip/GrabSystem.hx",lineNumber=43,className="deceptinfect.ecswip.GrabSystem",methodName="updateSig"}));
    ...
    __deceptinfect_ecswip_ComponentManager.components_2[1][draw] = __deceptinfect_ecswip_ComponentState.Comp(x);
    local _this = __deceptinfect_ecswip_ComponentManager.lookupEntity;
    _this.h[x] = draw;
    _this.k[x] = true;
...
__deceptinfect_ecswip_GrabSystem.remove = function(data) 
  __haxe_Log.trace(Std.string("delete grab ") .. Std.string(data.index), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/ecswip/GrabSystem.hx",lineNumber=51,className="deceptinfect.ecswip.GrabSystem",methodName="remove"}));
  if (__deceptinfect_ecswip_GrabSystem.activeDraws.h[data.index] ~= nil) then 
...
__deceptinfect_ecswip_GrabSystem.drawCylinders = function() 
  ...
  while (_g < _g1) do 
    _g = _g + 1;
    local ent = _g - 1;
    local _g = __deceptinfect_ecswip_ComponentManager.components_2[1][ent];
    if (_g[1] == 1) then 
      local _g = _g[2];
      local tmp;
...
__deceptinfect_infection_systems_InfectionSystem.prototype.onInfectedCl = function(self,data) 
  ...
  local _g = __deceptinfect_ecswip_ComponentManager.components_2[24][diID];
  if (_g[1] == 1) then 
    local _g = _g[2];
    ...
    __deceptinfect_ecswip_ComponentManager.components_2[30][to] = __deceptinfect_ecswip_ComponentState.Comp(x);
    local _this = __deceptinfect_ecswip_ComponentManager.lookupEntity;
    _this.h[x] = to;
    _this.k[x] = true;
    ...
    local to = __deceptinfect_PlayerManager.getLocalPlayerID();
    __deceptinfect_ecswip_ComponentManager.components_2[24][to] = __deceptinfect_ecswip_ComponentState.Comp(c_inf);
    local _this = __deceptinfect_ecswip_ComponentManager.lookupEntity;
    _this.h[c_inf] = to;
    _this.k[c_inf] = true;
...
__deceptinfect_game_RagdollSystem.prototype.recvraginfo = function(self,x) 
  ...
  if (_g[1] == 0) then 
    local _g = _g[2];
    local result = __deceptinfect_ecswip_ComponentManager.components_2[4][_g];
    if (result == __deceptinfect_ecswip_ComponentState.NONE) then 
      local x = __deceptinfect_game_components_RagInfo.new();
      __deceptinfect_ecswip_ComponentManager.components_2[4][_g] = __deceptinfect_ecswip_ComponentState.Comp(x);
      local _this = __deceptinfect_ecswip_ComponentManager.lookupEntity;
      _this.h[x] = _g;
      _this.k[x] = true;
      c_raginfo = x;
    ...
    if (_G.IsValid(x.rag)) then 
      ...
      local to = x.id;
      __deceptinfect_ecswip_ComponentManager.components_2[4][to] = __deceptinfect_ecswip_ComponentState.Comp(c_rag);
      local _this = __deceptinfect_ecswip_ComponentManager.lookupEntity;
      _this.h[c_rag] = to;
      _this.k[c_rag] = true;
      c_raginfo = c_rag;
...
__deceptinfect_game_RagdollSystem.prototype.recvstatinfo = function(self,x) 
  ...
  if (c_statinfo1) == 0 then 
    local _g = _g[2];
    local result = __deceptinfect_ecswip_ComponentManager.components_2[5][_g];
    if (result == __deceptinfect_ecswip_ComponentState.NONE) then 
      local x = __deceptinfect_game_components_StatInfo.new();
      __deceptinfect_ecswip_ComponentManager.components_2[5][_g] = __deceptinfect_ecswip_ComponentState.Comp(x);
      local _this = __deceptinfect_ecswip_ComponentManager.lookupEntity;
      _this.h[x] = _g;
      _this.k[x] = true;
      c_statinfo = x;
...
__deceptinfect_game_RagdollSystem.prototype.pvsChange = function(self,ent,shouldTransmit) 
  ...
  if (_g[1] == 0) then 
    local _g = _g[2];
    local _g1 = __deceptinfect_ecswip_ComponentManager.components_2[40][_g];
    local _g = __deceptinfect_ecswip_ComponentManager.components_2[34][_g];
    if (_g[1] == 1) then 
      if (_g1[1] == 1) then 
        local _g1 = _g1[2];
        local _hx_tmp;
...
__deceptinfect_game_RagdollSystem.prototype.run_client = function(self) 
  local rag = __gmod__LuaArray_LuaArray_Impl_.iterator(_G.ents.GetAll());
  while (rag:hasNext()) do 
    ...
    if (((mdl ~= nil) and (mdl ~= "")) and (rag.showwep == nil)) then 
      ...
      local to = _rag.id;
      __deceptinfect_ecswip_ComponentManager.components_2[40][to] = __deceptinfect_ecswip_ComponentState.Comp(c_stat);
      local _this = __deceptinfect_ecswip_ComponentManager.lookupEntity;
      _this.h[c_stat] = to;
      _this.k[c_stat] = true;
      ...
      c_wep.parent = rag;
      local to = ent.id;
      __deceptinfect_ecswip_ComponentManager.components_2[41][to] = __deceptinfect_ecswip_ComponentState.Comp(c_wep);
      local _this = __deceptinfect_ecswip_ComponentManager.lookupEntity;
      _this.h[c_wep] = to;
      _this.k[c_wep] = true;
      local x = __deceptinfect_game_components_KeepRestart.new();
  ...
  while (_g < _g1) do 
    ...
    local x = _g - 1;
    local ent = x;
    local _g = __deceptinfect_ecswip_ComponentManager.components_2[41][ent];
...
__deceptinfect_infection_systems_InfectionLookSystem.prototype.recvInfectionInfo = function(self,x) 
  ...
  local result = __deceptinfect_ecswip_ComponentManager.components_2[24][target.id];
  local c_inf;
  if (result == __deceptinfect_ecswip_ComponentState.NONE) then 
...
__deceptinfect_game_ItemOwnerSystem.drawHalos = function() 
  ...
  while (_g < _g1) do 
    _g = _g + 1;
    local _g = __deceptinfect_ecswip_ComponentManager.components_2[36][_g - 1];
    if (_g[1] == 1) then 
      x = x + 1;
...
__deceptinfect_game_ItemOwnerSystem.prototype.init_client = function(self) 
  ...
  __deceptinfect_game_components_ItemReveal.proxyInit();
end
...
__deceptinfect_ents_Di_puddle.prototype.Draw = function(self,flags) 
  ...
  local otherVec = _G.Vector(self.size / 2, self.size / 2, 0);
  _G.cam.Start3D2D(this1 - otherVec, _G.Angle(0, 90, 0), 1.0);
...
__deceptinfect_game_ClientTranslateSystem.super = function(self) 
  self.mapID = __haxe_ds_IntMap.new();
  __deceptinfect_ecswip_System.super(self);
end
...
__deceptinfect_game_ClientTranslateSystem.prototype.getID = function(self,servID) 
  local ret = self.mapID.h[servID];
  if (ret == __haxe_ds_IntMap.tnull) then 
    ret = nil;
  end;
  local ent = ret;
  if (ent == nil) then 
    local id = __deceptinfect_ecswip_ComponentManager.addEntity();
    local _this = self.mapID;
    if (id == nil) then 
      _this.h[servID] = __haxe_ds_IntMap.tnull;
    else
      _this.h[servID] = id;
    end;
    do return id end;
...
__deceptinfect_game_components_ItemReveal.proxyInit = function() 
  __haxe_Log.trace("we're runnin btw", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/macros/ProxyMacros.hx",lineNumber=72,className="deceptinfect.game.components.ItemReveal",methodName="proxyInit"}));
  __deceptinfect_game_components_ItemReveal.net_proxy.signal:listen(function(x) 
    __haxe_Log.trace(x, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/macros/ProxyMacros.hx",lineNumber=74,className="deceptinfect.game.components.ItemReveal",methodName="proxyInit"}));
    local id = __deceptinfect_ecswip_SystemManager.getSystem(__deceptinfect_game_ClientTranslateSystem):getID(x.proxy.id);
    local _g = __deceptinfect_ecswip_ComponentManager.components_2[36][id];
    if (_g[1] == 1) then 
      local _g = _g[2];
      _g.vec = x.item.vec;
      _g.model = x.item.model;
    else
      x.item:proxyCreated();
      local x = x.item;
      __deceptinfect_ecswip_ComponentManager.components_2[36][id] = __deceptinfect_ecswip_ComponentState.Comp(x);
      local _this = __deceptinfect_ecswip_ComponentManager.lookupEntity;
      _this.h[x] = id;
      _this.k[x] = true;
    end;
...
local _hx_static_init = function()
  ...
  __deceptinfect_game_components_ItemReveal.net_proxy = NETMESSAGE_net_proxy36.new();
