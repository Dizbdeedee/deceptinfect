...
_hxClasses["deceptinfect.WeaponStage"] = { __ename__ = "deceptinfect.WeaponStage", __constructs__ = _hx_tab_array({[0]="INITAL","TWO","THREE","FINAL"},4)}
...
__deceptinfect_game_RagdollSystem.prototype.pvsChange = function(self,ent,shouldTransmit) 
  ...
  if (_g[1] == 0) then 
    local _g = _g[2];
    local _g1 = __deceptinfect_ecswip_ComponentManager.lazyInit(__deceptinfect_game_components_Statue)[_g];
...
_hxClasses["deceptinfect.macros.BlockStatus"] = { __ename__ = "deceptinfect.macros.BlockStatus", __constructs__ = _hx_tab_array({[0]="NOT_BLOCKED","BLOCKED"},2)}
