...
__deceptinfect_GameManager.gameStateChanged = function(x) 
  __haxe_Log.trace(Std.string("game state changed ") .. Std.string(Std.string(x)), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/GameManager.hx",lineNumber=315,className="deceptinfect.GameManager",methodName="gameStateChanged"}));
...
__deceptinfect_client_GeigerSystem.prototype.run_client = function(self) 
  ...
  while (_g < __lowest) do 
    ...
    if (__compArr[21][1][ent] ~= nil) then 
...
__deceptinfect_ecswip_GrabSystem.updateSig = function(data) 
  if (__deceptinfect_ecswip_GrabSystem.activeDraws.h[data.index] == nil) then 
    ...
    if (fam[1][id] == nil) then 
      __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, draw, x);
    else
      __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, draw, x);
    end;
...
__deceptinfect_game_RagdollSystem.prototype.recvraginfo = function(self,x) 
  ...
  if (_g[1] == 0) then 
    ...
    if (_G.IsValid(x.rag)) then 
      ...
      local fam = __deceptinfect_ecswip_ComponentManager.components_3[id];
      if (fam[1][id] == nil) then 
        __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, to, c_rag);
      else
        __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, to, c_rag);
      end;
      c_raginfo = c_rag;
    else
      do return end;
...
__deceptinfect_game_RagdollSystem.prototype.run_client = function(self) 
  ...
  while (rag_nextV ~= nil) do 
    ...
    if (((mdl ~= nil) and (mdl ~= "")) and (rag.showwep == nil)) then 
      ...
      local fam = __deceptinfect_ecswip_ComponentManager.components_3[id];
      if (fam[1][id] == nil) then 
        __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, to, c_wep);
      else
        __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, to, c_wep);
      end;
      local id = 40;
      local x = __deceptinfect_game_components_KeepRestart.new();
      local to = ent.id;
    ...
    if (ret ~= nil) then 
      ...
      while (_g < _g1.length) do 
        ...
        while (_g < _g1.length) do 
          ...
          __haxe_Log.trace(field, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/game/ClientTranslateSystem.hx",lineNumber=57,className="deceptinfect.game.ClientTranslateSystem",methodName="updateEnt"}));
        end;
      end;
    else
      local id = __deceptinfect_ecswip_ComponentManager.addEntity();
      ...
      while (_g < _g1.length) do 
        ...
        local id1 = comp:getCompID();
        local fam = __deceptinfect_ecswip_ComponentManager.components_3[id1];
        if (fam[1][id1] == nil) then 
          __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(fam, id, comp);
        else
          __deceptinfect_ecswip__ComponentManager_Component__Impl_.set_component(fam, id, comp);
        end;
      end;
...
local _hx_static_init = function()
  ...
  __deceptinfect_ecswip_ComponentManager.initComponent(42, "ClientWeaponStatue");
  ...
  __deceptinfect_game_components_ClientWeaponStatue.compID = 42;
  ...
  __gmod_helpers_macros_include_Build.buildIdent = "Delta Echo";
