...
local NETMESSAGE_deceptinfect_game_ClientTranslateSystem_net_newServerEnt = _hx_e()
...
__deceptinfect_game_ClientComponent = _hx_e()
__deceptinfect_game_TestComponent = _hx_e()
__deceptinfect_game_Net_NewServerEnt = _hx_e()
...
NETMESSAGE_deceptinfect_Darken_net_darken.super = function(self,recvs) 
  ...
  _G.net.Receive("deceptinfect_Darken_net_darken", _hx_bind(self,self.receive));
  local _g = 0;
...
NETMESSAGE_deceptinfect_Spread_netSpread.super = function(self,recvs) 
  ...
  self.signal = self.signalTrigger;
  _G.net.Receive("deceptinfect_Spread_netSpread", _hx_bind(self,self.receive));
  local _g = 0;
  while (_g < recvs.length) do 
    local recv = recvs[_g];
    _g = _g + 1;
...
NETMESSAGE_deceptinfect_game_ClientTranslateSystem_net_newServerEnt.new = function(recvs) 
  local self = _hx_new(NETMESSAGE_deceptinfect_game_ClientTranslateSystem_net_newServerEnt.prototype)
  NETMESSAGE_deceptinfect_game_ClientTranslateSystem_net_newServerEnt.super(self,recvs)
  return self
end
NETMESSAGE_deceptinfect_game_ClientTranslateSystem_net_newServerEnt.super = function(self,recvs) 
  self.signalTrigger = __tink_core_SignalTrigger.new();
  local _gthis = self;
  _G.timer.Simple(0, function() 
    _gthis.seralizer = __hxbit_Serializer.new();
  ...
  self.signal = self.signalTrigger;
  _G.net.Receive("deceptinfect_game_ClientTranslateSystem_net_newServerEnt", _hx_bind(self,self.receive));
  local _g = 0;
  while (_g < recvs.length) do 
    local recv = recvs[_g];
    _g = _g + 1;
...
_hxClasses["NETMESSAGE_deceptinfect_game_ClientTranslateSystem_net_newServerEnt"] = NETMESSAGE_deceptinfect_game_ClientTranslateSystem_net_newServerEnt
NETMESSAGE_deceptinfect_game_ClientTranslateSystem_net_newServerEnt.__name__ = "NETMESSAGE_deceptinfect_game_ClientTranslateSystem_net_newServerEnt"
NETMESSAGE_deceptinfect_game_ClientTranslateSystem_net_newServerEnt.prototype = _hx_e();
NETMESSAGE_deceptinfect_game_ClientTranslateSystem_net_newServerEnt.prototype.receive = function(self) 
  local bytString = _G.net.ReadData(_G.net.BytesLeft());
  local bytes = __haxe_io_Bytes.ofString(bytString);
  local result = self.seralizer:unserialize(bytes, __deceptinfect_game_Net_NewServerEnt);
  self.signalTrigger.handlers:invoke(result);
end

NETMESSAGE_deceptinfect_game_ClientTranslateSystem_net_newServerEnt.prototype.__class__ =  NETMESSAGE_deceptinfect_game_ClientTranslateSystem_net_newServerEnt
...
__deceptinfect_ecswip_ComponentManager.addGEnt = function(x) 
  ...
  __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(__deceptinfect_ecswip_ComponentManager.components_3[36], id, x1);
  ...
  __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(__deceptinfect_ecswip_ComponentManager.components_3[33], id, x);
  local _this = __deceptinfect_ecswip_ComponentManager.lookupEntity;
  local key = x;
  _this.h[key] = id;
  _this.k[key] = true;
...
__deceptinfect_ecswip_ComponentManager.addPlayer = function(x) 
  ...
  __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(__deceptinfect_ecswip_ComponentManager.components_3[35], id, x1);
  local _this = __deceptinfect_ecswip_ComponentManager.lookupEntity;
  local key = x1;
  _this.h[key] = id;
  _this.k[key] = true;
...
__deceptinfect_infection_systems_InfectionSystem.prototype.onInfectedCl = function(self,data) 
  ...
  if (_g[1] == 1) then 
    ...
    local to = __deceptinfect_PlayerManager.getLocalPlayerID();
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(__deceptinfect_ecswip_ComponentManager.components_3[18], to, c_inf);
    local _this = __deceptinfect_ecswip_ComponentManager.lookupEntity;
    local key = c_inf;
    _this.h[key] = to;
    _this.k[key] = true;
...
__deceptinfect_radiation_RadiationSystem.testRadiation = function(vec) 
  ...
  __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(__deceptinfect_ecswip_ComponentManager.components_3[33], ent, x);
  local _this = __deceptinfect_ecswip_ComponentManager.lookupEntity;
  local key = x;
  _this.h[key] = ent;
  _this.k[key] = true;
...
__deceptinfect_game_RagdollSystem.prototype.run_client = function(self) 
  ...
  while (rag_nextV ~= nil) do 
    ...
    if (((mdl ~= nil) and (mdl ~= "")) and (rag.showwep == nil)) then 
      ...
      local to = _rag.id;
      __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(__deceptinfect_ecswip_ComponentManager.components_3[42], to, c_stat);
      local _this = __deceptinfect_ecswip_ComponentManager.lookupEntity;
      local key = c_stat;
      _this.h[key] = to;
      _this.k[key] = true;
      ...
      c_wep.parent = rag;
      local to = ent.id;
      __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(__deceptinfect_ecswip_ComponentManager.components_3[43], to, c_wep);
      local _this = __deceptinfect_ecswip_ComponentManager.lookupEntity;
      local key = c_wep;
      _this.h[key] = to;
      _this.k[key] = true;
...
__deceptinfect_ents_Di_ragdoll.prototype.Initialize = function(self) 
  ...
  local to = self.id;
  __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(__deceptinfect_ecswip_ComponentManager.components_3[20], to, x);
  local _this = __deceptinfect_ecswip_ComponentManager.lookupEntity;
  local key = x;
  _this.h[key] = to;
  _this.k[key] = true;
  ...
  local to = self.id;
  __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(__deceptinfect_ecswip_ComponentManager.components_3[12], to, x);
  local _this = __deceptinfect_ecswip_ComponentManager.lookupEntity;
  local key = x;
  _this.h[key] = to;
  _this.k[key] = true;
...
__deceptinfect_game_ClientComponent.new = function() 
  local self = _hx_new(__deceptinfect_game_ClientComponent.prototype)
  __deceptinfect_game_ClientComponent.super(self)
  return self
end
__deceptinfect_game_ClientComponent.super = function(self) 
  self.__uid = _hx_bit.bor(_hx_bit.lshift(__hxbit_Serializer.SEQ,24),(function() 
  local _hx_obj = __hxbit_Serializer;
  local _hx_fld = 'UID';
  _hx_obj[_hx_fld] = _hx_obj[_hx_fld]  + 1;
...
_hxClasses["deceptinfect.game.ClientComponent"] = __deceptinfect_game_ClientComponent
__deceptinfect_game_ClientComponent.__name__ = "deceptinfect.game.ClientComponent"
__deceptinfect_game_ClientComponent.__interfaces__ = {__hxbit_Serializable}
__deceptinfect_game_ClientComponent.prototype = _hx_e();
__deceptinfect_game_ClientComponent.prototype.getCLID = function(self) 
  do return __deceptinfect_game_ClientComponent.__clid end
end
__deceptinfect_game_ClientComponent.prototype.serialize = function(self,__ctx) 
end
__deceptinfect_game_ClientComponent.prototype.getSerializeSchema = function(self) 
  local schema = __hxbit_Schema.new();
  schema.isFinal = __hxbit_Serializer.isClassFinal(__deceptinfect_game_ClientComponent.__clid);
  do return schema end
end
__deceptinfect_game_ClientComponent.prototype.unserializeInit = function(self) 
  self.who = 5;
end
__deceptinfect_game_ClientComponent.prototype.unserialize = function(self,__ctx) 
end

__deceptinfect_game_ClientComponent.prototype.__class__ =  __deceptinfect_game_ClientComponent
__deceptinfect_game_ClientComponent.__super__ = __deceptinfect_ecswip_Component
setmetatable(__deceptinfect_game_ClientComponent.prototype,{__index=__deceptinfect_ecswip_Component.prototype})

__deceptinfect_game_TestComponent.new = function(x) 
  local self = _hx_new(__deceptinfect_game_TestComponent.prototype)
  __deceptinfect_game_TestComponent.super(self,x)
  return self
end
__deceptinfect_game_TestComponent.super = function(self,x) 
  self.test = 10;
  __deceptinfect_game_ClientComponent.super(self);
  self.test = x;
end
_hxClasses["deceptinfect.game.TestComponent"] = __deceptinfect_game_TestComponent
__deceptinfect_game_TestComponent.__name__ = "deceptinfect.game.TestComponent"
__deceptinfect_game_TestComponent.prototype = _hx_e();
__deceptinfect_game_TestComponent.prototype.getCLID = function(self) 
  do return __deceptinfect_game_TestComponent.__clid end
end
__deceptinfect_game_TestComponent.prototype.serialize = function(self,__ctx) 
  __deceptinfect_game_ClientComponent.prototype.serialize(self,__ctx);
  local v = self.test;
  if ((v >= 0) and (v < 128)) then 
    __ctx.out.b:push(v);
  else
...
__deceptinfect_game_TestComponent.prototype.getSerializeSchema = function(self) 
  local schema = __deceptinfect_game_ClientComponent.prototype.getSerializeSchema(self);
  schema.fieldsNames:push("test");
  schema.fieldsTypes:push(__hxbit_PropTypeDesc.PInt);
  schema.isFinal = __hxbit_Serializer.isClassFinal(__deceptinfect_game_TestComponent.__clid);
  do return schema end
end
__deceptinfect_game_TestComponent.prototype.unserializeInit = function(self) 
  __deceptinfect_game_ClientComponent.prototype.unserializeInit(self);
  self.test = 10;
end
__deceptinfect_game_TestComponent.prototype.unserialize = function(self,__ctx) 
  __deceptinfect_game_ClientComponent.prototype.unserialize(self,__ctx);
  local pos = (function() 
  local _hx_obj = __ctx;
  local _hx_fld = 'inPos';
  local _ = _hx_obj[_hx_fld];
...
__deceptinfect_game_TestComponent.prototype.__class__ =  __deceptinfect_game_TestComponent
__deceptinfect_game_TestComponent.__super__ = __deceptinfect_game_ClientComponent
setmetatable(__deceptinfect_game_TestComponent.prototype,{__index=__deceptinfect_game_ClientComponent.prototype})

__deceptinfect_game_Net_NewServerEnt.new = function(arr,serverID) 
  local self = _hx_new(__deceptinfect_game_Net_NewServerEnt.prototype)
  __deceptinfect_game_Net_NewServerEnt.super(self,arr,serverID)
  return self
end
__deceptinfect_game_Net_NewServerEnt.super = function(self,arr,serverID) 
  self.__uid = _hx_bit.bor(_hx_bit.lshift(__hxbit_Serializer.SEQ,24),(function() 
  local _hx_obj = __hxbit_Serializer;
  local _hx_fld = 'UID';
  _hx_obj[_hx_fld] = _hx_obj[_hx_fld]  + 1;
  ...
  self.initalComponents = arr;
  self.serverID = serverID;
end
_hxClasses["deceptinfect.game.Net_NewServerEnt"] = __deceptinfect_game_Net_NewServerEnt
__deceptinfect_game_Net_NewServerEnt.__name__ = "deceptinfect.game.Net_NewServerEnt"
__deceptinfect_game_Net_NewServerEnt.__interfaces__ = {__hxbit_Serializable}
__deceptinfect_game_Net_NewServerEnt.prototype = _hx_e();
__deceptinfect_game_Net_NewServerEnt.prototype.getCLID = function(self) 
  do return __deceptinfect_game_Net_NewServerEnt.__clid end
end
__deceptinfect_game_Net_NewServerEnt.prototype.serialize = function(self,__ctx) 
  local a = self.initalComponents;
  if (a == nil) then 
    __ctx.out.b:push(0);
  else
    local v = a.length + 1;
...
__deceptinfect_game_Net_NewServerEnt.prototype.getSerializeSchema = function(self) 
  local schema = __hxbit_Schema.new();
  schema.fieldsNames:push("initalComponents");
  schema.fieldsTypes:push(__hxbit_PropTypeDesc.PArray(__hxbit_PropTypeDesc.PSerializable("deceptinfect.game.ClientComponent")));
  schema.fieldsNames:push("serverID");
  schema.fieldsTypes:push(__hxbit_PropTypeDesc.PInt);
  schema.isFinal = __hxbit_Serializer.isClassFinal(__deceptinfect_game_Net_NewServerEnt.__clid);
  do return schema end
end
__deceptinfect_game_Net_NewServerEnt.prototype.unserializeInit = function(self) 
end
__deceptinfect_game_Net_NewServerEnt.prototype.unserialize = function(self,__ctx) 
  local e0;
  local pos = (function() 
  local _hx_obj = __ctx;
  local _hx_fld = 'inPos';
  ...
  if (len == 0) then 
    ...
    while (_g < _g1) do 
      _g = _g + 1;
      local i = _g - 1;
      e0 = __ctx:getRef(__deceptinfect_game_ClientComponent, __deceptinfect_game_ClientComponent.__clid);
      a[i] = e0;
    end;
    tmp = a;
  end;
  self.initalComponents = tmp;
  local pos = (function() 
  local _hx_obj = __ctx;
  local _hx_fld = 'inPos';
  local _ = _hx_obj[_hx_fld];
...
__deceptinfect_game_Net_NewServerEnt.prototype.__class__ =  __deceptinfect_game_Net_NewServerEnt
...
__deceptinfect_game_ClientTranslateSystem.newEnt = function(x) 
  local id = __deceptinfect_ecswip_ComponentManager.addEntity();
  local _g = 0;
  local _g1 = x.initalComponents;
  while (_g < _g1.length) do 
    local comp = _g1[_g];
    _g = _g + 1;
    __deceptinfect_ecswip__ComponentManager_Component__Impl_.init_entity(__deceptinfect_ecswip_ComponentManager.components_3[25], id, comp);
    local _this = __deceptinfect_ecswip_ComponentManager.lookupEntity;
    local key = comp;
    _this.h[key] = id;
    _this.k[key] = true;
...
local _hx_static_init = function()
  ...
  __deceptinfect_ecswip_ComponentManager.initComponent(36, "GEntityComponent");
  __deceptinfect_ecswip_ComponentManager.initComponent(35, "PlayerComponent");
  __deceptinfect_ecswip_ComponentManager.initComponent(39, "ProxyComponent");
  __deceptinfect_ecswip_ComponentManager.initComponent(37, "ComponentProxy");
  __deceptinfect_ecswip_ComponentManager.initComponent(33, "VirtualPosition");
  __deceptinfect_ecswip_ComponentManager.initComponent(25, "ClientComponent");
  __deceptinfect_ecswip_ComponentManager.initComponent(26, "TestComponent");
  __deceptinfect_ecswip_ComponentManager.initComponent(19, "AliveComponent");
  ...
  __deceptinfect_ecswip_ComponentManager.initComponent(43, "ClientWeaponStatue");
  __deceptinfect_ecswip_ComponentManager.initComponent(23, "EvacZone");
  __deceptinfect_ecswip_ComponentManager.initComponent(21, "FlareComponent");
  __deceptinfect_ecswip_ComponentManager.initComponent(34, "ItemOwner");
  __deceptinfect_ecswip_ComponentManager.initComponent(38, "ItemReveal");
  __deceptinfect_ecswip_ComponentManager.initComponent(41, "KeepRestart");
  __deceptinfect_ecswip_ComponentManager.initComponent(22, "NestComponent");
  __deceptinfect_ecswip_ComponentManager.initComponent(4, "RagInfo");
  __deceptinfect_ecswip_ComponentManager.initComponent(20, "Ragdoll");
  __deceptinfect_ecswip_ComponentManager.initComponent(40, "Spawned");
  __deceptinfect_ecswip_ComponentManager.initComponent(5, "StatInfo");
  __deceptinfect_ecswip_ComponentManager.initComponent(42, "Statue");
  __deceptinfect_ecswip_ComponentManager.initComponent(3, "InfVunerability");
  __deceptinfect_ecswip_ComponentManager.initComponent(24, "InfectedComponent");
  __deceptinfect_ecswip_ComponentManager.initComponent(18, "InfectionComponent");
  __deceptinfect_ecswip_ComponentManager.initComponent(6, "InfectionLookInfo");
  __deceptinfect_ecswip_ComponentManager.initComponent(29, "RateComponent");
  ...
  __deceptinfect_ecswip_ComponentManager.initComponent(32, "ContaminationProducer");
  __deceptinfect_ecswip_ComponentManager.initComponent(30, "RadSource");
  ...
  __deceptinfect_ecswip_ComponentManager.initComponent(31, "RadiationProducer");
  ...
  __deceptinfect_ecswip_GEntityComponent.compID = 36;
  ...
  __deceptinfect_ecswip_PlayerComponent.compID = 35;
  
  __deceptinfect_ecswip_ProxyComponent.compID = 39;
  
  __deceptinfect_ecswip_ComponentProxy.compID = 37;
  ...
  __deceptinfect_ecswip_VirtualPosition.compID = 33;
  ...
  __deceptinfect_game_ClientComponent.__clid = __hxbit_Serializer.registerClass(__deceptinfect_game_ClientComponent);
  
  __deceptinfect_game_ClientComponent.compID = 25;
  
  __deceptinfect_game_TestComponent.compID = 26;
  
  __deceptinfect_game_TestComponent.__clid = __hxbit_Serializer.registerClass(__deceptinfect_game_TestComponent);
  
  __deceptinfect_game_Net_NewServerEnt.__clid = __hxbit_Serializer.registerClass(__deceptinfect_game_Net_NewServerEnt);
  
  __deceptinfect_game_ClientTranslateSystem.net_newServerEnt = NETMESSAGE_deceptinfect_game_ClientTranslateSystem_net_newServerEnt.new(_hx_tab_array({[0]=__deceptinfect_game_ClientTranslateSystem.newEnt}, 1));
  
  __deceptinfect_game_ClientTranslateSystem.serverIDToClientID = __haxe_ds_IntMap.new();
  
  __deceptinfect_game_ClientTranslateSystem.components = __haxe_ds_IntMap.new();
  
  __deceptinfect_game_components_AliveComponent.compID = 19;
  ...
  __deceptinfect_game_components_ClientWeaponStatue.compID = 43;
  
  __deceptinfect_game_components_EvacZone.compID = 23;
  
  __deceptinfect_game_components_FlareComponent.compID = 21;
  ...
  __deceptinfect_game_components_ItemOwner.compID = 34;
  ...
  __deceptinfect_game_components_ItemReveal.compID = 38;
  ...
  __deceptinfect_game_components_KeepRestart.compID = 41;
  
  __deceptinfect_game_components_NestComponent.compID = 22;
  
  __deceptinfect_game_components_RagInfo.compID = 4;
  
  __deceptinfect_game_components_Ragdoll.compID = 20;
  
  __deceptinfect_game_components_Spawned.compID = 40;
  
  __deceptinfect_game_components_StatInfo.compID = 5;
  
  __deceptinfect_game_components_Statue.compID = 42;
  
  __deceptinfect_infection_InfVunerability.compID = 3;
  
  __deceptinfect_infection_InfectedComponent.compID = 24;
  
  __deceptinfect_infection_InfectionComponent.compID = 18;
  
  __deceptinfect_infection_InfectionLookInfo.compID = 6;
  
  __deceptinfect_infection_RateComponent.compID = 29;
  ...
  __deceptinfect_radiation_ContaminationProducer.compID = 32;
  
  __deceptinfect_radiation_RadSource.compID = 30;
  
  __deceptinfect_radiation_RadVictim.compID = 13;
  
  __deceptinfect_radiation_RadiationAccepter.compID = 27;
  
  __deceptinfect_radiation_RadiationProducer.compID = 31;
  ...
  __gmod_helpers_macros_include_Build.buildIdent = "Mike Golf";
