...
__deceptinfect_ecswip_GrabSystem.updateSig = function(data) 
  if (__deceptinfect_ecswip_GrabSystem.activeDraws.h[data.index] == nil) then 
    __haxe_Log.trace(Std.string("activated grab ") .. Std.string(data.index), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/ecswip/GrabSystem.hx",lineNumber=45,className="deceptinfect.ecswip.GrabSystem",methodName="updateSig"}));
...
__deceptinfect_ecswip_GrabSystem.remove = function(data) 
  __haxe_Log.trace(Std.string("delete grab ") .. Std.string(data.index), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/ecswip/GrabSystem.hx",lineNumber=53,className="deceptinfect.ecswip.GrabSystem",methodName="remove"}));
  if (__deceptinfect_ecswip_GrabSystem.activeDraws.h[data.index] ~= nil) then 
...
__deceptinfect_infection_systems_InfectionSystem.prototype.onInfectedCl = function(self,data) 
  __haxe_Log.trace("Recieved infected data", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/infection/systems/InfectionSystem.hx",lineNumber=27,className="deceptinfect.infection.systems.InfectionSystem",methodName="onInfectedCl"}));
  ...
  if (_g[1] == 1) then 
    ...
    _this.h[key] = to;
    _this.k[key] = true;
    __haxe_Log.trace(_g, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/infection/systems/InfectionSystem.hx",lineNumber=32,className="deceptinfect.infection.systems.InfectionSystem",methodName="onInfectedCl"}));
  else
    __haxe_Log.trace("no...", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/infection/systems/InfectionSystem.hx",lineNumber=34,className="deceptinfect.infection.systems.InfectionSystem",methodName="onInfectedCl"}));
...
__deceptinfect_infection_systems_InfectionSystem.prototype.recvInfection = function(self,data) 
  ...
  if (_g[1] == 1) then 
    ...
    __haxe_Log.trace("nu shit", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/infection/systems/InfectionSystem.hx",lineNumber=51,className="deceptinfect.infection.systems.InfectionSystem",methodName="recvInfection"}));
    local c_inf = __deceptinfect_infection_InfectionComponent.new();
    local to = __deceptinfect_PlayerManager.getLocalPlayerID();
    __deceptinfect_ecswip_ComponentManager.components_2[24][to] = __deceptinfect_ecswip_ComponentState.Comp(c_inf);
    local _this = __deceptinfect_ecswip_ComponentManager.lookupEntity;
...
__deceptinfect_game_RagdollSystem.prototype.pvsChange = function(self,ent,shouldTransmit) 
  ...
  if (_g[1] == 0) then 
    local _g = _g[2];
    local _g1 = __deceptinfect_ecswip_ComponentManager.components_2[34][_g];
    local _g = __deceptinfect_ecswip_ComponentManager.components_2[40][_g];
    if (_g1[1] == 1) then 
      if (_g[1] == 1) then 
        local _g = _g[2];
        local _hx_tmp;
        _hx_tmp = _g1[2].entity;
        __haxe_Log.trace("THing changed", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/game/RagdollSystem.hx",lineNumber=112,className="deceptinfect.game.RagdollSystem",methodName="pvsChange"}));
...
__deceptinfect_game_RagdollSystem.prototype.run_client = function(self) 
  ...
  while (rag:hasNext()) do 
    ...
    if (((mdl ~= nil) and (mdl ~= "")) and (rag.showwep == nil)) then 
      ...
      _this.h[key] = to;
      _this.k[key] = true;
      __haxe_Log.trace(mdl, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/game/RagdollSystem.hx",lineNumber=169,className="deceptinfect.game.RagdollSystem",methodName="run_client"}));
      rag.showwep = true;
  ...
  while (_g < _g1) do 
    ...
    local _g1 = __deceptinfect_ecswip_ComponentManager.components_2[41][ent];
    if (_g[1] == 1) then 
      if (_g1[1] == 1) then 
        local _hx_tmp;
        local c_stat = _g1[2];
