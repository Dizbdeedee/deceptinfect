...
__deceptinfect_GameManager.cleanup = function() 
  ...
  while (ent:hasNext()) do 
    local ent = ent:next();
    if (__deceptinfect_ecswip_ComponentManager.components_2[34][ent][1] ~= 1) then 
...
__deceptinfect_GameManager.gameStateChanged = function(x) 
  __haxe_Log.trace(Std.string("game state changed ") .. Std.string(Std.string(x)), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/deceptinfect/GameManager.hx",lineNumber=322,className="deceptinfect.GameManager",methodName="gameStateChanged"}));
...
__deceptinfect_client_Hud.targetID = function() 
  ...
  if (_g[1] == 0) then 
    local _hx_tmp = __deceptinfect_ecswip_ComponentManager.components_2[23][_g[2]];
    if (_hx_tmp[1] == 1) then 
...
__deceptinfect_client_Hud.infectionMeter = function() 
  ...
  if (_g1[1] == 0) then 
    local _hx_tmp = __deceptinfect_ecswip_ComponentManager.components_2[23][_g1[2]];
    if (_hx_tmp[1] == 1) then 
      if (_g[1] == 2) then 
        inf = _hx_tmp[2];
      else
...
__deceptinfect_ecswip_GrabSystem.updateSig = function(data) 
  if (__deceptinfect_ecswip_GrabSystem.activeDraws.h[data.index] == nil) then 
    ...
    __deceptinfect_ecswip_ComponentManager.components_2[1][draw] = __deceptinfect_ecswip_ComponentState.Comp(__deceptinfect_infection_components_GrabDraw.new(data.ent, data.ent2));
...
__deceptinfect_infection_systems_InfectionSystem.prototype.onInfectedCl = function(self,data) 
  ...
  local _g = __deceptinfect_ecswip_ComponentManager.components_2[23][diID];
  if (_g[1] == 1) then 
    local _g = _g[2];
    ...
    __deceptinfect_ecswip_ComponentManager.components_2[32][to] = __deceptinfect_ecswip_ComponentState.Comp(x);
    ...
    local to = __deceptinfect_PlayerManager.getLocalPlayerID();
    __deceptinfect_ecswip_ComponentManager.components_2[23][to] = __deceptinfect_ecswip_ComponentState.Comp(c_inf);
...
__deceptinfect_game_RagdollSystem.prototype.recvraginfo = function(self,x) 
  ...
  if (_g[1] == 0) then 
    local _g = _g[2];
    local result = __deceptinfect_ecswip_ComponentManager.components_2[3][_g];
    if (result == __deceptinfect_ecswip_ComponentState.NONE) then 
      local x = __deceptinfect_game_components_RagInfo.new();
      __deceptinfect_ecswip_ComponentManager.components_2[3][_g] = __deceptinfect_ecswip_ComponentState.Comp(x);
      c_raginfo = x;
    else
    ...
    if (_G.IsValid(x.rag)) then 
      ...
      __deceptinfect_ecswip_ComponentManager.components_2[3][x.id] = __deceptinfect_ecswip_ComponentState.Comp(c_rag);
      c_raginfo = c_rag;
    else
      do return end;
    end;
...
__deceptinfect_game_RagdollSystem.prototype.recvstatinfo = function(self,x) 
  ...
  elseif (c_statinfo1) == 1 then 
    ...
    __deceptinfect_ecswip_ComponentManager.components_2[4][x.id] = __deceptinfect_ecswip_ComponentState.Comp(c_stat);
    c_statinfo = c_stat;
...
__deceptinfect_game_RagdollSystem.prototype.pvsChange = function(self,ent,shouldTransmit) 
  ...
  if (_g[1] == 0) then 
    local _g = _g[2];
    local _g1 = __deceptinfect_ecswip_ComponentManager.components_2[35][_g];
    local _g = __deceptinfect_ecswip_ComponentManager.components_2[28][_g];
    if (_g[1] == 1) then 
      if (_g1[1] == 1) then 
        local _g1 = _g1[2];
        local _hx_tmp;
...
__deceptinfect_game_RagdollSystem.prototype.run_client = function(self) 
  ...
  while (rag:hasNext()) do 
    ...
    if (((mdl ~= nil) and (mdl ~= "")) and (rag.showwep == nil)) then 
      ...
      __deceptinfect_ecswip_ComponentManager.components_2[35][_rag.id] = __deceptinfect_ecswip_ComponentState.Comp(c_stat);
      local x = __deceptinfect_game_components_KeepRestart.new();
      __deceptinfect_ecswip_ComponentManager.components_2[34][_rag.id] = __deceptinfect_ecswip_ComponentState.Comp(x);
      ...
      c_wep.parent = rag;
      __deceptinfect_ecswip_ComponentManager.components_2[36][ent.id] = __deceptinfect_ecswip_ComponentState.Comp(c_wep);
      local x = __deceptinfect_game_components_KeepRestart.new();
      __deceptinfect_ecswip_ComponentManager.components_2[34][ent.id] = __deceptinfect_ecswip_ComponentState.Comp(x);
      ent:SetupBones();
  ...
  while (ent:hasNext()) do 
    local ent = ent:next();
    local _g = __deceptinfect_ecswip_ComponentManager.components_2[36][ent];
...
__deceptinfect_infection_systems_InfectionLookSystem.prototype.recvInfectionInfo = function(self,x) 
  ...
  local result = __deceptinfect_ecswip_ComponentManager.components_2[23][target.id];
  local c_inf;
  if (result == __deceptinfect_ecswip_ComponentState.NONE) then 
    local x = __deceptinfect_infection_InfectionComponent.new();
    __deceptinfect_ecswip_ComponentManager.components_2[23][target.id] = __deceptinfect_ecswip_ComponentState.Comp(x);
    c_inf = x;
  else
...
local _hx_static_init = function()
  ...
  __deceptinfect_ecswip_ComponentManager.initComponent(1);__haxe_ds_StringMap.tnull = ({});
